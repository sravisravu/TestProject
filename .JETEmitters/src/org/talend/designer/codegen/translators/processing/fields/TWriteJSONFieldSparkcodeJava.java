...
public class TWriteJSONFieldSparkcodeJava
{
  ...
  protected final String TEXT_337 = NL + "public static class ";
  protected final String TEXT_338 = "_SetKeyAsNullWritable<KEY, VALUE>" + NL + "    implements" + NL + "    org.apache.spark.api.java.function.PairFunction<scala.Tuple2<KEY, VALUE>, NullWritable, VALUE> {" + NL + "" + NL + "    private ContextProperties context = null;" + NL + "" + NL + "    public ";
  protected final String TEXT_339 = "_SetKeyAsNullWritable(JobConf job) {" + NL + "        this.context = new ContextProperties(job);" + NL + "    }" + NL + "" + NL + "    public scala.Tuple2<NullWritable, VALUE> call(" + NL + "            scala.Tuple2<KEY, VALUE> data)" + NL + "            throws java.lang.Exception {" + NL + "        return new scala.Tuple2<NullWritable, VALUE>(" + NL + "                NullWritable.get()," + NL + "                data._2());" + NL + "    }" + NL + "}";
