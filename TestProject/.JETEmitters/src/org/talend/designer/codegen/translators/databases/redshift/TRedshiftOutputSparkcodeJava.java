...
public class TRedshiftOutputSparkcodeJava
{
  protected static String nl;
  public static synchronized TRedshiftOutputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftOutputSparkcodeJava result = new TRedshiftOutputSparkcodeJava();
    nl = null;
    return result;
  }
