...
public class TJDBCOutputSparkstreamingconfigJava {
  protected static String nl;
  public static synchronized TJDBCOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputSparkstreamingconfigJava result = new TJDBCOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_51 = "_ForeachRDDOutput(job));" + NL;
