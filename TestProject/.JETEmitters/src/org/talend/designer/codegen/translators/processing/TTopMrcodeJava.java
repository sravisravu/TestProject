...
public class TTopMrcodeJava
{
  ...
  protected final String TEXT_925 = "> valueToDelete = topK.entries().iterator().next();" + NL + "                    topK.remove(valueToDelete.getKey(), valueToDelete.getValue());" + NL + "                }" + NL + "            }" + NL + "" + NL + "            // Set put the topK into the output" + NL + "            java.util.ArrayList<";
  protected final String TEXT_926 = "> reversedOutput_";
  protected final String TEXT_927 = " = new java.util.ArrayList<";
  protected final String TEXT_928 = ">(topK.values());" + NL + "            java.util.Collections.reverse(reversedOutput_";
  protected final String TEXT_929 = ");" + NL + "            for(";
  protected final String TEXT_930 = " topElement: reversedOutput_";
  protected final String TEXT_931 = ") {";
  protected final String TEXT_932 = NL + "            }";
  protected final String TEXT_933 = NL;
  protected final String TEXT_934 = NL + "                        public java.nio.ByteBuffer ";
  protected final String TEXT_935 = ";";
  protected final String TEXT_936 = NL + "                        public ";
  protected final String TEXT_937 = " ";
  protected final String TEXT_938 = ";";
  protected final String TEXT_939 = NL + "                    this.";
  protected final String TEXT_940 = " = input.";
  protected final String TEXT_941 = ";";
  protected final String TEXT_942 = NL + "        // the two objects are the same, but multimap implementation need to see them as different." + NL + "        return -1;";
  protected final String TEXT_943 = NL + "            return -1;";
  protected final String TEXT_944 = NL + "            return 1;";
  protected final String TEXT_945 = NL + "            return 1;";
  protected final String TEXT_946 = NL + "            return -1;";
  protected final String TEXT_947 = NL + "            if(this.";
  protected final String TEXT_948 = " == null && target.";
  protected final String TEXT_949 = " != null){";
  protected final String TEXT_950 = NL + "            }else if(this.";
  protected final String TEXT_951 = " != null && target.";
  protected final String TEXT_952 = " == null){";
  protected final String TEXT_953 = NL + "            }else if(this.";
  protected final String TEXT_954 = " == null && target.";
  protected final String TEXT_955 = " == null){" + NL + "                // ignore and will use the next criteria" + NL + "            }else{";
  protected final String TEXT_956 = NL + "                if(this.";
  protected final String TEXT_957 = " != target.";
  protected final String TEXT_958 = "){" + NL + "                    if (this.";
  protected final String TEXT_959 = "){";
  protected final String TEXT_960 = NL + "                    } else {";
  protected final String TEXT_961 = NL + "                    }" + NL + "                }";
  protected final String TEXT_962 = NL + "                if(this.";
  protected final String TEXT_963 = " > target.";
  protected final String TEXT_964 = "){";
  protected final String TEXT_965 = NL + "                }else if(this.";
  protected final String TEXT_966 = " < target.";
  protected final String TEXT_967 = "){";
  protected final String TEXT_968 = NL + "                }";
  protected final String TEXT_969 = NL + "                    if(!this.";
  protected final String TEXT_970 = ".equals(target.";
  protected final String TEXT_971 = ")) {" + NL + "                        if(this.";
  protected final String TEXT_972 = ".compareTo(target.";
  protected final String TEXT_973 = ") > 0){";
  protected final String TEXT_974 = NL + "                        }else{";
  protected final String TEXT_975 = NL + "                        }" + NL + "                    }";
  protected final String TEXT_976 = NL + "                    String s1_";
  protected final String TEXT_977 = " = new String(this.";
  protected final String TEXT_978 = ");" + NL + "                    String s2_";
  protected final String TEXT_979 = " = new String(target.";
  protected final String TEXT_980 = ");" + NL + "                    if(!s1_";
  protected final String TEXT_981 = ".equals(s2_";
  protected final String TEXT_982 = ")){" + NL + "                        if(s1_";
  protected final String TEXT_983 = ".compareTo(s2_";
  protected final String TEXT_984 = ") > 0){";
  protected final String TEXT_985 = NL + "                        }else{";
  protected final String TEXT_986 = NL + "                        }" + NL + "                    }";
  protected final String TEXT_987 = NL + "                if(this.";
  protected final String TEXT_988 = " - target.";
  protected final String TEXT_989 = " != 0){" + NL + "                    if(this.";
  protected final String TEXT_990 = " - target.";
  protected final String TEXT_991 = " > 0){";
  protected final String TEXT_992 = NL + "                    }else{";
  protected final String TEXT_993 = NL + "                    }" + NL + "                }";
  protected final String TEXT_994 = NL + "                    int cmp_";
  protected final String TEXT_995 = " = FormatterUtils.format_DateInUTC(this.";
  protected final String TEXT_996 = ", ";
  protected final String TEXT_997 = ").compareTo(FormatterUtils.format_DateInUTC(target.";
  protected final String TEXT_998 = ", ";
  protected final String TEXT_999 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1000 = " > 0){";
  protected final String TEXT_1001 = NL + "                    }else if(cmp_";
  protected final String TEXT_1002 = " < 0){";
  protected final String TEXT_1003 = NL + "                    }";
  protected final String TEXT_1004 = NL + "                    if(!this.";
  protected final String TEXT_1005 = ".equals(target.";
  protected final String TEXT_1006 = ")){" + NL + "                        if(this.";
  protected final String TEXT_1007 = ".compareTo(target.";
  protected final String TEXT_1008 = ") > 0){";
  protected final String TEXT_1009 = NL + "                        }else{";
  protected final String TEXT_1010 = NL + "                        }" + NL + "                    }";
  protected final String TEXT_1011 = NL + "                    int cmp_";
  protected final String TEXT_1012 = " = String.valueOf(this.";
  protected final String TEXT_1013 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1014 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1015 = " > 0){";
  protected final String TEXT_1016 = NL + "                    }else if(cmp_";
  protected final String TEXT_1017 = " < 0){";
  protected final String TEXT_1018 = NL + "                    }";
  protected final String TEXT_1019 = NL + "                    if(this.";
  protected final String TEXT_1020 = " > target.";
  protected final String TEXT_1021 = "){";
  protected final String TEXT_1022 = NL + "                    }else if(this.";
  protected final String TEXT_1023 = " < target.";
  protected final String TEXT_1024 = "){";
  protected final String TEXT_1025 = NL + "                    }";
  protected final String TEXT_1026 = NL + "                    int cmp_";
  protected final String TEXT_1027 = " = String.valueOf(this.";
  protected final String TEXT_1028 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1029 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1030 = " > 0){";
  protected final String TEXT_1031 = NL + "                    }else if(cmp_";
  protected final String TEXT_1032 = " < 0){";
  protected final String TEXT_1033 = NL + "                    }";
  protected final String TEXT_1034 = NL + "                    if(this.";
  protected final String TEXT_1035 = " > target.";
  protected final String TEXT_1036 = "){";
  protected final String TEXT_1037 = NL + "                    }else if(this.";
  protected final String TEXT_1038 = " < target.";
  protected final String TEXT_1039 = "){";
  protected final String TEXT_1040 = NL + "                    }";
  protected final String TEXT_1041 = NL + "                    int cmp_";
  protected final String TEXT_1042 = " = String.valueOf(this.";
  protected final String TEXT_1043 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1044 = "));";
  protected final String TEXT_1045 = NL + "                    int cmp_";
  protected final String TEXT_1046 = " = this.";
  protected final String TEXT_1047 = ".compareTo(target.";
  protected final String TEXT_1048 = ");";
  protected final String TEXT_1049 = NL + "                if(cmp_";
  protected final String TEXT_1050 = " > 0){";
  protected final String TEXT_1051 = NL + "                }else if(cmp_";
  protected final String TEXT_1052 = " < 0){";
  protected final String TEXT_1053 = NL + "                }";
  protected final String TEXT_1054 = NL + "                    int cmp_";
  protected final String TEXT_1055 = " = String.valueOf(this.";
  protected final String TEXT_1056 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1057 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1058 = " > 0){";
  protected final String TEXT_1059 = NL + "                    }else if(cmp_";
  protected final String TEXT_1060 = " < 0){";
  protected final String TEXT_1061 = NL + "                    }";
  protected final String TEXT_1062 = NL + "                    if(this.";
  protected final String TEXT_1063 = " > target.";
  protected final String TEXT_1064 = "){";
  protected final String TEXT_1065 = NL + "                    }else if(this.";
  protected final String TEXT_1066 = " < target.";
  protected final String TEXT_1067 = "){";
  protected final String TEXT_1068 = NL + "                    }";
  protected final String TEXT_1069 = NL + "                    int cmp_";
  protected final String TEXT_1070 = " = String.valueOf(this.";
  protected final String TEXT_1071 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1072 = "));" + NL + "                    if(cmp_";
  protected final String TEXT_1073 = " > 0){";
  protected final String TEXT_1074 = NL + "                    }else if(cmp_";
  protected final String TEXT_1075 = " < 0){";
  protected final String TEXT_1076 = NL + "                }";
  protected final String TEXT_1077 = NL + "                if(this.";
  protected final String TEXT_1078 = " > target.";
  protected final String TEXT_1079 = "){";
  protected final String TEXT_1080 = NL + "                }else if(this.";
  protected final String TEXT_1081 = " < target.";
  protected final String TEXT_1082 = "){";
  protected final String TEXT_1083 = NL + "                }";
  protected final String TEXT_1084 = NL + "            Don't support Object type: column--";
  protected final String TEXT_1085 = NL + "                int cmp_";
  protected final String TEXT_1086 = " = String.valueOf(this.";
  protected final String TEXT_1087 = ").compareTo(String.valueOf(target.";
  protected final String TEXT_1088 = "));" + NL + "                if(cmp_";
  protected final String TEXT_1089 = " > 0){";
  protected final String TEXT_1090 = NL + "                }else if(cmp_";
  protected final String TEXT_1091 = " < 0){";
  protected final String TEXT_1092 = NL + "                }";
  protected final String TEXT_1093 = NL + "                if(this.";
  protected final String TEXT_1094 = " > target.";
  protected final String TEXT_1095 = "){";
  protected final String TEXT_1096 = NL + "                }else if(this.";
  protected final String TEXT_1097 = " < target.";
  protected final String TEXT_1098 = "){";
  protected final String TEXT_1099 = NL + "                }";
  protected final String TEXT_1100 = NL + "            int comp_";
  protected final String TEXT_1101 = " = this.";
  protected final String TEXT_1102 = ".compareTo(target.";
  protected final String TEXT_1103 = ");" + NL + "            if(comp_";
  protected final String TEXT_1104 = " != 0){" + NL + "                if(comp_";
  protected final String TEXT_1105 = " > 0){";
  protected final String TEXT_1106 = NL + "                }else{";
  protected final String TEXT_1107 = NL + "                }" + NL + "" + NL + "            }";
  protected final String TEXT_1108 = NL + "            Don't support List type: column--";
  protected final String TEXT_1109 = NL + "            Don't support Document type: column--";
  protected final String TEXT_1110 = NL + "            Don't support Dynamic type: column--";
  protected final String TEXT_1111 = NL + "            }";
  protected final String TEXT_1112 = NL + "    public static class ";
  protected final String TEXT_1113 = "_Comparator  implements Comparable<";
  protected final String TEXT_1114 = "_Comparator>{";
  protected final String TEXT_1115 = NL + "        public ";
  protected final String TEXT_1116 = "_Comparator (";
  protected final String TEXT_1117 = " input) {";
  protected final String TEXT_1118 = NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public int compareTo(";
  protected final String TEXT_1119 = "_Comparator target) {";
  protected final String TEXT_1120 = NL + "        }" + NL + "    }";
  protected final String TEXT_1121 = NL;
  protected final String TEXT_1122 = NL;
  protected final String TEXT_1123 = "\tstatic class OneReducePartitioner_";
  protected final String TEXT_1124 = " implements org.apache.hadoop.mapred.Partitioner {" + NL + "\t\tpublic int getPartition(Object keyObj, Object valueObj, int splitNum) {" + NL + "\t\t\treturn 0;" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void configure(JobConf arg0) {" + NL + "" + NL + "\t\t}" + NL + "\t}" + NL;
