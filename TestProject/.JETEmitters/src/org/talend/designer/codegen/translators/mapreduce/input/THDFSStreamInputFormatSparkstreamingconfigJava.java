...
public class THDFSStreamInputFormatSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized THDFSStreamInputFormatSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSStreamInputFormatSparkstreamingconfigJava result = new THDFSStreamInputFormatSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_119 = NL + "\t\t\torg.apache.spark.streaming.api.java.JavaPairInputDStream<NullWritable, ";
  protected final String TEXT_120 = "> rdd_";
  protected final String TEXT_121 = " = ctx.fileStream(";
  protected final String TEXT_122 = ", NullWritable.class, ";
  protected final String TEXT_123 = ".class, ";
  protected final String TEXT_124 = "StructInputFormat.class);";
