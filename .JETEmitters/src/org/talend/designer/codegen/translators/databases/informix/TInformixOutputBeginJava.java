...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_336 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_337 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_338 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_339 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_340 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_348 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_349 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_350 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_351 = " = rsTable_";
  protected final String TEXT_352 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_353 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_358 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_366 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_367 = ".";
  protected final String TEXT_368 = ", \"";
  protected final String TEXT_369 = "\")";
  protected final String TEXT_370 = ".toUpperCase()";
  ...
  protected final String TEXT_379 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_410 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_411 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_412 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_426 = NL + "                              stmtTruncCount_";
  protected final String TEXT_427 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_428 = "));";
  protected final String TEXT_429 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_430 = " = stmtTruncCount_";
  protected final String TEXT_431 = ".executeQuery(\"";
  protected final String TEXT_432 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_433 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_438 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_456 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_457 = " = conn_";
  protected final String TEXT_458 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_459 = " = stmtTruncCount_";
  protected final String TEXT_460 = ".executeQuery(\"";
  protected final String TEXT_461 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_494 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_500 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_507 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_533 = NL + "        StringBuffer query_";
  protected final String TEXT_534 = " = null;" + NL + "       \t";
  protected final String TEXT_535 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_545 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_546 = " = insert_";
  protected final String TEXT_547 = ".split(\"\\\\?\");";
  protected final String TEXT_548 = NL + "\t\t\tdelete_";
  protected final String TEXT_549 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_550 = " = delete_";
  protected final String TEXT_551 = ".split(\"\\\\?\");";
  protected final String TEXT_552 = NL + "\t\t\treplace_";
  protected final String TEXT_553 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_554 = " = replace_";
  protected final String TEXT_555 = ".split(\"\\\\?\");";
  protected final String TEXT_556 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_557 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_558 = " = insertIgnore_";
  ...
  protected final String TEXT_563 = NL + NL + "        int commitEvery_";
  protected final String TEXT_564 = " = ";
  protected final String TEXT_565 = ";" + NL + "" + NL + "        int commitCounter_";
