...
public class TSAPHanaOutputMainJava {
  ...
  protected final String TEXT_256 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_257 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_330 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_331 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_332 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_333 = " = conn_";
  protected final String TEXT_334 = ".createStatement();";
  protected final String TEXT_335 = NL + "                              stmtClear_";
  protected final String TEXT_336 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_346 = NL + "                              stmtTruncCount_";
  protected final String TEXT_347 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_348 = "));";
  protected final String TEXT_349 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_350 = " = stmtTruncCount_";
  protected final String TEXT_351 = ".executeQuery(\"";
  protected final String TEXT_352 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_353 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_354 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_358 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_399 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  ...
  protected final String TEXT_443 = "\")+\") VALUES (";
  ...
  protected final String TEXT_465 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_472 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_473 = " + \" WHERE ";
  protected final String TEXT_474 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_475 = " = conn_";
  protected final String TEXT_476 = ".prepareStatement(insert_";
  protected final String TEXT_477 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_496 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_502 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_509 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_510 = ".";
  protected final String TEXT_511 = ", \"";
  protected final String TEXT_512 = "\")+\" WHERE ";
  protected final String TEXT_513 = "\";";
  protected final String TEXT_514 = NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_521 = NL + "\t    String delete_";
  protected final String TEXT_522 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_587 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_588 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_589 = NL + "    \t\t  batchSizeCounter_";
  ...
  protected final String TEXT_597 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_598 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_599 = " = true;";
  protected final String TEXT_600 = NL + "                    throw(e_";
  ...
  protected final String TEXT_614 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_615 = ").getSQLState();";
  protected final String TEXT_616 = NL + "                        ";
  protected final String TEXT_617 = ".errorMessage = e_";
  protected final String TEXT_618 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_619 = ";";
  protected final String TEXT_620 = NL + "                        System.err.print(e_";
  protected final String TEXT_621 = ".getMessage());";
  ...
  protected final String TEXT_673 = "                " + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_674 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_675 = " = true;";
  protected final String TEXT_676 = NL + "                    throw(e_";
  ...
  protected final String TEXT_690 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_691 = ").getSQLState();";
  protected final String TEXT_692 = NL + "                        ";
  protected final String TEXT_693 = ".errorMessage = e_";
  protected final String TEXT_694 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_695 = ";";
  protected final String TEXT_696 = NL + "                        System.err.print(e_";
  protected final String TEXT_697 = ".getMessage());";
  ...
  protected final String TEXT_744 = NL + "                    globalMap.put(\"";
  protected final String TEXT_745 = "_QUERY\", query_";
  protected final String TEXT_746 = ".toString().trim());";
  protected final String TEXT_747 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_748 = " = updatedCount_";
  protected final String TEXT_749 = " + pstmtUpdate_";
  protected final String TEXT_750 = ".executeUpdate(); " + NL + "                    nb_line_";
  ...
  protected final String TEXT_771 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_772 = ").getSQLState();";
  ...
  protected final String TEXT_779 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_788 = ",insertSQLSplits_";
  ...
  protected final String TEXT_799 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_800 = " = insertedCount_";
  protected final String TEXT_801 = " + pstmtInsert_";
  protected final String TEXT_802 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_803 = "++;";
  protected final String TEXT_804 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_805 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_806 = " = true;";
  protected final String TEXT_807 = NL + "                        throw(e_";
  protected final String TEXT_808 = ");";
  protected final String TEXT_809 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_823 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_824 = ").getSQLState();";
  protected final String TEXT_825 = NL + "                            ";
  protected final String TEXT_826 = ".errorMessage = e_";
  protected final String TEXT_827 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_828 = ";";
  protected final String TEXT_829 = NL + "                            System.err.print(e_";
  protected final String TEXT_830 = ".getMessage());";
  protected final String TEXT_831 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_832 = NL + "    \t    int updateFlag_";
  ...
  protected final String TEXT_842 = ",updateSQLSplits_";
  protected final String TEXT_843 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_844 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_845 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_872 = NL + "    \t" + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_873 = "=pstmtUpdate_";
  protected final String TEXT_874 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_875 = " = updatedCount_";
  protected final String TEXT_876 = " + updateFlag_";
  protected final String TEXT_877 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_878 = " == 0) {" + NL + "            \t";
  protected final String TEXT_879 = NL + "\t\t\t\tquery_";
  protected final String TEXT_880 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_881 = NL + "                        ";
  protected final String TEXT_882 = NL + "                            query_";
  protected final String TEXT_883 = " = ";
  protected final String TEXT_884 = ";";
  protected final String TEXT_885 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  ...
  protected final String TEXT_891 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_897 = NL + "                    globalMap.put(\"";
  protected final String TEXT_898 = "_QUERY\", query_";
  protected final String TEXT_899 = ".toString().trim());";
  protected final String TEXT_900 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_905 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_906 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_907 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_908 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_909 = " = true;";
  protected final String TEXT_910 = NL + "                        throw(e_";
  ...
  protected final String TEXT_926 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_927 = ").getSQLState();";
  protected final String TEXT_928 = NL + "                            ";
  protected final String TEXT_929 = ".errorMessage = e_";
  protected final String TEXT_930 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_931 = ";";
  protected final String TEXT_932 = NL + "                            System.err.print(e_";
  protected final String TEXT_933 = ".getMessage());";
  ...
  protected final String TEXT_945 = NL + "                globalMap.put(\"";
  protected final String TEXT_946 = "_QUERY\", query_";
  protected final String TEXT_947 = ".toString().trim());";
  protected final String TEXT_948 = NL + "    \t\t";
  protected final String TEXT_949 = NL + "    \t\t\tpstmt_";
  protected final String TEXT_950 = ".addBatch();" + NL + "\t\t\t\tnb_line_";
  protected final String TEXT_951 = "++;" + NL + "    \t\t\t";
  protected final String TEXT_952 = NL + "\t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_953 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_954 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_955 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_956 = " = deletedCount_";
  protected final String TEXT_957 = " + pstmt_";
  protected final String TEXT_958 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_959 = "++;";
  protected final String TEXT_960 = NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_961 = ") {" + NL + "                whetherReject_";
  protected final String TEXT_962 = " = true;";
  protected final String TEXT_963 = NL + "                    throw(e_";
  ...
  protected final String TEXT_979 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_980 = ").getSQLState();";
  protected final String TEXT_981 = NL + "                        ";
  protected final String TEXT_982 = ".errorMessage = e_";
  protected final String TEXT_983 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_984 = ";";
  protected final String TEXT_985 = NL + "                        System.err.print(e_";
  protected final String TEXT_986 = ".getMessage());";
  protected final String TEXT_987 = NL + "            }";
  protected final String TEXT_988 = NL + "    \t";
  protected final String TEXT_989 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1001 = " <= batchSizeCounter_";
  protected final String TEXT_1002 = ") {                ";
  protected final String TEXT_1003 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1004 = " = 0;" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_1022 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1023 = "){" + NL + "                \t";
  protected final String TEXT_1024 = NL + "                \t\tthrow(e_";
  protected final String TEXT_1025 = ");" + NL + "                \t";
  protected final String TEXT_1026 = NL + "                \tint countSum_";
  protected final String TEXT_1027 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1028 = ": e_";
  protected final String TEXT_1029 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1042 = " " + NL + "                \tSystem.err.println(e_";
  protected final String TEXT_1043 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1044 = NL + "                }";
  protected final String TEXT_1045 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1046 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1047 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_1048 = " <= commitCounter_";
  protected final String TEXT_1049 = ") {" + NL + "                ";
  protected final String TEXT_1050 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1051 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1052 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1053 = ": pstmt_";
  protected final String TEXT_1054 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1055 = " += (countEach_";
  protected final String TEXT_1056 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1057 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1058 = NL + "            \t    \t";
  protected final String TEXT_1059 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1060 = " += countSum_";
  protected final String TEXT_1061 = ";" + NL + "            \t    \t";
  protected final String TEXT_1062 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1063 = " += countSum_";
  protected final String TEXT_1064 = ";" + NL + "            \t    \t";
  protected final String TEXT_1065 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1066 = " += countSum_";
  protected final String TEXT_1067 = ";" + NL + "            \t    \t";
  protected final String TEXT_1068 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e_";
  ...
  protected final String TEXT_1074 = ": e_";
  protected final String TEXT_1075 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1089 = ".getMessage());" + NL + "                \t";
  protected final String TEXT_1090 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_1091 = NL + "                \t";
  protected final String TEXT_1092 = NL + "                \tconn_";
  protected final String TEXT_1093 = ".commit();                " + NL + "                \t";
  protected final String TEXT_1094 = "   " + NL + "                \tcommitCounter_";
