...
public class TCassandraOutputSparkstreamingconfigJava
{
  ...
  protected final String TEXT_141 = NL + "\t\t\trdd_";
  protected final String TEXT_142 = ".rdd().conf().set(";
  protected final String TEXT_143 = ", ";
  protected final String TEXT_144 = ");\t" + NL + "\t\t";
  protected final String TEXT_145 = NL + "\t    java.util.Map<String, String> columnMapping_";
  protected final String TEXT_146 = " = new java.util.HashMap<String, String>();" + NL + "\t\t";
  protected final String TEXT_147 = NL + "\t\t\t\tcolumnMapping_";
  protected final String TEXT_148 = ".put(\"";
  protected final String TEXT_149 = "\", \"";
  protected final String TEXT_150 = "\");" + NL + "\t    \t";
  protected final String TEXT_151 = NL + "\t\tcom.datastax.spark.connector.japi.CassandraStreamingJavaUtil.javaFunctions(rdd_";
  protected final String TEXT_152 = ").writerBuilder(" + NL + "\t    \t\t";
  protected final String TEXT_153 = ", ";
  protected final String TEXT_154 = ", " + NL + "\t    \t\tcom.datastax.spark.connector.japi.CassandraJavaUtil.mapToRow(";
  protected final String TEXT_155 = ".class, columnMapping_";
  protected final String TEXT_156 = ")" + NL + "\t\t\t)" + NL + "\t\t\t.withColumnSelector(com.datastax.spark.connector.japi.CassandraJavaUtil.someColumns(";
  protected final String TEXT_157 = "))" + NL + "\t\t\t.saveToCassandra();" + NL + "\t";
  protected final String TEXT_158 = NL + "\t\trdd_";
  protected final String TEXT_159 = ".foreachRDD(new ";
  protected final String TEXT_160 = "_ForeachRDDFunction(job));" + NL + "\t";
