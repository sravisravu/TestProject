...
public class TMDMRestInputEndJava
{
  protected static String nl;
  public static synchronized TMDMRestInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMDMRestInputEndJava result = new TMDMRestInputEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_42 = NL + "                    }" + NL + "                }" + NL + "                globalMap.put(\"";
