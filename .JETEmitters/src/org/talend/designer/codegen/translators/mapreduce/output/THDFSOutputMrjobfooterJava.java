...
public class THDFSOutputMrjobfooterJava
{
  protected static String nl;
  public static synchronized THDFSOutputMrjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSOutputMrjobfooterJava result = new THDFSOutputMrjobfooterJava();
    nl = null;
    return result;
  }
