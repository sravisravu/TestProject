...
public class TNormalizeMrconfigJava
{
  protected static String nl;
  public static synchronized TNormalizeMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNormalizeMrconfigJava result = new TNormalizeMrconfigJava();
    nl = null;
    return result;
  }
