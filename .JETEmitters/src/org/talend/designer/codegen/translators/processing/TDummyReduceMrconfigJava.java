...
public class TDummyReduceMrconfigJava
{
  protected static String nl;
  public static synchronized TDummyReduceMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyReduceMrconfigJava result = new TDummyReduceMrconfigJava();
    nl = null;
    return result;
  }
