...
public class TWriteDelimitedFieldsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TWriteDelimitedFieldsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWriteDelimitedFieldsSparkstreamingconfigJava result = new TWriteDelimitedFieldsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
