...
public class TSqoopExportBeginJava
{
  ...
  protected final String TEXT_194 = ".set(\"mapreduce.application.classpath\", \"";
  protected final String TEXT_195 = "\");";
  protected final String TEXT_196 = NL + "\t\tconfiguration_";
  protected final String TEXT_197 = ".set(\"yarn.application.classpath\", \"";
  protected final String TEXT_198 = "\");";
  protected final String TEXT_199 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_200 = ".set(\"mapreduce.map.memory.mb\", ";
  protected final String TEXT_201 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_202 = ".set(\"mapreduce.reduce.memory.mb\", ";
  protected final String TEXT_203 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_204 = ".set(\"yarn.app.mapreduce.am.resource.mb\", ";
  protected final String TEXT_205 = ");";
  protected final String TEXT_206 = NL + "\t\tconfiguration_";
  protected final String TEXT_207 = ".set(\"mapred.job.tracker\", ";
  protected final String TEXT_208 = ");";
  protected final String TEXT_209 = NL + "        configuration_";
  protected final String TEXT_210 = ".set(\"mapred.job.map.memory.mb\", ";
  protected final String TEXT_211 = ");" + NL + "        configuration_";
  protected final String TEXT_212 = ".set(\"mapred.job.reduce.memory.mb\", ";
  ...
  protected final String TEXT_219 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_220 = ");";
  protected final String TEXT_221 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_222 = ".set(\"mapreduce.jobtracker.kerberos.principal\", ";
  protected final String TEXT_223 = ");";
  protected final String TEXT_224 = NL + "\t\t\tconfiguration_";
  protected final String TEXT_225 = ".set(\"yarn.resourcemanager.principal\", ";
  protected final String TEXT_226 = ");" + NL + "\t\t\tconfiguration_";
  protected final String TEXT_227 = ".set(\"mapreduce.jobhistory.principal\", ";
  protected final String TEXT_228 = ");";
  protected final String TEXT_229 = NL + "            System.setProperty(\"pname\", \"MapRLogin\");" + NL + "            System.setProperty(\"https.protocols\", \"TLSv1.2\");" + NL + "            System.setProperty(\"mapr.home.dir\", ";
  protected final String TEXT_230 = ");" + NL + "            System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_231 = ");";
  protected final String TEXT_232 = NL + "\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_233 = ", ";
  protected final String TEXT_234 = ");";
  protected final String TEXT_235 = NL + "            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_236 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "            maprLogin_";
  protected final String TEXT_237 = ".getMapRCredentialsViaKerberos(";
  ...
  protected final String TEXT_241 = ");" + NL + "            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_242 = " = new com.mapr.login.client.MapRLoginHttpsClient();";
  protected final String TEXT_243 = NL + "                System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_244 = ");";
  protected final String TEXT_245 = NL + "                maprLogin_";
  protected final String TEXT_246 = ".setCheckUGI(false);";
  protected final String TEXT_247 = " " + NL + "                final String decryptedMapRPassword_";
  protected final String TEXT_248 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_249 = ");";
  protected final String TEXT_250 = NL + "                final String decryptedMapRPassword_";
  protected final String TEXT_251 = " = ";
  protected final String TEXT_252 = "; ";
  protected final String TEXT_253 = NL + "            maprLogin_";
  protected final String TEXT_254 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_255 = ", ";
  protected final String TEXT_256 = ", decryptedMapRPassword_";
  protected final String TEXT_257 = ", ";
  protected final String TEXT_258 = ");";
  protected final String TEXT_259 = NL + "        configuration_";
  protected final String TEXT_260 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_261 = NL + "\t//check whether we can connect to the fs?" + NL + "\torg.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_262 = " = org.apache.hadoop.fs.FileSystem.get(configuration_";
  protected final String TEXT_263 = ");" + NL + "\t" + NL + "\tcom.cloudera.sqoop.tool.SqoopTool sqoopTool_";
  protected final String TEXT_264 = " = com.cloudera.sqoop.tool.SqoopTool.getTool(\"export\");" + NL + "" + NL + "\tcom.cloudera.sqoop.SqoopOptions sqoopOptions_";
  protected final String TEXT_265 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_266 = ");" + NL + "\t" + NL + "\tsqoopOptions_";
  protected final String TEXT_267 = ".setConnectString(";
  protected final String TEXT_268 = "); // __CONNECTION__";
  protected final String TEXT_269 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_270 = ".setTableName(";
  protected final String TEXT_271 = ");";
  protected final String TEXT_272 = NL + "\tsqoopOptions_";
  protected final String TEXT_273 = ".setExportDir(";
  protected final String TEXT_274 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_275 = ".setUsername(";
  protected final String TEXT_276 = "); // __USERNAME__" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_285 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_286 = ".setPassword(decryptedPassword_";
  protected final String TEXT_287 = "); // __PASSWORD__" + NL + "\t";
  protected final String TEXT_288 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_289 = ".setPasswordFilePath(";
  protected final String TEXT_290 = ");" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_291 = ".setPassword(org.apache.sqoop.util.CredentialsUtil.fetchPassword";
  ...
  protected final String TEXT_296 = ".setDirectMode(true);";
  protected final String TEXT_297 = NL + "\t";
  protected final String TEXT_298 = "sqoopOptions_";
  protected final String TEXT_299 = ".setNumMappers(Integer.valueOf(";
  protected final String TEXT_300 = "));";
  protected final String TEXT_301 = NL + "\t";
  protected final String TEXT_302 = "sqoopOptions_";
  protected final String TEXT_303 = ".setBatchMode(true);";
  protected final String TEXT_304 = NL + "\t";
  protected final String TEXT_305 = "sqoopOptions_";
  protected final String TEXT_306 = ".setClearStagingTable(true);";
  protected final String TEXT_307 = NL + "\t";
  protected final String TEXT_308 = "sqoopOptions_";
  protected final String TEXT_309 = ".setCall(";
  protected final String TEXT_310 = ");";
  protected final String TEXT_311 = NL + "\t";
  protected final String TEXT_312 = "sqoopOptions_";
  protected final String TEXT_313 = ".setStagingTableName(";
  protected final String TEXT_314 = ");";
  protected final String TEXT_315 = NL + "\t";
  protected final String TEXT_316 = "sqoopOptions_";
  protected final String TEXT_317 = ".setUpdateMode(com.cloudera.sqoop.SqoopOptions.";
  protected final String TEXT_318 = ");";
  protected final String TEXT_319 = NL + "\t";
  protected final String TEXT_320 = NL + "\t\t\t\tStringBuilder sb_update_";
  protected final String TEXT_321 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_322 = NL + "\t\t\t\t\t\tsb_update_";
  protected final String TEXT_323 = ".append(";
  protected final String TEXT_324 = ");" + NL + "\t";
  protected final String TEXT_325 = NL + "\t\t\t\t\t\tsb_update_";
  protected final String TEXT_326 = ".append(\",\" + ";
  protected final String TEXT_327 = ");" + NL + "\t";
  protected final String TEXT_328 = NL + "\t\t\t\tsqoopOptions_";
  protected final String TEXT_329 = ".setUpdateKeyCol(sb_update_";
  protected final String TEXT_330 = ".toString());" + NL + "\t";
  protected final String TEXT_331 = NL + "\t\t\t\tStringBuilder sb_java_";
  protected final String TEXT_332 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_333 = NL + "\t\t\t\t\t\tsb_java_";
  protected final String TEXT_334 = ".append(";
  protected final String TEXT_335 = " + \"=\" + ";
  protected final String TEXT_336 = ");" + NL + "\t";
  protected final String TEXT_337 = NL + "\t\t\t\t\t\tsb_java_";
  protected final String TEXT_338 = ".append(\",\" + ";
  protected final String TEXT_339 = " + \"=\" + ";
  protected final String TEXT_340 = ");" + NL + "\t";
  protected final String TEXT_341 = NL + "\t\t\t\tsqoopOptions_";
  protected final String TEXT_342 = ".setMapColumnJava(sb_java_";
  protected final String TEXT_343 = ".toString());" + NL + "\t";
  protected final String TEXT_344 = NL + "\tjava.util.Properties additionalProperties_";
  protected final String TEXT_345 = " = new java.util.Properties();";
  protected final String TEXT_346 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_347 = ".put(";
  protected final String TEXT_348 = ", \"\"+";
  protected final String TEXT_349 = ".codePointAt(0)); ";
  protected final String TEXT_350 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_351 = ".put(";
  protected final String TEXT_352 = ", ";
  protected final String TEXT_353 = "); ";
  protected final String TEXT_354 = NL + "\tsqoopOptions_";
  protected final String TEXT_355 = ".loadProperties(additionalProperties_";
  protected final String TEXT_356 = ");" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_357 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_358 = ", configuration_";
  protected final String TEXT_359 = ", sqoopOptions_";
  protected final String TEXT_360 = ");" + NL + "" + NL + "\ttry {" + NL + "\t\tint result_";
  protected final String TEXT_361 = " = sqoop_";
  protected final String TEXT_362 = ".run(null);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_363 = "_EXIT_CODE\", result_";
  protected final String TEXT_364 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_365 = " != 0) {";
  protected final String TEXT_366 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop export job has failed. Please check the logs.\");";
  protected final String TEXT_367 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop export job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_369 = " - The Sqoop export job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_370 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  protected final String TEXT_371 = NL + "\t\t\tthrow e;";
  protected final String TEXT_372 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_373 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_374 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_375 = NL + "\t}" + NL + "\t" + NL + "\t";
  protected final String TEXT_376 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_377 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_378 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_379 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_380 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_381 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_382 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_383 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_384 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
