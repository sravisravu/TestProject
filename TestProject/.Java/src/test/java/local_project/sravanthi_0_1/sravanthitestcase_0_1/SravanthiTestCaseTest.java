package local_project.sravanthi_0_1.sravanthitestcase_0_1;
...
/**
 * Job: SravanthiTestCaseTest Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class SravanthiTestCaseTest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "SravanthiTestCaseTest.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(SravanthiTestCaseTest.class);
	...
	private final String jobName = "SravanthiTestCase";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SravanthiTestCaseTest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SravanthiTestCaseTest.this, new Object[] {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_SravanthiTestCase = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_SravanthiTestCase = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_LOCAL_PROJECT_SravanthiTestCase) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				log4jParamters_tFileInputDelimited_1
						.append("FILENAME"
								+ " = "
								+ "\"C:/Talend/6.2.1/cmdline/studio/workspace/in.csv\"");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Talend/6.2.1/cmdline/studio/workspace/in.csv";
					...
					if (!((Object) ("C:/Talend/6.2.1/cmdline/studio/workspace/in.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final SravanthiTestCaseTest SravanthiTestCaseTestClass = new SravanthiTestCaseTest();

		int exitCode = SravanthiTestCaseTestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'SravanthiTestCase' - Done.");
		}
	...
	public void testDefault() throws java.lang.Exception {
		...
		SravanthiTestCaseTestClass.runJobInTOS(arrays);
		...
		if (SravanthiTestCaseTestClass.exception != null) {
			throw SravanthiTestCaseTestClass.exception;
		}
	}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'SravanthiTestCase' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = SravanthiTestCaseTest.class
					.getClassLoader().getResourceAsStream(
							"local_project/sravanthi_0_1/sravanthitestcase_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : SravanthiTestCaseTest");
		}
...
/************************************************************************************************
 * 60314 characters generated by Talend Big Data Platform on the March 8, 2017
 * 3:35:54 PM CST
 ************************************************************************************************/
