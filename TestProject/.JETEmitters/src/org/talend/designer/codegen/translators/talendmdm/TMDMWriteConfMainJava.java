...
public class TMDMWriteConfMainJava
{
  ...
  protected final String TEXT_49 = ".peek());";
  ...
  protected final String TEXT_76 = ".getBytes();";
  ...
  protected final String TEXT_87 = NL + "    input_";
  protected final String TEXT_88 = " = queue_";
  protected final String TEXT_89 = ".peek();" + NL + "" + NL + "    try {";
  protected final String TEXT_90 = NL + "            Integer pos = null;" + NL + "            if(!";
  protected final String TEXT_91 = ") {" + NL + "                pos = ";
  protected final String TEXT_92 = ";" + NL + "            }" + NL + "" + NL + "            org.talend.mdm.webservice.WSPartialPutItem wsPartialPutItem_";
  protected final String TEXT_93 = " = new org.talend.mdm.webservice.WSPartialPutItem(";
  ...
  protected final String TEXT_101 = ",pos, input_";
  protected final String TEXT_102 = ");" + NL + "            wspk_";
  protected final String TEXT_103 = " = service_";
  protected final String TEXT_104 = ".partialPutItem(wsPartialPutItem_";
  protected final String TEXT_105 = ");" + NL;
  protected final String TEXT_106 = NL;
  protected final String TEXT_107 = NL + "                      ";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = "= wspk_";
  protected final String TEXT_110 = ".getIds().get(";
  protected final String TEXT_111 = ");";
  protected final String TEXT_112 = NL;
  protected final String TEXT_113 = NL + NL + "            org.talend.mdm.webservice.WSPutItem item_";
  protected final String TEXT_114 = " = new org.talend.mdm.webservice.WSPutItem(";
  protected final String TEXT_115 = ", dataCluster_";
  protected final String TEXT_116 = ",dataModel_";
  protected final String TEXT_117 = ",input_";
  protected final String TEXT_118 = ");";
  protected final String TEXT_119 = NL;
  protected final String TEXT_120 = NL + NL + "                org.talend.mdm.webservice.WSPutItemWithReport itemReport_";
  protected final String TEXT_121 = " = new org.talend.mdm.webservice.WSPutItemWithReport(";
  ...
  protected final String TEXT_135 = ".putItemWithReportArray(putItemWithReportArray).getWsItemPK();" + NL;
  protected final String TEXT_136 = NL + NL + "                    miList_";
  protected final String TEXT_137 = ".clear();";
  ...
  protected final String TEXT_152 = ".clear();";
  ...
  protected final String TEXT_167 = ".getIds().get(";
  protected final String TEXT_168 = ");";
  protected final String TEXT_169 = NL;
  protected final String TEXT_170 = NL;
  protected final String TEXT_171 = NL + "                        taskIDs_";
  protected final String TEXT_172 = ".add(";
  protected final String TEXT_173 = ");";
  protected final String TEXT_174 = NL + "                  miList_";
  protected final String TEXT_175 = ".add(item_";
  protected final String TEXT_176 = ");" + NL + "" + NL + "                  if (miList_";
  protected final String TEXT_177 = ".size() >= ";
  protected final String TEXT_178 = ") {" + NL + "" + NL + "                      org.talend.mdm.webservice.WSPutItemArray putItemArray = new org.talend.mdm.webservice.WSPutItemArray(miList_";
  protected final String TEXT_179 = ");" + NL + "                      wspks_";
  protected final String TEXT_180 = " = service_";
  protected final String TEXT_181 = ".putItemArray(putItemArray).getWsItemPK();" + NL;
  protected final String TEXT_182 = NL + NL + "                      miList_";
  protected final String TEXT_183 = ".clear();";
  protected final String TEXT_184 = NL + NL + "                        int i2_";
  protected final String TEXT_185 = " = 0;" + NL + "                        for(org.talend.mdm.webservice.WSItemPK wspk2_";
  protected final String TEXT_186 = " : wspks_";
  protected final String TEXT_187 = "){" + NL + "" + NL + "                            String compositeId = \"\";" + NL + "                            for(String id:wspk2_";
  protected final String TEXT_188 = ".getIds()) {" + NL + "                                  compositeId += id;" + NL + "                            }" + NL + "" + NL + "                            wspk2_";
  protected final String TEXT_189 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_190 = ");" + NL + "                            service_";
  protected final String TEXT_191 = ".updateItemMetadata(util_";
  protected final String TEXT_192 = ".makeUpdateMeteItm(taskIDs_";
  protected final String TEXT_193 = ".get(i2_";
  protected final String TEXT_194 = "), wspk2_";
  protected final String TEXT_195 = "));" + NL + "                            i2_";
  protected final String TEXT_196 = "++;" + NL + "                        }" + NL;
  protected final String TEXT_197 = NL + "                        taskIDs_";
  protected final String TEXT_198 = ".clear();";
  protected final String TEXT_199 = NL + "                  }";
  protected final String TEXT_200 = NL + NL + "                  wspk_";
  protected final String TEXT_201 = " = service_";
  protected final String TEXT_202 = ".putItem(item_";
  protected final String TEXT_203 = ");" + NL;
  protected final String TEXT_204 = NL;
  protected final String TEXT_205 = NL + "                      service_";
  protected final String TEXT_206 = ".updateItemMetadata(util_";
  protected final String TEXT_207 = ". makeUpdateMeteItm(";
  protected final String TEXT_208 = ",wspk_";
  protected final String TEXT_209 = "));";
  protected final String TEXT_210 = NL + "                      ";
  protected final String TEXT_211 = ".";
  protected final String TEXT_212 = "= wspk_";
  protected final String TEXT_213 = ".getIds().get(";
  protected final String TEXT_214 = ");";
  protected final String TEXT_215 = NL + "    } catch (java.lang.Exception e) {";
  protected final String TEXT_216 = NL + "        throw(e);";
  ...
  protected final String TEXT_222 = NL + "              java.util.Map<String,String> rejectXmlFlow_";
  protected final String TEXT_223 = " = xmlFlowList_";
  protected final String TEXT_224 = ".get(flowNum_";
  protected final String TEXT_225 = ");" + NL + "              String rejectValueStr_";
  protected final String TEXT_226 = ";";
  protected final String TEXT_227 = NL + "                 rejectValueStr_";
  protected final String TEXT_228 = " = rejectXmlFlow_";
  protected final String TEXT_229 = ".get(\"";
  protected final String TEXT_230 = "\");" + NL + "                  if (rejectValueStr_";
  protected final String TEXT_231 = " != null){";
  protected final String TEXT_232 = NL + "                        ";
  protected final String TEXT_233 = ".";
  protected final String TEXT_234 = " = rejectValueStr_";
  protected final String TEXT_235 = ";";
  protected final String TEXT_236 = NL + "                        ";
  protected final String TEXT_237 = ".";
  protected final String TEXT_238 = " = ParserUtils.parseTo_Date(rejectValueStr_";
  protected final String TEXT_239 = ", ";
  protected final String TEXT_240 = ");";
  protected final String TEXT_241 = NL + "                        ";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = " = rejectValueStr_";
  protected final String TEXT_244 = ".getBytes();";
  protected final String TEXT_245 = NL + "                        ";
  protected final String TEXT_246 = ".";
  protected final String TEXT_247 = " = ParserUtils.parseTo_";
  protected final String TEXT_248 = "(rejectValueStr_";
  protected final String TEXT_249 = ");";
  protected final String TEXT_250 = NL + "                } else {";
  ...
  protected final String TEXT_257 = " = ParserUtils.parseTo_Document(queue_";
  protected final String TEXT_258 = ".peek());";
  ...
  protected final String TEXT_268 = NL + "          System.err.println(e.getMessage());";
  protected final String TEXT_269 = NL + "    }";
  protected final String TEXT_270 = NL + "    flowNum_";
  protected final String TEXT_271 = "++;";
  protected final String TEXT_272 = NL + "    nb_line_";
  protected final String TEXT_273 = "++;";
  protected final String TEXT_274 = NL + "queue_";
  protected final String TEXT_275 = ".remove();";
