...
public class TFilterRowMrconfigJava
{
  protected static String nl;
  public static synchronized TFilterRowMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterRowMrconfigJava result = new TFilterRowMrconfigJava();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    IConnection outFilterConn = null;
    String outFilterConnName = null;
    IMetadataTable outFilterMetadataTable = null;
    IConnection outRejectConn = null;
    String outRejectConnName = null;
    IMetadataTable outRejectMetadataTable = null;
    ...
    if(outFilterConns != null && outFilterConns.size()>0){
        outFilterConn = outFilterConns.get(0);
        outFilterConnName = outFilterConn.getName();
        outFilterMetadataTable = outFilterConn.getMetadataTable();
    }
    List<? extends IConnection> outRejectConns = node.getOutgoingConnections("REJECT");
    if(outRejectConns != null && outRejectConns.size()>0){
        outRejectConn = outRejectConns.get(0);
        outRejectConnName = outRejectConn.getName();
        outRejectMetadataTable = outRejectConn.getMetadataTable();
    }
    ...
    boolean hasMultipleOutputs = (outFilterConnName != null && outRejectConnName != null) ? true : false;
    ...
    if(hasMultipleOutputs){
        ...
        String outConnName = outFilterConnName != null ? outFilterConnName : outRejectConnName;
