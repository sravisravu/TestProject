...
public class TRedshiftInputSparkcodeJava
{
  protected static String nl;
  public static synchronized TRedshiftInputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftInputSparkcodeJava result = new TRedshiftInputSparkcodeJava();
    nl = null;
    return result;
  }
