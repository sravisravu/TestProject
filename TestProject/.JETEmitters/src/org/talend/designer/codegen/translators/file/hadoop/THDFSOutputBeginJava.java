...
public class THDFSOutputBeginJava
{
  ...
  protected final String TEXT_125 = NL + "\torg.apache.hadoop.fs.Path path_";
  ...
  protected final String TEXT_129 = "\t\t\t" + NL + "\t\torg.apache.hadoop.fs.FSDataOutputStream fsDataOutputStream_";
  protected final String TEXT_130 = " = null;" + NL + "\t\t";
  protected final String TEXT_131 = NL + "    \t\tif(!fs_";
  protected final String TEXT_132 = ".exists(path_";
  protected final String TEXT_133 = ")) {" + NL + "    \t\t\tfsDataOutputStream_";
  protected final String TEXT_134 = " = fs_";
  protected final String TEXT_135 = ".create(path_";
  protected final String TEXT_136 = ",false);" + NL + "    \t\t} else {" + NL + "\t\t\t\tfsDataOutputStream_";
  protected final String TEXT_137 = " = fs_";
  protected final String TEXT_138 = ".append(path_";
  protected final String TEXT_139 = ");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_140 = NL + "\t\t\tfsDataOutputStream_";
  protected final String TEXT_141 = " = fs_";
  protected final String TEXT_142 = ".create(path_";
  protected final String TEXT_143 = ", ";
  protected final String TEXT_144 = ");" + NL + "\t\t";
  protected final String TEXT_145 = NL + "\t\t\tjava.io.Writer out";
  protected final String TEXT_146 = " = null;" + NL + "\t\t\tout";
  protected final String TEXT_147 = "=new java.io.BufferedWriter(new java.io.OutputStreamWriter(fsDataOutputStream_";
  protected final String TEXT_148 = ",";
  protected final String TEXT_149 = "));" + NL + "\t";
  protected final String TEXT_150 = NL + "\t\t\t\torg.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_151 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\t\t\tcodec_";
  protected final String TEXT_152 = ".setConf(conf_";
  protected final String TEXT_153 = ");";
  protected final String TEXT_154 = NL + "\t\t\t\torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_155 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_156 = ");";
  protected final String TEXT_157 = NL + "\t\t\torg.apache.hadoop.io.compress.CompressionOutputStream out";
  protected final String TEXT_158 = " = codec_";
  protected final String TEXT_159 = ".createOutputStream(fsDataOutputStream_";
  protected final String TEXT_160 = ");";
  protected final String TEXT_161 = NL + "\t\t\tboolean fileExistAndHasContent_";
  protected final String TEXT_162 = " = false;" + NL + "\t\t\tif(fs_";
  protected final String TEXT_163 = ".exists(path_";
  protected final String TEXT_164 = ")) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_165 = " = fs_";
  protected final String TEXT_166 = ".getFileStatus(path_";
  protected final String TEXT_167 = ");" + NL + "\t\t\t\tfileExistAndHasContent_";
  protected final String TEXT_168 = " = (!statu_";
  protected final String TEXT_169 = ".isDir()) && (statu_";
  protected final String TEXT_170 = ".getLen() != 0);" + NL + "\t\t\t}" + NL + "\t\t\tif(!fileExistAndHasContent_";
  protected final String TEXT_171 = ") {";
  protected final String TEXT_172 = NL + "\t\t\tStringBuilder header_";
  protected final String TEXT_173 = " = new StringBuilder();";
  protected final String TEXT_174 = NL + "\t\t\t\theader_";
  protected final String TEXT_175 = ".append(\"";
  protected final String TEXT_176 = "\");";
  protected final String TEXT_177 = NL + "                header_";
  protected final String TEXT_178 = ".append(";
  protected final String TEXT_179 = ");";
  protected final String TEXT_180 = NL + "\t\t\theader_";
  protected final String TEXT_181 = ".append(";
  protected final String TEXT_182 = ");";
  protected final String TEXT_183 = NL + "\t\t\tout";
  protected final String TEXT_184 = ".write(header_";
  protected final String TEXT_185 = ".toString());";
  protected final String TEXT_186 = NL + "\t\t\tout";
  protected final String TEXT_187 = ".write(header_";
  protected final String TEXT_188 = ".toString().getBytes(";
  protected final String TEXT_189 = "));";
  protected final String TEXT_190 = NL + "\t\t\t}";
  protected final String TEXT_191 = NL + NL + "\t\t";
  protected final String TEXT_192 = NL;
  protected final String TEXT_193 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_194 = " = new org.apache.hadoop.io.SequenceFile.Writer(fs_";
  protected final String TEXT_195 = ", conf_";
  protected final String TEXT_196 = ", path_";
  protected final String TEXT_197 = ", ";
  protected final String TEXT_198 = ".class, ";
  protected final String TEXT_199 = ".class);" + NL + "\t";
  protected final String TEXT_200 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_201 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_202 = ", conf_";
  protected final String TEXT_203 = ", path_";
  protected final String TEXT_204 = ", ";
  protected final String TEXT_205 = ".class, ";
  protected final String TEXT_206 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.GzipCodec());";
  protected final String TEXT_207 = NL + "\torg.apache.hadoop.io.SequenceFile.Writer writer_";
  protected final String TEXT_208 = " = org.apache.hadoop.io.SequenceFile.createWriter(fs_";
  protected final String TEXT_209 = ", conf_";
  protected final String TEXT_210 = ", path_";
  protected final String TEXT_211 = ", ";
  protected final String TEXT_212 = ".class, ";
  protected final String TEXT_213 = ".class, org.apache.hadoop.io.SequenceFile.CompressionType.BLOCK, new org.apache.hadoop.io.compress.BZip2Codec());";
  protected final String TEXT_214 = NL + "\t\t\tList<";
  protected final String TEXT_215 = "Struct> ";
  protected final String TEXT_216 = "_list_";
  protected final String TEXT_217 = "= new java.util.ArrayList<";
