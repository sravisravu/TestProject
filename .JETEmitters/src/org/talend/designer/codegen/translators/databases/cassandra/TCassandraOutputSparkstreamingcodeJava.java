...
public class TCassandraOutputSparkstreamingcodeJava
{
  ...
  protected final String TEXT_172 = NL + "    \tsession.close();" + NL + "    }" + NL + "" + NL + "}" + NL + "" + NL + "public static class ";
  protected final String TEXT_173 = "_ForeachRDDFunction implements org.apache.spark.api.java.function.Function<org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_174 = ">, Void> {" + NL + "\t" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_175 = "_ForeachRDDFunction(JobConf conf) {" + NL + "\t\tthis.context = new ContextProperties(conf);" + NL + "\t}" + NL + "\t" + NL + "\t@Override" + NL + "   \tpublic Void call(org.apache.spark.api.java.JavaRDD<";
  protected final String TEXT_176 = "> rdd) throws Exception {" + NL + "    \trdd.foreachPartition(new ";
  protected final String TEXT_177 = "_OutputFunction(context));" + NL + "      \treturn null;" + NL + "\t}" + NL + "}";
