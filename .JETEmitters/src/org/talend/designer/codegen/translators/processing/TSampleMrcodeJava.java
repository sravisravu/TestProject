...
public class TSampleMrcodeJava
{
  protected static String nl;
  public static synchronized TSampleMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSampleMrcodeJava result = new TSampleMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_120 = NL + "\t\t\tjava.util.Random randomNumberGenerator;" + NL + "\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t\trandomNumberGenerator = new java.util.Random();" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\trandomNumberGenerator = new java.util.Random(";
  protected final String TEXT_123 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\tif(randomNumberGenerator.nextDouble()< (";
  protected final String TEXT_125 = "<=1.0?";
  protected final String TEXT_126 = ":1.0)){" + NL + "\t\t\t\t";
  ...
  public String generate(Object argument)
  {
	...
	final boolean hasSeedParameter = "true".equals(hasSeed) ? true : false;
