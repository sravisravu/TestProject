...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_339 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_340 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_351 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_352 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_361 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_393 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_432 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_433 = " = stmtTruncCount_";
  protected final String TEXT_434 = ".executeQuery(\"";
  protected final String TEXT_435 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_436 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_437 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_441 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_477 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_478 = ".close();";
  protected final String TEXT_479 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_480 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_482 = ".append(\",\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_486 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_496 = " += \tduplidateClause_";
  ...
  protected final String TEXT_507 = "    " + NL + "" + NL + "                java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_785 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
