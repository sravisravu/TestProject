...
public class TPatternCheckBeginJava
{
  ...
  protected final String TEXT_9 = "=false;\t" + NL + "\tint nb_line_";
  protected final String TEXT_10 = " = 0;" + NL + "\tint nb_line_ok_";
  protected final String TEXT_11 = " = 0;" + NL + "\tint nb_line_reject_";
  protected final String TEXT_12 = " = 0;";
  protected final String TEXT_13 = NL + "\tjava.util.regex.Pattern pattern_";
  protected final String TEXT_14 = " = null;" + NL + "\ttry {" + NL + "    \tpattern_";
  protected final String TEXT_15 = " = java.util.regex.Pattern.compile(stringpattern_";
  protected final String TEXT_16 = ");" + NL + "    } catch (java.util.regex.PatternSyntaxException pe_";
  protected final String TEXT_17 = ") {" + NL + "    \tSystem.err.println(\"Error in component tPatternCheck: the pattern defined contains errors\"); " + NL + "        throw pe_";
