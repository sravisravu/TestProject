...
public class TVerticaOutputBeginJava {
  ...
  protected final String TEXT_79 = " = \"com.vertica.Driver\";" + NL + "\t\t\t";
  ...
  protected final String TEXT_398 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_437 = NL + "            java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_441 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_446 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_457 = NL + "                if(!conn_";
  protected final String TEXT_458 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_459 = ".commit();" + NL + "                }";
  protected final String TEXT_460 = NL + "            deletedCount_";
  protected final String TEXT_461 = " += rsTruncCountNumber_";
  protected final String TEXT_462 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_463 = ".close();";
  protected final String TEXT_464 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_482 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_483 = ".close();";
  protected final String TEXT_484 = NL + "\t\t\t\tjava.sql.Statement stmtCreateProjection_";
  protected final String TEXT_485 = " = conn_";
  protected final String TEXT_486 = ".createStatement();" + NL + "\t\t\t\tstmtCreateProjection_";
  protected final String TEXT_487 = ".execute(\"CREATE PROJECTION \" + tableName_";
  protected final String TEXT_488 = " + \"_proj (";
  protected final String TEXT_489 = ") AS SELECT ";
  protected final String TEXT_490 = " FROM \" + tableName_";
  protected final String TEXT_491 = ");" + NL + "\t\t\t\tstmtCreateProjection_";
  ...
  protected final String TEXT_555 = NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_556 = " = new StringBuilder();" + NL + "        java.sql.Statement stmt_";
  protected final String TEXT_557 = " = conn_";
  protected final String TEXT_558 = ".createStatement();" + NL + "        String template_";
  protected final String TEXT_559 = " = \"COPY \" + tableName_";
  protected final String TEXT_560 = " +\" (";
  protected final String TEXT_561 = ")\"" + NL + "\t\t\t\t\t\t          + \" FROM STDIN UNCOMPRESSED WITH DELIMITER ';' RECORD TERMINATOR '\\n' ENCLOSED BY '|' NULL AS '' ";
  protected final String TEXT_562 = "DIRECT";
  protected final String TEXT_563 = "\";" + NL + "\t\t";
  protected final String TEXT_564 = NL + "        StringBuffer query_";
  protected final String TEXT_565 = " = null;" + NL + "       \t";
  protected final String TEXT_566 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_595 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_596 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_605 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_611 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_612 = " = null;";
  protected final String TEXT_613 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_614 = " = null;";
  protected final String TEXT_615 = NL + "\t\tjava.sql.Statement stmt_";
  protected final String TEXT_616 = " = null;" + NL + "\t\tStringBuilder stmtBuilder_";
  protected final String TEXT_617 = " = null;" + NL + "\t\tString template_";
