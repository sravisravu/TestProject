...
public class TLoopSparkconfigJava
{
  protected static String nl;
  public static synchronized TLoopSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TLoopSparkconfigJava result = new TLoopSparkconfigJava();
    nl = null;
    return result;
  }
