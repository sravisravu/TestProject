...
public class TMysqlOutputSparkstreamingconfigJava {
  ...
  protected final String TEXT_50 = NL + NL + NL + "java.util.Properties jdbcDriverProperties_";
  ...
  protected final String TEXT_426 = ".foreachRDD(new ";
  protected final String TEXT_427 = "_ForeachRDDOutput(job));" + NL;
