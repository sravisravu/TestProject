...
public class TOracleOutputSparkconfigJava {
  ...
  protected final String TEXT_50 = NL + "           " + NL + "" + NL + "Class.forName(";
  protected final String TEXT_51 = ");" + NL + "java.util.Properties jdbcDriverProperties_";
  protected final String TEXT_52 = " = new java.util.Properties();" + NL + "String jdbcAdditionalParameters_";
  protected final String TEXT_53 = " = ";
  protected final String TEXT_54 = ";" + NL + "if(jdbcAdditionalParameters_";
  protected final String TEXT_55 = " != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters_";
  protected final String TEXT_56 = ") && !\"\".equals(jdbcAdditionalParameters_";
  protected final String TEXT_57 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_58 = ".load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters_";
  protected final String TEXT_59 = ".replace(";
  protected final String TEXT_60 = ", \"\\n\").getBytes()));" + NL + "}" + NL + "if(";
  protected final String TEXT_61 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_62 = ") && !\"\".equals(";
  protected final String TEXT_63 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_64 = ".setProperty(\"user\", ";
  protected final String TEXT_65 = ");" + NL + "}" + NL + "String password_";
  protected final String TEXT_66 = " = ";
  protected final String TEXT_67 = " ;" + NL + "if(password_";
  protected final String TEXT_68 = " != null && !\"\\\"\\\"\".equals(password_";
  protected final String TEXT_69 = ") && !\"\".equals(password_";
  protected final String TEXT_70 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_71 = ".setProperty(\"password\", password_";
  protected final String TEXT_72 = ");" + NL + "}" + NL + "java.sql.Connection conn_";
  protected final String TEXT_73 = " = java.sql.DriverManager.getConnection(";
  protected final String TEXT_74 = ", jdbcDriverProperties_";
  protected final String TEXT_75 = ");" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_76 = " = 0;" + NL + "String dbschema_";
  ...
  protected final String TEXT_90 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_101 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_138 = NL + "                    String keyCheckTable_";
  protected final String TEXT_139 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_146 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_149 = " + \"]\";";
  protected final String TEXT_150 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_151 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_152 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  ...
  protected final String TEXT_194 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_199 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_224 = ".equalsIgnoreCase(schema_";
  ...
  protected final String TEXT_292 = ".getTables(null, schemaForSearch_";
  ...
  protected final String TEXT_296 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_309 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_346 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_385 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_386 = " = stmtTruncCount_";
  protected final String TEXT_387 = ".executeQuery(\"";
  protected final String TEXT_388 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_389 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_390 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_394 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_405 = NL + "                if(!conn_";
  protected final String TEXT_406 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_407 = ".commit();" + NL + "                }";
  ...
  protected final String TEXT_421 = ".commit();";
  ...
  protected final String TEXT_433 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_434 = ".foreachPartition(new ";
  protected final String TEXT_435 = "_OutputFunction(job));" + NL;
  protected final String TEXT_436 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_437 = " code : ";
...
try {
    ...
    stringBuffer.append(storage.getSchemaDb());
