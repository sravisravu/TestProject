...
public class TMDMCloseMainJava
{
  ...
  protected final String TEXT_41 = NL + "java.util.Iterator it_";
  protected final String TEXT_42 = " = globalMap.keySet().iterator();" + NL + "while (it_";
  protected final String TEXT_43 = ".hasNext()) {" + NL + "    String key_";
  protected final String TEXT_44 = " = it_";
  protected final String TEXT_45 = ".next().toString();" + NL + "    if (key_";
  protected final String TEXT_46 = ".startsWith(\"";
  protected final String TEXT_47 = "_\")) {" + NL + "        org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_48 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(key_";
  protected final String TEXT_49 = ");" + NL + "        if(service_";
  protected final String TEXT_50 = " != null) {" + NL + "           service_";
  protected final String TEXT_51 = ".logout(new org.talend.mdm.webservice.WSLogout());";
