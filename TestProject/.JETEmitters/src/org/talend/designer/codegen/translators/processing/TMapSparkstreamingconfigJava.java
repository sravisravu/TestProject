...
public class TMapSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TMapSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapSparkstreamingconfigJava result = new TMapSparkstreamingconfigJava();
    nl = null;
    return result;
  }
