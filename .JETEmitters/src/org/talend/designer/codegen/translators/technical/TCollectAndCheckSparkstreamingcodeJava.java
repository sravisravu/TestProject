...
public class TCollectAndCheckSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TCollectAndCheckSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCollectAndCheckSparkstreamingcodeJava result = new TCollectAndCheckSparkstreamingcodeJava();
    nl = null;
    return result;
  }
