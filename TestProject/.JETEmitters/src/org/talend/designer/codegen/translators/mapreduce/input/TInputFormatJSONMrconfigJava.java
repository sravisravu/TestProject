...
public class TInputFormatJSONMrconfigJava
{
  ...
  protected final String TEXT_127 = NL + "            final String clouderaManagerPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_128 = ");";
  protected final String TEXT_129 = NL + "            final String clouderaManagerPassword = ";
  protected final String TEXT_130 = ";";
  protected final String TEXT_131 = NL + "        this.lineageCreator = new org.talend.lineage.cloudera.LineageCreator(";
  ...
  protected final String TEXT_139 = "," + NL + "                clouderaManagerPassword," + NL + "                jobName + \"_\" + jobVersion.replace(\".\", \"_\")," + NL + "                projectName,";
  ...
  protected final String TEXT_146 = NL + "        this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_147 = ");" + NL + "" + NL + "        java.util.Map<String, Object> lineageCreatorJobMetadata = new java.util.HashMap<String, Object>();" + NL + "        lineageCreatorJobMetadata.put(\"name\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"description\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"purpose\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"author\", System.getProperty(\"user.name\"));" + NL + "        lineageCreatorJobMetadata.put(\"version\", jobVersion);" + NL + "        lineageCreatorJobMetadata.put(\"jobType\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"framework\", \"Talend BigData\");" + NL + "        lineageCreatorJobMetadata.put(\"status\", \"FINISHED\");" + NL + "        lineageCreatorJobMetadata.put(\"creationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"lastModificationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"startTime\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"endTime\", System.currentTimeMillis());" + NL + "" + NL + "        this.lineageCreator.addJobInfo(lineageCreatorJobMetadata);";
  protected final String TEXT_148 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_149 = " = new java.util.HashMap<>();";
  protected final String TEXT_150 = NL + "            columns_";
  protected final String TEXT_151 = ".put(\"";
  protected final String TEXT_152 = "\", \"";
  protected final String TEXT_153 = "\");";
  protected final String TEXT_154 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_155 = " = new java.util.HashMap<>();";
  protected final String TEXT_156 = NL + "                        columns_";
  protected final String TEXT_157 = ".put(\"";
  protected final String TEXT_158 = "\", \"";
  protected final String TEXT_159 = "\");";
  protected final String TEXT_160 = NL + "                    columns_";
  protected final String TEXT_161 = ".put(\"";
  protected final String TEXT_162 = "\", \"";
  protected final String TEXT_163 = "\");";
  protected final String TEXT_164 = NL + "        lineageCreator.addDataset(columns_";
  protected final String TEXT_165 = ", \"";
  protected final String TEXT_166 = "\", ";
  protected final String TEXT_167 = ", \"";
  protected final String TEXT_168 = "\");";
  protected final String TEXT_169 = NL + "        java.util.List<String> inputNodes_";
  protected final String TEXT_170 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_171 = NL + "                inputNodes_";
  protected final String TEXT_172 = ".add(\"";
  protected final String TEXT_173 = "\");";
  protected final String TEXT_174 = NL + "        java.util.List<String> outputNodes_";
  protected final String TEXT_175 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_176 = NL + "                outputNodes_";
  protected final String TEXT_177 = ".add(\"";
  protected final String TEXT_178 = "\");";
  protected final String TEXT_179 = NL + "        this.lineageCreator.addNodeToLineage(\"";
  protected final String TEXT_180 = "\", columns_";
  protected final String TEXT_181 = ", inputNodes_";
  protected final String TEXT_182 = ", outputNodes_";
  protected final String TEXT_183 = ", new java.util.HashMap<String, Object>());";
