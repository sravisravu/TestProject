...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_500 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_501 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_502 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_503 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_504 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_505 = ".append (\"`\" +  ";
  protected final String TEXT_506 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_507 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_512 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_513 = " + \"` (";
  protected final String TEXT_514 = ") VALUES (";
  protected final String TEXT_515 = ")\";";
  protected final String TEXT_516 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_517 = " += \tduplidateClause_";
  protected final String TEXT_518 = ".toString();";
  protected final String TEXT_519 = NL + "\t\t\t\t";
  protected final String TEXT_520 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_521 = " = new StringBuffer(insert_";
  protected final String TEXT_522 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_523 = ".insert(insert_";
  protected final String TEXT_524 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_525 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_526 = " =insertStringBuffer_";
  ...
  protected final String TEXT_539 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_540 = ",insert_";
  protected final String TEXT_541 = ",keyPsmt_";
  protected final String TEXT_542 = ");";
  protected final String TEXT_543 = NL;
  protected final String TEXT_544 = NL + "\t            class BufferLine_";
  protected final String TEXT_545 = " {" + NL + "    \t            ";
  protected final String TEXT_546 = NL + "                            ";
  protected final String TEXT_547 = " ";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_558 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_559 = "> exInsertColValueList";
  protected final String TEXT_560 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_561 = " exInsertColValue";
  protected final String TEXT_562 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_563 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_564 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_565 = ".append(\"(";
  protected final String TEXT_566 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_567 = "-1) extendInsertValueStmt_";
  protected final String TEXT_568 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_569 = " = \"INSERT INTO `\"+";
  protected final String TEXT_570 = "+\"` (";
  protected final String TEXT_571 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_572 = ".toString();";
  protected final String TEXT_573 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_574 = " += \tduplidateClause_";
  ...
  protected final String TEXT_618 = NL + "\t    String update_";
  protected final String TEXT_619 = " = \"UPDATE `\" + ";
  protected final String TEXT_620 = " + \"` SET ";
  protected final String TEXT_621 = " WHERE ";
  protected final String TEXT_622 = "\";" + NL + "\t    ";
  protected final String TEXT_623 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_624 = " = new StringBuffer(update_";
  protected final String TEXT_625 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_626 = ".insert(update_";
  protected final String TEXT_627 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_628 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_629 = " =updateStringBuffer_";
  ...
  protected final String TEXT_633 = ".prepareStatement(update_";
  ...
  protected final String TEXT_637 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_638 = " + \"` WHERE ";
  protected final String TEXT_639 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_640 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_656 = " = \"UPDATE `\" + ";
  protected final String TEXT_657 = " + \"` SET ";
  protected final String TEXT_658 = " WHERE ";
  protected final String TEXT_659 = "\";" + NL + "\t    ";
  protected final String TEXT_660 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_661 = " = new StringBuffer(update_";
  protected final String TEXT_662 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_663 = ".insert(update_";
  protected final String TEXT_664 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_665 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_666 = " =updateStringBuffer_";
  protected final String TEXT_667 = ".toString(); ";
  protected final String TEXT_668 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_669 = " = conn_";
  protected final String TEXT_670 = ".prepareStatement(update_";
  protected final String TEXT_671 = ");" + NL + "\t    ";
  protected final String TEXT_672 = NL + "\t    String update_";
  protected final String TEXT_673 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_688 = ");" + NL + "\t    String insert_";
  protected final String TEXT_689 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_690 = " + \"` (";
  protected final String TEXT_691 = ") VALUES (";
  protected final String TEXT_692 = ")\";" + NL + "\t     ";
  protected final String TEXT_693 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_694 = " = new StringBuffer(insert_";
  protected final String TEXT_695 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_696 = ".insert(insert_";
  protected final String TEXT_697 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_698 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_699 = " =insertStringBuffer_";
  protected final String TEXT_700 = ".toString(); ";
  protected final String TEXT_701 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_705 = NL + "\t    String delete_";
  protected final String TEXT_706 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_707 = " + \"` WHERE ";
  protected final String TEXT_708 = "\";" + NL + "\t    ";
  protected final String TEXT_709 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_710 = " = new StringBuffer(delete_";
  protected final String TEXT_711 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_712 = ".insert(delete_";
  protected final String TEXT_713 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_714 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_715 = " =deleteStringBuffer_";
  protected final String TEXT_716 = ".toString();  ";
  protected final String TEXT_717 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_718 = " = conn_";
  protected final String TEXT_719 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_729 = NL + "\t    String insertIgnore_";
  protected final String TEXT_730 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_731 = " + \"` (";
  protected final String TEXT_732 = ") VALUES (";
  protected final String TEXT_733 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_734 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_735 = " = conn_";
  protected final String TEXT_736 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_737 = ");" + NL + "\t    ";
  protected final String TEXT_738 = NL + "\t    String insert_";
  ...
  protected final String TEXT_743 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_744 = " = new StringBuffer(insert_";
  protected final String TEXT_745 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_746 = ".insert(insert_";
  protected final String TEXT_747 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_748 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_749 = " =insertStringBuffer_";
  protected final String TEXT_750 = ".toString(); ";
  protected final String TEXT_751 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_752 = " = conn_";
  protected final String TEXT_753 = ".prepareStatement(insert_";
  protected final String TEXT_754 = ");" + NL + "\t    ";
  protected final String TEXT_755 = NL + "        StringBuffer query_";
  protected final String TEXT_756 = " = null;" + NL + "       \t";
  protected final String TEXT_757 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_758 = " = insert_";
  protected final String TEXT_759 = ".split(\"\\\\?\");";
  protected final String TEXT_760 = NL + "\t\t\tupdate_";
  protected final String TEXT_761 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_762 = " = update_";
  protected final String TEXT_763 = ".split(\"\\\\?\");";
  protected final String TEXT_764 = NL + "\t\t\tupdate_";
  protected final String TEXT_765 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_766 = " = update_";
  protected final String TEXT_767 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_768 = " = insert_";
  protected final String TEXT_769 = ".split(\"\\\\?\");";
  protected final String TEXT_770 = NL + "\t\t\tdelete_";
  protected final String TEXT_771 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_772 = " = delete_";
  protected final String TEXT_773 = ".split(\"\\\\?\");";
  protected final String TEXT_774 = NL + "\t\t\treplace_";
  protected final String TEXT_775 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_776 = " = replace_";
  protected final String TEXT_777 = ".split(\"\\\\?\");";
  protected final String TEXT_778 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_779 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_780 = " = insertIgnore_";
  protected final String TEXT_781 = ".split(\"\\\\?\");";
  protected final String TEXT_782 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_783 = " = insert_";
  protected final String TEXT_784 = ".split(\"\\\\?\");";
  protected final String TEXT_785 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_786 = " {" + NL + "    \t            ";
  protected final String TEXT_787 = NL + "                            ";
  protected final String TEXT_788 = " ";
  protected final String TEXT_789 = ";";
  protected final String TEXT_790 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_791 = ";" + NL + "\t\t\t";
  protected final String TEXT_792 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_793 = "(";
  protected final String TEXT_794 = NL + "                                ,";
  protected final String TEXT_795 = NL + "                            ";
  protected final String TEXT_796 = " ";
  protected final String TEXT_797 = NL + "\t\t\t\t, routines.system.Dynamic ";
  ...
  protected final String TEXT_806 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_807 = "> exInsertColValueList";
  protected final String TEXT_808 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_809 = " exInsertColValue";
  protected final String TEXT_810 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_811 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_812 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_813 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_814 = "=1;";
  protected final String TEXT_815 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_816 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_817 = "=0;";
  protected final String TEXT_818 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_819 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_820 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_821 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_822 = "=0;" + NL + "\t";
  protected final String TEXT_823 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_824 = " = null;" + NL + "\t\t";
  protected final String TEXT_825 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_829 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_830 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_831 = " = null;";
  protected final String TEXT_832 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_836 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_837 = " = null;";
  protected final String TEXT_838 = NL + "\t\t \tString[] insertSQLSplits_";
