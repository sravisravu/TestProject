...
public class TExtractFullRowMrconfigJava
{
  protected static String nl;
  public static synchronized TExtractFullRowMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractFullRowMrconfigJava result = new TExtractFullRowMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_119 = NL + "                chainMapper.addMapper(job, ";
  protected final String TEXT_120 = "," + NL + "                    NullWritable.class, ";
  protected final String TEXT_121 = "Struct.class," + NL + "                    NullWritable.class, ";
  protected final String TEXT_122 = "Struct.class," + NL + "                    true, new JobConf(false));" + NL;
  protected final String TEXT_123 = NL + "                    MultipleOutputs.setWorkDir(job," + NL + "                            genTempFolderForComponent(\"";
  protected final String TEXT_124 = "\"));" + NL + "                    MultipleOutputs.setKeyValue(job, \"";
  protected final String TEXT_125 = "\"," + NL + "                            NullWritable.class, ";
  protected final String TEXT_126 = "Struct.class);";
...
// Defined for use in mr_basicflow_withrejectoutput_mrconfig
String inputMapperClass = cid + "_InputMapper.class";
...
// MultiOutputUtils multiouputUtils = new MultiOutputUtils();
