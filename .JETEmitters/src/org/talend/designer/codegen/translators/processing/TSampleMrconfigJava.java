...
public class TSampleMrconfigJava
{
  protected static String nl;
  public static synchronized TSampleMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSampleMrconfigJava result = new TSampleMrconfigJava();
    nl = null;
    return result;
  }
