...
public class TSortRowSparkstreamingcodeJava
{
  ...
  protected final String TEXT_237 = NL + NL + "public static class ";
  protected final String TEXT_238 = "_Function implements org.apache.spark.api.java.function.Function<";
  protected final String TEXT_239 = ", ";
  protected final String TEXT_240 = "> {" + NL + "" + NL + "\tprivate JobConf job;" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_241 = "_Function(JobConf job) {" + NL + "\t\tthis.job = job;" + NL + "\t}" + NL + "" + NL + "\tpublic ";
  protected final String TEXT_242 = " call(";
  protected final String TEXT_243 = " in) {" + NL + "\t\treturn in.sortByKey(new ";
  protected final String TEXT_244 = "(job));" + NL + "\t}" + NL + "}";
