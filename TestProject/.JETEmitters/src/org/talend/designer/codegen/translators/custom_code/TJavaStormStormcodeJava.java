...
public class TJavaStormStormcodeJava
{
  protected static String nl;
  public static synchronized TJavaStormStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaStormStormcodeJava result = new TJavaStormStormcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "public static class StormFunction_";
  protected final String TEXT_46 = " extends storm.trident.operation.BaseFunction {" + NL + "" + NL + "    private static final long serialVersionUID = 11L;" + NL;
  protected final String TEXT_47 = NL + NL + "    private final ";
  protected final String TEXT_48 = " input" + NL + "            = new ";
  protected final String TEXT_49 = "(null);" + NL + "" + NL + "    private final ";
  protected final String TEXT_50 = " output" + NL + "            = new ";
  protected final String TEXT_51 = "(null);" + NL + "" + NL + "    public void prepare(Map conf, TridentOperationContext context) {";
  protected final String TEXT_52 = NL + "        ";
  protected final String TEXT_53 = NL + "    }" + NL + "" + NL + "    public void execute(TridentTuple tuple, TridentCollector collector) {" + NL + "        input.setTuple(tuple);";
  protected final String TEXT_54 = NL + "        ";
  protected final String TEXT_55 = NL + "    }" + NL + "" + NL + "    public void cleanup() {";
  protected final String TEXT_56 = NL + "        ";
  protected final String TEXT_57 = NL + "    }" + NL;
  protected final String TEXT_58 = NL + NL + "    public void prepare(Map conf, TridentOperationContext context) {" + NL + "    }" + NL + "" + NL + "    public void execute(TridentTuple tuple, TridentCollector collector) {" + NL + "    }" + NL + "" + NL + "    public void cleanup() {" + NL + "    }" + NL;
...
String boltExecCode = ElementParameterParser.getValue(node, "___BOLT_EXEC_METHOD_CODE__");
if(boltExecCode == null) {
    boltExecCode = "";
}

boolean boltPrep = "true".equals(ElementParameterParser.getValue(node, "__BOLT_PREP__"));
boolean boltClean = "true".equals(ElementParameterParser.getValue(node, "__BOLT_CLEAN__"));

String boltPrepCode = (boltPrep ? ElementParameterParser.getValue(node, "___BOLT_PREP_CODE__") : "");
String boltCleanCode = (boltClean ? ElementParameterParser.getValue(node, "___BOLT_CLEAN_CODE__") : "");
...
new TupleWrapperHelper().generateAllOutgoing(node);
    ...
    if(streamUtil.getInConnection() != null && streamUtil.getOutConnection() != null) {
    ...
    stringBuffer.append(new TupleWrapperHelper().getClassName(streamUtil.getOutConnection()));
    stringBuffer.append(TEXT_50);
    stringBuffer.append(new TupleWrapperHelper().getClassName(streamUtil.getOutConnection()));
    stringBuffer.append(TEXT_51);
    stringBuffer.append(TEXT_52);
    stringBuffer.append( boltPrepCode );
    stringBuffer.append(TEXT_53);
    stringBuffer.append(TEXT_54);
    stringBuffer.append( boltExecCode );
    stringBuffer.append(TEXT_55);
    stringBuffer.append(TEXT_56);
    stringBuffer.append( boltCleanCode );
