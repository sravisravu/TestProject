...
public class TConvertTypeMrconfigJava
{
  protected static String nl;
  public static synchronized TConvertTypeMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TConvertTypeMrconfigJava result = new TConvertTypeMrconfigJava();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    final boolean hasMultipleOutputs = outconnName!=null && rejectConnName!=null && !outconnName.equals(rejectConnName)? true : false;
