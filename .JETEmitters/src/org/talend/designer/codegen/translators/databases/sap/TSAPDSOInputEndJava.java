...
public class TSAPDSOInputEndJava
{
  protected static String nl;
  public static synchronized TSAPDSOInputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDSOInputEndJava result = new TSAPDSOInputEndJava();
    nl = null;
    return result;
  }
