...
public class TExtractRegexFieldsStormcodeJava
{
  protected static String nl;
  public static synchronized TExtractRegexFieldsStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractRegexFieldsStormcodeJava result = new TExtractRegexFieldsStormcodeJava();
    nl = null;
    return result;
  }
...
rowTransformUtil.generateStormCode(tExtractRegexFieldsUtil);
