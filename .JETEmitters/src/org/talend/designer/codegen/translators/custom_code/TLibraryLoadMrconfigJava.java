...
public class TLibraryLoadMrconfigJava
{
  protected static String nl;
  public static synchronized TLibraryLoadMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TLibraryLoadMrconfigJava result = new TLibraryLoadMrconfigJava();
    nl = null;
    return result;
  }
