...
public class TFileOutputPositionalMrcodeJava
{
  protected static String nl;
  public static synchronized TFileOutputPositionalMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputPositionalMrcodeJava result = new TFileOutputPositionalMrcodeJava();
    nl = null;
    return result;
  }
