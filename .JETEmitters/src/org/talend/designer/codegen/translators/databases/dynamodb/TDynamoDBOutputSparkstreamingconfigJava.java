...
public class TDynamoDBOutputSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TDynamoDBOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDynamoDBOutputSparkstreamingconfigJava result = new TDynamoDBOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_89 = ".foreachRDD(new ";
  protected final String TEXT_90 = "_ForeachRDDOutput(jobConf_";
