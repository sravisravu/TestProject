...
public class THDFSDeleteMainJava
{
  ...
  protected final String TEXT_127 = ");" + NL + "\tif(fs_";
  protected final String TEXT_128 = ".exists(path_";
  protected final String TEXT_129 = ")){" + NL + "\t\tif(fs_";
  protected final String TEXT_130 = ".delete(path_";
  protected final String TEXT_131 = ", true)){" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_132 = "_CURRENT_STATUS\", \"Path deleted.\");" + NL + "\t\t\t" + NL + "\t    \t";
  protected final String TEXT_133 = NL + "            log.info(\"";
  protected final String TEXT_134 = " - directory or file : \" + path_";
  protected final String TEXT_135 = " + \" is deleted.\");";
  protected final String TEXT_136 = NL + "\t\t}else{" + NL + "\t\t\tglobalMap.put(\"";
  protected final String TEXT_137 = "_CURRENT_STATUS\", \"No path deleted.\");" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_138 = NL + "            log.info(\"";
  protected final String TEXT_139 = " - fail to delete directory or file : \" + path_";
  protected final String TEXT_140 = " + \".\");";
  protected final String TEXT_141 = NL + "\t\t}" + NL + "\t}else{" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_142 = "_CURRENT_STATUS\", \"Path does not exist.\");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_143 = NL + "       \tlog.warn(\"";
  protected final String TEXT_144 = " - directory or file : \" + path_";
  protected final String TEXT_145 = " + \" does not exist.\");";
  protected final String TEXT_146 = NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_147 = "_DELETE_PATH\",";
  protected final String TEXT_148 = ");" + NL + "\t" + NL + "" + NL + "" + NL + "" + NL + "\t";
