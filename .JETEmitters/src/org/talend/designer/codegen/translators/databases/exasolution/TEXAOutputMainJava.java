...
public class TEXAOutputMainJava {
  ...
  protected final String TEXT_608 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_618 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_619 = ",";
  protected final String TEXT_620 = ".";
  protected final String TEXT_621 = ", ";
  protected final String TEXT_622 = ",updateSQLSplits_";
  protected final String TEXT_623 = ");";
  protected final String TEXT_624 = NL + "                    int count_";
  ...
  protected final String TEXT_660 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_675 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_683 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_684 = " = pstmt_";
  protected final String TEXT_685 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_686 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_687 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_688 = " = rs_";
  protected final String TEXT_689 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_690 = " > 0) {";
  protected final String TEXT_691 = NL + "                        ";
  protected final String TEXT_692 = NL + "                            query_";
  protected final String TEXT_693 = " = ";
  protected final String TEXT_694 = ";";
  protected final String TEXT_695 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_696 = ",";
  protected final String TEXT_697 = ".";
  protected final String TEXT_698 = ", ";
  protected final String TEXT_699 = ",updateSQLSplits_";
  ...
  protected final String TEXT_845 = " == 0) {";
  protected final String TEXT_846 = NL + "                query_";
  protected final String TEXT_847 = " = new StringBuffer(\"\");";
  ...
  protected final String TEXT_874 = NL + "                    }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_875 = " = true;";
  protected final String TEXT_876 = NL + "                        throw(e);";
  protected final String TEXT_877 = NL + "                        nb_line_";
  protected final String TEXT_878 = "++;";
  protected final String TEXT_879 = NL + "                            ";
  protected final String TEXT_880 = " = new ";
  protected final String TEXT_881 = "Struct();";
  protected final String TEXT_882 = NL + "                                ";
  protected final String TEXT_883 = ".";
  protected final String TEXT_884 = " = ";
  protected final String TEXT_885 = ".";
  protected final String TEXT_886 = ";";
  protected final String TEXT_887 = NL + "                            rejectedCount_";
  protected final String TEXT_888 = " = rejectedCount_";
  protected final String TEXT_889 = " + 1;";
  protected final String TEXT_890 = NL + "                            ";
  protected final String TEXT_891 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_892 = NL + "                            ";
  protected final String TEXT_893 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_894 = ";";
  protected final String TEXT_895 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_918 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_955 = ")) {" + NL + "                try {" + NL + "                        int countSum_";
  ...
  protected final String TEXT_973 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  ...
  protected final String TEXT_993 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_994 = " <= commitCounter_";
  protected final String TEXT_995 = ") {";
  protected final String TEXT_996 = NL + "                if ((batchSize_";
  protected final String TEXT_997 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_998 = " > 0)) {" + NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_999 = " = 0;";
  protected final String TEXT_1000 = NL + "                        for(int countEach_";
  protected final String TEXT_1001 = ": pstmt_";
  protected final String TEXT_1002 = ".executeBatch()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1006 = NL + "                            insertedCount_";
  protected final String TEXT_1007 = " += countSum_";
  protected final String TEXT_1008 = ";";
  protected final String TEXT_1009 = NL + "                            updatedCount_";
  protected final String TEXT_1010 = " += countSum_";
  protected final String TEXT_1011 = ";";
  protected final String TEXT_1012 = NL + "                            deletedCount_";
  ...
  protected final String TEXT_1016 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_1017 = NL + "                        throw(e);";
  protected final String TEXT_1018 = NL + "                        int countSum_";
  protected final String TEXT_1019 = " = 0;" + NL + "                        for(int countEach_";
  protected final String TEXT_1020 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  ...
  protected final String TEXT_1033 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1034 = NL + "                }" + NL + "            }";
  protected final String TEXT_1035 = NL + "                    conn_";
  protected final String TEXT_1036 = ".commit();";
  protected final String TEXT_1037 = NL + "                    commitCounter_";
