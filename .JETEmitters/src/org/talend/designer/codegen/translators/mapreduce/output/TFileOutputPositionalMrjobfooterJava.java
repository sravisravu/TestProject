...
public class TFileOutputPositionalMrjobfooterJava
{
  protected static String nl;
  public static synchronized TFileOutputPositionalMrjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputPositionalMrjobfooterJava result = new TFileOutputPositionalMrjobfooterJava();
    nl = null;
    return result;
  }
