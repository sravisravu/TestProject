...
public class TELTHiveMapMainJava
{
  ...
  protected final String TEXT_59 = NL + "\t\t\tSystem.setProperty(\"mapred.job.tracker\", ";
  protected final String TEXT_60 = ");";
  protected final String TEXT_61 = NL + "\t\t\tSystem.setProperty(\"";
  protected final String TEXT_62 = "\", ";
  protected final String TEXT_63 = ");";
  protected final String TEXT_64 = NL + NL + "\t\t\tglobalMap.put(" + NL + "\t\t\t\t\"";
  protected final String TEXT_65 = "\"+\"QUERY\" + \"";
  protected final String TEXT_66 = "\"," + NL + "\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t);" + NL + "\t\t\tglobalMap.put(" + NL + "\t\t\t\t\t\"";
  protected final String TEXT_68 = "\"+\"QUERY_COLUMNS_NAME\" + \"";
  protected final String TEXT_69 = "\"," + NL + "\t\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t);" + NL + "\t\t\t";
  protected final String TEXT_71 = "       " + NL + "                Object ";
  protected final String TEXT_72 = " = new Object();         ";
