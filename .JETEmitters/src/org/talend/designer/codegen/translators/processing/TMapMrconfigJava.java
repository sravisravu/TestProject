...
public class TMapMrconfigJava
{
  ...
  protected final String TEXT_994 = NL + "                try {" + NL + "                    org.talend.hadoop.mapred.lib.DistributedCache.addCacheFile(";
  protected final String TEXT_995 = NL + "                        ";
  protected final String TEXT_996 = ", job);" + NL + "                } catch (java.net.URISyntaxException e) {" + NL + "                    // Normally this can't happen, since the tMapUtil generates" + NL + "                    // a valid URI for the lookup source." + NL + "                    throw new RuntimeException(e);" + NL + "                }";
  protected final String TEXT_997 = NL + "    job.setPartitionerClass(JoinKeyPartitioner_";
  protected final String TEXT_998 = ".class);" + NL + "    job.setOutputValueGroupingComparator(JoinKeyGroupingComparator_";
  protected final String TEXT_999 = ".class);" + NL + "    job.setOutputKeyComparatorClass(JoinKeySortComparator_";
  protected final String TEXT_1000 = ".class);";
