...
public class TJDBCConfigurationSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TJDBCConfigurationSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCConfigurationSparkstreamingcodeJava result = new TJDBCConfigurationSparkstreamingcodeJava();
    nl = null;
    return result;
  }
