...
public class TMRInputMrcodeJava
{
  protected static String nl;
  public static synchronized TMRInputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMRInputMrcodeJava result = new TMRInputMrcodeJava();
    nl = null;
    return result;
  }
...
if(metadata != null){
    folder = ElementParameterParser.getValue(node,"__FILENAME__");
...
if(rowStructName == null || columns == null || folder == null){
    return "";
}

AvroInput avroInput = new AvroInput(rowStructName, columns, folder);
avroInput.setCreateInputDirIfNotExists(true);
avroInput.gen();
