...
public class TMysqlInputMrcodeJava
{
  protected static String nl;
  public static synchronized TMysqlInputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlInputMrcodeJava result = new TMysqlInputMrcodeJava();
    nl = null;
    return result;
  }
