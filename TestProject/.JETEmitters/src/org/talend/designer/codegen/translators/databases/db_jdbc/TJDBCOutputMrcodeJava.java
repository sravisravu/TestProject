...
public class TJDBCOutputMrcodeJava
{
  protected static String nl;
  public static synchronized TJDBCOutputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputMrcodeJava result = new TJDBCOutputMrcodeJava();
    nl = null;
    return result;
  }
