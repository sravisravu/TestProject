...
public class TAvroMapSparkcodeJava
{
  protected static String nl;
  public static synchronized TAvroMapSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAvroMapSparkcodeJava result = new TAvroMapSparkcodeJava();
    nl = null;
    return result;
  }
