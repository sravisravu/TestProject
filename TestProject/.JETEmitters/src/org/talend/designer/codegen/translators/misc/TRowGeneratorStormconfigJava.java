...
public class TRowGeneratorStormconfigJava
{
  protected static String nl;
  public static synchronized TRowGeneratorStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRowGeneratorStormconfigJava result = new TRowGeneratorStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "{" + NL + "    int nb_max_row_";
  protected final String TEXT_46 = " = ";
  protected final String TEXT_47 = ";" + NL + "" + NL + "    // Create the different objects which will generate the fields." + NL + "    List<org.talend.libs.tbd.ee.libstorm.AbstractFieldGenerator> fieldGenerators_";
  protected final String TEXT_48 = NL + "        = new java.util.ArrayList<org.talend.libs.tbd.ee.libstorm.AbstractFieldGenerator>();" + NL;
  protected final String TEXT_49 = NL + "        fieldGenerators_";
  protected final String TEXT_50 = ".add(new FieldGenerator_";
  protected final String TEXT_51 = "());";
  protected final String TEXT_52 = NL + NL + "    org.talend.libs.tbd.ee.libstorm.TRowGeneratorSpout spout" + NL + "            = new org.talend.libs.tbd.ee.libstorm.TRowGeneratorSpout(";
  protected final String TEXT_53 = NL + "                    ";
  protected final String TEXT_54 = ", fieldGenerators_";
  protected final String TEXT_55 = ", nb_max_row_";
  protected final String TEXT_56 = " );" + NL;
  protected final String TEXT_57 = NL + "                stream_";
  protected final String TEXT_58 = " = ctx.getTridentTopology().newStream(topologyName+\"";
  protected final String TEXT_59 = "WithStr\", spout);";
...
if (streamUtil.getOutFieldsSize() == 0)
    return "";
...
streamUtil.generateAllOutStreamsDeclarations();
    ...
    stringBuffer.append((("").equals(ElementParameterParser.getValue(node, "__NB_ROWS__"))
            ? 100 : ElementParameterParser.getValue(node, "__NB_ROWS__")));
    stringBuffer.append(TEXT_47);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_48);
     for (IMetadataColumn column : streamUtil.getOutColumns()) { 
