...
public class TInputFormatXMLSparkconfigJava
{
  ...
  protected final String TEXT_126 = NL + "            final String clouderaManagerPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_127 = ");";
  protected final String TEXT_128 = NL + "            final String clouderaManagerPassword = ";
  protected final String TEXT_129 = ";";
  protected final String TEXT_130 = NL + "        this.lineageCreator = new org.talend.lineage.cloudera.LineageCreator(";
  ...
  protected final String TEXT_138 = "," + NL + "                clouderaManagerPassword," + NL + "                jobName + \"_\" + jobVersion.replace(\".\", \"_\")," + NL + "                projectName,";
  ...
  protected final String TEXT_145 = NL + "        this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_146 = ");" + NL + "" + NL + "        java.util.Map<String, Object> lineageCreatorJobMetadata = new java.util.HashMap<String, Object>();" + NL + "        lineageCreatorJobMetadata.put(\"name\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"description\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"purpose\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"author\", System.getProperty(\"user.name\"));" + NL + "        lineageCreatorJobMetadata.put(\"version\", jobVersion);" + NL + "        lineageCreatorJobMetadata.put(\"jobType\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"framework\", \"Talend BigData\");" + NL + "        lineageCreatorJobMetadata.put(\"status\", \"FINISHED\");" + NL + "        lineageCreatorJobMetadata.put(\"creationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"lastModificationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"startTime\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"endTime\", System.currentTimeMillis());" + NL + "" + NL + "        this.lineageCreator.addJobInfo(lineageCreatorJobMetadata);";
  protected final String TEXT_147 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_148 = " = new java.util.HashMap<>();";
  protected final String TEXT_149 = NL + "            columns_";
  protected final String TEXT_150 = ".put(\"";
  protected final String TEXT_151 = "\", \"";
  protected final String TEXT_152 = "\");";
  protected final String TEXT_153 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_154 = " = new java.util.HashMap<>();";
  protected final String TEXT_155 = NL + "                        columns_";
  protected final String TEXT_156 = ".put(\"";
  protected final String TEXT_157 = "\", \"";
  protected final String TEXT_158 = "\");";
  protected final String TEXT_159 = NL + "                    columns_";
  protected final String TEXT_160 = ".put(\"";
  protected final String TEXT_161 = "\", \"";
  protected final String TEXT_162 = "\");";
  protected final String TEXT_163 = NL + "        lineageCreator.addDataset(columns_";
  protected final String TEXT_164 = ", \"";
  protected final String TEXT_165 = "\", ";
  protected final String TEXT_166 = ", \"";
  protected final String TEXT_167 = "\");";
  protected final String TEXT_168 = NL + "        java.util.List<String> inputNodes_";
  protected final String TEXT_169 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_170 = NL + "                inputNodes_";
  protected final String TEXT_171 = ".add(\"";
  protected final String TEXT_172 = "\");";
  protected final String TEXT_173 = NL + "        java.util.List<String> outputNodes_";
  protected final String TEXT_174 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_175 = NL + "                outputNodes_";
  protected final String TEXT_176 = ".add(\"";
  protected final String TEXT_177 = "\");";
  protected final String TEXT_178 = NL + "        this.lineageCreator.addNodeToLineage(\"";
  protected final String TEXT_179 = "\", columns_";
  protected final String TEXT_180 = ", inputNodes_";
  protected final String TEXT_181 = ", outputNodes_";
  protected final String TEXT_182 = ", new java.util.HashMap<String, Object>());";
