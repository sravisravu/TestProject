...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_331 = ".getTables(null, schemaForSearch_";
  ...
  protected final String TEXT_352 = NL + "                                if(!whetherExist_";
  protected final String TEXT_353 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_374 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_405 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_406 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_407 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_421 = NL + "                              stmtTruncCount_";
  protected final String TEXT_422 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_423 = "));";
  protected final String TEXT_424 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_425 = " = stmtTruncCount_";
  protected final String TEXT_426 = ".executeQuery(\"";
  protected final String TEXT_427 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_428 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_433 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_444 = NL + "                if(!conn_";
  protected final String TEXT_445 = ".getAutoCommit()){" + NL + "                    conn_";
  ...
  protected final String TEXT_495 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_528 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_540 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_548 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_560 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_561 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_562 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_563 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_564 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_565 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_574 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_580 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
