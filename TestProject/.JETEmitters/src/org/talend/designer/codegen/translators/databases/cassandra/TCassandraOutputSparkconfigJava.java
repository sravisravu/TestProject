...
public class TCassandraOutputSparkconfigJava
{
  ...
  protected final String TEXT_140 = NL + "\t\t\trdd_";
  protected final String TEXT_141 = ".rdd().conf().set(";
  protected final String TEXT_142 = ", ";
  protected final String TEXT_143 = ");\t" + NL + "\t\t";
  protected final String TEXT_144 = NL + "\t\tjava.util.Map<String, String> columnMapping_";
  protected final String TEXT_145 = " = new java.util.HashMap<String, String>();" + NL + "\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\tcolumnMapping_";
  protected final String TEXT_147 = ".put(\"";
  protected final String TEXT_148 = "\", \"";
  protected final String TEXT_149 = "\");" + NL + "\t    \t";
  protected final String TEXT_150 = NL + "\t\tcom.datastax.spark.connector.japi.CassandraJavaUtil.javaFunctions(rdd_";
  protected final String TEXT_151 = ").writerBuilder(" + NL + "\t    \t\t";
  protected final String TEXT_152 = ", ";
  protected final String TEXT_153 = ", " + NL + "\t    \t\tcom.datastax.spark.connector.japi.CassandraJavaUtil.mapToRow(";
  protected final String TEXT_154 = ".class, columnMapping_";
  protected final String TEXT_155 = ")" + NL + "\t\t\t)" + NL + "\t\t\t.withColumnSelector(com.datastax.spark.connector.japi.CassandraJavaUtil.someColumns(";
  protected final String TEXT_156 = "))" + NL + "\t\t\t.saveToCassandra();" + NL + "\t";
  protected final String TEXT_157 = NL + "\t\trdd_";
  protected final String TEXT_158 = ".foreachPartition(new ";
  protected final String TEXT_159 = "_OutputFunction(job));" + NL + "\t";
