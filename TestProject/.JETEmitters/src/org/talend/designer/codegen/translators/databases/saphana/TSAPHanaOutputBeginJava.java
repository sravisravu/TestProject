...
public class TSAPHanaOutputBeginJava {
  ...
  protected final String TEXT_334 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_335 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_336 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_337 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_355 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_379 = NL + "                                                      stmtDrop_";
  ...
  protected final String TEXT_387 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_407 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_408 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_409 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_423 = NL + "                              stmtTruncCount_";
  protected final String TEXT_424 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_425 = "));";
  protected final String TEXT_426 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_427 = " = stmtTruncCount_";
  protected final String TEXT_428 = ".executeQuery(\"";
  protected final String TEXT_429 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_430 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_431 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_435 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_469 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_470 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_471 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_492 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_505 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_506 = " = conn_";
  protected final String TEXT_507 = ".prepareStatement(update_";
