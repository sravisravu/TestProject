...
public class THBaseOutputBeginJava
{
  ...
  protected final String TEXT_137 = NL + NL + "            maprLogin_";
  protected final String TEXT_138 = ".getMapRCredentialsViaPassword(";
  ...
  protected final String TEXT_148 = " = (org.apache.hadoop.conf.Configuration)globalMap.get(\"";
  protected final String TEXT_149 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_150 = " == null){" + NL + "\t\tthrow new RuntimeException(\"";
  protected final String TEXT_151 = "'s connection is null!\");" + NL + "\t}";
  protected final String TEXT_152 = NL + "\tconn_";
  protected final String TEXT_153 = ".set(\"hbase.table.namespace.mappings\", ";
  protected final String TEXT_154 = ");";
  protected final String TEXT_155 = NL + "\torg.apache.hadoop.hbase.client.HBaseAdmin admin_";
  protected final String TEXT_156 = " = new org.apache.hadoop.hbase.client.HBaseAdmin(conn_";
  protected final String TEXT_157 = ");";
  protected final String TEXT_158 = NL + "\tboolean tableExist_";
  protected final String TEXT_159 = " = admin_";
  protected final String TEXT_160 = ".tableExists(";
  protected final String TEXT_161 = ");" + NL + "\tif(!tableExist_";
  protected final String TEXT_162 = "){";
  protected final String TEXT_163 = NL + "\t}";
  protected final String TEXT_164 = NL + "\tboolean tableExist_";
  protected final String TEXT_165 = " = admin_";
  protected final String TEXT_166 = ".tableExists(";
  protected final String TEXT_167 = ");" + NL + "\tif(tableExist_";
  protected final String TEXT_168 = "){";
  protected final String TEXT_169 = NL + "\t}";
  protected final String TEXT_170 = NL + "org.apache.hadoop.hbase.client.HTable table_";
  protected final String TEXT_171 = " = null;" + NL + "table_";
  protected final String TEXT_172 = " = new org.apache.hadoop.hbase.client.HTable(conn_";
  protected final String TEXT_173 = ",";
  protected final String TEXT_174 = ");" + NL + "byte[] temp_";
