...
public class TQASAddressVerifiedEndJava
{
  protected static String nl;
  public static synchronized TQASAddressVerifiedEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TQASAddressVerifiedEndJava result = new TQASAddressVerifiedEndJava();
    nl = null;
    return result;
  }
