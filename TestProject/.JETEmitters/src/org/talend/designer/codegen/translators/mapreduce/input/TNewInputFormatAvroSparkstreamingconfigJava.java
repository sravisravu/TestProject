...
public class TNewInputFormatAvroSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TNewInputFormatAvroSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNewInputFormatAvroSparkstreamingconfigJava result = new TNewInputFormatAvroSparkstreamingconfigJava();
    nl = null;
    return result;
  }
