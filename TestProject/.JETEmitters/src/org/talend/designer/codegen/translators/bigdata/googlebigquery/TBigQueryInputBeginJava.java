...
public class TBigQueryInputBeginJava
{
  ...
  protected final String TEXT_137 = ").build();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "" + NL + "\t// Start a Query Job" + NL + "\tString querySql_";
  protected final String TEXT_138 = " = ";
  protected final String TEXT_139 = ";" + NL + "\tSystem.out.format(\"Running Query : %s\\n\", querySql_";
  protected final String TEXT_140 = ");" + NL + "\t";
  protected final String TEXT_141 = NL + "\t\tlog.debug(\"";
  protected final String TEXT_142 = " - Running Query: \"+querySql_";
  protected final String TEXT_143 = ");" + NL + "\t";
  protected final String TEXT_144 = NL + "\tcom.google.api.services.bigquery.model.Job job_";
  protected final String TEXT_145 = " = new com.google.api.services.bigquery.model.Job();" + NL + "\tcom.google.api.services.bigquery.model.JobConfiguration config_";
  protected final String TEXT_146 = " = new com.google.api.services.bigquery.model.JobConfiguration();" + NL + "\tcom.google.api.services.bigquery.model.JobConfigurationQuery queryConfig_";
  protected final String TEXT_147 = " = new com.google.api.services.bigquery.model.JobConfigurationQuery();" + NL + "\tconfig_";
  protected final String TEXT_148 = ".setQuery(queryConfig_";
  protected final String TEXT_149 = ");" + NL + "" + NL + "\tjob_";
  protected final String TEXT_150 = ".setConfiguration(config_";
  protected final String TEXT_151 = ");" + NL + "\tqueryConfig_";
  protected final String TEXT_152 = ".setQuery(querySql_";
  protected final String TEXT_153 = ");" + NL + "\t" + NL + "\tcom.google.api.services.bigquery.model.Job insert_";
  protected final String TEXT_154 = " = null;" + NL + "\tcom.google.api.services.bigquery.model.JobReference jobId_";
  protected final String TEXT_155 = " = null;" + NL + "\ttry {" + NL + "\t\tinsert_";
  protected final String TEXT_156 = " = bigqueryclient_";
  protected final String TEXT_157 = ".jobs().insert(PROJECT_ID_";
  protected final String TEXT_158 = ", job_";
  protected final String TEXT_159 = ").execute();" + NL + "\t\tjobId_";
  protected final String TEXT_160 = " = insert_";
  protected final String TEXT_161 = ".getJobReference();" + NL + "\t} catch (com.google.api.client.googleapis.json.GoogleJsonResponseException e_";
  protected final String TEXT_162 = ") {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.File f_";
  protected final String TEXT_163 = " = new java.io.File(tokenFile_";
  protected final String TEXT_164 = ");" + NL + "\t\t\tboolean isRemoved_";
  protected final String TEXT_165 = " = f_";
  protected final String TEXT_166 = ".delete();" + NL + "\t\t\tif(isRemoved_";
  protected final String TEXT_167 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_168 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_169 = " - Unable to connect. This might come from the token expiration. Execute again the job with an empty authorization code.\");" + NL + "\t\t\t\t";
  protected final String TEXT_170 = NL + "\t\t\t\tSystem.err.println(\"---> Unable to connect. This might come from the token expiration. Execute again the job with an empty authorization code.\");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tthrow new java.lang.Exception();" + NL + "\t\t\t}" + NL + "\t\t} catch (java.lang.Exception ee_";
  protected final String TEXT_171 = ") {" + NL + "\t\t\t";
  protected final String TEXT_172 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_173 = " - Unable to connect. This might come from the token expiration. Remove the file \" + tokenFile_";
  protected final String TEXT_174 = " + \" Execute again the job with an empty authorization code.\");" + NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t\t\tSystem.err.println(\"---> Unable to connect. This might come from the token expiration. Remove the file \" + tokenFile_";
  protected final String TEXT_176 = " + \" Execute again the job with an empty authorization code.\");" + NL + "\t\t}" + NL + "\t\tthrow e_";
  protected final String TEXT_177 = ";" + NL + "\t}" + NL + "\t";
  protected final String TEXT_178 = NL + "\t\tlog.info(\"";
  protected final String TEXT_179 = " - Wait for query execution\");" + NL + "\t";
  protected final String TEXT_180 = NL + "\t// wait for query execution" + NL + "\twhile (true) {" + NL + "\t\tcom.google.api.services.bigquery.model.Job pollJob_";
  protected final String TEXT_181 = " = bigqueryclient_";
  protected final String TEXT_182 = ".jobs().get(PROJECT_ID_";
  protected final String TEXT_183 = ", jobId_";
  protected final String TEXT_184 = ".getJobId()).execute();" + NL + "\t\tif (pollJob_";
  protected final String TEXT_185 = ".getStatus().getState().equals(\"DONE\")) {" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t\t// Pause execution for one second before polling job status again, to " + NL + "\t\t// reduce unnecessary calls to the BigQUery API and lower overall" + NL + "\t\t// application bandwidth." + NL + "\t\tThread.sleep(1000);" + NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_186 = NL + "\t\tlog.info(\"";
  protected final String TEXT_187 = " - Retrieving records from dataset.\");" + NL + "\t";
  protected final String TEXT_188 = NL + "\tString pageToken_";
  protected final String TEXT_189 = " = null;" + NL + "\twhile (true) {" + NL + "\t\t// Fetch Results" + NL + "\t\tcom.google.api.services.bigquery.model.TableDataList dataList_";
  protected final String TEXT_190 = " = bigqueryclient_";
  protected final String TEXT_191 = ".tabledata()" + NL + "\t\t\t\t\t.list(PROJECT_ID_";
  protected final String TEXT_192 = "," + NL + "\t\t\t\t\t\t\tinsert_";
  protected final String TEXT_193 = ".getConfiguration().getQuery()" + NL + "\t\t\t\t\t\t\t\t\t.getDestinationTable().getDatasetId()," + NL + "\t\t\t\t\t\t\tinsert_";
  protected final String TEXT_194 = ".getConfiguration().getQuery()" + NL + "\t\t\t\t\t\t\t\t\t.getDestinationTable().getTableId())" + NL + "\t\t\t\t\t.setPageToken(pageToken_";
  protected final String TEXT_195 = ").execute();" + NL + "\t\t" + NL + "\t\tList<com.google.api.services.bigquery.model.TableRow> rows_";
  protected final String TEXT_196 = " = dataList_";
  protected final String TEXT_197 = ".getRows();" + NL + "" + NL + "\t\tif(rows_";
  protected final String TEXT_198 = " == null) {" + NL + "\t\t\t// Means there is no record." + NL + "\t\t\trows_";
  protected final String TEXT_199 = " = new java.util.ArrayList<com.google.api.services.bigquery.model.TableRow>();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tfor (com.google.api.services.bigquery.model.TableRow row_";
  protected final String TEXT_200 = " : rows_";
  protected final String TEXT_201 = ") {" + NL + "\t\t\tjava.util.List<com.google.api.services.bigquery.model.TableCell> field_";
  protected final String TEXT_202 = " = row_";
  protected final String TEXT_203 = ".getF();" + NL + "\t\t\tObject value_";
  protected final String TEXT_204 = " = null;" + NL + "\t\t\tnb_line_";
  protected final String TEXT_205 = " ++;" + NL + "\t\t";
  protected final String TEXT_206 = NL + "\t\t\t\t\t\t\t\tvalue_";
  protected final String TEXT_207 = " = field_";
  protected final String TEXT_208 = ".get(";
  protected final String TEXT_209 = ").getV();" + NL + "\t\t\t\t\t\t\t\tif(com.google.api.client.util.Data.isNull(value_";
  protected final String TEXT_210 = ")) value_";
  protected final String TEXT_211 = " = null;" + NL + "\t\t\t\t\t\t\t\tif(value_";
  protected final String TEXT_212 = " != null){" + NL + "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_213 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = " = value_";
  protected final String TEXT_216 = ".toString();" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_217 = "\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_218 = ".";
  protected final String TEXT_219 = " = value_";
  protected final String TEXT_220 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_221 = "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_222 = ".";
  protected final String TEXT_223 = " = ParserUtils.parseTo_Date(value_";
  protected final String TEXT_224 = ".toString(), ";
  protected final String TEXT_225 = ");\t\t\t\t" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_227 = ".";
  protected final String TEXT_228 = " = ParserUtils.parseTo_";
  protected final String TEXT_229 = "(ParserUtils.parseTo_Number(value_";
  ...
  protected final String TEXT_236 = ".toString().getBytes(";
  ...
  protected final String TEXT_243 = NL + "\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t";
