...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_416 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_471 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_569 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_570 = ",";
  protected final String TEXT_571 = ".";
  protected final String TEXT_572 = ", ";
  protected final String TEXT_573 = ",insertSQLSplits_";
  protected final String TEXT_574 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_575 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_595 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_614 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  ...
  protected final String TEXT_658 = NL + "\t\t\tbatchSizeCounter_";
  protected final String TEXT_659 = "++;" + NL + "    \t\t";
  protected final String TEXT_660 = NL + "             try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_665 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_666 = " = true;";
  protected final String TEXT_667 = NL + "                    throw(e);";
  ...
  protected final String TEXT_684 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_685 = NL + "            }";
  protected final String TEXT_686 = NL + "                    \t";
  protected final String TEXT_687 = NL + "                    ";
  protected final String TEXT_688 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_689 = " = pstmt_";
  protected final String TEXT_690 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_691 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_692 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_693 = " = rs_";
  protected final String TEXT_694 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_695 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_696 = NL + "                        ";
  protected final String TEXT_697 = NL + "                            query_";
  protected final String TEXT_698 = " = ";
  protected final String TEXT_699 = ";";
  protected final String TEXT_700 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_701 = ",";
  protected final String TEXT_702 = ".";
  protected final String TEXT_703 = ", ";
  protected final String TEXT_704 = ",updateSQLSplits_";
  protected final String TEXT_705 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_706 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_707 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_708 = ".";
  protected final String TEXT_709 = ", pstmtUpdate_";
  ...
  protected final String TEXT_734 = NL + "        \t\t\tupdatedCount_";
  ...
  protected final String TEXT_739 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_760 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_761 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  ...
  protected final String TEXT_786 = NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_807 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_808 = NL + "                }" + NL + "    \t\t}" + NL + "" + NL + "    \t\t";
  protected final String TEXT_809 = NL + "    \t    int updateFlag_";
  protected final String TEXT_810 = "=0;" + NL + "            try {" + NL + "    \t    ";
  ...
  protected final String TEXT_849 = NL + "                updateFlag_";
  ...
  protected final String TEXT_854 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_855 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_856 = NL + "\t\t\t\tquery_";
  protected final String TEXT_857 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_884 = NL + "    \t\t\t}" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_916 = NL + "                globalMap.put(\"";
  protected final String TEXT_917 = "_QUERY\", query_";
  protected final String TEXT_918 = ".toString().trim());";
  protected final String TEXT_919 = NL + "    \t\t";
  protected final String TEXT_920 = NL + "    \t\tpstmt_";
  protected final String TEXT_921 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_922 = "++;" + NL + "\t\t\t";
  protected final String TEXT_923 = NL + "   \t\t\tbatchSizeCounter_";
  protected final String TEXT_924 = "++;" + NL + "   \t\t   ";
  protected final String TEXT_925 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_926 = " = deletedCount_";
  protected final String TEXT_927 = " + pstmt_";
  protected final String TEXT_928 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_929 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_930 = NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_951 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_952 = NL + "            }" + NL + "    \t";
  protected final String TEXT_953 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_964 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_965 = " > 0) && (batchSize_";
  protected final String TEXT_966 = " <= batchSizeCounter_";
  protected final String TEXT_967 = ")) {" + NL + "    \t\t\t    try {" + NL + "    \t\t\t    \t";
  protected final String TEXT_968 = NL + "                            pstmt_";
  protected final String TEXT_969 = ".executeBatch();";
  protected final String TEXT_970 = NL + "                            int countSum_";
  ...
  protected final String TEXT_983 = NL + "                    }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_984 = "){";
  protected final String TEXT_985 = NL + "                            throw(e_";
  ...
  protected final String TEXT_990 = ".getUpdateCounts()) {" + NL + "                                    countSum_";
  ...
  protected final String TEXT_1000 = NL + "                            System.err.println(e_";
  protected final String TEXT_1001 = ".getMessage());";
  protected final String TEXT_1002 = NL + "                    }";
  protected final String TEXT_1003 = NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1004 = " = pstmt_";
  protected final String TEXT_1005 = ".getUpdateCount();" + NL + "                        insertedCount_";
  protected final String TEXT_1006 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1007 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1008 = ":0);";
  protected final String TEXT_1009 = NL + "                    batchSizeCounter_";
  protected final String TEXT_1010 = " = 0;" + NL + "\t\t\t\t}" + NL + "\t    \t\t";
  ...
  protected final String TEXT_1015 = NL + "\t                if(batchSizeCounter_";
  protected final String TEXT_1016 = " > 0){" + NL + "    \t                try {" + NL + "    \t                \t";
  protected final String TEXT_1017 = NL + "                                pstmt_";
  protected final String TEXT_1018 = ".executeBatch();";
  protected final String TEXT_1019 = NL + "                                int countSum_";
  protected final String TEXT_1020 = " = 0;" + NL + "                                for(int countEach_";
  ...
  protected final String TEXT_1032 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1033 = "){";
  protected final String TEXT_1034 = NL + "                                throw(e_";
  ...
  protected final String TEXT_1043 = NL + "                                    updatedCount_";
  protected final String TEXT_1044 = " += countSum_";
  protected final String TEXT_1045 = ";";
  protected final String TEXT_1046 = NL + "                                    deletedCount_";
  ...
  protected final String TEXT_1052 = NL + "                            tmp_batchUpdateCount_";
  protected final String TEXT_1053 = " = pstmt_";
  protected final String TEXT_1054 = ".getUpdateCount();" + NL + "                            insertedCount_";
  protected final String TEXT_1055 = "+= (tmp_batchUpdateCount_";
  protected final String TEXT_1056 = " >0 ? tmp_batchUpdateCount_";
  protected final String TEXT_1057 = ":0);";
  protected final String TEXT_1058 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1059 = " = 0;" + NL + "                    }" + NL + "\t                ";
  protected final String TEXT_1060 = NL + "\t                \t";
  protected final String TEXT_1061 = NL + "                        conn_";
  protected final String TEXT_1062 = ".commit();";
  protected final String TEXT_1063 = NL + "                        commitCounter_";
