...
public class TFilterColumnsMrconfigJava
{
  protected static String nl;
  public static synchronized TFilterColumnsMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsMrconfigJava result = new TFilterColumnsMrconfigJava();
    nl = null;
    return result;
  }
