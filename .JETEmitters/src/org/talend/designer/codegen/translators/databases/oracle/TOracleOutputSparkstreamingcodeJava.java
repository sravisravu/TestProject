...
import org.talend.designer.common.tjdbcoutput.TJdbcOutputUtil;
...
public class TOracleOutputSparkstreamingcodeJava {
  ...
  protected final String TEXT_5 = NL + "\t\tpublic static class BlobTypeUtil_";
  protected final String TEXT_6 = " {" + NL + "\t\t" + NL + "\t\t\tpublic Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "\t\t\t\tif(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\toracle.sql.BLOB blob = null;" + NL + "\t\t\tjava.io.InputStream in = null;" + NL + "\t\t\tjava.io.OutputStream out = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t//in" + NL + "\t\t\t\tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "\t\t\t\tin = blobData.getBinaryStream();" + NL + "\t\t" + NL + "\t\t    \t//out" + NL + "\t\t\t\tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "\t\t\t\tblob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "\t\t\t\t//blob = conn.createBlob(); oracle jdbc don't support it" + NL + "\t\t    \tout = blob.setBinaryStream(1);" + NL + "\t\t" + NL + "\t\t\t\tbyte[] cache = new byte[8192];" + NL + "\t\t\t\tint len = 0;" + NL + "\t\t\t\twhile ((len = in.read(cache)) != -1) {" + NL + "\t\t\t\t    out.write(cache, 0, len);" + NL + "\t\t\t\t}" + NL + "\t\t" + NL + "\t\t\t\treturn blob;" + NL + "\t\t    } catch(java.sql.SQLException sqlexp){" + NL + "\t\t\t\tif(blob!=null) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tblob.freeTemporary();" + NL + "\t\t\t\t\t} catch(java.sql.SQLException e_";
  protected final String TEXT_7 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t    \t\t}" + NL + "\t\t    \t}" + NL + "\t\t    \tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t\t   \tif(blob!=null) {" + NL + "\t\t\t\ttry {" + NL + "\t\t    \t\tblob.freeTemporary();" + NL + "\t\t    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_8 = ") {" + NL + "\t\t\t\t\t//keep quiet" + NL + "\t\t    \t}" + NL + "\t\t    }" + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t\t} finally {" + NL + "\t\t\t\tif(out!=null) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tout.flush();" + NL + "\t\t    \t\t\tout.close();" + NL + "\t\t    \t\t} catch(java.io.IOException e_";
  protected final String TEXT_9 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t" + NL + "\t\t\t \tif(in!=null) {" + NL + "\t\t    \t\ttry {" + NL + "\t\t        \t\tin.close();" + NL + "\t\t        \t} catch(java.io.IOException e_";
  protected final String TEXT_10 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t" + NL + "\t\t    \tif(blob!=null) {" + NL + "\t\t    \t\ttry {" + NL + "\t\t        \t\tblob.close();" + NL + "\t\t        \t} catch(java.sql.SQLException e_";
  protected final String TEXT_11 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t    }" + NL + "\t\t" + NL + "\t\t    return null;" + NL + "\t\t" + NL + "\t\t    }" + NL + "\t\t" + NL + "\t\t}";
  protected final String TEXT_12 = NL + NL + NL + "\t\tpublic static class ";
  protected final String TEXT_13 = "_OutputFunction implements org.apache.spark.api.java.function.VoidFunction<java.util.Iterator<";
  protected final String TEXT_14 = ">> {" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_15 = NL;
  protected final String TEXT_16 = NL + "\t\tint batchSize = -1;" + NL + "\t\tint batchSizeCounter = 0;";
  protected final String TEXT_17 = NL + NL + "\t\t\tContextProperties context;" + NL + "" + NL + "\t\t\tpublic ";
  protected final String TEXT_18 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    this(new ContextProperties(conf));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic ";
  protected final String TEXT_19 = "_OutputFunction(ContextProperties context) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    Class.forName(";
  protected final String TEXT_20 = ");" + NL + "\t\t\t    this.context = context;" + NL + "\t\t\t    ";
  protected final String TEXT_21 = NL;
  protected final String TEXT_22 = NL + "\t\tbatchSize = ";
  protected final String TEXT_23 = ";";
  protected final String TEXT_24 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\tpublic void call(java.util.Iterator<";
  protected final String TEXT_25 = "> dataIterator) throws java.lang.Exception {" + NL + "\t\t\t\tjava.sql.Connection connection = ";
  protected final String TEXT_26 = ".get(context).borrowObject();" + NL + "\t\t\t\t" + NL + "\t\t\t\t// Not to break retro-compatibility with JDBC Talend Data Integration util classes" + NL + "\t\t\t\tjava.sql.Connection conn_";
  protected final String TEXT_27 = " = connection;";
  protected final String TEXT_28 = NL + "        \t\t\tBlobTypeUtil_";
  protected final String TEXT_29 = " blobTypeUtil_";
  protected final String TEXT_30 = " = new BlobTypeUtil_";
  ...
  protected final String TEXT_35 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_36 = "\" + ";
  protected final String TEXT_37 = " + \"";
  protected final String TEXT_38 = " (";
  protected final String TEXT_39 = ") VALUES(";
  protected final String TEXT_40 = ")\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_41 = " ";
  protected final String TEXT_42 = " = dataIterator.next();";
  protected final String TEXT_43 = NL + "\t\t\t";
  protected final String TEXT_44 = NL + "\t";
  protected final String TEXT_45 = NL;
  protected final String TEXT_46 = NL + "\tpstmt_";
  protected final String TEXT_47 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_48 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  protected final String TEXT_49 = "                            " + NL + "\t\t\t\tthrow(e);";
  protected final String TEXT_50 = NL + "\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_51 = NL + "\t\t}" + NL + "\t\tpstmt_";
  protected final String TEXT_52 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_53 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_54 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_55 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_56 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_57 = NL + "\t}             ";
  protected final String TEXT_58 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_59 = NL;
  protected final String TEXT_60 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_61 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  ...
  protected final String TEXT_69 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_70 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_71 = "\" + ";
  protected final String TEXT_72 = " + \"";
  protected final String TEXT_73 = " SET ";
  protected final String TEXT_74 = " WHERE ";
  protected final String TEXT_75 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_76 = " ";
  protected final String TEXT_77 = " = dataIterator.next();";
  protected final String TEXT_78 = NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL;
  protected final String TEXT_82 = NL + "\tpstmt_";
  protected final String TEXT_83 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_84 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_88 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_89 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_90 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_91 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_92 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_93 = NL + "\t}             ";
  protected final String TEXT_94 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_95 = NL;
  protected final String TEXT_96 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_97 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_98 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_99 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_100 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_101 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_102 = NL + NL + "pstmt_";
  protected final String TEXT_103 = ".close();";
  protected final String TEXT_104 = NL + "\t\t\t\t\t";
  protected final String TEXT_105 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_106 = " = connection.prepareStatement(\"SELECT COUNT(1) FROM ";
  protected final String TEXT_107 = "\" + ";
  protected final String TEXT_108 = " + \"";
  protected final String TEXT_109 = " WHERE ";
  protected final String TEXT_110 = "\");" + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_111 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_112 = "\" + ";
  protected final String TEXT_113 = " + \"";
  protected final String TEXT_114 = " (";
  protected final String TEXT_115 = ") VALUES (";
  protected final String TEXT_116 = ")\");" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_117 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_118 = "\" + ";
  protected final String TEXT_119 = " +\"";
  protected final String TEXT_120 = " SET ";
  protected final String TEXT_121 = " WHERE ";
  protected final String TEXT_122 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_123 = " ";
  protected final String TEXT_124 = " = dataIterator.next();";
  protected final String TEXT_125 = NL + "\t\t\t";
  protected final String TEXT_126 = NL + "\tjava.sql.ResultSet rs_";
  protected final String TEXT_127 = " = pstmt_";
  protected final String TEXT_128 = ".executeQuery();" + NL + "\tint checkCount_";
  protected final String TEXT_129 = " = -1;" + NL + "\t" + NL + "\twhile(rs_";
  protected final String TEXT_130 = ".next()) {" + NL + "\t\tcheckCount_";
  protected final String TEXT_131 = " = rs_";
  protected final String TEXT_132 = ".getInt(1);" + NL + "\t}" + NL + "\t" + NL + "\tif(checkCount_";
  protected final String TEXT_133 = " > 0) {";
  protected final String TEXT_134 = NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t pstmtUpdate_";
  protected final String TEXT_137 = ".executeUpdate();" + NL + "\t} else {";
  protected final String TEXT_138 = NL + "\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_140 = ".executeUpdate();" + NL + "\t}\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmt_";
  protected final String TEXT_141 = ".close();" + NL + "pstmtInsert_";
  protected final String TEXT_142 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_143 = ".close();";
  protected final String TEXT_144 = NL + "\t\t\t\t\t";
  protected final String TEXT_145 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_146 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_152 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_153 = "\" + ";
  protected final String TEXT_154 = " +\"";
  protected final String TEXT_155 = " SET ";
  protected final String TEXT_156 = " WHERE ";
  protected final String TEXT_157 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_158 = " ";
  protected final String TEXT_159 = " = dataIterator.next();";
  protected final String TEXT_160 = NL + "\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t";
  protected final String TEXT_162 = NL + "\tint updateFlag_";
  protected final String TEXT_163 = " = pstmtUpdate_";
  protected final String TEXT_164 = ".executeUpdate();" + NL + "\t" + NL + "\tif(updateFlag_";
  protected final String TEXT_165 = " == 0) {";
  protected final String TEXT_166 = NL + "\t\t\t\t";
  protected final String TEXT_167 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_168 = ".executeUpdate();" + NL + "\t}" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_169 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_170 = ".close();";
  protected final String TEXT_171 = NL + "\t\t\t\t\t";
  protected final String TEXT_172 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_173 = " = connection.prepareStatement(\"DELETE FROM ";
  protected final String TEXT_174 = "\" + ";
  protected final String TEXT_175 = " + \"";
  protected final String TEXT_176 = " WHERE ";
  protected final String TEXT_177 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_178 = " ";
  protected final String TEXT_179 = " = dataIterator.next();";
  protected final String TEXT_180 = NL + "\t\t\t";
  protected final String TEXT_181 = NL + "\t";
  protected final String TEXT_182 = NL;
  protected final String TEXT_183 = NL + "\tpstmt_";
  protected final String TEXT_184 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_185 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_189 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_190 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_191 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_192 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_193 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_194 = NL + "\t}             ";
  protected final String TEXT_195 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_196 = NL;
  protected final String TEXT_197 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_198 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_199 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_200 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_201 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_202 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_203 = NL + NL + "pstmt_";
  protected final String TEXT_204 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_205 = NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\tif(connection != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_206 = ".get(context).returnObject(connection);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} // end call()" + NL + "\t\t} // end class" + NL;
  protected final String TEXT_207 = NL + "\t\t\t";
  protected final String TEXT_208 = NL + NL + "public static class ";
  protected final String TEXT_209 = " {" + NL + "\tprivate static volatile org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_210 = "> pool;" + NL + "\t" + NL + "\tprivate ";
  protected final String TEXT_211 = "() {" + NL + "\t    // empty" + NL + "\t}" + NL + "" + NL + "\tpublic static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_212 = "> get(ContextProperties context) {" + NL + "\t\tif(pool == null) {" + NL + "\t\t\tsynchronized(";
  protected final String TEXT_213 = ".class) {" + NL + "\t\t\t\tif(pool == null) {" + NL + "\t\t\t\t\tpool = createPool(context);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t   return pool;" + NL + "\t}" + NL + "" + NL + "\tprivate static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_214 = "> createPool(ContextProperties context) {" + NL + "\t    org.apache.commons.pool2.impl.GenericObjectPoolConfig config = new org.apache.commons.pool2.impl.GenericObjectPoolConfig();" + NL + "\t    config.setMaxTotal(";
  protected final String TEXT_215 = ");" + NL + "\t    config.setMaxWaitMillis(";
  protected final String TEXT_216 = ");" + NL + "\t    config.setMinIdle(";
  protected final String TEXT_217 = ");" + NL + "\t    config.setMaxIdle(";
  protected final String TEXT_218 = ");" + NL + "\t    config.setBlockWhenExhausted(true);";
  protected final String TEXT_219 = NL + "\t\t\tconfig.setTimeBetweenEvictionRunsMillis(";
  protected final String TEXT_220 = ");" + NL + "\t\t\tconfig.setMinEvictableIdleTimeMillis(";
  protected final String TEXT_221 = ");" + NL + "\t\t\tconfig.setSoftMinEvictableIdleTimeMillis(";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "\t    return new org.apache.commons.pool2.impl.GenericObjectPool<";
  protected final String TEXT_224 = ">(new ";
  protected final String TEXT_225 = "(context), config);" + NL + "\t}" + NL + "}" + NL + "\t\t\t";
  protected final String TEXT_226 = NL + NL + "public static class ";
  protected final String TEXT_227 = " extends org.apache.commons.pool2.BasePooledObjectFactory<";
  protected final String TEXT_228 = "> {" + NL + "" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_229 = "(ContextProperties context) {" + NL + "\t\tthis.context = context;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_230 = " create() throws Exception {" + NL + "\t   Class.forName(";
  protected final String TEXT_231 = ");" + NL + "\t\tjava.util.Properties jdbcDriverProperties = new java.util.Properties();" + NL + "\t\tString jdbcAdditionalParameters = ";
  protected final String TEXT_232 = ";" + NL + "\t\tif(jdbcAdditionalParameters != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters) && !\"\".equals(jdbcAdditionalParameters)){" + NL + "\t\t\tjdbcDriverProperties.load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters.replace(";
  protected final String TEXT_233 = ", \"\\n\").getBytes()));" + NL + "\t\t}" + NL + "\t\tif(";
  protected final String TEXT_234 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_235 = ") && !\"\".equals(";
  protected final String TEXT_236 = ")){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"user\", ";
  protected final String TEXT_237 = ");" + NL + "\t\t}" + NL + "\t\tString password = ";
  protected final String TEXT_238 = " ;" + NL + "\t\tif(password != null && !\"\\\"\\\"\".equals(password) && !\"\".equals(password)){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"password\", password);" + NL + "\t\t}" + NL + "\t   return java.sql.DriverManager.getConnection(";
  protected final String TEXT_239 = ", jdbcDriverProperties);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_240 = "> wrap(";
  protected final String TEXT_241 = " connection) {" + NL + "\t   return new org.apache.commons.pool2.impl.DefaultPooledObject<";
  protected final String TEXT_242 = ">(connection);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void destroyObject(org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_243 = "> pooledObject) throws Exception {" + NL + "\t\tif (pooledObject != null) {" + NL + "\t\t    pooledObject.getObject().close();" + NL + "\t\t}" + NL + "\t\tsuper.destroyObject(pooledObject);" + NL + "\t}" + NL + "}";
  protected final String TEXT_244 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_245 = " code : ";
  protected final String TEXT_246 = "\");" + NL + "\t\t}";
  protected final String TEXT_247 = NL;
  protected final String TEXT_248 = NL + NL + "    public static class ";
  protected final String TEXT_249 = "_ForeachRDDOutput implements ";
  protected final String TEXT_250 = " {" + NL + "" + NL + "        private ContextProperties context;" + NL + "" + NL + "        public ";
  protected final String TEXT_251 = "_ForeachRDDOutput(JobConf conf) {" + NL + "            this.context = new ContextProperties(conf);" + NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public ";
  protected final String TEXT_252 = " call(";
  protected final String TEXT_253 = " rdd) throws Exception {" + NL + "            rdd.foreachPartition(new ";
  protected final String TEXT_254 = "_OutputFunction(context));";
    ...
    public String generate(Object argument)
  {
    ...
    try {
		TJdbcOutputUtil tJdbcOutputUtil = new TJdbcOutputUtil(node);
		OracleSparkStorage storage = new OracleSparkStorage(node);

		String tableNameLDelimiter = "";
		String tableNameRDelimiter = "";
		String table = tJdbcOutputUtil.getTable();
		boolean useBatchSize = tJdbcOutputUtil.useBatchSize();
		String batchSize = tJdbcOutputUtil.getBatchSize();
		boolean dieOnError = tJdbcOutputUtil.dieOnError();
		String dbmsId = tJdbcOutputUtil.getDbmsId();
		String dataAction = tJdbcOutputUtil.getDataAction();
		String schemaDb = storage.getSchemaDb();
		
		if(schemaDb != null && schemaDb.trim().length() != 0) {
			table = schemaDb + "+\".\"+" + table;
	   }
		
		IConnection inConn = tJdbcOutputUtil.getIncomingConnection();
		String connStructName = codeGenArgument.getRecordStructName(inConn);
		String inConnName = inConn.getName();
		
		Manager manager = getManager(dbmsId, cid, node);
		List<Column> stmtStructure = manager.createColumnList(tJdbcOutputUtil.getColumns(), false, null, null);
	...
	// Code generation for the tOracleOutput BlobTypeUtil as it exists in DI.
	
	// This file is intended to be included in tOracleOutput_sparkcode.javajet 

    stringBuffer.append(TEXT_4);
    
	// Column class is defined in db_output_bulk.skeleton so we can't move that code in the TJdbcOutputUtil class
	boolean blobTypeExists = false;
	for(Column column : stmtStructure) {
		if (column.getColumn()!= null) {
		    String typeToGenerate = JavaTypesManager.getTypeToGenerate(column.getColumn().getTalendType(), column.getColumn().isNullable());
		    if (typeToGenerate.equals("Object") && !column.isDynamic()) {
					if("BLOB".equals(column.getColumn().getType())) {
		        		blobTypeExists = true;
		        		break;
		        }
		    }
	...
	// Code generation for the "batch" and "die on error" options within RDBMS tXxxOutput
    ...
    stringBuffer.append(TEXT_27);
				...
				// blobTypeExists is defined in tOracleOutput_blob_util.javajet
				if(blobTypeExists) {
	...
	// Code generation for the RDBMS "INSERT" operation
	
	// This file is intended to be included in every JDBC output component sparkcode.javajet 

    stringBuffer.append(TEXT_34);
    stringBuffer.append(cid);
    stringBuffer.append(TEXT_35);
    stringBuffer.append(tableNameLDelimiter);
    stringBuffer.append(TEXT_36);
    stringBuffer.append(table);
    stringBuffer.append(TEXT_37);
    stringBuffer.append(tableNameRDelimiter);
    stringBuffer.append(TEXT_38);
    stringBuffer.append(insertColName);
    stringBuffer.append(TEXT_39);
    stringBuffer.append(insertValueStmt);
    ...
    stringBuffer.append(manager.generateSetStmt(typeToGenerate, column, i, inConnName, cid, NORMAL_TYPE));
...
if (useBatchSize) {
	...
	// Code generation for the RDBMS "UPDATE" operation
    ...
    stringBuffer.append(updateSetStmt);
    stringBuffer.append(TEXT_74);
    stringBuffer.append(updateWhereStmt);
...
if (useBatchSize) {
	...
	// Code generation for the RDBMS "INSERT_OR_UPDATE" operation
    ...
    stringBuffer.append(manager.generateSetStmt(typeToGenerate, column, i, inConnName, cid, UPDATE_TYPE));
    ...
    stringBuffer.append(manager.generateSetStmt(typeToGenerate, column, i, inConnName, cid, INSERT_TYPE));
	...
	// Code generation for the RDBMS "UPDATE_OR_INSERT" operation
	...
	// Code generation for the RDBMS "DELETE" operation
...
if (useBatchSize) {
    ...
    stringBuffer.append(TEXT_243);
			...
			// Prevents the code from compiling but emphases the actual error instead of returning a blank
...
String connTypeName = codeGenArgument.getRecordStructName(node.getIncomingConnections().get(0));
...
{ // Start ForeachRDD helper function
    ...
    org.talend.designer.spark.generator.utils.ForeachRDDUtil foreachUtil =
            org.talend.designer.spark.generator.utils.ForeachRDDUtil.createFunctionJavaRDD(
                    codeGenArgument.getSparkVersion(), connTypeName);
