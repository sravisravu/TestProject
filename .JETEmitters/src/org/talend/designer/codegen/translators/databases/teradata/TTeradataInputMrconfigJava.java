...
public class TTeradataInputMrconfigJava
{
  protected static String nl;
  public static synchronized TTeradataInputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataInputMrconfigJava result = new TTeradataInputMrconfigJava();
    nl = null;
    return result;
  }
