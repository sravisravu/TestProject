...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_353 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_354 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_355 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_356 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_357 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_546 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_550 = NL + "        StringBuffer query_";
  protected final String TEXT_551 = " = null;" + NL + "       \t";
  protected final String TEXT_552 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_562 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_563 = " = insert_";
  protected final String TEXT_564 = ".split(\"\\\\?\");";
  protected final String TEXT_565 = NL + "\t\t\tdelete_";
  protected final String TEXT_566 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_580 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_581 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_582 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_583 = " = 0;" + NL + "    \tboolean firstGeometry_";
