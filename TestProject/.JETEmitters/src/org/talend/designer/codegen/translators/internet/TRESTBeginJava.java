...
public class TRESTBeginJava
{
  ...
  protected final String TEXT_124 = ".Body = errorResponse_";
  protected final String TEXT_125 = ".getEntity(String.class);" + NL + "\t\t\t\t\t";
  protected final String TEXT_126 = ".ERROR_CODE = errorResponse_";
  protected final String TEXT_127 = ".getStatus();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = ".Body = restResponse_";
