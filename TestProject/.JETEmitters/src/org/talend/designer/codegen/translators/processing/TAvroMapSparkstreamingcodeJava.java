...
public class TAvroMapSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TAvroMapSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAvroMapSparkstreamingcodeJava result = new TAvroMapSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
// TODO: This is necessary in both config and code... to validate why.
tMapUtil.generateAuxiliaryRecordStructs();

tMapUtil.generateCode();
