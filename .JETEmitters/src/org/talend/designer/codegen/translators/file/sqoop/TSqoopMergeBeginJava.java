...
public class TSqoopMergeBeginJava
{
  ...
  protected final String TEXT_305 = NL + "            maprLogin_";
  protected final String TEXT_306 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_307 = ", ";
  protected final String TEXT_308 = ", decryptedMapRPassword_";
  protected final String TEXT_309 = ", ";
  protected final String TEXT_310 = ");";
  protected final String TEXT_311 = NL + "        configuration_";
  protected final String TEXT_312 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_313 = NL + "\t//check whether we can connect to the fs?" + NL + "\torg.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_314 = " = org.apache.hadoop.fs.FileSystem.get(configuration_";
  protected final String TEXT_315 = ");" + NL + "\tString jarFileName_";
  protected final String TEXT_316 = " = ";
  protected final String TEXT_317 = ";";
  protected final String TEXT_318 = NL + "        com.cloudera.sqoop.SqoopOptions needGenereateJarSqoopOptions_";
  protected final String TEXT_319 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_320 = ");" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_321 = ".setConnectString(";
  protected final String TEXT_322 = "); // __CONNECTION__" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_323 = ".setUsername(";
  ...
  protected final String TEXT_332 = NL + "\t\t        " + NL + "        " + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_333 = ".setPassword(decryptedPassword_";
  protected final String TEXT_334 = ");" + NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_335 = ".setTableName(";
  protected final String TEXT_336 = ");";
  protected final String TEXT_337 = NL + "            needGenereateJarSqoopOptions_";
  protected final String TEXT_338 = ".setClassName(";
  protected final String TEXT_339 = ");";
  protected final String TEXT_340 = NL + "            needGenereateJarSqoopOptions_";
  protected final String TEXT_341 = ".setClassName(\"SqoopMerge_";
  protected final String TEXT_342 = "\");";
  protected final String TEXT_343 = NL + NL + "        java.util.Properties generateJarAdditionalProperties_";
  protected final String TEXT_344 = " = new java.util.Properties();";
  protected final String TEXT_345 = " " + NL + "                    generateJarAdditionalProperties_";
  protected final String TEXT_346 = ".put(";
  protected final String TEXT_347 = ", \"\"+";
  protected final String TEXT_348 = ".codePointAt(0)); ";
  protected final String TEXT_349 = " " + NL + "                    generateJarAdditionalProperties_";
  protected final String TEXT_350 = ".put(";
  protected final String TEXT_351 = ", ";
  protected final String TEXT_352 = "); ";
  protected final String TEXT_353 = NL + "        needGenereateJarSqoopOptions_";
  protected final String TEXT_354 = ".loadProperties(generateJarAdditionalProperties_";
  protected final String TEXT_355 = ");" + NL + "        " + NL + "        com.cloudera.sqoop.tool.CodeGenTool codeGen_";
  protected final String TEXT_356 = " = new com.cloudera.sqoop.tool.CodeGenTool();" + NL + "        com.cloudera.sqoop.Sqoop codeGenerator_";
  protected final String TEXT_357 = " = new com.cloudera.sqoop.Sqoop(codeGen_";
  protected final String TEXT_358 = ",configuration_";
  protected final String TEXT_359 = ", needGenereateJarSqoopOptions_";
  protected final String TEXT_360 = ");" + NL + "        " + NL + "\t\ttry {" + NL + "\t\t\tint ret_";
  protected final String TEXT_361 = " = com.cloudera.sqoop.Sqoop.runSqoop(codeGenerator_";
  protected final String TEXT_362 = ", new String[0]);" + NL + "       \tif (0 != ret_";
  protected final String TEXT_363 = ") {";
  protected final String TEXT_364 = NL + "\t\t\t\t\tthrow new Exception(\"The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_365 = ");";
  protected final String TEXT_366 = NL + "\t\t\t\t\tSystem.err.println(\"The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_367 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_368 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_369 = " - The Sqoop jar generation has failed with the following code:\" + ret_";
  protected final String TEXT_370 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_371 = NL + "        \t}" + NL + "        " + NL + "        List<String> jars_";
  protected final String TEXT_372 = " = codeGen_";
  protected final String TEXT_373 = ".getGeneratedJarFiles();" + NL + "        jarFileName_";
  protected final String TEXT_374 = " = jars_";
  protected final String TEXT_375 = ".get(0);" + NL + "\t\t} catch (Exception e) {";
  protected final String TEXT_376 = NL + "\t\t\t\tthrow e;";
  protected final String TEXT_377 = NL + "\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_379 = " - \" + e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_380 = NL + "\t\t}";
  protected final String TEXT_381 = NL + NL + "    java.net.URLClassLoader sysloader_";
  protected final String TEXT_382 = " = (java.net.URLClassLoader) ClassLoader.getSystemClassLoader();" + NL + "    java.lang.reflect.Method method_";
  protected final String TEXT_383 = " = java.net.URLClassLoader.class.getDeclaredMethod(\"addURL\", new Class[] { java.net.URL.class});" + NL + "    method_";
  protected final String TEXT_384 = ".setAccessible(true);" + NL + "    try {" + NL + "\t\tmethod_";
  protected final String TEXT_385 = ".invoke(sysloader_";
  protected final String TEXT_386 = ", new Object[] { new java.io.File(jarFileName_";
  protected final String TEXT_387 = ").toURL()});" + NL + "    } catch (Exception e) {";
  protected final String TEXT_388 = NL + "\t\t\tthrow e;";
  protected final String TEXT_389 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_390 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_391 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_392 = NL + "    }" + NL + "    " + NL + "    com.cloudera.sqoop.tool.SqoopTool sqoopTool_";
  protected final String TEXT_393 = " = com.cloudera.sqoop.tool.SqoopTool.getTool(\"merge\");" + NL + "" + NL + "    com.cloudera.sqoop.SqoopOptions sqoopOptions_";
  protected final String TEXT_394 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_395 = ");" + NL + "" + NL + "\tsqoopOptions_";
  protected final String TEXT_396 = ".setMergeOldPath(";
  protected final String TEXT_397 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_398 = ".setMergeNewPath(";
  protected final String TEXT_399 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_400 = ".setMergeKeyCol(";
  protected final String TEXT_401 = ");" + NL + "\tsqoopOptions_";
  protected final String TEXT_402 = ".setTargetDir(";
  protected final String TEXT_403 = "); ";
  protected final String TEXT_404 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_405 = ".setClassName(";
  protected final String TEXT_406 = ");";
  protected final String TEXT_407 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_408 = ".setClassName(\"SqoopMerge_";
  protected final String TEXT_409 = "\");";
  protected final String TEXT_410 = NL + "\t\t" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_411 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_412 = ", configuration_";
  protected final String TEXT_413 = ", sqoopOptions_";
  protected final String TEXT_414 = ");" + NL + "\ttry {" + NL + "\t\tint result_";
  protected final String TEXT_415 = " = sqoop_";
  protected final String TEXT_416 = ".run(null);" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_417 = "_EXIT_CODE\", result_";
  protected final String TEXT_418 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_419 = " != 0) {";
  protected final String TEXT_420 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop merge job has failed. Please check the logs.\");";
  protected final String TEXT_421 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop merge job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_422 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_423 = " - The Sqoop merge job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_424 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  ...
  protected final String TEXT_428 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_429 = NL + "\t}" + NL + "\t" + NL + "\t";
  protected final String TEXT_430 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_431 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_432 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_433 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_434 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_435 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_436 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_437 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_438 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
