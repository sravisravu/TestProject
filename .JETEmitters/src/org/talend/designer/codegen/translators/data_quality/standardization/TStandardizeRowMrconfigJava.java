...
public class TStandardizeRowMrconfigJava
{
  protected static String nl;
  public static synchronized TStandardizeRowMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TStandardizeRowMrconfigJava result = new TStandardizeRowMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_120 = NL + "\t\t\torg.talend.hadoop.mapred.lib.DistributedCache.addCacheArchive(new Path(";
  protected final String TEXT_121 = ").toUri(), job);" + NL + "\t\t";
