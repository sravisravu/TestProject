...
public class TExtractAbstractAvroFieldsSparkconfigJava
{
  ...
  protected final String TEXT_110 = NL + "    org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_111 = "> rdd_";
  protected final String TEXT_112 = ";" + NL + "    {" + NL + "        // Set up a Spark DataFlow with all of the necessary inputs to use" + NL + "        // this component." + NL + "        org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlowContext ";
  protected final String TEXT_113 = "_sdfContext =" + NL + "                new org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlowContext.Builder().withSparkContext(ctx).build();" + NL + "        org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlow ";
  protected final String TEXT_114 = "_sdf =" + NL + "                new org.talend.bigdata.dataflow.spark.batch.SparkBatchDataFlow(";
  protected final String TEXT_115 = "_sdfContext);" + NL;
  protected final String TEXT_116 = NL + "        ";
  protected final String TEXT_117 = "_sdf.putPairRDD(\"";
  ...
  protected final String TEXT_123 = "_hmap.createSpecBuilder();" + NL + "" + NL + "        String avroSchema = rdd_";
  protected final String TEXT_124 = ".filter(new keepOneFilter_";
  protected final String TEXT_125 = "()).map(new MapToString_";
  protected final String TEXT_126 = "()).first();";
  protected final String TEXT_127 = NL + "            LOG.info(\"Schema for rdd_";
  protected final String TEXT_128 = ": \"+ avroSchema);";
  protected final String TEXT_129 = NL;
  protected final String TEXT_130 = NL + "        ";
  protected final String TEXT_131 = "_hsb.declareInput(\"";
  protected final String TEXT_132 = "\", new org.apache.avro.Schema.Parser().parse(avroSchema));";
  protected final String TEXT_133 = NL + "        ";
  protected final String TEXT_134 = "_hsb.declareOutput(\"";
  protected final String TEXT_135 = "\", ";
  protected final String TEXT_136 = ".getClassSchema()," + NL + "                                org.talend.bigdata.dataflow.hmap.HMapSpec.OutputType.FLATTEN);" + NL + "" + NL + "        // map each field";
  protected final String TEXT_137 = NL + "            ";
  protected final String TEXT_138 = "_hsb.map(\"";
  protected final String TEXT_139 = "\" + \".\" + ";
  protected final String TEXT_140 = ", \"";
  protected final String TEXT_141 = "\" + \".\" + \"";
  protected final String TEXT_142 = "\");";
  protected final String TEXT_143 = NL + NL + "        // Build the tMap spec and use that to build into the dataflow." + NL + "        org.talend.bigdata.dataflow.hmap.HMapSpec ";
  protected final String TEXT_144 = "_hs = ";
  protected final String TEXT_145 = "_hsb.build();";
  protected final String TEXT_146 = NL + "        ";
  protected final String TEXT_147 = "_hmap.createDataFlowBuilder(";
  protected final String TEXT_148 = "_hs).build(";
  protected final String TEXT_149 = "_sdf);" + NL + "" + NL + "        rdd_";
  protected final String TEXT_150 = " = ";
  protected final String TEXT_151 = "_sdf.getPairRDD(\"";
