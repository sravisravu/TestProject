...
public class TDynamoDBOutputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TDynamoDBOutputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDynamoDBOutputSparkstreamingcodeJava result = new TDynamoDBOutputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_28 = NL + NL + "    public static class ";
  protected final String TEXT_29 = "_ForeachRDDOutput implements ";
  protected final String TEXT_30 = " {" + NL + "" + NL + "        private JobConf job;" + NL + "" + NL + "        public ";
  protected final String TEXT_31 = "_ForeachRDDOutput(JobConf conf) {" + NL + "            this.job = job;" + NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public ";
  protected final String TEXT_32 = " call(";
  protected final String TEXT_33 = " rdd) throws Exception {" + NL + "            if (!rdd.isEmpty()) {" + NL + "                rdd.saveAsHadoopDataset(job);" + NL + "            }";
...
{ // Start ForeachRDD helper function
    ...
    org.talend.designer.spark.generator.utils.ForeachRDDUtil foreachUtil =
            org.talend.designer.spark.generator.utils.ForeachRDDUtil.createFunctionJavaPairRDD(
                    codeGenArgument.getSparkVersion(), "NullWritable", rowStruct);
