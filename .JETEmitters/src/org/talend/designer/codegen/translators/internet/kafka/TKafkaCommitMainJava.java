...
public class TKafkaCommitMainJava
{
  ...
  protected final String TEXT_5 = "_consumerConnector\")).commitOffsets();" + NL + "\t} else {" + NL + "\t    throw new RuntimeException(\"HEY\");" + NL + "\t}";
  protected final String TEXT_6 = NL + "\tif (globalMap.containsKey(\"";
  protected final String TEXT_7 = "_kafkaConsumer\")) {" + NL + "\t    ((org.apache.kafka.clients.consumer.KafkaConsumer) globalMap.get(\"";
  protected final String TEXT_8 = "_kafkaConsumer\")).commitSync();" + NL + "\t} else {" + NL + "\t    throw new RuntimeException(\"HEY\");" + NL + "\t}";
