...
public class TExtractXMLFieldMrcodeJava
{
  protected static String nl;
  public static synchronized TExtractXMLFieldMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractXMLFieldMrcodeJava result = new TExtractXMLFieldMrcodeJava();
    nl = null;
    return result;
  }
...
mrTransformUtil.generateMrCode(tExtractXMLFieldUtil);
