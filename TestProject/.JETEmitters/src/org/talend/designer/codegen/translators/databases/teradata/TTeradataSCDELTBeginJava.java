...
public class TTeradataSCDELTBeginJava {
  ...
  protected final String TEXT_286 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_287 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_288 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_289 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_290 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_302 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_303 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_348 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_376 = NL + "                              stmtTruncCount_";
  protected final String TEXT_377 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_378 = "));";
  protected final String TEXT_379 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_380 = " = stmtTruncCount_";
  protected final String TEXT_381 = ".executeQuery(\"";
  protected final String TEXT_382 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_383 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_384 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_388 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_399 = NL + "                if(!conn_";
  protected final String TEXT_400 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_401 = ".commit();" + NL + "                }";
  protected final String TEXT_402 = NL + "            deletedCount_";
  protected final String TEXT_403 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_427 = NL + "        String updateForType1_";
  protected final String TEXT_428 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_429 = " +\" FROM \"+ sourceTable_";
  protected final String TEXT_430 = " + \" t SET ";
  protected final String TEXT_431 = " WHERE ";
  protected final String TEXT_432 = " AND (";
  protected final String TEXT_433 = ")\";" + NL + "        java.sql.Statement stmtType1Update_";
  protected final String TEXT_434 = " = conn_";
  protected final String TEXT_435 = ".createStatement();" + NL + "        stmtType1Update_";
  protected final String TEXT_436 = ".executeUpdate(updateForType1_";
  protected final String TEXT_437 = ");" + NL + "        stmtType1Update_";
  protected final String TEXT_438 = ".close();";
  protected final String TEXT_439 = NL + "        String updateForType2_";
  protected final String TEXT_440 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_441 = NL + "                                        + \" FROM \" + sourceTable_";
  protected final String TEXT_442 = " + \" t\"" + NL + "                                        + \" SET ";
  protected final String TEXT_443 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_444 = "\")))" + NL + "                                        + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')";
  protected final String TEXT_445 = ", ";
  protected final String TEXT_446 = " = 0";
  protected final String TEXT_447 = " \"" + NL + "                                        + \" WHERE ";
  protected final String TEXT_448 = " AND (";
  protected final String TEXT_449 = ") AND \" + tableName_";
  protected final String TEXT_450 = " + \".";
  protected final String TEXT_451 = " IS NULL\";" + NL + "        java.sql.Statement stmtType2Update_";
  protected final String TEXT_452 = " = conn_";
  protected final String TEXT_453 = ".createStatement();" + NL + "        stmtType2Update_";
  protected final String TEXT_454 = ".executeUpdate(updateForType2_";
  protected final String TEXT_455 = ");" + NL + "        stmtType2Update_";
  protected final String TEXT_456 = ".close();";
  protected final String TEXT_457 = NL + "        String insertForType2_";
  protected final String TEXT_458 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_459 = " + \"(";
  protected final String TEXT_460 = ", ";
  protected final String TEXT_461 = ") SELECT ";
  protected final String TEXT_462 = "\" + ";
  protected final String TEXT_463 = " + \".NEXTVAL, ";
  protected final String TEXT_464 = "t.";
  protected final String TEXT_465 = ", cast('\" +" + NL + "        (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_466 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL";
  protected final String TEXT_467 = ", 1";
  protected final String TEXT_468 = ", d.";
  protected final String TEXT_469 = " + 1";
  protected final String TEXT_470 = " FROM \" +" + NL + "        sourceTable_";
  protected final String TEXT_471 = " + \" t, \" + tableName_";
  protected final String TEXT_472 = " + \" d WHERE ";
  protected final String TEXT_473 = " AND (";
  protected final String TEXT_474 = ") AND d.";
  protected final String TEXT_475 = " = cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_476 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)')\";" + NL + "        java.sql.Statement stmtType2Insert_";
  protected final String TEXT_477 = " = conn_";
  protected final String TEXT_478 = ".createStatement();" + NL + "        stmtType2Insert_";
  protected final String TEXT_479 = ".executeUpdate(insertForType2_";
  protected final String TEXT_480 = ");" + NL + "        stmtType2Insert_";
  ...
  protected final String TEXT_486 = ") SELECT ";
  protected final String TEXT_487 = "\" + ";
  protected final String TEXT_488 = " + \".NEXTVAL, ";
  protected final String TEXT_489 = "t.";
  protected final String TEXT_490 = "\"";
  protected final String TEXT_491 = " + \", cast('\" + (new java.sql.Timestamp((Long)start_Hash.get(\"";
  protected final String TEXT_492 = "\"))) + \"' as timestamp format 'YYYY-MM-DDBHH:MI:SS.S(F)'), NULL\"";
  protected final String TEXT_493 = NL + "    + \"";
  protected final String TEXT_494 = ", 1";
  protected final String TEXT_495 = ", 1";
  protected final String TEXT_496 = " FROM \" +" + NL + "    sourceTable_";
  protected final String TEXT_497 = " + \" t LEFT JOIN \" + tableName_";
  protected final String TEXT_498 = " + \" d ON ";
  protected final String TEXT_499 = " WHERE (";
  protected final String TEXT_500 = ")\";" + NL + "    java.sql.Statement stmtInsert_";
  protected final String TEXT_501 = " = conn_";
  protected final String TEXT_502 = ".createStatement();" + NL + "    stmtInsert_";
  protected final String TEXT_503 = ".executeUpdate(insert_";
  protected final String TEXT_504 = ");" + NL + "    stmtInsert_";
