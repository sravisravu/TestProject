...
public class TOracleOutputMrcodeJava
{
  protected static String nl;
  public static synchronized TOracleOutputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleOutputMrcodeJava result = new TOracleOutputMrcodeJava();
    nl = null;
    return result;
  }
