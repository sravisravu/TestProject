...
public class TMysqlOutputSparkstreamingcodeJava {
  ...
  protected final String TEXT_4 = "_OutputFunction implements org.apache.spark.api.java.function.VoidFunction<java.util.Iterator<";
  protected final String TEXT_5 = ">> {" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_6 = NL;
  protected final String TEXT_7 = NL + "\t\tint batchSize = -1;" + NL + "\t\tint batchSizeCounter = 0;";
  protected final String TEXT_8 = NL + NL + "\t\t\tContextProperties context;" + NL + "" + NL + "\t\t\tpublic ";
  protected final String TEXT_9 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    this(new ContextProperties(conf));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic ";
  protected final String TEXT_10 = "_OutputFunction(ContextProperties context) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    Class.forName(";
  protected final String TEXT_11 = ");" + NL + "\t\t\t    this.context = context;" + NL + "\t\t\t    ";
  protected final String TEXT_12 = NL;
  protected final String TEXT_13 = NL + "\t\tbatchSize = ";
  protected final String TEXT_14 = ";";
  protected final String TEXT_15 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\tpublic void call(java.util.Iterator<";
  protected final String TEXT_16 = "> dataIterator) throws java.lang.Exception {" + NL + "\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_17 = NL + "\t\t\t\tjava.util.Calendar calendar_";
  protected final String TEXT_18 = " = java.util.Calendar.getInstance();" + NL + "\t\t\t\tcalendar_";
  protected final String TEXT_19 = ".set(1, 0, 1, 0, 0, 0);" + NL + "\t\t\t\tlong year1_";
  protected final String TEXT_20 = " = calendar_";
  protected final String TEXT_21 = ".getTime().getTime();" + NL + "\t\t\t\tcalendar_";
  protected final String TEXT_22 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "\t\t\t\tlong year10000_";
  protected final String TEXT_23 = " = calendar_";
  protected final String TEXT_24 = ".getTime().getTime();" + NL + "\t\t\t\tlong date_";
  protected final String TEXT_25 = ";" + NL + "\t\t\t" + NL + "\t\t\t\tjava.sql.Connection connection = ";
  protected final String TEXT_26 = ".get(context).borrowObject();" + NL + "\t\t\t\ttry {\t\t ";
  protected final String TEXT_27 = NL + "\t\t\t\t\t";
  protected final String TEXT_28 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_29 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_30 = "\" + ";
  protected final String TEXT_31 = " + \"";
  protected final String TEXT_32 = " (";
  protected final String TEXT_33 = ") VALUES(";
  protected final String TEXT_34 = ")\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_35 = " ";
  protected final String TEXT_36 = " = dataIterator.next();";
  protected final String TEXT_37 = NL + "\t\t\t";
  protected final String TEXT_38 = NL + "\t";
  protected final String TEXT_39 = NL;
  protected final String TEXT_40 = NL + "\tpstmt_";
  protected final String TEXT_41 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_42 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  protected final String TEXT_43 = "                            " + NL + "\t\t\t\tthrow(e);";
  protected final String TEXT_44 = NL + "\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_45 = NL + "\t\t}" + NL + "\t\tpstmt_";
  protected final String TEXT_46 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_47 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_48 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_49 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_50 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_51 = NL + "\t}             ";
  protected final String TEXT_52 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_53 = NL;
  protected final String TEXT_54 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_55 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  ...
  protected final String TEXT_59 = ".clearBatch();" + NL + "\t\t}";
  ...
  protected final String TEXT_64 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_65 = "\" + ";
  protected final String TEXT_66 = " + \"";
  protected final String TEXT_67 = " SET ";
  protected final String TEXT_68 = " WHERE ";
  protected final String TEXT_69 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_70 = " ";
  protected final String TEXT_71 = " = dataIterator.next();";
  protected final String TEXT_72 = NL + "\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t";
  protected final String TEXT_74 = NL + "\t";
  protected final String TEXT_75 = NL;
  protected final String TEXT_76 = NL + "\tpstmt_";
  protected final String TEXT_77 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_78 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_82 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_83 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_84 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_85 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_86 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_87 = NL + "\t}             ";
  protected final String TEXT_88 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_89 = NL;
  protected final String TEXT_90 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_91 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_92 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_93 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_94 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_95 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_96 = NL + NL + "pstmt_";
  protected final String TEXT_97 = ".close();";
  protected final String TEXT_98 = NL + "\t\t\t\t\t";
  protected final String TEXT_99 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_100 = " = connection.prepareStatement(\"SELECT COUNT(1) FROM ";
  protected final String TEXT_101 = "\" + ";
  protected final String TEXT_102 = " + \"";
  protected final String TEXT_103 = " WHERE ";
  protected final String TEXT_104 = "\");" + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_105 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_111 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_112 = "\" + ";
  protected final String TEXT_113 = " +\"";
  protected final String TEXT_114 = " SET ";
  protected final String TEXT_115 = " WHERE ";
  protected final String TEXT_116 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_117 = " ";
  protected final String TEXT_118 = " = dataIterator.next();";
  protected final String TEXT_119 = NL + "\t\t\t";
  protected final String TEXT_120 = NL + "\tjava.sql.ResultSet rs_";
  protected final String TEXT_121 = " = pstmt_";
  protected final String TEXT_122 = ".executeQuery();" + NL + "\tint checkCount_";
  protected final String TEXT_123 = " = -1;" + NL + "\t" + NL + "\twhile(rs_";
  protected final String TEXT_124 = ".next()) {" + NL + "\t\tcheckCount_";
  protected final String TEXT_125 = " = rs_";
  protected final String TEXT_126 = ".getInt(1);" + NL + "\t}" + NL + "\t" + NL + "\tif(checkCount_";
  protected final String TEXT_127 = " > 0) {";
  protected final String TEXT_128 = NL + "\t\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t pstmtUpdate_";
  protected final String TEXT_131 = ".executeUpdate();" + NL + "\t} else {";
  protected final String TEXT_132 = NL + "\t\t\t\t";
  protected final String TEXT_133 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_134 = ".executeUpdate();" + NL + "\t}\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmt_";
  protected final String TEXT_135 = ".close();" + NL + "pstmtInsert_";
  protected final String TEXT_136 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_137 = ".close();";
  protected final String TEXT_138 = NL + "\t\t\t\t\t";
  protected final String TEXT_139 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_140 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_146 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_147 = "\" + ";
  protected final String TEXT_148 = " +\"";
  protected final String TEXT_149 = " SET ";
  protected final String TEXT_150 = " WHERE ";
  protected final String TEXT_151 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_152 = " ";
  protected final String TEXT_153 = " = dataIterator.next();";
  protected final String TEXT_154 = NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\tint updateFlag_";
  protected final String TEXT_157 = " = pstmtUpdate_";
  protected final String TEXT_158 = ".executeUpdate();" + NL + "\t" + NL + "\tif(updateFlag_";
  protected final String TEXT_159 = " == 0) {";
  protected final String TEXT_160 = NL + "\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_162 = ".executeUpdate();" + NL + "\t}" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_163 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_164 = ".close();";
  protected final String TEXT_165 = NL + "\t\t\t\t\t";
  protected final String TEXT_166 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_167 = " = connection.prepareStatement(\"DELETE FROM ";
  protected final String TEXT_168 = "\" + ";
  protected final String TEXT_169 = " + \"";
  protected final String TEXT_170 = " WHERE ";
  protected final String TEXT_171 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_172 = " ";
  protected final String TEXT_173 = " = dataIterator.next();";
  protected final String TEXT_174 = NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t";
  protected final String TEXT_176 = NL;
  protected final String TEXT_177 = NL + "\tpstmt_";
  protected final String TEXT_178 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_179 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_183 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_184 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_185 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_186 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_187 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_188 = NL + "\t}             ";
  protected final String TEXT_189 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_190 = NL;
  protected final String TEXT_191 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_192 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_193 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_194 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_195 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_196 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_197 = NL + NL + "pstmt_";
  protected final String TEXT_198 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_199 = NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\tif(connection != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_200 = ".get(context).returnObject(connection);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} // end call()" + NL + "\t\t} // end class" + NL;
  protected final String TEXT_201 = NL + "\t\t\t";
  protected final String TEXT_202 = NL + NL + "public static class ";
  protected final String TEXT_203 = " {" + NL + "\tprivate static volatile org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_204 = "> pool;" + NL + "\t" + NL + "\tprivate ";
  protected final String TEXT_205 = "() {" + NL + "\t    // empty" + NL + "\t}" + NL + "" + NL + "\tpublic static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_206 = "> get(ContextProperties context) {" + NL + "\t\tif(pool == null) {" + NL + "\t\t\tsynchronized(";
  protected final String TEXT_207 = ".class) {" + NL + "\t\t\t\tif(pool == null) {" + NL + "\t\t\t\t\tpool = createPool(context);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t   return pool;" + NL + "\t}" + NL + "" + NL + "\tprivate static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_208 = "> createPool(ContextProperties context) {" + NL + "\t    org.apache.commons.pool2.impl.GenericObjectPoolConfig config = new org.apache.commons.pool2.impl.GenericObjectPoolConfig();" + NL + "\t    config.setMaxTotal(";
  protected final String TEXT_209 = ");" + NL + "\t    config.setMaxWaitMillis(";
  protected final String TEXT_210 = ");" + NL + "\t    config.setMinIdle(";
  protected final String TEXT_211 = ");" + NL + "\t    config.setMaxIdle(";
  protected final String TEXT_212 = ");" + NL + "\t    config.setBlockWhenExhausted(true);";
  protected final String TEXT_213 = NL + "\t\t\tconfig.setTimeBetweenEvictionRunsMillis(";
  protected final String TEXT_214 = ");" + NL + "\t\t\tconfig.setMinEvictableIdleTimeMillis(";
  protected final String TEXT_215 = ");" + NL + "\t\t\tconfig.setSoftMinEvictableIdleTimeMillis(";
  protected final String TEXT_216 = ");";
  protected final String TEXT_217 = NL + "\t    return new org.apache.commons.pool2.impl.GenericObjectPool<";
  protected final String TEXT_218 = ">(new ";
  protected final String TEXT_219 = "(context), config);" + NL + "\t}" + NL + "}" + NL + "\t\t\t";
  protected final String TEXT_220 = NL + NL + "public static class ";
  protected final String TEXT_221 = " extends org.apache.commons.pool2.BasePooledObjectFactory<";
  protected final String TEXT_222 = "> {" + NL + "" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_223 = "(ContextProperties context) {" + NL + "\t\tthis.context = context;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_224 = " create() throws Exception {" + NL + "\t   Class.forName(";
  protected final String TEXT_225 = ");" + NL + "\t\tjava.util.Properties jdbcDriverProperties = new java.util.Properties();" + NL + "\t\tString jdbcAdditionalParameters = ";
  protected final String TEXT_226 = ";" + NL + "\t\tif(jdbcAdditionalParameters != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters) && !\"\".equals(jdbcAdditionalParameters)){" + NL + "\t\t\tjdbcDriverProperties.load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters.replace(";
  protected final String TEXT_227 = ", \"\\n\").getBytes()));" + NL + "\t\t}" + NL + "\t\tif(";
  protected final String TEXT_228 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_229 = ") && !\"\".equals(";
  protected final String TEXT_230 = ")){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"user\", ";
  protected final String TEXT_231 = ");" + NL + "\t\t}" + NL + "\t\tString password = ";
  protected final String TEXT_232 = " ;" + NL + "\t\tif(password != null && !\"\\\"\\\"\".equals(password) && !\"\".equals(password)){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"password\", password);" + NL + "\t\t}" + NL + "\t   return java.sql.DriverManager.getConnection(";
  protected final String TEXT_233 = ", jdbcDriverProperties);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_234 = "> wrap(";
  protected final String TEXT_235 = " connection) {" + NL + "\t   return new org.apache.commons.pool2.impl.DefaultPooledObject<";
  protected final String TEXT_236 = ">(connection);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void destroyObject(org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_237 = "> pooledObject) throws Exception {" + NL + "\t\tif (pooledObject != null) {" + NL + "\t\t    pooledObject.getObject().close();" + NL + "\t\t}" + NL + "\t\tsuper.destroyObject(pooledObject);" + NL + "\t}" + NL + "}";
  protected final String TEXT_238 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_239 = " code : ";
  protected final String TEXT_240 = "\");" + NL + "\t\t}";
  protected final String TEXT_241 = NL;
  protected final String TEXT_242 = NL + NL + "    public static class ";
  protected final String TEXT_243 = "_ForeachRDDOutput implements ";
  protected final String TEXT_244 = " {" + NL + "" + NL + "        private ContextProperties context;" + NL + "" + NL + "        public ";
  protected final String TEXT_245 = "_ForeachRDDOutput(JobConf conf) {" + NL + "            this.context = new ContextProperties(conf);" + NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public ";
  protected final String TEXT_246 = " call(";
  protected final String TEXT_247 = " rdd) throws Exception {" + NL + "            rdd.foreachPartition(new ";
  protected final String TEXT_248 = "_OutputFunction(context));";
    ...
    public String generate(Object argument)
  {
    ...
    //use for date type, refer to MysqlManager in db_output_bulk and tMysqlOutput_begin
