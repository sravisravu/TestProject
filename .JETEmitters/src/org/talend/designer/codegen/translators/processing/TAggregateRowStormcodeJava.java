...
public class TAggregateRowStormcodeJava
{
  protected static String nl;
  public static synchronized TAggregateRowStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAggregateRowStormcodeJava result = new TAggregateRowStormcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_144 = NL + "    static class UtilClass_";
  ...
  protected final String TEXT_146 = NL + NL + "public static class StormAggregator_";
  protected final String TEXT_147 = " extends BaseFunction" + NL + "    implements storm.trident.operation.CombinerAggregator<";
  protected final String TEXT_148 = "> {" + NL + "" + NL + "    /** Default serial version UID. */" + NL + "    private static final long serialVersionUID = 1L;" + NL + "" + NL + "    /* Initializes the aggregate structure from a tuple along the ";
  protected final String TEXT_149 = " connection */" + NL + "    public ";
  protected final String TEXT_150 = " init(TridentTuple init) {" + NL + "      return new ";
  protected final String TEXT_151 = "(new ";
  protected final String TEXT_152 = "(init));" + NL + "    }" + NL + "" + NL + "    public ";
  protected final String TEXT_153 = " combine(";
  protected final String TEXT_154 = " val1, ";
  protected final String TEXT_155 = " val2) {";
  protected final String TEXT_156 = NL + "        return val1;" + NL + "    }" + NL + "" + NL + "    public ";
  protected final String TEXT_157 = " zero() {" + NL + "        return new ";
  protected final String TEXT_158 = "();" + NL + "    }" + NL + "" + NL + "    public void execute(TridentTuple tuple, TridentCollector collector) {";
  protected final String TEXT_159 = NL + "        ";
  protected final String TEXT_160 = " out = (";
  protected final String TEXT_161 = ") tuple.get(0);" + NL + "        // Emit the final calculation as fields." + NL + "        collector.emit(";
...
// All of the groupBy fields are passed through on the standard connection
// TupleWrapper.
TupleWrapperHelper twhStandard = new TupleWrapperHelper(streamUtil.getOutConnection());
if (tAggregateRowUtil.getGroupByColumns().size() != 0) {
    // The group by fields pass through in the standard tuple wrapper.
    for (IMetadataColumn column : tAggregateRowUtil.getGroupByColumns()) {
        twhStandard.setCodeFieldName(column,
                new TupleWrapperHelper().getClassName(
                        streamUtil.getInConnection())
                        + ".getField_" + tAggregateRowUtil.getGroupByInputColumn(column) +"()");
    }
}
twhStandard.generate();

// A secondary TupleWrapper is created to hold the temporary aggregator values
// during the combine operation.
TAggregateRowStruct twhAggregate = new TAggregateRowStruct(tAggregateRowUtil, streamUtil);
twhAggregate.generate();

// The StormAggregator_ operates both as the Combiner for the aggregation, and
// then as the BaseFunction for emitting the results.
...
if (checkTypeOverflow || checkUlp) {
    ...
    stringBuffer.append(twhAggregate);
    stringBuffer.append(TEXT_148);
    stringBuffer.append(streamUtil.getInConnection().getName());
    ...
    stringBuffer.append(TEXT_155);
        ...
        twhAggregate.generateCombine("val1", "val2");
    ...
    stringBuffer.append(twhAggregate.getCodeEmitValues("out"));
