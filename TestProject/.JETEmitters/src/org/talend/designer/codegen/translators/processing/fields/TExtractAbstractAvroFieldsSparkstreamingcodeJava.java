...
public class TExtractAbstractAvroFieldsSparkstreamingcodeJava
{
  ...
  protected final String TEXT_110 = NL + NL + "    public static class keepOneFilter_";
  protected final String TEXT_111 = " implements org.apache.spark.api.java.function.Function<scala.Tuple2<org.apache.hadoop.io.NullWritable, ";
  protected final String TEXT_112 = ">, Boolean> {" + NL + "        boolean ok = true;" + NL + "" + NL + "        @Override" + NL + "        public Boolean call(scala.Tuple2<org.apache.hadoop.io.NullWritable, ";
  protected final String TEXT_113 = "> arg0)" + NL + "                throws Exception {" + NL + "            if (ok) {" + NL + "                ok = false;" + NL + "                return true;" + NL + "            } else {" + NL + "                return false;" + NL + "            }" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public static class MapToString_";
  protected final String TEXT_114 = " implements org.apache.spark.api.java.function.Function<scala.Tuple2<org.apache.hadoop.io.NullWritable, ";
  protected final String TEXT_115 = ">, String> {" + NL + "        @Override" + NL + "        public String call(scala.Tuple2<org.apache.hadoop.io.NullWritable, ";
  protected final String TEXT_116 = "> input)" + NL + "            throws Exception {" + NL + "        return ((org.apache.avro.generic.GenericRecord)input._2.get()).getSchema().toString();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public static class ExtractGenericRecord_";
  protected final String TEXT_117 = " implements org.apache.spark.api.java.function.PairFunction<scala.Tuple2<NullWritable, ";
  protected final String TEXT_118 = ">," + NL + "                                        NullWritable, org.apache.avro.generic.GenericRecord> {" + NL + "        public scala.Tuple2<NullWritable,org.apache.avro.generic.GenericRecord> call(scala.Tuple2<NullWritable,";
  protected final String TEXT_119 = "> arg0) throws Exception {" + NL + "            return new scala.Tuple2<NullWritable,org.apache.avro.generic.GenericRecord>(NullWritable.get(), (org.apache.avro.generic.GenericRecord)arg0._2.get());" + NL + "        }" + NL + "    }";
