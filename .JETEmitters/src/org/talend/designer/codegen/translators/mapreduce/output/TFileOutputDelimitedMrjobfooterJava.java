...
public class TFileOutputDelimitedMrjobfooterJava
{
  protected static String nl;
  public static synchronized TFileOutputDelimitedMrjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputDelimitedMrjobfooterJava result = new TFileOutputDelimitedMrjobfooterJava();
    nl = null;
    return result;
  }
