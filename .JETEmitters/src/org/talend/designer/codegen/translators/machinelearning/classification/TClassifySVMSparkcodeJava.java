...
public class TClassifySVMSparkcodeJava
{
  protected static String nl;
  public static synchronized TClassifySVMSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TClassifySVMSparkcodeJava result = new TClassifySVMSparkcodeJava();
    nl = null;
    return result;
  }
