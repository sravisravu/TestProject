...
public class THDFSOutputMrcodeJava
{
  protected static String nl;
  public static synchronized THDFSOutputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSOutputMrcodeJava result = new THDFSOutputMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_24 = "Struct> {" + NL + "\t\t\t\tprotected static class HDFSRecordWriter implements RecordWriter<NullWritable, ";
  protected final String TEXT_25 = "Struct> {" + NL + "\t\t\t\t\tprotected DataOutputStream out;" + NL + "\t\t\t\t\tprivate ContextProperties context;" + NL + "\t\t" + NL + "\t\t\t\t\tpublic HDFSRecordWriter(DataOutputStream out, JobConf job) {" + NL + "\t\t\t\t\t\tthis.out = out;" + NL + "\t\t\t\t\t\tthis.context = new ContextProperties(job);" + NL + "\t\t\t\t\t}" + NL + "\t\t" + NL + "\t\t\t\t\tprivate void writeObject(";
  ...
  protected final String TEXT_68 = NL + "\t\t\t\t\treturn new HDFSRecordWriter(fileOut, job);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
