...
public class THDFSCompareMainJava
{
  ...
  protected final String TEXT_125 = NL + "\tboolean result_";
  protected final String TEXT_126 = " = true;" + NL + "\t" + NL + "\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_127 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_128 = ");" + NL + "\torg.apache.hadoop.fs.Path ref_path_";
  protected final String TEXT_129 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_130 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_131 = NL + "\tlong fileLength_";
  protected final String TEXT_132 = " = fs_";
  protected final String TEXT_133 = ".getFileStatus(path_";
  protected final String TEXT_134 = ").getLen();" + NL + "\tlong fileRefLength_";
  protected final String TEXT_135 = " = fs_";
  protected final String TEXT_136 = ".getFileStatus(ref_path_";
  protected final String TEXT_137 = ").getLen();" + NL + "\tif(fileLength_";
  protected final String TEXT_138 = " != fileRefLength_";
  protected final String TEXT_139 = ")" + NL + "\t{" + NL + "\t\tresult_";
  protected final String TEXT_140 = " = false;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_141 = NL + "\tif (result_";
  protected final String TEXT_142 = ")" + NL + "\t{" + NL + "\t\torg.apache.hadoop.fs.FSDataInputStream file_is_";
  protected final String TEXT_143 = " = fs_";
  protected final String TEXT_144 = ".open(path_";
  protected final String TEXT_145 = ");" + NL + "\t\torg.apache.hadoop.fs.FSDataInputStream file_ref_is_";
  protected final String TEXT_146 = " = fs_";
  protected final String TEXT_147 = ".open(ref_path_";
  protected final String TEXT_148 = ");" + NL + "\t";
  protected final String TEXT_149 = NL + "\t\tjava.io.BufferedReader file_";
  protected final String TEXT_150 = " = new java.io.BufferedReader(new java.io.InputStreamReader(file_is_";
  protected final String TEXT_151 = ",";
  protected final String TEXT_152 = "));" + NL + "\t\tjava.io.BufferedReader fileRef_";
  protected final String TEXT_153 = " = new java.io.BufferedReader(new java.io.InputStreamReader(file_ref_is_";
  protected final String TEXT_154 = ",";
  protected final String TEXT_155 = "));" + NL + "\t\tString content_";
  protected final String TEXT_156 = " = null,contentRef_";
  protected final String TEXT_157 = " = null;" + NL + "\t\twhile((content_";
  protected final String TEXT_158 = " = file_";
  protected final String TEXT_159 = ".readLine()) != null && (contentRef_";
  protected final String TEXT_160 = " = fileRef_";
  protected final String TEXT_161 = ".readLine()) != null)" + NL + "\t\t{" + NL + "\t\t\tif(content_";
  protected final String TEXT_162 = ".compareTo(contentRef_";
  protected final String TEXT_163 = ") != 0)" + NL + "\t\t\t{" + NL + "\t\t\t\tresult_";
  protected final String TEXT_164 = " = false;" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t// Check if files has a different number of lines:" + NL + "\t\tif(content_";
  protected final String TEXT_165 = " == null){" + NL + "\t\t    // This step is done in case of the while upper ignore second part:" + NL + "\t\t    contentRef_";
  protected final String TEXT_166 = " = fileRef_";
  protected final String TEXT_167 = ".readLine();" + NL + "\t\t}" + NL + "\t\tif(content_";
  protected final String TEXT_168 = " != null || contentRef_";
  protected final String TEXT_169 = " != null){" + NL + "\t\t    result_";
  protected final String TEXT_170 = " = false;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tfile_";
  protected final String TEXT_171 = ".close();" + NL + "\t\tfileRef_";
  protected final String TEXT_172 = ".close();" + NL + "\t\t";
  protected final String TEXT_173 = NL + "    \tjava.io.BufferedInputStream file_";
  protected final String TEXT_174 = " = new java.io.BufferedInputStream(file_is_";
  protected final String TEXT_175 = ");" + NL + "    \tjava.io.BufferedInputStream fileRef_";
  protected final String TEXT_176 = " = new java.io.BufferedInputStream(file_ref_is_";
  protected final String TEXT_177 = ");" + NL + "    \tint content_";
  protected final String TEXT_178 = " = -1,contentRef_";
  protected final String TEXT_179 = " = -1;" + NL + "    \twhile((content_";
  protected final String TEXT_180 = " = file_";
  protected final String TEXT_181 = ".read()) != -1 && (contentRef_";
  protected final String TEXT_182 = " = fileRef_";
  protected final String TEXT_183 = ".read()) != -1)" + NL + "    \t{" + NL + "    \t\tif(content_";
  protected final String TEXT_184 = " != contentRef_";
  protected final String TEXT_185 = ")" + NL + "    \t\t{" + NL + "    \t\t\tresult_";
  protected final String TEXT_186 = " = false;" + NL + "    \t\t\tbreak;" + NL + "    \t\t}" + NL + "    \t}" + NL + "    \tfile_";
  protected final String TEXT_187 = ".close();" + NL + "    \tfileRef_";
  protected final String TEXT_188 = ".close();\t\t\t" + NL + "\t\t";
  protected final String TEXT_189 = NL + "\t}" + NL + "" + NL + "\tString message";
  protected final String TEXT_190 = " = \"\";" + NL + "\tif (result_";
  protected final String TEXT_191 = ") {" + NL + "\t\tmessage";
  protected final String TEXT_192 = " = ";
  protected final String TEXT_193 = ";" + NL + "\t\t" + NL + "\t} else {" + NL + "\t\tmessage";
  protected final String TEXT_194 = " = ";
  protected final String TEXT_195 = ";" + NL + "\t}" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_196 = "_DIFFERENCE\",result_";
  protected final String TEXT_197 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_198 = NL + "    System.out.println(message";
  protected final String TEXT_199 = ");" + NL + "\t";
  protected final String TEXT_200 = NL + "\tlog.info(\"";
  protected final String TEXT_201 = " - Compare result : \" + message";
  protected final String TEXT_202 = " + \".\");" + NL + "\t";
  protected final String TEXT_203 = NL + "\t";
  protected final String TEXT_204 = ".file = ";
  protected final String TEXT_205 = ";" + NL + "\t";
  protected final String TEXT_206 = ".file_ref = ";
  protected final String TEXT_207 = ";\t" + NL + "\t";
  protected final String TEXT_208 = ".moment = java.util.Calendar.getInstance().getTime();" + NL + "\t";
  protected final String TEXT_209 = ".job = jobName;" + NL + "\t";
  protected final String TEXT_210 = ".component = currentComponent;" + NL + "\t";
  protected final String TEXT_211 = ".differ = (result_";
  protected final String TEXT_212 = ")?0:1;" + NL + "\t";
  protected final String TEXT_213 = ".message = message";
  protected final String TEXT_214 = ";" + NL + "\t";
  protected final String TEXT_215 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_216 = " - Compare date : \" + routines.system.FormatterUtils.format_Date(";
  protected final String TEXT_217 = ".moment,\"dd-MM-yyyy HH:mm:ss\") + \".\");" + NL + "\t\t\t";
