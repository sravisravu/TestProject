...
public class TJavaStormComponentStormconfigJava
{
  protected static String nl;
  public static synchronized TJavaStormComponentStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaStormComponentStormconfigJava result = new TJavaStormComponentStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_46 = NL + "        Stream inStream = ";
  protected final String TEXT_47 = ";";
  protected final String TEXT_48 = NL + "        ";
  protected final String TEXT_49 = " in =" + NL + "            new ";
  protected final String TEXT_50 = "(null);";
  protected final String TEXT_51 = NL + "        ";
  protected final String TEXT_52 = " out =" + NL + "            new ";
  protected final String TEXT_53 = "(null);";
  protected final String TEXT_54 = NL + "    Stream outStream = null;" + NL;
  protected final String TEXT_55 = NL + "    ";
  protected final String TEXT_56 = NL;
  protected final String TEXT_57 = NL + "        ";
  protected final String TEXT_58 = " = outStream;";
...
streamUtil.generateAllOutStreamsDeclarations();
    ...
    stringBuffer.append( ElementParameterParser.getValue(node, "__GENERIC_STORM_CONFIG__") );
