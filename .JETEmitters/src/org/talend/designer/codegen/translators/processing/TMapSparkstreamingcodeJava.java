...
public class TMapSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TMapSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapSparkstreamingcodeJava result = new TMapSparkstreamingcodeJava();
    nl = null;
    return result;
  }
