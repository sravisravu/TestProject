...
public class TRedshiftLookupInputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TRedshiftLookupInputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftLookupInputSparkstreamingcodeJava result = new TRedshiftLookupInputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
final class TRedshiftLookupInputUtil extends AbstractJDBCLookupInputUtil {

	public TRedshiftLookupInputUtil(INode node) {
		super(node);
	}

} // end class TRedshiftLookupInputUtil
...
TRedshiftLookupInputUtil tRedshiftLookupInputUtil = new TRedshiftLookupInputUtil(node);
RedshiftSparkStorage storage = new RedshiftSparkStorage(node);
TMapJDBCFlatMapperUtil tMapFlatMapperUtil = new TMapJDBCFlatMapperUtil(tRedshiftLookupInputUtil, storage);
