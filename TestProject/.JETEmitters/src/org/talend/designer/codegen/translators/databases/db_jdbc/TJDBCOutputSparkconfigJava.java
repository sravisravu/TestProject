...
public class TJDBCOutputSparkconfigJava {
  protected static String nl;
  public static synchronized TJDBCOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputSparkconfigJava result = new TJDBCOutputSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = " < 1) {" + NL + "\t\t    throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_49 = NL + NL + "\trdd_";
  protected final String TEXT_50 = ".foreachPartition(new ";
  protected final String TEXT_51 = "_OutputFunction(job));" + NL;
  protected final String TEXT_52 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_53 = " code : ";
