...
public class TFileStreamInputParquetSparkstreamingcodeJava
{
  ...
  protected final String TEXT_106 = NL + NL + "public static class PathFilter_";
  protected final String TEXT_107 = " implements org.apache.spark.api.java.function.Function<Path, Boolean> {" + NL + "    public Boolean call(Path p) {" + NL + "        return !p.getName().startsWith(\".\");" + NL + "    }" + NL + "}";
