...
public class TQASAddressRowEndJava
{
  protected static String nl;
  public static synchronized TQASAddressRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TQASAddressRowEndJava result = new TQASAddressRowEndJava();
    nl = null;
    return result;
  }
