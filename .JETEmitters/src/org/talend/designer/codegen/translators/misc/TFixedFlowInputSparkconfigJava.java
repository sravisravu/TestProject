...
public class TFixedFlowInputSparkconfigJava
{
  ...
  protected final String TEXT_136 = NL + NL + "org.apache.spark.api.java.JavaPairRDD<NullWritable, ";
  protected final String TEXT_137 = "> rdd_";
  protected final String TEXT_138 = NL + "        = ctx.parallelizePairs(new Data_";
  protected final String TEXT_139 = "().getPairList(), ";
