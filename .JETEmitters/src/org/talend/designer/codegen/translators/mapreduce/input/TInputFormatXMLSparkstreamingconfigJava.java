...
public class TInputFormatXMLSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatXMLSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatXMLSparkstreamingconfigJava result = new TInputFormatXMLSparkstreamingconfigJava();
    nl = null;
    return result;
  }
