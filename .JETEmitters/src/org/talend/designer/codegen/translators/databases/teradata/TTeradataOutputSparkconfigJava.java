...
public class TTeradataOutputSparkconfigJava {
  ...
  protected final String TEXT_49 = " < 1) {" + NL + "\t\t    throw new RuntimeException(\"For update, the schema must have a key\");" + NL + "\t\t}";
  protected final String TEXT_50 = NL + "           " + NL + "" + NL + "Class.forName(\"com.teradata.jdbc.TeraDriver\");" + NL + "java.util.Properties jdbcDriverProperties_";
  protected final String TEXT_51 = " = new java.util.Properties();" + NL + "String jdbcAdditionalParameters_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "if(jdbcAdditionalParameters_";
  protected final String TEXT_54 = " != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters_";
  protected final String TEXT_55 = ") && !\"\".equals(jdbcAdditionalParameters_";
  protected final String TEXT_56 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_57 = ".load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters_";
  protected final String TEXT_58 = ".replace(";
  protected final String TEXT_59 = ", \"\\n\").getBytes()));" + NL + "}" + NL + "if(";
  protected final String TEXT_60 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_61 = ") && !\"\".equals(";
  protected final String TEXT_62 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_63 = ".setProperty(\"user\", ";
  protected final String TEXT_64 = ");" + NL + "}" + NL + "String password_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = " ;" + NL + "if(password_";
  protected final String TEXT_67 = " != null && !\"\\\"\\\"\".equals(password_";
  protected final String TEXT_68 = ") && !\"\".equals(password_";
  protected final String TEXT_69 = ")){" + NL + "\tjdbcDriverProperties_";
  protected final String TEXT_70 = ".setProperty(\"password\", password_";
  protected final String TEXT_71 = ");" + NL + "}" + NL + "java.sql.Connection conn_";
  protected final String TEXT_72 = " = java.sql.DriverManager.getConnection(";
  protected final String TEXT_73 = ", jdbcDriverProperties_";
  protected final String TEXT_74 = ");" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_75 = " = 0;" + NL + "String dbUser_";
  ...
  protected final String TEXT_103 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_111 = ".toUpperCase()";
  ...
  protected final String TEXT_140 = NL + "                    String keyCheckTable_";
  protected final String TEXT_141 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_148 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_149 = " = conn_";
  protected final String TEXT_150 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_151 = " + \"]\";";
  protected final String TEXT_152 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_153 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_154 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_155 = ")== null){//}";
  protected final String TEXT_156 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_157 = " = conn_";
  protected final String TEXT_158 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_159 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  ...
  protected final String TEXT_163 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_168 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_169 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_170 = " = tableNameForSearch_";
  protected final String TEXT_171 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_172 = " = tableNameForSearch_";
  protected final String TEXT_173 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_174 = " = dbMetaData_";
  protected final String TEXT_175 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_176 = ", tableNameForSearch_";
  protected final String TEXT_177 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_178 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_179 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_180 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_235 = " = false;" + NL + "                                String defaultSchema_";
  protected final String TEXT_236 = " = \"public\";" + NL + "                                if(dbschema_";
  protected final String TEXT_237 = " == null || dbschema_";
  protected final String TEXT_238 = ".trim().length() == 0) {" + NL + "                                    java.sql.Statement stmtSchema_";
  protected final String TEXT_239 = " = conn_";
  protected final String TEXT_240 = ".createStatement();" + NL + "                                    java.sql.ResultSet rsSchema_";
  protected final String TEXT_241 = " = stmtSchema_";
  protected final String TEXT_242 = ".executeQuery(\"select current_schema() \");" + NL + "                                    while(rsSchema_";
  protected final String TEXT_243 = ".next()){" + NL + "                                        defaultSchema_";
  protected final String TEXT_244 = " = rsSchema_";
  protected final String TEXT_245 = ".getString(\"current_schema\");" + NL + "                                    }" + NL + "                                    rsSchema_";
  protected final String TEXT_246 = ".close();" + NL + "                                    stmtSchema_";
  protected final String TEXT_247 = ".close();" + NL + "                                }" + NL + "                                while(rsTable_";
  protected final String TEXT_248 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_249 = " = rsTable_";
  protected final String TEXT_250 = ".getString(\"TABLE_NAME\");" + NL + "                                    String schema_";
  protected final String TEXT_251 = " = rsTable_";
  protected final String TEXT_252 = ".getString(\"TABLE_SCHEM\");" + NL + "                                    if(table_";
  protected final String TEXT_253 = ".equals";
  protected final String TEXT_254 = "IgnoreCase";
  protected final String TEXT_255 = "(";
  protected final String TEXT_256 = ")" + NL + "                                        && (schema_";
  ...
  protected final String TEXT_265 = "(schema_";
  ...
  protected final String TEXT_269 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_270 = " = ";
  protected final String TEXT_271 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_272 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_273 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_274 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_275 = " =  tableForSearch_";
  protected final String TEXT_276 = ".substring(1,tableForSearch_";
  protected final String TEXT_277 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_278 = " =  tableForSearch_";
  protected final String TEXT_279 = ".toUpperCase();" + NL + "\t\t\t\t            \t\t}" + NL + "\t\t\t\t            \t}" + NL + "\t\t\t\t                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_283 = ".getTables(null, conn_";
  protected final String TEXT_284 = ".getSchema(), tableForSearch_";
  protected final String TEXT_285 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_286 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_287 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_288 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_294 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_295 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_296 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_297 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_298 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_306 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_307 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_308 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_309 = " = rsTable_";
  protected final String TEXT_310 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_311 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_368 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_369 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_384 = NL + "                              stmtTruncCount_";
  protected final String TEXT_385 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_386 = "));";
  protected final String TEXT_387 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_388 = " = stmtTruncCount_";
  protected final String TEXT_389 = ".executeQuery(\"";
  protected final String TEXT_390 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_391 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_392 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_396 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_407 = NL + "                if(!conn_";
  ...
  protected final String TEXT_411 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_435 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_436 = ".foreachPartition(new ";
  protected final String TEXT_437 = "_OutputFunction(job));" + NL;
  protected final String TEXT_438 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_439 = " code : ";
...
try {
	...
	IConnection conn = tJdbcOutputUtil.getIncomingConnection();
	...
	String tableAction = tJdbcOutputUtil.getTableAction();
