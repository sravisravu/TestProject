...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_320 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_321 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_322 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_323 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_324 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_467 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_478 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_479 = " + \" WHERE ";
  protected final String TEXT_480 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_481 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_488 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_496 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_548 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_549 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_558 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_562 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_563 = " = null;";
  protected final String TEXT_564 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
