...
public class TJDBCOutputStormconfigJava
{
  protected static String nl;
  public static synchronized TJDBCOutputStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputStormconfigJava result = new TJDBCOutputStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_47 = ".each(";
  protected final String TEXT_48 = NL + "            ";
  protected final String TEXT_49 = "," + NL + "            new StormFunction_";
  protected final String TEXT_50 = "(), new Fields());" + NL + "}";
