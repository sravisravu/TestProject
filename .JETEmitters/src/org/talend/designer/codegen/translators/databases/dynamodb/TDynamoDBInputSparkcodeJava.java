...
public class TDynamoDBInputSparkcodeJava
{
  protected static String nl;
  public static synchronized TDynamoDBInputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDynamoDBInputSparkcodeJava result = new TDynamoDBInputSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_186 = NL + NL + "public static class ";
  protected final String TEXT_187 = "Function implements org.apache.spark.api.java.function.FlatMapFunction<org.apache.hadoop.dynamodb.DynamoDBItemWritable, ";
  protected final String TEXT_188 = "> {" + NL + "" + NL + "    /** Default serial version UID. */" + NL + "    private static final long serialVersionUID = 1L;" + NL;
  protected final String TEXT_189 = NL + "        public String lastErrorMessage = null;" + NL + "        public ";
  protected final String TEXT_190 = " mainRow = null;";
  protected final String TEXT_191 = NL + NL + "    public ";
  protected final String TEXT_192 = "<";
  protected final String TEXT_193 = "> call(org.apache.hadoop.dynamodb.DynamoDBItemWritable w) {";
  protected final String TEXT_194 = NL + "        ";
  protected final String TEXT_195 = " row = new ";
  protected final String TEXT_196 = "();";
  protected final String TEXT_197 = NL + "            mainRow = row;";
  protected final String TEXT_198 = NL + "        com.amazonaws.services.dynamodbv2.document.Item item = com.amazonaws.services.dynamodbv2.document.Item.fromMap(" + NL + "                com.amazonaws.services.dynamodbv2.document.internal.InternalUtils.toSimpleMapValue(w.getItem()));";
  protected final String TEXT_199 = NL + "            try {";
  protected final String TEXT_200 = NL + "        return java.util.Arrays.asList(row)";
  protected final String TEXT_201 = ";";
  protected final String TEXT_202 = NL + "            } catch (RuntimeException e) {";
  protected final String TEXT_203 = NL + "                    lastErrorMessage = e.toString();";
  protected final String TEXT_204 = NL + "                return java.util.Collections.<";
  protected final String TEXT_205 = ">emptyList()";
  protected final String TEXT_206 = ";" + NL + "            }";
  protected final String TEXT_207 = NL + "    }" + NL + "}" + NL;
  protected final String TEXT_208 = NL + "        public static class ";
  protected final String TEXT_209 = "RejectFunction implements org.apache.spark.api.java.function.FlatMapFunction<org.apache.hadoop.dynamodb.DynamoDBItemWritable, ";
  protected final String TEXT_210 = "> {" + NL + "" + NL + "            /** Default serial version UID. */" + NL + "            private static final long serialVersionUID = 1L;" + NL + "" + NL + "            public final ";
  protected final String TEXT_211 = "Function mainFunction = new ";
  protected final String TEXT_212 = "Function();" + NL + "" + NL + "            public ";
  protected final String TEXT_213 = " rejectRow = null;" + NL + "" + NL + "            public ";
  protected final String TEXT_214 = "<";
  protected final String TEXT_215 = "> call(org.apache.hadoop.dynamodb.DynamoDBItemWritable w) {";
  protected final String TEXT_216 = NL + "                ";
  protected final String TEXT_217 = "<";
  protected final String TEXT_218 = "> main = mainFunction.call(w);" + NL + "                if (main";
  protected final String TEXT_219 = ".hasNext())" + NL + "                    return java.util.Collections.<";
  protected final String TEXT_220 = ">emptyList()";
  protected final String TEXT_221 = ";" + NL + "" + NL + "                rejectRow = new ";
  protected final String TEXT_222 = "();";
  protected final String TEXT_223 = NL + "                    rejectRow.";
  protected final String TEXT_224 = " = mainFunction.mainRow.";
  protected final String TEXT_225 = ";";
  protected final String TEXT_226 = NL + "                rejectRow.errorMessage = mainFunction.lastErrorMessage;" + NL + "                rejectRow.errorData = w.toString();" + NL + "                return java.util.Arrays.asList(rejectRow)";
  protected final String TEXT_227 = ";" + NL + "            }" + NL + "        }";
  protected final String TEXT_228 = NL;
  protected final String TEXT_229 = NL + "        public static class ";
  protected final String TEXT_230 = "MainAndRejectFunction implements org.apache.spark.api.java.function.Function<org.apache.hadoop.dynamodb.DynamoDBItemWritable, scala.Tuple2<";
  protected final String TEXT_231 = ", ";
  protected final String TEXT_232 = ">> {" + NL + "" + NL + "            /** Default serial version UID. */" + NL + "            private static final long serialVersionUID = 1L;" + NL + "" + NL + "            private final ";
  protected final String TEXT_233 = "RejectFunction rejectFunction = new ";
  protected final String TEXT_234 = "RejectFunction();" + NL + "" + NL + "            public scala.Tuple2<";
  protected final String TEXT_235 = ", ";
  protected final String TEXT_236 = "> call(org.apache.hadoop.dynamodb.DynamoDBItemWritable w) {";
  protected final String TEXT_237 = NL + "                ";
  protected final String TEXT_238 = "<";
  protected final String TEXT_239 = "> reject = rejectFunction.call(w);" + NL + "                if (reject";
  protected final String TEXT_240 = ".hasNext())" + NL + "                    return new scala.Tuple2<";
  protected final String TEXT_241 = ", ";
  protected final String TEXT_242 = ">(null, reject";
  protected final String TEXT_243 = ".next());" + NL + "                return new scala.Tuple2<";
  protected final String TEXT_244 = ", ";
  protected final String TEXT_245 = ">(rejectFunction.mainFunction.mainRow, null);" + NL + "            }" + NL + "        }" + NL + "" + NL + "        public static class ";
  protected final String TEXT_246 = "MainFilterFunction implements org.apache.spark.api.java.function.FlatMapFunction<scala.Tuple2<";
  protected final String TEXT_247 = ", ";
  protected final String TEXT_248 = ">, ";
  protected final String TEXT_249 = "> {" + NL + "            /** Default serial version UID. */" + NL + "            private static final long serialVersionUID = 1L;" + NL + "" + NL + "            public ";
  protected final String TEXT_250 = "<";
  protected final String TEXT_251 = "> call(scala.Tuple2<";
  protected final String TEXT_252 = ", ";
  protected final String TEXT_253 = "> t) {" + NL + "                if (t._1() != null)" + NL + "                    return java.util.Arrays.asList(t._1())";
  protected final String TEXT_254 = ";" + NL + "                return java.util.Collections.<";
  protected final String TEXT_255 = ">emptyList()";
  protected final String TEXT_256 = ";" + NL + "            }" + NL + "        }" + NL + "" + NL + "        public static class ";
  protected final String TEXT_257 = "RejectFilterFunction implements org.apache.spark.api.java.function.FlatMapFunction<scala.Tuple2<";
  protected final String TEXT_258 = ", ";
  protected final String TEXT_259 = ">, ";
  protected final String TEXT_260 = "> {" + NL + "            /** Default serial version UID. */" + NL + "            private static final long serialVersionUID = 1L;" + NL + "" + NL + "            public ";
  protected final String TEXT_261 = "<";
  protected final String TEXT_262 = "> call(scala.Tuple2<";
  protected final String TEXT_263 = ", ";
  protected final String TEXT_264 = "> t) {" + NL + "                if (t._2() != null)" + NL + "                    return java.util.Arrays.asList(t._2())";
  protected final String TEXT_265 = ";" + NL + "                return java.util.Collections.<";
  protected final String TEXT_266 = ">emptyList()";
...
boolean swallowRejectExceptions = !ElementParameterParser.getBooleanValue(node, "__DIE_ON_ERROR__");
boolean rememberRejectInfo = false;
...
if (util.getOutConnReject() != null) {
    ...
    swallowRejectExceptions = true;
    rememberRejectInfo = true;
    if (mainRowStruct == null)
        mainRowStruct = rejectRowStruct;
}
...
String flatMapIterateClass = usingIterator
        ? "java.util.Iterator"
        : "java.lang.Iterable";
String returnResultMethod = usingIterator
        ? ".iterator()"
        : "";
String toIteratorMethod = usingIterator
        ? ""
        : ".iterator()";
    ...
    stringBuffer.append(TEXT_198);
     if (swallowRejectExceptions) { 
    stringBuffer.append(TEXT_199);
     } 
     util.generateTransform("row"); 
    stringBuffer.append(TEXT_200);
    stringBuffer.append(returnResultMethod);
...
if (util.getOutConnReject() != null) {
    ...
    stringBuffer.append(toIteratorMethod);
    ...
    stringBuffer.append(TEXT_222);
                ...
                for (IMetadataColumn column : util.mainColumnsCopy) {
