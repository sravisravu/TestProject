...
public class TLoopSparkjobfooterJava
{
  protected static String nl;
  public static synchronized TLoopSparkjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TLoopSparkjobfooterJava result = new TLoopSparkjobfooterJava();
    nl = null;
    return result;
  }
