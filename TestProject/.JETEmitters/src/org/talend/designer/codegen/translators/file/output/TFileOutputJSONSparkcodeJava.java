...
public class TFileOutputJSONSparkcodeJava
{
  protected static String nl;
  public static synchronized TFileOutputJSONSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputJSONSparkcodeJava result = new TFileOutputJSONSparkcodeJava();
    nl = null;
    return result;
  }
