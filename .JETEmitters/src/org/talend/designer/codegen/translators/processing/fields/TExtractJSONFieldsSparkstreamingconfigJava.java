...
public class TExtractJSONFieldsSparkstreamingconfigJava
{
  ...
  protected final String TEXT_295 = NL + "                    if (xmlListTemp_";
  protected final String TEXT_296 = ".isEmpty()) {";
  ...
  protected final String TEXT_303 = NL + "            // Die immediately on errors." + NL + "            throw new IOException(";
  protected final String TEXT_304 = ");";
  protected final String TEXT_305 = NL + "                // Ignore errors processing this row and move to the next.";
  protected final String TEXT_306 = NL + "                // Send error rows to the reject output.";
