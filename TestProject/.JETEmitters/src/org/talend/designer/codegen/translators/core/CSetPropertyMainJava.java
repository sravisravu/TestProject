...
public class CSetPropertyMainJava {

  protected static String nl;
  public static synchronized CSetPropertyMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    CSetPropertyMainJava result = new CSetPropertyMainJava();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "\t\t\t\t\t\t.setProperty(";
