...
public class TWriteJSONFieldMrconfigJava
{
  protected static String nl;
  public static synchronized TWriteJSONFieldMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWriteJSONFieldMrconfigJava result = new TWriteJSONFieldMrconfigJava();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
	...
	if(inConnName == null || outConnName == null || outColumns == null || outColumns.size() == 0){ 
		return "";
	}
