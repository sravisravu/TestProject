...
public class TWriteAvroFieldsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TWriteAvroFieldsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWriteAvroFieldsSparkstreamingconfigJava result = new TWriteAvroFieldsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
