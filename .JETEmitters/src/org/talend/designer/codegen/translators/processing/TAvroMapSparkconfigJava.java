...
public class TAvroMapSparkconfigJava
{
  protected static String nl;
  public static synchronized TAvroMapSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAvroMapSparkconfigJava result = new TAvroMapSparkconfigJava();
    nl = null;
    return result;
  }
