...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_255 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_256 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_257 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_258 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_259 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_329 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_330 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_345 = NL + "                              stmtTruncCount_";
  protected final String TEXT_346 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_347 = "));";
  protected final String TEXT_348 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_349 = " = stmtTruncCount_";
  protected final String TEXT_350 = ".executeQuery(\"";
  protected final String TEXT_351 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_352 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_353 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_357 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_364 = ".commit();";
  protected final String TEXT_365 = NL + "            stmtTrunc_";
  protected final String TEXT_366 = ".executeUpdate(\"";
  protected final String TEXT_367 = "\");";
  protected final String TEXT_368 = NL + "                if(!conn_";
  protected final String TEXT_369 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_370 = ".commit();" + NL + "                }";
  protected final String TEXT_371 = NL + "            deletedCount_";
  protected final String TEXT_372 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_473 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_474 = " = conn_";
  protected final String TEXT_475 = ".prepareStatement(insert_";
  protected final String TEXT_476 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_513 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_514 = " = conn_";
  protected final String TEXT_515 = ".prepareStatement(update_";
  protected final String TEXT_516 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_532 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_533 = " = update_";
  ...
  protected final String TEXT_538 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_539 = " = insert_";
  protected final String TEXT_540 = ".split(\"\\\\?\");";
  protected final String TEXT_541 = NL + "\t\t\tdelete_";
  protected final String TEXT_542 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_543 = " = delete_";
  protected final String TEXT_544 = ".split(\"\\\\?\");";
  protected final String TEXT_545 = NL + "\t\t\treplace_";
  protected final String TEXT_546 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_547 = " = replace_";
  protected final String TEXT_548 = ".split(\"\\\\?\");";
  protected final String TEXT_549 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_550 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_551 = " = insertIgnore_";
  protected final String TEXT_552 = ".split(\"\\\\?\");";
  protected final String TEXT_553 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_554 = " = insert_";
  protected final String TEXT_555 = ".split(\"\\\\?\");";
  protected final String TEXT_556 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_557 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_558 = " = buffersSize_";
  protected final String TEXT_559 = ";";
  protected final String TEXT_560 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_561 = " = buffersSize_";
  protected final String TEXT_562 = ";";
  protected final String TEXT_563 = NL + "        whetherReject_";
  ...
  protected final String TEXT_569 = NL + "                            geometryColumnName_";
  protected final String TEXT_570 = " = \"";
  protected final String TEXT_571 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_572 = ") {" + NL + "                                dimension_";
  protected final String TEXT_573 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_576 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_577 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_578 = ".";
  protected final String TEXT_579 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_580 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_581 = " = refSys_";
  protected final String TEXT_582 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_583 = " = refSys_";
  protected final String TEXT_584 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_585 = " == null || ident_";
  protected final String TEXT_586 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_587 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_588 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_589 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_590 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_591 = " = Integer.parseInt(code_";
  protected final String TEXT_592 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_593 = " = \"SRID_";
  protected final String TEXT_594 = " could not be determined\";";
  protected final String TEXT_595 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_596 = ");" + NL + "                                            SRID_";
  protected final String TEXT_597 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_598 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_599 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_600 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_601 = ",";
  protected final String TEXT_602 = ".";
  protected final String TEXT_603 = ", ";
  protected final String TEXT_604 = ",insertSQLSplits_";
  ...
  protected final String TEXT_621 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_622 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_623 = NL + "                \tsp_";
  protected final String TEXT_624 = " = conn_";
  protected final String TEXT_625 = ".setSavepoint();" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_631 = NL + "\t                conn_";
  protected final String TEXT_632 = ".releaseSavepoint(sp_";
  protected final String TEXT_633 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_634 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_635 = NL + "\t                conn_";
  protected final String TEXT_636 = ".rollback(sp_";
  protected final String TEXT_637 = ");" + NL + "\t            ";
  protected final String TEXT_638 = NL + "                whetherReject_";
  protected final String TEXT_639 = " = true;";
  protected final String TEXT_640 = NL + "                    throw(e);";
  ...
  protected final String TEXT_653 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_663 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_664 = ",";
  protected final String TEXT_665 = ".";
  protected final String TEXT_666 = ", ";
  protected final String TEXT_667 = ",updateSQLSplits_";
  protected final String TEXT_668 = ");";
  protected final String TEXT_669 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_704 = NL + "\t                sp_";
  protected final String TEXT_705 = " = conn_";
  protected final String TEXT_706 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_707 = NL + "                updatedCount_";
  protected final String TEXT_708 = " = updatedCount_";
  protected final String TEXT_709 = " + pstmt_";
  protected final String TEXT_710 = ".executeUpdate();";
  protected final String TEXT_711 = NL + "\t\t\t\t";
  protected final String TEXT_712 = NL + "                \tconn_";
  protected final String TEXT_713 = ".releaseSavepoint(sp_";
  protected final String TEXT_714 = ");";
  protected final String TEXT_715 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_716 = NL + "\t                conn_";
  protected final String TEXT_717 = ".rollback(sp_";
  ...
  protected final String TEXT_734 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_735 = NL + "                        ";
  protected final String TEXT_736 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_737 = ";";
  protected final String TEXT_738 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_739 = NL + "            }";
  protected final String TEXT_740 = NL + "                    \t";
  protected final String TEXT_741 = NL + "                    ";
  protected final String TEXT_742 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_743 = " = pstmt_";
  protected final String TEXT_744 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_745 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_746 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_747 = " = rs_";
  protected final String TEXT_748 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_758 = ",updateSQLSplits_";
  protected final String TEXT_759 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_760 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_761 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_762 = ".";
  protected final String TEXT_763 = ", pstmtUpdate_";
  ...
  protected final String TEXT_787 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_788 = NL + "\t                    sp_";
  protected final String TEXT_789 = " = conn_";
  protected final String TEXT_790 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_797 = NL + "    \t                conn_";
  protected final String TEXT_798 = ".releaseSavepoint(sp_";
  protected final String TEXT_799 = ");" + NL + "    \t            ";
  protected final String TEXT_800 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_801 = NL + "    \t                conn_";
  protected final String TEXT_802 = ".rollback(sp_";
  protected final String TEXT_803 = ");" + NL + "    \t            ";
  protected final String TEXT_804 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_826 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_835 = ",insertSQLSplits_";
  protected final String TEXT_836 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_837 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_846 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_847 = NL + "\t                    sp_";
  protected final String TEXT_848 = " = conn_";
  protected final String TEXT_849 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_856 = NL + "    \t                conn_";
  protected final String TEXT_857 = ".releaseSavepoint(sp_";
  protected final String TEXT_858 = ");" + NL + "    \t            ";
  protected final String TEXT_859 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_860 = NL + "    \t                conn_";
  protected final String TEXT_861 = ".rollback(sp_";
  protected final String TEXT_862 = ");" + NL + "    \t            ";
  protected final String TEXT_863 = NL + "                    whetherReject_";
  ...
  protected final String TEXT_886 = NL + "            int updateFlag_";
  protected final String TEXT_887 = "=0;";
  ...
  protected final String TEXT_926 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_927 = NL + "\t                sp_";
  protected final String TEXT_928 = " = conn_";
  protected final String TEXT_929 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_930 = NL + "                updateFlag_";
  ...
  protected final String TEXT_936 = NL + "\t                conn_";
  protected final String TEXT_937 = ".releaseSavepoint(sp_";
  protected final String TEXT_938 = ");" + NL + "\t            ";
  protected final String TEXT_939 = NL + "            if(updateFlag_";
  protected final String TEXT_940 = " == 0) {" + NL + "            \t";
  protected final String TEXT_941 = NL + "\t\t\t\tquery_";
  protected final String TEXT_942 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_963 = NL + "\t                    sp_";
  protected final String TEXT_964 = " = conn_";
  protected final String TEXT_965 = ".setSavepoint();" + NL + "\t                ";
  ...
  protected final String TEXT_969 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_970 = "++;";
  protected final String TEXT_971 = NL + "\t\t\t\t\t";
  protected final String TEXT_972 = NL + "    \t                conn_";
  protected final String TEXT_973 = ".releaseSavepoint(sp_";
  protected final String TEXT_974 = ");" + NL + "    \t            ";
  protected final String TEXT_975 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_976 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_977 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_978 = NL + "    \t                conn_";
  protected final String TEXT_979 = ".rollback(sp_";
  protected final String TEXT_980 = ");" + NL + "    \t            ";
  protected final String TEXT_981 = NL + "                    whetherReject_";
  protected final String TEXT_982 = " = true;";
  protected final String TEXT_983 = NL + "                        throw(e);";
  protected final String TEXT_984 = NL + "                        nb_line_";
  ...
  protected final String TEXT_994 = NL + "                            rejectedCount_";
  protected final String TEXT_995 = " = rejectedCount_";
  protected final String TEXT_996 = " + 1;";
  protected final String TEXT_997 = NL + "                            ";
  protected final String TEXT_998 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_1016 = NL + "    \t\tpstmt_";
  protected final String TEXT_1017 = ".addBatch();" + NL + "\t\t\tnb_line_";
  ...
  protected final String TEXT_1021 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_1022 = NL + "\t                sp_";
  protected final String TEXT_1023 = " = conn_";
  protected final String TEXT_1024 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_1025 = NL + "                deletedCount_";
  protected final String TEXT_1026 = " = deletedCount_";
  protected final String TEXT_1027 = " + pstmt_";
  protected final String TEXT_1028 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1029 = "++;";
  protected final String TEXT_1030 = NL + "\t\t\t\t";
  protected final String TEXT_1031 = NL + "\t                conn_";
  protected final String TEXT_1032 = ".releaseSavepoint(sp_";
  protected final String TEXT_1033 = ");" + NL + "\t            ";
  protected final String TEXT_1034 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_1035 = NL + "\t                conn_";
  protected final String TEXT_1036 = ".rollback(sp_";
  protected final String TEXT_1037 = ");" + NL + "\t            ";
  protected final String TEXT_1038 = NL + "                whetherReject_";
  protected final String TEXT_1039 = " = true;";
  protected final String TEXT_1040 = NL + "                    throw(e);";
  ...
  protected final String TEXT_1055 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1056 = NL + "                        ";
  protected final String TEXT_1057 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1058 = ";";
  protected final String TEXT_1059 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1060 = NL + "            }";
  protected final String TEXT_1061 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1073 = " > 0) && (batchSize_";
  protected final String TEXT_1074 = " <= batchSizeCounter_";
  protected final String TEXT_1075 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  ...
  protected final String TEXT_1094 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1095 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1096 = NL + "                \tint countSum_";
  protected final String TEXT_1097 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1098 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1099 = " += (countEach_";
  protected final String TEXT_1100 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1101 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_1102 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1103 = " += countSum_";
  protected final String TEXT_1104 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_1105 = NL + "\t\t\t    \t\tupdatedCount_";
  ...
  protected final String TEXT_1119 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_1120 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_1121 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1122 = ": pstmt_";
  protected final String TEXT_1123 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1137 = NL + "                batchSizeCounter_";
  protected final String TEXT_1138 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1139 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1140 = NL + "                \t\tint countSum_";
  protected final String TEXT_1141 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1142 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_1146 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_1147 = " += countSum_";
  protected final String TEXT_1148 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_1149 = NL + "\t\t\t\t    \t\tupdatedCount_";
  ...
  protected final String TEXT_1155 = NL + "                        System.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1156 = NL + "                }" + NL + "            }";
  protected final String TEXT_1157 = NL + "                \tconn_";
  protected final String TEXT_1158 = ".commit();" + NL + "                \t";
  protected final String TEXT_1159 = NL + "                \tcommitCounter_";
  protected final String TEXT_1160 = "=0;" + NL + "                }";
