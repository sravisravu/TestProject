...
public class TFilterRowSparkconfigJava
{
  protected static String nl;
  public static synchronized TFilterRowSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterRowSparkconfigJava result = new TFilterRowSparkconfigJava();
    nl = null;
    return result;
  }
