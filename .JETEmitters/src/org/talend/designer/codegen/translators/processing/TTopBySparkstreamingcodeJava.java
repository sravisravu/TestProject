...
public class TTopBySparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TTopBySparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTopBySparkstreamingcodeJava result = new TTopBySparkstreamingcodeJava();
    nl = null;
    return result;
  }
