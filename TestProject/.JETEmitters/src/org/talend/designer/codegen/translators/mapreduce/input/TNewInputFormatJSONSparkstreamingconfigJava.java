...
public class TNewInputFormatJSONSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TNewInputFormatJSONSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TNewInputFormatJSONSparkstreamingconfigJava result = new TNewInputFormatJSONSparkstreamingconfigJava();
    nl = null;
    return result;
  }
