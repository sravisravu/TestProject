...
public class TFixedFlowInputStormconfigJava
{
  protected static String nl;
  public static synchronized TFixedFlowInputStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFixedFlowInputStormconfigJava result = new TFixedFlowInputStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "{" + NL + "    Stream spoutStream = ctx.getTridentTopology().newStream(topologyName+\"";
  protected final String TEXT_46 = "\"," + NL + "            new Spout_";
...
streamUtil.generateAllOutStreamsDeclarations();
    ...
    streamUtil.generateSetAllOutStreams(false, "spoutStream");
