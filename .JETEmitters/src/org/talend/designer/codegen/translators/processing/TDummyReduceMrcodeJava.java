...
public class TDummyReduceMrcodeJava
{
  protected static String nl;
  public static synchronized TDummyReduceMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyReduceMrcodeJava result = new TDummyReduceMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_901 = " = value_";
  ...
  protected final String TEXT_908 = NL + "\t\t\twhile(values_";
  protected final String TEXT_909 = ".hasNext()){" + NL + "\t\t\t\t";
  protected final String TEXT_910 = " ";
  protected final String TEXT_911 = " = values_";
  protected final String TEXT_912 = ".next();" + NL + "" + NL + "\t\t\t\t";
  ...
  public String generate(Object argument)
  {
	...
	StructHelper rowStruct = new StructHelper("mOutValue_"+cid, outMetadataTable.getListColumns(), false);
	...
	mapper.init(node, cid, null, inConnName, null, "mOutValue_"+cid);
	mapper.generate();
	...
	reducer.init(cid, null, "mOutValue_"+cid, null, outConnName);
	reducer.generate();
