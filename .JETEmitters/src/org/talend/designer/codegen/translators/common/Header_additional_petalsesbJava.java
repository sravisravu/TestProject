...
public class Header_additional_petalsesbJava
{
  protected static String nl;
  public static synchronized Header_additional_petalsesbJava create(String lineSeparator)
  {
    nl = lineSeparator;
    Header_additional_petalsesbJava result = new Header_additional_petalsesbJava();
    nl = null;
    return result;
  }
