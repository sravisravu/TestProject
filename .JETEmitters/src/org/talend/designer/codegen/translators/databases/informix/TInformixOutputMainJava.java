...
public class TInformixOutputMainJava {
  ...
  protected final String TEXT_471 = ".prepareStatement(\"SELECT COUNT(*) FROM \" + tableName_";
  ...
  protected final String TEXT_668 = ".executeUpdate();" + NL + "        \t    ";
  protected final String TEXT_669 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_738 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_853 = NL + "            try {" + NL + "                updateFlag_";
  ...
  protected final String TEXT_858 = ";" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_888 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_925 = ".addBatch();" + NL + "\t\t    \t\tbatchSizeCounter_";
  ...
  protected final String TEXT_970 = ")) {" + NL + "                try {" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_971 = " = 0;" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_972 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_973 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_974 = ": pstmt_";
  protected final String TEXT_975 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_976 = " += (countEach_";
  protected final String TEXT_977 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_989 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_990 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_991 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_992 = NL + "                \t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_993 = NL + "            commitCounter_";
  protected final String TEXT_994 = "++;" + NL + "" + NL + "            if(commitEvery_";
  protected final String TEXT_995 = "<=commitCounter_";
  protected final String TEXT_996 = ") {" + NL + "            \t";
  protected final String TEXT_997 = NL + "                conn_";
  protected final String TEXT_998 = ".commit();";
  protected final String TEXT_999 = NL + "                commitCounter_";
  protected final String TEXT_1000 = " = 0;" + NL + "" + NL + "            }" + NL;
