...
public class TFileOutputJSONSparkconfigJava
{
  ...
  protected final String TEXT_9 = NL + "     rdd_";
  protected final String TEXT_10 = ".saveAsHadoopFile(";
  protected final String TEXT_11 = ", NullWritable.class, ";
  protected final String TEXT_12 = ".class, ";
  protected final String TEXT_13 = "StructOutputFormat.class);";
  protected final String TEXT_14 = NL + "         FileSystem.setDefaultUri(ctx.hadoopConfiguration(), currentURI_";
  protected final String TEXT_15 = "_config);" + NL + "         fs = FileSystem.get(ctx.hadoopConfiguration());";
  protected final String TEXT_16 = NL + "            final String clouderaManagerPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_17 = ");";
  protected final String TEXT_18 = NL + "            final String clouderaManagerPassword = ";
  protected final String TEXT_19 = ";";
  protected final String TEXT_20 = NL + "        this.lineageCreator = new org.talend.lineage.cloudera.LineageCreator(";
  ...
  protected final String TEXT_28 = "," + NL + "                clouderaManagerPassword," + NL + "                jobName + \"_\" + jobVersion.replace(\".\", \"_\")," + NL + "                projectName,";
  ...
  protected final String TEXT_35 = NL + "        this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_36 = ");" + NL + "" + NL + "        java.util.Map<String, Object> lineageCreatorJobMetadata = new java.util.HashMap<String, Object>();" + NL + "        lineageCreatorJobMetadata.put(\"name\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"description\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"purpose\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"author\", System.getProperty(\"user.name\"));" + NL + "        lineageCreatorJobMetadata.put(\"version\", jobVersion);" + NL + "        lineageCreatorJobMetadata.put(\"jobType\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"framework\", \"Talend BigData\");" + NL + "        lineageCreatorJobMetadata.put(\"status\", \"FINISHED\");" + NL + "        lineageCreatorJobMetadata.put(\"creationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"lastModificationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"startTime\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"endTime\", System.currentTimeMillis());" + NL + "" + NL + "        this.lineageCreator.addJobInfo(lineageCreatorJobMetadata);";
  protected final String TEXT_37 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_38 = " = new java.util.HashMap<>();";
  protected final String TEXT_39 = NL + "            columns_";
  protected final String TEXT_40 = ".put(\"";
  protected final String TEXT_41 = "\", \"";
  protected final String TEXT_42 = "\");";
  protected final String TEXT_43 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_44 = " = new java.util.HashMap<>();";
  protected final String TEXT_45 = NL + "                        columns_";
  ...
  protected final String TEXT_53 = NL + "        lineageCreator.addDataset(columns_";
  protected final String TEXT_54 = ", \"";
  protected final String TEXT_55 = "\", ";
  protected final String TEXT_56 = ", \"";
  protected final String TEXT_57 = "\");";
  protected final String TEXT_58 = NL + "        java.util.List<String> inputNodes_";
  protected final String TEXT_59 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_60 = NL + "                inputNodes_";
  protected final String TEXT_61 = ".add(\"";
  protected final String TEXT_62 = "\");";
  protected final String TEXT_63 = NL + "        java.util.List<String> outputNodes_";
  protected final String TEXT_64 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_65 = NL + "                outputNodes_";
  protected final String TEXT_66 = ".add(\"";
  protected final String TEXT_67 = "\");";
  protected final String TEXT_68 = NL + "        this.lineageCreator.addNodeToLineage(\"";
  protected final String TEXT_69 = "\", columns_";
  protected final String TEXT_70 = ", inputNodes_";
  protected final String TEXT_71 = ", outputNodes_";
  protected final String TEXT_72 = ", new java.util.HashMap<String, Object>());";
    ...
    */
    ...
    if (talendLineageAPI.doRequireLineageSupport(node)) {
         if (node.getIncomingConnections() != null
             ...
             talendLineageAPI.addDataset(cid, originalName, folder, "JSON");
         }
     }
 }
}
