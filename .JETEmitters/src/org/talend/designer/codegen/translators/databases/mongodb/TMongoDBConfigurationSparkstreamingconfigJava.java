...
public class TMongoDBConfigurationSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TMongoDBConfigurationSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBConfigurationSparkstreamingconfigJava result = new TMongoDBConfigurationSparkstreamingconfigJava();
    nl = null;
    return result;
  }
