...
public class TBatchAddressRowCloudOutFinallyJava
{
  protected static String nl;
  public static synchronized TBatchAddressRowCloudOutFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TBatchAddressRowCloudOutFinallyJava result = new TBatchAddressRowCloudOutFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = ".hashCode()), \"true\");" + NL + "        }";
