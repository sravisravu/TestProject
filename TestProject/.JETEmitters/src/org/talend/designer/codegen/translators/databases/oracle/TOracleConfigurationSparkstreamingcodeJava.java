...
public class TOracleConfigurationSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TOracleConfigurationSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleConfigurationSparkstreamingcodeJava result = new TOracleConfigurationSparkstreamingcodeJava();
    nl = null;
    return result;
  }
