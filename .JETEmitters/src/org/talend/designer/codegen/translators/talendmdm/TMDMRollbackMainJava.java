...
public class TMDMRollbackMainJava
{
  ...
  protected final String TEXT_41 = NL + NL + "String transKey_";
  protected final String TEXT_42 = " = \"";
  protected final String TEXT_43 = "_\" + Thread.currentThread().getThreadGroup().getName();" + NL + "com.talend.mdm.transaction.client.MDMTransaction mdmTransaction_";
  protected final String TEXT_44 = " = (com.talend.mdm.transaction.client.MDMTransaction)globalMap.get(transKey_";
  protected final String TEXT_45 = ");" + NL + "if(mdmTransaction_";
  protected final String TEXT_46 = " != null) {";
  protected final String TEXT_47 = NL + "    mdmTransaction_";
  protected final String TEXT_48 = ".rollback();";
  protected final String TEXT_49 = NL + "}" + NL;
  protected final String TEXT_50 = NL + "    String connKey_";
  protected final String TEXT_51 = " = \"";
  protected final String TEXT_52 = "_\" + Thread.currentThread().getThreadGroup().getName();" + NL + "    org.talend.mdm.webservice.TMDMService service_";
  protected final String TEXT_53 = " = (org.talend.mdm.webservice.TMDMService)globalMap.get(connKey_";
  protected final String TEXT_54 = ");" + NL + "    if(service_";
  protected final String TEXT_55 = " != null) {" + NL + "        service_";
  protected final String TEXT_56 = ".logout(new org.talend.mdm.webservice.WSLogout());";
