...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_426 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_427 = ".";
  protected final String TEXT_428 = ")+\")\";";
  protected final String TEXT_429 = NL + "\t\t\t\t";
  protected final String TEXT_430 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_431 = " = new StringBuffer(insert_";
  protected final String TEXT_432 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_433 = ".insert(insert_";
  protected final String TEXT_434 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_435 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_436 = " =insertStringBuffer_";
  protected final String TEXT_437 = ".toString(); ";
  protected final String TEXT_438 = "    " + NL + "" + NL + "\t\t\t\tpstmt_";
  ...
  protected final String TEXT_462 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_463 = " = new StringBuffer(update_";
  protected final String TEXT_464 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_465 = ".insert(update_";
  protected final String TEXT_466 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_467 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_468 = " =updateStringBuffer_";
  ...
  protected final String TEXT_508 = ".toUpperCase()";
  ...
  protected final String TEXT_607 = "    " + NL + "\t\t\t\tpstmtInsert_";
  ...
  protected final String TEXT_628 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_629 = " = insert_";
  protected final String TEXT_630 = ".split(\"\\\\?\");";
  protected final String TEXT_631 = NL + "\t\t\tupdate_";
  protected final String TEXT_632 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  ...
  protected final String TEXT_638 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_639 = " = insert_";
  protected final String TEXT_640 = ".split(\"\\\\?\");";
  protected final String TEXT_641 = NL + "\t\t\tdelete_";
  protected final String TEXT_642 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_643 = " = delete_";
  protected final String TEXT_644 = ".split(\"\\\\?\");";
  protected final String TEXT_645 = NL + "\t\t\treplace_";
  protected final String TEXT_646 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_647 = " = replace_";
  protected final String TEXT_648 = ".split(\"\\\\?\");";
  protected final String TEXT_649 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_650 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_651 = " = insertIgnore_";
  protected final String TEXT_652 = ".split(\"\\\\?\");";
  protected final String TEXT_653 = NL + "\t\t \tinsertSQLSplits_";
  ...
  protected final String TEXT_659 = " = new StringBuffer(\"\");";
  protected final String TEXT_660 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_661 = " = buffersSize_";
  protected final String TEXT_662 = ";";
  protected final String TEXT_663 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_664 = " = buffersSize_";
  protected final String TEXT_665 = ";";
  protected final String TEXT_666 = NL + NL;
  protected final String TEXT_667 = NL + "        whetherReject_";
  protected final String TEXT_668 = " = false;";
  protected final String TEXT_669 = NL + "\t\t\t\t\t     \t// TODO unable to parse integer: ";
  protected final String TEXT_670 = NL + "\t\t\t\t\t     \t// TODO error: ";
  protected final String TEXT_671 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_672 = NL + "                    \torg.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_673 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_674 = ".";
  protected final String TEXT_675 = ";" + NL + "\t                    com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_676 = " = tGeometry_";
  protected final String TEXT_677 = "._getInternalGeometry();" + NL + "" + NL + "                    \tcom.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_678 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_679 = "\");" + NL + "                    \tif (extends_";
  protected final String TEXT_680 = " == null) {" + NL + "                    \t    geometryColumnToExtends.put(\"";
  protected final String TEXT_681 = "\", geometry_";
  protected final String TEXT_682 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "                    \telse {" + NL + "                    \t    extends_";
  protected final String TEXT_683 = ".expandToInclude(geometry_";
  protected final String TEXT_684 = ".getEnvelopeInternal());" + NL + "                    \t}" + NL + "" + NL + "\t\t\t\t\t\tString wkt_";
  protected final String TEXT_685 = " = geometry_";
  protected final String TEXT_686 = ".toText();" + NL + "\t\t\t\t\t\toracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_687 = " = new oracle.spatial.util.WKT();" + NL + "\t\t\t\t\t\toracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_688 = " = oracle_wkt_";
  protected final String TEXT_689 = ".toJGeometry(wkt_";
  protected final String TEXT_690 = ".getBytes());" + NL;
  protected final String TEXT_691 = NL + "\t\t\t\t\t\t\tjgeometry_";
  protected final String TEXT_692 = ".setSRID(";
  protected final String TEXT_693 = ");";
  protected final String TEXT_694 = NL + "               \t\tpstmt_";
  protected final String TEXT_695 = ".setObject(";
  protected final String TEXT_696 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  ...
  protected final String TEXT_720 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_721 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_722 = "++;";
  protected final String TEXT_723 = NL + "    \t\t";
  protected final String TEXT_724 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_728 = ".executeUpdate();";
  protected final String TEXT_729 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_748 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_760 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_791 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_792 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_793 = "++;" + NL + "    \t\t";
  protected final String TEXT_794 = NL + "    \t\t";
  protected final String TEXT_795 = NL + "             try {" + NL + "                nb_line_";
  protected final String TEXT_796 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_797 = " = updatedCount_";
  protected final String TEXT_798 = " + pstmt_";
  protected final String TEXT_799 = ".executeUpdate();";
  ...
  protected final String TEXT_826 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_827 = " = pstmt_";
  protected final String TEXT_828 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_829 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_830 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_831 = " = rs_";
  protected final String TEXT_832 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  ...
  protected final String TEXT_844 = NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_871 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_872 = " = updatedCount_";
  ...
  protected final String TEXT_876 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_946 = NL + "    \t    int updateFlag_";
  protected final String TEXT_947 = " = 0;" + NL + "    \t    ";
  protected final String TEXT_948 = NL + "                    ";
  protected final String TEXT_949 = NL + "                        query_";
  protected final String TEXT_950 = " = ";
  protected final String TEXT_951 = ";";
  protected final String TEXT_952 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_953 = ",";
  protected final String TEXT_954 = ".";
  protected final String TEXT_955 = ", ";
  protected final String TEXT_956 = ",updateSQLSplits_";
  protected final String TEXT_957 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_958 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_959 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_969 = NL + "\t\t\t\t\t\tquery_";
  ...
  protected final String TEXT_992 = " == 0) {" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_993 = NL + "\t\t\t\tquery_";
  protected final String TEXT_994 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_1057 = NL + "    \t\tpstmt_";
  protected final String TEXT_1058 = ".addBatch();" + NL + "            batchSizeCounter_";
  protected final String TEXT_1059 = "++;" + NL + "    \t\tnb_line_";
  protected final String TEXT_1060 = "++;" + NL + "    \t\t";
  protected final String TEXT_1061 = NL + "    \t\t";
  protected final String TEXT_1062 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1063 = " = deletedCount_";
  protected final String TEXT_1064 = " + pstmt_";
  protected final String TEXT_1065 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1066 = "++;";
  protected final String TEXT_1067 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1068 = " = true;";
  protected final String TEXT_1069 = NL + "                    throw(e);";
  protected final String TEXT_1070 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_1105 = ")) {" + NL + "                \ttry {" + NL + "                \t\t";
  protected final String TEXT_1106 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_1107 = ".executeBatch();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1108 = NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_1109 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_1110 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_1111 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_1112 = " = pstmt_";
  protected final String TEXT_1113 = ".getUpdateCount();" + NL + "        \t    \t";
  ...
  protected final String TEXT_1120 = NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1121 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1122 = ":0);" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_1123 = " = 0;" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_1124 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1125 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1126 = " <= commitCounter_";
  protected final String TEXT_1127 = ") {" + NL + "" + NL + "\t                ";
  protected final String TEXT_1128 = NL + "\t                \tif(batchSizeCounter_";
  protected final String TEXT_1129 = " > 0){" + NL + "\t\t                try {" + NL + "\t\t                \t";
  protected final String TEXT_1130 = NL + "\t                \t\tpstmt_";
  protected final String TEXT_1131 = ".executeBatch();" + NL + "\t\t                \t";
  protected final String TEXT_1132 = NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_1133 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_1134 = NL + "\t\t                        System.err.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_1135 = NL + NL + "\t\t                }" + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_1136 = " = pstmt_";
  protected final String TEXT_1137 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  ...
  protected final String TEXT_1144 = NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_1145 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_1146 = ":0);" + NL + "\t\t    \t    \tbatchSizeCounter_";
  protected final String TEXT_1147 = " = 0;" + NL + "\t\t    \t    \t}" + NL + "\t                ";
  protected final String TEXT_1148 = NL + "\t                ";
  protected final String TEXT_1149 = NL + "                \tconn_";
  protected final String TEXT_1150 = ".commit();" + NL + "    \t\t\t\t";
  protected final String TEXT_1151 = NL + "                \tcommitCounter_";
  protected final String TEXT_1152 = "=0;" + NL + "                }";
