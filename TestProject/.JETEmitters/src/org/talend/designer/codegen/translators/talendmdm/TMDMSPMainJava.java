...
public class TMDMSPMainJava
{
  ...
  protected final String TEXT_41 = NL + NL + "List<String> params = new java.util.ArrayList<String>();";
  protected final String TEXT_42 = NL + NL + "params.add(";
  protected final String TEXT_43 = ".";
  protected final String TEXT_44 = ");";
  protected final String TEXT_45 = NL + "org.talend.mdm.webservice.WSExecuteStoredProcedure wsExeProc_";
  protected final String TEXT_46 = " = new org.talend.mdm.webservice.WSExecuteStoredProcedure(params,dataCluster_";
  protected final String TEXT_47 = ",wsStoredProcPK_";
  protected final String TEXT_48 = ");" + NL;
  protected final String TEXT_49 = NL + "        List<String> xmlFields = service_";
  protected final String TEXT_50 = ".executeStoredProcedure(wsExeProc_";
  protected final String TEXT_51 = ").getStrings();";
  protected final String TEXT_52 = NL + NL + "            for(String xmlField_";
  protected final String TEXT_53 = " : xmlFields){";
