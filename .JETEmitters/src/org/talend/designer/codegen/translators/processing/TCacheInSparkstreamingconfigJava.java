...
public class TCacheInSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TCacheInSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TCacheInSparkstreamingconfigJava result = new TCacheInSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_79 = NL + NL + "     org.apache.spark.streaming.api.java.JavaPairDStream<NullWritable, ";
  protected final String TEXT_80 = "> rdd_";
  protected final String TEXT_81 = " = ((org.apache.spark.streaming.api.java.JavaPairDStream<NullWritable, ";
