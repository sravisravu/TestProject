...
public class TExtractRegexFieldsMrconfigJava
{
  protected static String nl;
  public static synchronized TExtractRegexFieldsMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractRegexFieldsMrconfigJava result = new TExtractRegexFieldsMrconfigJava();
    nl = null;
    return result;
  }
...
mrTransformUtil.generateMrConfig(tExtractRegexFieldsUtil, cid + "Mapper.class");
