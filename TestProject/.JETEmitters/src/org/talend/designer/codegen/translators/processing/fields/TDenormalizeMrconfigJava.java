...
public class TDenormalizeMrconfigJava
{
  protected static String nl;
  public static synchronized TDenormalizeMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDenormalizeMrconfigJava result = new TDenormalizeMrconfigJava();
    nl = null;
    return result;
  }
