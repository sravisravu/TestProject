...
public class TFileOutputPositionalSparkjobfooterJava
{
  protected static String nl;
  public static synchronized TFileOutputPositionalSparkjobfooterJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFileOutputPositionalSparkjobfooterJava result = new TFileOutputPositionalSparkjobfooterJava();
    nl = null;
    return result;
  }
