...
public class TJavaStormComponentStormcodeJava
{
  protected static String nl;
  public static synchronized TJavaStormComponentStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaStormComponentStormcodeJava result = new TJavaStormComponentStormcodeJava();
    nl = null;
    return result;
  }
...
new TupleWrapperHelper().generateAllOutgoing(node);
    ...
    stringBuffer.append( ElementParameterParser.getValue(node, "__GENERIC_STORM_CODE__") );
