...
public class TInputFormatJSONSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TInputFormatJSONSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TInputFormatJSONSparkstreamingconfigJava result = new TInputFormatJSONSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_120 = "Struct> rdd_";
  protected final String TEXT_121 = " = ctx" + NL + "                            .sparkContext().hadoopRDD(" + NL + "                                    job,";
  protected final String TEXT_122 = NL + "                                    ";
  protected final String TEXT_123 = "StructInputFormat.class," + NL + "                                    NullWritable.class,";
  protected final String TEXT_124 = NL + "                                    ";
  protected final String TEXT_125 = "Struct.class);";
