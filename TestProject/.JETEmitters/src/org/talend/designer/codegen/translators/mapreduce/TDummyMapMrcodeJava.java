...
public class TDummyMapMrcodeJava
{
  protected static String nl;
  public static synchronized TDummyMapMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapMrcodeJava result = new TDummyMapMrcodeJava();
    nl = null;
    return result;
  }
