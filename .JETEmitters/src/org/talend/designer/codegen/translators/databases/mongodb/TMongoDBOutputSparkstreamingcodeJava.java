...
public class TMongoDBOutputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TMongoDBOutputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBOutputSparkstreamingcodeJava result = new TMongoDBOutputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_119 = NL + "    public static class ";
  protected final String TEXT_120 = "_ForeachRDDOutput implements ";
  protected final String TEXT_121 = " {" + NL + "" + NL + "            org.apache.hadoop.conf.Configuration mongoConfig;" + NL + "" + NL + "            public ";
  protected final String TEXT_122 = "_ForeachRDDOutput(org.apache.hadoop.conf.Configuration mongoConfig){" + NL + "                this.mongoConfig = mongoConfig;" + NL + "            }" + NL + "" + NL + "            public ";
  protected final String TEXT_123 = " call(";
  protected final String TEXT_124 = " rdd) throws Exception {" + NL + "                rdd.saveAsNewAPIHadoopFile(" + NL + "                \"\"," + NL + "                Object.class," + NL + "                org.bson.BSONObject.class," + NL + "                com.mongodb.hadoop.MongoOutputFormat.class," + NL + "                mongoConfig" + NL + "                );";
...
{ // Start ForeachRDD helper function
    ...
    org.talend.designer.spark.generator.utils.ForeachRDDUtil foreachUtil =
            org.talend.designer.spark.generator.utils.ForeachRDDUtil.createFunctionJavaPairRDD(
                    codeGenArgument.getSparkVersion(), "Object",
                    isInsert ? "org.bson.BSONObject" : "com.mongodb.hadoop.io.MongoUpdateWritable");
    // Note that the RDD value type depends on whether an insert is occurring.
