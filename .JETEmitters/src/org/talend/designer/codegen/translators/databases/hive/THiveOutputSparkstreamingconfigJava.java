...
public class THiveOutputSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized THiveOutputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THiveOutputSparkstreamingconfigJava result = new THiveOutputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
