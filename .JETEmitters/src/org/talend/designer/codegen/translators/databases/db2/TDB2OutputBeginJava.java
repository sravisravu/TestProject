...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_350 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_351 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_393 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_404 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_426 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_443 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_444 = " = stmtTruncCount_";
  protected final String TEXT_445 = ".executeQuery(\"";
  protected final String TEXT_446 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_447 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_448 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_452 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_467 = " += rsTruncCountNumber_";
  protected final String TEXT_468 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_469 = ".close();";
  protected final String TEXT_470 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_508 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_514 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_538 = ".prepareStatement(insert_";
