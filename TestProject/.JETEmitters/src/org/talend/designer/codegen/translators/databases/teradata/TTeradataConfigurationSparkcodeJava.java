...
public class TTeradataConfigurationSparkcodeJava
{
  protected static String nl;
  public static synchronized TTeradataConfigurationSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataConfigurationSparkcodeJava result = new TTeradataConfigurationSparkcodeJava();
    nl = null;
    return result;
  }
