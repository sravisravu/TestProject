...
public class TRedshiftOutputMainJava {
  ...
  protected final String TEXT_417 = NL + "\t                StringBuilder extendInsertValueStmt_";
  protected final String TEXT_418 = " = new StringBuilder();" + NL + "\t                for(int i_";
  ...
  protected final String TEXT_429 = ".append(\"(\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ")+\")\");";
  protected final String TEXT_432 = NL + "                \t\tif (i_";
  protected final String TEXT_433 = "!=";
  protected final String TEXT_434 = "-1) extendInsertValueStmt_";
  ...
  protected final String TEXT_442 = "\")+\") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_516 = ");" + NL + "\t\t\t    pstmtUpdate_";
  ...
  protected final String TEXT_527 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_535 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_541 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_548 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_556 = ");" + NL + "\t\t\t    pstmtInsert_";
  ...
  protected final String TEXT_587 = NL + NL + "                                    try {" + NL + "                                        insertedCount_";
  protected final String TEXT_588 = " = insertedCount_";
  protected final String TEXT_589 = " + pstmt_";
  protected final String TEXT_590 = ".executeUpdate();" + NL + "                                        nb_line_";
  protected final String TEXT_591 = "++;";
  protected final String TEXT_592 = NL + "                                    } catch(java.lang.Exception e) {" + NL + "                                        whetherReject_";
  ...
  protected final String TEXT_618 = ",java.sql.Types.CHAR);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_619 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_620 = ".";
  protected final String TEXT_621 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_622 = ".setNull(counter";
  protected final String TEXT_623 = ",java.sql.Types.DATE);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_628 = ",java.sql.Types.ARRAY);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_633 = ",java.sql.Types.INTEGER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_638 = ",java.sql.Types.VARCHAR);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_643 = ",java.sql.Types.OTHER);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_648 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_653 = ",java.sql.Types.DOUBLE);" + NL + "\t\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_658 = ",java.sql.Types.FLOAT);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_659 = NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_660 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_661 = NL + "\t\t\t\t\t\t\t\tif(";
  protected final String TEXT_662 = ".";
  protected final String TEXT_663 = "==null){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_664 = NL + "\t\t\t\t\t\t\t\tif((\"null\").equals(String.valueOf(";
  protected final String TEXT_665 = ".";
  protected final String TEXT_666 = ").toLowerCase())){" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_667 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_668 = ".setNull(counter";
  protected final String TEXT_669 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t\t\t\t\t\t}else if(";
  protected final String TEXT_670 = ".";
  protected final String TEXT_671 = " == '\\0'){" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_672 = ".setString(counter";
  protected final String TEXT_673 = ",\"\");" + NL + "" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_674 = ".setString(counter";
  protected final String TEXT_675 = ",String.valueOf(";
  protected final String TEXT_676 = ".";
  protected final String TEXT_677 = "));" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_678 = NL + "\t\t\t\t\t\t\tif(";
  protected final String TEXT_679 = ".";
  protected final String TEXT_680 = "!=null){" + NL + "\t\t\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\t\t\tdate_";
  protected final String TEXT_681 = " = ";
  protected final String TEXT_682 = ".";
  protected final String TEXT_683 = ".getTime();" + NL + "\t\t\t\t\t\t\t\tif (date_";
  protected final String TEXT_684 = " < year1_";
  protected final String TEXT_685 = " || date_";
  protected final String TEXT_686 = " >= year10000_";
  protected final String TEXT_687 = ") {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_688 = ".setString(counter";
  protected final String TEXT_689 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_690 = ".setTimestamp(counter";
  protected final String TEXT_691 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_692 = "));" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}else{" + NL + "" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_693 = ".setNull(counter";
  protected final String TEXT_694 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_695 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_696 = ".set";
  protected final String TEXT_697 = "(counter";
  protected final String TEXT_698 = ",";
  protected final String TEXT_699 = ".";
  protected final String TEXT_700 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_701 = NL + NL + "\t\t\t\t\t\t\t}" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_702 = NL + "\t\t\t\tint counter";
  protected final String TEXT_703 = " = rowCount";
  protected final String TEXT_704 = " *" + NL + "\t\t\t\t\t(";
  protected final String TEXT_705 = NL + "\t\t\t\t\t\t+ ";
  protected final String TEXT_706 = ".";
  protected final String TEXT_707 = ".getColumnCount()";
  protected final String TEXT_708 = NL + "\t\t\t\t\t)" + NL + "\t\t\t\t+ 1;";
  protected final String TEXT_709 = NL + "\t\t\t\t\t\tcounter";
  ...
  protected final String TEXT_714 = ", counter";
  protected final String TEXT_715 = "-1, \"";
  protected final String TEXT_716 = "\");";
  protected final String TEXT_717 = NL + "\t\t\t\texInsertColValue";
  protected final String TEXT_718 = " = new BufferLine_";
  ...
  protected final String TEXT_727 = ".clone()" + NL + "\t                \t";
  protected final String TEXT_728 = NL + "\t\t\t\t);" + NL + "" + NL + "\t\t\t\texInsertColValueList";
  protected final String TEXT_729 = ".add(exInsertColValue";
  protected final String TEXT_730 = ");" + NL + "\t\t\t\trowCount";
  protected final String TEXT_731 = "++;" + NL + "" + NL + "                nb_line_";
  protected final String TEXT_732 = "++;" + NL + "" + NL + "\t\t\t\tif(rowCount";
  ...
  protected final String TEXT_737 = ".executeUpdate();" + NL + "\t                exInsertColValueList";
  protected final String TEXT_738 = ".clear();" + NL + "\t                rowCount";
  protected final String TEXT_739 = " = 0;" + NL + "\t\t\t\t\tcounter";
  protected final String TEXT_740 = "=1;" + NL + "\t\t\t\t}";
  protected final String TEXT_741 = NL + "                    ";
  protected final String TEXT_742 = NL + "                    int count_";
  protected final String TEXT_743 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_754 = NL + "                       pstmt_";
  protected final String TEXT_755 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_756 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_757 = "++;";
  protected final String TEXT_758 = NL + "                           try {" + NL + "                               updatedCount_";
  ...
  protected final String TEXT_763 = NL + "                           } catch(java.lang.Exception e) {" + NL + "                               whetherReject_";
  ...
  protected final String TEXT_788 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_789 = " = pstmt_";
  protected final String TEXT_790 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_791 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_792 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_793 = " = rs_";
  protected final String TEXT_794 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_795 = " > 0) {";
  protected final String TEXT_796 = NL + "                        ";
  protected final String TEXT_797 = NL + "                        int count_";
  ...
  protected final String TEXT_809 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_810 = " = updatedCount_";
  protected final String TEXT_811 = " + pstmtUpdate_";
  protected final String TEXT_812 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_813 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_814 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_815 = " = true;";
  protected final String TEXT_816 = NL + "                        throw(e);";
  protected final String TEXT_817 = NL + "                    \tnb_line_";
  protected final String TEXT_818 = "++;" + NL + "                    \t";
  protected final String TEXT_819 = NL + "                            ";
  protected final String TEXT_820 = " = new ";
  protected final String TEXT_821 = "Struct();";
  protected final String TEXT_822 = NL + "                                ";
  protected final String TEXT_823 = ".";
  protected final String TEXT_824 = " = ";
  protected final String TEXT_825 = ".";
  protected final String TEXT_826 = ";";
  protected final String TEXT_827 = NL + "                            rejectedCount_";
  protected final String TEXT_828 = " = rejectedCount_";
  protected final String TEXT_829 = " + 1;";
  protected final String TEXT_830 = NL + "                            ";
  protected final String TEXT_831 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_836 = NL + "                }" + NL + "            } else {";
  ...
  protected final String TEXT_844 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_849 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_850 = " = true;";
  protected final String TEXT_851 = NL + "                        throw(e);";
  protected final String TEXT_852 = NL + "                    \tnb_line_";
  protected final String TEXT_853 = "++;" + NL + "                    \t";
  protected final String TEXT_854 = NL + "                            ";
  protected final String TEXT_855 = " = new ";
  protected final String TEXT_856 = "Struct();";
  protected final String TEXT_857 = NL + "                                ";
  protected final String TEXT_858 = ".";
  protected final String TEXT_859 = " = ";
  protected final String TEXT_860 = ".";
  protected final String TEXT_861 = ";";
  protected final String TEXT_862 = NL + "                            rejectedCount_";
  protected final String TEXT_863 = " = rejectedCount_";
  protected final String TEXT_864 = " + 1;";
  protected final String TEXT_865 = NL + "                            ";
  protected final String TEXT_866 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_867 = NL + "                            ";
  protected final String TEXT_868 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_869 = ";";
  protected final String TEXT_870 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_871 = NL + "                }" + NL + "            }";
  protected final String TEXT_872 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_878 = ", pstmtUpdate_";
  ...
  protected final String TEXT_888 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_889 = "=pstmtUpdate_";
  protected final String TEXT_890 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_891 = " = updatedCount_";
  protected final String TEXT_892 = "+updateFlag_";
  ...
  protected final String TEXT_902 = NL + "                    insertedCount_";
  protected final String TEXT_903 = " = insertedCount_";
  protected final String TEXT_904 = " + pstmtInsert_";
  protected final String TEXT_905 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_906 = "++;";
  protected final String TEXT_907 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_908 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_909 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_938 = NL + "                       pstmt_";
  protected final String TEXT_939 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_940 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_941 = "++;";
  protected final String TEXT_942 = NL + "                       try {" + NL + "                           deletedCount_";
  protected final String TEXT_943 = " = deletedCount_";
  protected final String TEXT_944 = " + pstmt_";
  protected final String TEXT_945 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_946 = "++;";
  protected final String TEXT_947 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_964 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_965 = NL + "                                   ";
  protected final String TEXT_966 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_967 = ";";
  protected final String TEXT_968 = NL + "                                   System.err.print(e.getMessage());";
  ...
  protected final String TEXT_984 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_985 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_986 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_987 = " = 0;";
  protected final String TEXT_988 = NL + "                        status_";
  protected final String TEXT_989 = " = pstmt_";
  protected final String TEXT_990 = ".executeBatch();";
  protected final String TEXT_991 = NL + "                        for(int countEach_";
  protected final String TEXT_992 = ": status_";
  protected final String TEXT_993 = ") {" + NL + "                            countSum_";
  protected final String TEXT_994 = " += (countEach_";
  protected final String TEXT_995 = " < 0 ? 0 : countEach_";
  protected final String TEXT_996 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_997 = NL + "                            throw(e);";
  protected final String TEXT_998 = NL + "                        for(int countEach_";
  protected final String TEXT_999 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_1000 = " += (countEach_";
  protected final String TEXT_1001 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1002 = ");" + NL + "                        }";
  protected final String TEXT_1003 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1004 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_1005 = " = pstmt_";
  protected final String TEXT_1006 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_1007 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  ...
  protected final String TEXT_1024 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_1025 = "<=commitCounter_";
  protected final String TEXT_1026 = ") {";
  protected final String TEXT_1027 = NL + "                                if(batchSize_";
  protected final String TEXT_1028 = " > 0){";
  protected final String TEXT_1029 = NL + "                                      conn_";
  protected final String TEXT_1030 = ".commit();";
  protected final String TEXT_1031 = NL + "                                      commitCounter_";
  protected final String TEXT_1032 = "=0;" + NL + "                                }";
