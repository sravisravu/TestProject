...
public class TMongoDBInputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TMongoDBInputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBInputSparkstreamingcodeJava result = new TMongoDBInputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
