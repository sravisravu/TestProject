...
public class TInputFormatXMLMrconfigJava
{
  ...
  protected final String TEXT_128 = NL + "            final String clouderaManagerPassword = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_129 = ");";
  protected final String TEXT_130 = NL + "            final String clouderaManagerPassword = ";
  protected final String TEXT_131 = ";";
  protected final String TEXT_132 = NL + "        this.lineageCreator = new org.talend.lineage.cloudera.LineageCreator(";
  ...
  protected final String TEXT_140 = "," + NL + "                clouderaManagerPassword," + NL + "                jobName + \"_\" + jobVersion.replace(\".\", \"_\")," + NL + "                projectName,";
  ...
  protected final String TEXT_147 = NL + "        this.lineageCreator = new org.talend.lineage.atlas.AtlasLineageCreator(";
  protected final String TEXT_148 = ");" + NL + "" + NL + "        java.util.Map<String, Object> lineageCreatorJobMetadata = new java.util.HashMap<String, Object>();" + NL + "        lineageCreatorJobMetadata.put(\"name\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"description\", jobName);" + NL + "        lineageCreatorJobMetadata.put(\"purpose\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"author\", System.getProperty(\"user.name\"));" + NL + "        lineageCreatorJobMetadata.put(\"version\", jobVersion);" + NL + "        lineageCreatorJobMetadata.put(\"jobType\", \"Talend BigData Job\");" + NL + "        lineageCreatorJobMetadata.put(\"framework\", \"Talend BigData\");" + NL + "        lineageCreatorJobMetadata.put(\"status\", \"FINISHED\");" + NL + "        lineageCreatorJobMetadata.put(\"creationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"lastModificationDate\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"startTime\", System.currentTimeMillis());" + NL + "        lineageCreatorJobMetadata.put(\"endTime\", System.currentTimeMillis());" + NL + "" + NL + "        this.lineageCreator.addJobInfo(lineageCreatorJobMetadata);";
  protected final String TEXT_149 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_150 = " = new java.util.HashMap<>();";
  protected final String TEXT_151 = NL + "            columns_";
  protected final String TEXT_152 = ".put(\"";
  protected final String TEXT_153 = "\", \"";
  protected final String TEXT_154 = "\");";
  protected final String TEXT_155 = NL + "        java.util.Map<String, String> columns_";
  protected final String TEXT_156 = " = new java.util.HashMap<>();";
  protected final String TEXT_157 = NL + "                        columns_";
  protected final String TEXT_158 = ".put(\"";
  protected final String TEXT_159 = "\", \"";
  protected final String TEXT_160 = "\");";
  protected final String TEXT_161 = NL + "                    columns_";
  protected final String TEXT_162 = ".put(\"";
  protected final String TEXT_163 = "\", \"";
  protected final String TEXT_164 = "\");";
  protected final String TEXT_165 = NL + "        lineageCreator.addDataset(columns_";
  protected final String TEXT_166 = ", \"";
  protected final String TEXT_167 = "\", ";
  protected final String TEXT_168 = ", \"";
  protected final String TEXT_169 = "\");";
  protected final String TEXT_170 = NL + "        java.util.List<String> inputNodes_";
  protected final String TEXT_171 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_172 = NL + "                inputNodes_";
  protected final String TEXT_173 = ".add(\"";
  protected final String TEXT_174 = "\");";
  protected final String TEXT_175 = NL + "        java.util.List<String> outputNodes_";
  protected final String TEXT_176 = " = new java.util.ArrayList<String>();";
  protected final String TEXT_177 = NL + "                outputNodes_";
  protected final String TEXT_178 = ".add(\"";
  protected final String TEXT_179 = "\");";
  protected final String TEXT_180 = NL + "        this.lineageCreator.addNodeToLineage(\"";
  protected final String TEXT_181 = "\", columns_";
  protected final String TEXT_182 = ", inputNodes_";
  protected final String TEXT_183 = ", outputNodes_";
  protected final String TEXT_184 = ", new java.util.HashMap<String, Object>());";
