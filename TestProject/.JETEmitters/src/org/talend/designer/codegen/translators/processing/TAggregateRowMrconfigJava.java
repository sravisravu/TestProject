...
public class TAggregateRowMrconfigJava
{
  protected static String nl;
  public static synchronized TAggregateRowMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAggregateRowMrconfigJava result = new TAggregateRowMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_227 = NL + "\tjob.setNumReduceTasks(1);" + NL + "    job.setPartitionerClass(OneReducePartitioner_";
  protected final String TEXT_228 = ".class);";
  protected final String TEXT_229 = NL + "\t    job.setOutputKeyComparatorClass(AggregateKeyComparator_";
