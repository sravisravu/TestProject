...
public class TSqoopImportAllTablesBeginJava
{
  ...
  protected final String TEXT_246 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_247 = ", ";
  protected final String TEXT_248 = ", decryptedMapRPassword_";
  protected final String TEXT_249 = ", ";
  protected final String TEXT_250 = ");";
  protected final String TEXT_251 = NL + "        configuration_";
  protected final String TEXT_252 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_253 = NL + "\t//check whether we can connect to the fs?" + NL + "\torg.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_254 = " = org.apache.hadoop.fs.FileSystem.get(configuration_";
  protected final String TEXT_255 = ");" + NL + "\tcom.cloudera.sqoop.tool.SqoopTool sqoopTool_";
  protected final String TEXT_256 = " = com.cloudera.sqoop.tool.SqoopTool.getTool(\"import-all-tables\");" + NL + "" + NL + "\tcom.cloudera.sqoop.SqoopOptions sqoopOptions_";
  protected final String TEXT_257 = " = new com.cloudera.sqoop.SqoopOptions(configuration_";
  protected final String TEXT_258 = ");" + NL + "\t" + NL + "\tsqoopOptions_";
  protected final String TEXT_259 = ".setConnectString(";
  protected final String TEXT_260 = "); // __CONNECTION__" + NL + "\tsqoopOptions_";
  protected final String TEXT_261 = ".setUsername(";
  protected final String TEXT_262 = "); // __USERNAME__" + NL + "\t";
  protected final String TEXT_263 = NL + "\t\t";
  protected final String TEXT_264 = NL + "\t\t";
  protected final String TEXT_265 = " " + NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_266 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_267 = ");";
  protected final String TEXT_268 = NL + "\tfinal String decryptedPassword_";
  protected final String TEXT_269 = " = ";
  protected final String TEXT_270 = "; ";
  protected final String TEXT_271 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_272 = ".setPassword(decryptedPassword_";
  protected final String TEXT_273 = "); // __PASSWORD__" + NL + "\t";
  protected final String TEXT_274 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_275 = ".setPasswordFilePath(";
  protected final String TEXT_276 = ");" + NL + "\t\tsqoopOptions_";
  protected final String TEXT_277 = ".setPassword(org.apache.sqoop.util.CredentialsUtil.fetchPassword";
  ...
  protected final String TEXT_282 = ".setDirectMode(true);" + NL + "\t\t";
  protected final String TEXT_283 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_284 = ".setDirectSplitSize(Long.parseLong(";
  protected final String TEXT_285 = "));" + NL + "\t\t";
  protected final String TEXT_286 = NL + "\t";
  protected final String TEXT_287 = NL + "\t\tsqoopOptions_";
  protected final String TEXT_288 = ".setUseCompression(true);" + NL + "\t\t";
  protected final String TEXT_289 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_290 = ".setCompressionCodec(";
  protected final String TEXT_291 = ");" + NL + "\t\t";
  protected final String TEXT_292 = NL + "\t";
  protected final String TEXT_293 = "sqoopOptions_";
  protected final String TEXT_294 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.SequenceFile);";
  protected final String TEXT_295 = "sqoopOptions_";
  protected final String TEXT_296 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.TextFile);";
  protected final String TEXT_297 = "sqoopOptions_";
  protected final String TEXT_298 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.ParquetFile);";
  protected final String TEXT_299 = "sqoopOptions_";
  protected final String TEXT_300 = ".setFileLayout(com.cloudera.sqoop.SqoopOptions.FileLayout.AvroDataFile);";
  protected final String TEXT_301 = NL + NL + "\t";
  protected final String TEXT_302 = "sqoopOptions_";
  protected final String TEXT_303 = ".setNumMappers(Integer.valueOf(";
  protected final String TEXT_304 = "));";
  protected final String TEXT_305 = NL + "\t" + NL + "\tjava.util.Properties additionalProperties_";
  protected final String TEXT_306 = " = new java.util.Properties();";
  protected final String TEXT_307 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_308 = ".put(";
  protected final String TEXT_309 = ", \"\"+";
  protected final String TEXT_310 = ".codePointAt(0)); ";
  protected final String TEXT_311 = " " + NL + "\t\t\t\tadditionalProperties_";
  protected final String TEXT_312 = ".put(";
  protected final String TEXT_313 = ", ";
  protected final String TEXT_314 = "); ";
  protected final String TEXT_315 = NL + "\t\t\t\tStringBuilder sb_exclude_";
  protected final String TEXT_316 = " = new StringBuilder();";
  protected final String TEXT_317 = NL + "\t\t\t\t\t\tsb_exclude_";
  protected final String TEXT_318 = ".append(";
  protected final String TEXT_319 = ");";
  protected final String TEXT_320 = NL + "\t\t\t\t\t\tsb_exclude_";
  protected final String TEXT_321 = ".append(\",\" + ";
  protected final String TEXT_322 = ");";
  protected final String TEXT_323 = NL + "\t\t\t\tsqoopOptions_";
  protected final String TEXT_324 = ".setAllTablesExclude(sb_exclude_";
  protected final String TEXT_325 = ".toString());";
  protected final String TEXT_326 = NL + "\t\t\tStringBuilder sb_hive_";
  protected final String TEXT_327 = " = new StringBuilder();" + NL + "\t";
  protected final String TEXT_328 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_329 = ".append(";
  protected final String TEXT_330 = " + \"=\" + ";
  protected final String TEXT_331 = ");" + NL + "\t";
  protected final String TEXT_332 = NL + "\t\t\t\t\tsb_hive_";
  protected final String TEXT_333 = ".append(\",\" + ";
  protected final String TEXT_334 = " + \"=\" + ";
  protected final String TEXT_335 = ");" + NL + "\t";
  protected final String TEXT_336 = NL + "\t\t\tsqoopOptions_";
  protected final String TEXT_337 = ".setMapColumnHive(sb_hive_";
  protected final String TEXT_338 = ".toString());" + NL + "\t";
  protected final String TEXT_339 = NL + "\t" + NL + "\tsqoopOptions_";
  protected final String TEXT_340 = ".loadProperties(additionalProperties_";
  protected final String TEXT_341 = ");" + NL + "" + NL + "\torg.apache.sqoop.Sqoop sqoop_";
  protected final String TEXT_342 = " = new org.apache.sqoop.Sqoop(sqoopTool_";
  protected final String TEXT_343 = ", configuration_";
  protected final String TEXT_344 = ", sqoopOptions_";
  protected final String TEXT_345 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_346 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_347 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_348 = " = new java.lang.StringBuilder();";
  protected final String TEXT_349 = NL + "\t\t\t\t\tsb_";
  protected final String TEXT_350 = ".append(getJarsToRegister_";
  protected final String TEXT_351 = ".replaceJarPaths(\"";
  protected final String TEXT_352 = "\", \"file:///\") + \",\");";
  protected final String TEXT_353 = NL + "\t";
  protected final String TEXT_354 = NL + "\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_355 = " = new routines.system.GetJarsToRegister();" + NL + "\t\tjava.lang.StringBuilder sb_";
  protected final String TEXT_356 = " = new java.lang.StringBuilder();";
  protected final String TEXT_357 = NL + "\t\t\t\t\tsb_";
  protected final String TEXT_358 = ".append(getJarsToRegister_";
  protected final String TEXT_359 = ".replaceJarPaths(\"";
  protected final String TEXT_360 = "\", \"file:///\") + \",\");";
  protected final String TEXT_361 = NL + "\ttry {";
  protected final String TEXT_362 = NL + "\t\t\tint result_";
  protected final String TEXT_363 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_364 = ", new String[] {\"-libjars\", sb_";
  protected final String TEXT_365 = ".toString()});";
  protected final String TEXT_366 = NL + "\t\t\tint result_";
  protected final String TEXT_367 = " = org.apache.sqoop.Sqoop.runSqoop(sqoop_";
  protected final String TEXT_368 = ", new String[] {});";
  protected final String TEXT_369 = NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_370 = "_EXIT_CODE\", result_";
  protected final String TEXT_371 = ");" + NL + "\t\tif(result_";
  protected final String TEXT_372 = " != 0) {";
  protected final String TEXT_373 = NL + "\t\t\t\tthrow new Exception(\"The Sqoop import job has failed. Please check the logs.\");";
  protected final String TEXT_374 = NL + "\t\t\t\tSystem.err.println(\"The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_375 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_376 = " - The Sqoop import job has failed. Please check the logs.\");" + NL + "\t\t\t\t";
  protected final String TEXT_377 = NL + "\t\t}" + NL + "\t} catch (Exception e) {";
  protected final String TEXT_378 = NL + "\t\t\tthrow e;";
  protected final String TEXT_379 = NL + "\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_380 = NL + "\t\t\tlog.error(\"";
  protected final String TEXT_381 = " - \" + e.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_382 = NL + "\t}" + NL + "\t" + NL + "\t";
  protected final String TEXT_383 = NL + "String currentClientPathSeparator_";
  protected final String TEXT_384 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_385 = "!=null) {" + NL + "\tSystem.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_386 = ");" + NL + "\tglobalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_387 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_388 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_389 = "!=null) {" + NL + "\tSystem.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_390 = ");" + NL + "\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_391 = "\", null);" + NL + "} else {" + NL + "\tSystem.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
