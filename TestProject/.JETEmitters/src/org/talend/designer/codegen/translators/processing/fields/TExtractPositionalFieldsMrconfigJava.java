...
public class TExtractPositionalFieldsMrconfigJava
{
  protected static String nl;
  public static synchronized TExtractPositionalFieldsMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TExtractPositionalFieldsMrconfigJava result = new TExtractPositionalFieldsMrconfigJava();
    nl = null;
    return result;
  }
...
mrTransformUtil.generateMrConfig(tExtractPositionalFieldsUtil, cid + "Mapper.class");
