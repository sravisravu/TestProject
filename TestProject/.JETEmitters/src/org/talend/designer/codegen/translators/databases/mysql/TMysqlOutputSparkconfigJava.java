...
public class TMysqlOutputSparkconfigJava {
  ...
  protected final String TEXT_50 = NL + "           " + NL + "" + NL + "Class.forName(\"org.gjt.mm.mysql.Driver\");" + NL + "java.util.Properties jdbcDriverProperties_";
  ...
  protected final String TEXT_75 = " = 0;" + NL + "String tableName_";
  ...
  protected final String TEXT_82 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_91 = ".createStatement();";
  protected final String TEXT_92 = NL + "                              stmtCreate_";
  protected final String TEXT_93 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_101 = ".toUpperCase()";
  ...
  protected final String TEXT_113 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_130 = NL + "                    String keyCheckTable_";
  protected final String TEXT_131 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_138 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_139 = " = conn_";
  protected final String TEXT_140 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_141 = " + \"]\";";
  protected final String TEXT_142 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_143 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_144 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_145 = ")== null){//}";
  protected final String TEXT_146 = NL + "                                java.sql.Statement isExistStmt_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = ".createStatement();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_149 = " = false;" + NL + "                                try {" + NL + "                                    isExistStmt_";
  protected final String TEXT_150 = ".execute(\"SELECT TOP 1 1 FROM [\" +  tableName_";
  protected final String TEXT_151 = " + \"]\" );" + NL + "                                    whetherExist_";
  protected final String TEXT_152 = " = true;" + NL + "                                } catch (java.lang.Exception e){" + NL + "                                    whetherExist_";
  protected final String TEXT_153 = " = false;" + NL + "                                }" + NL + "                                isExistStmt_";
  ...
  protected final String TEXT_158 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_159 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_160 = " = tableNameForSearch_";
  protected final String TEXT_161 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_162 = " = tableNameForSearch_";
  protected final String TEXT_163 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_164 = " = dbMetaData_";
  protected final String TEXT_165 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_166 = ", tableNameForSearch_";
  protected final String TEXT_167 = ", new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_168 = " = false;" + NL + "                                if(rsTable_";
  protected final String TEXT_169 = ".next()) {" + NL + "                                    whetherExist_";
  protected final String TEXT_170 = " = true;" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_191 = ".trim().length() ==0)) {" + NL + "                                        whetherExist_";
  ...
  protected final String TEXT_259 = NL + "\t\t\t\t            \tString tableForSearch_";
  protected final String TEXT_260 = " = ";
  protected final String TEXT_261 = ";" + NL + "\t\t\t\t            \tif(tableForSearch_";
  protected final String TEXT_262 = " != null){" + NL + "\t\t\t\t            \t\tif(tableForSearch_";
  protected final String TEXT_263 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_264 = ".endsWith(\"\\\"\")){" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  protected final String TEXT_265 = " =  tableForSearch_";
  protected final String TEXT_266 = ".substring(1,tableForSearch_";
  protected final String TEXT_267 = ".length()-1);" + NL + "\t\t\t\t            \t\t}else{" + NL + "\t\t\t\t            \t\t\ttableForSearch_";
  ...
  protected final String TEXT_273 = ".getTables(null, conn_";
  protected final String TEXT_274 = ".getSchema(), tableForSearch_";
  protected final String TEXT_275 = ", new String[]{\"TABLE\"});" + NL + "\t\t\t\t                boolean whetherExist_";
  protected final String TEXT_276 = " = false;" + NL + "\t\t\t\t               \tif(rsTable_";
  protected final String TEXT_277 = ".next()) {" + NL + "\t\t\t\t\t\t\t\t\twhetherExist_";
  protected final String TEXT_278 = " = true;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t                rsTable_";
  ...
  protected final String TEXT_284 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_285 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_286 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_287 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_288 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_308 = ".createStatement();";
  protected final String TEXT_309 = NL + "                                                      stmtCreate_";
  protected final String TEXT_310 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_358 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_359 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  ...
  protected final String TEXT_374 = NL + "                              stmtTruncCount_";
  protected final String TEXT_375 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_376 = "));";
  protected final String TEXT_377 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_378 = " = stmtTruncCount_";
  protected final String TEXT_379 = ".executeQuery(\"";
  protected final String TEXT_380 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_381 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_382 = ".next()) {" + NL + "                rsTruncCountNumber_";
  protected final String TEXT_383 = " = rsTruncCount_";
  protected final String TEXT_384 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_385 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_386 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_397 = NL + "                if(!conn_";
  protected final String TEXT_398 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_399 = ".commit();" + NL + "                }";
  ...
  protected final String TEXT_413 = ".commit();";
  ...
  protected final String TEXT_425 = ".close();" + NL + "" + NL + "rdd_";
  protected final String TEXT_426 = ".foreachPartition(new ";
  protected final String TEXT_427 = "_OutputFunction(job));" + NL;
  protected final String TEXT_428 = NL + "\tif(true) {" + NL + "\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_429 = " code : ";
