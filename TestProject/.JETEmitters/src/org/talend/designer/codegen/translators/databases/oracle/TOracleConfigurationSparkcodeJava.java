...
public class TOracleConfigurationSparkcodeJava
{
  protected static String nl;
  public static synchronized TOracleConfigurationSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TOracleConfigurationSparkcodeJava result = new TOracleConfigurationSparkcodeJava();
    nl = null;
    return result;
  }
