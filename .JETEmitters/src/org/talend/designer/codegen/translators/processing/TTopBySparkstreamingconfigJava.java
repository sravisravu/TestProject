...
public class TTopBySparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TTopBySparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTopBySparkstreamingconfigJava result = new TTopBySparkstreamingconfigJava();
    nl = null;
    return result;
  }
