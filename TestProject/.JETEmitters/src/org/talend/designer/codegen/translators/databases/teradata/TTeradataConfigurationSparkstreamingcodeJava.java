...
public class TTeradataConfigurationSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TTeradataConfigurationSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataConfigurationSparkstreamingcodeJava result = new TTeradataConfigurationSparkstreamingcodeJava();
    nl = null;
    return result;
  }
