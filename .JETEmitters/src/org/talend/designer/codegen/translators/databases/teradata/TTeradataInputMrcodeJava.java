...
public class TTeradataInputMrcodeJava
{
  protected static String nl;
  public static synchronized TTeradataInputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataInputMrcodeJava result = new TTeradataInputMrcodeJava();
    nl = null;
    return result;
  }
