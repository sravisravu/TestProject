...
public class TGenKeyMrcodeJava
{
  protected static String nl;
  public static synchronized TGenKeyMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TGenKeyMrcodeJava result = new TGenKeyMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_897 = NL + "        String winKey_";
  protected final String TEXT_898 = " = \"\";" + NL + "        String strInput_";
  protected final String TEXT_899 = " = null;";
  protected final String TEXT_900 = NL + "            strInput_";
  protected final String TEXT_901 = " = \"\";";
  protected final String TEXT_902 = NL + "                strInput_";
  protected final String TEXT_903 = " = TypeConvert.";
  protected final String TEXT_904 = "2String(value_";
  protected final String TEXT_905 = ".";
  protected final String TEXT_906 = ", ";
  protected final String TEXT_907 = ");";
  protected final String TEXT_908 = NL + "                strInput_";
  protected final String TEXT_909 = " = TypeConvert.";
  protected final String TEXT_910 = "2String(value_";
  protected final String TEXT_911 = ".";
  protected final String TEXT_912 = ");";
  protected final String TEXT_913 = NL + "                strInput_";
  protected final String TEXT_914 = " = org.talend.windowkey.AlgoBox.";
  protected final String TEXT_915 = "(strInput_";
  protected final String TEXT_916 = NL + "                , ";
  protected final String TEXT_917 = ");";
  protected final String TEXT_918 = NL + "            strInput_";
  protected final String TEXT_919 = " = org.talend.windowkey.AlgoBox.";
  protected final String TEXT_920 = "(strInput_";
  protected final String TEXT_921 = NL + "            , ";
  protected final String TEXT_922 = ");";
  protected final String TEXT_923 = NL + "                strInput_";
  protected final String TEXT_924 = " = org.talend.windowkey.AlgoBox.";
  protected final String TEXT_925 = "(strInput_";
  protected final String TEXT_926 = NL + "                , ";
  protected final String TEXT_927 = ");";
  protected final String TEXT_928 = NL + "            winKey_";
  protected final String TEXT_929 = " += (strInput_";
  protected final String TEXT_930 = " == null) ? \"\" : strInput_";
  protected final String TEXT_931 = ";";
  protected final String TEXT_932 = "// T01" + NL + "        ";
  protected final String TEXT_933 = NL + "                    ";
  protected final String TEXT_934 = ".T_GEN_KEY = winKey_";
  protected final String TEXT_935 = ";";
  protected final String TEXT_936 = NL + "                    ";
  protected final String TEXT_937 = ".";
  protected final String TEXT_938 = " = value_";
...
List<IMetadataColumn> columnsTemp =new ArrayList<IMetadataColumn>();

if (inConns.size() <= 0 || outConns.size() <= 0){
    return "";
}else if(!(outConns.get(0).getLineStyle().hasConnectionCategory(IConnectionCategory.DATA))) {
            return "";
}
...
final String connNameOut=outConnName;
List<IMetadataTable> metaTables = node.getMetadataList();
IMetadataTable metaTableTemp=null;
if (metaTables != null && metaTables.size() > 0){
    metaTableTemp = metaTables.get(0);
    columnsTemp = metaTableTemp.getListColumns();
}else{
    return "";
}
final IMetadataTable metaTable=metaTableTemp;
IMetadataTable inputMetadataTable=null;
final List<IMetadataColumn> outPutColumns=columnsTemp;
...
final List<IMetadataColumn> inputcolumns=inputMetadataTable.getListColumns();


List<String> listNoParamAlgoTemp = new java.util.ArrayList<String>();
/* to store the funcations that do not have the second parameter */
listNoParamAlgoTemp.addAll(java.util.Arrays.asList("first_Char_EW", "soundex", "metaphone", "doublemetaphone", "exact", "fingerPrintKey", "nGramKey", "colognePhonetic"));
listNoParamAlgoTemp.addAll(java.util.Arrays.asList("lowerCase", "upperCase", "removeDiacriticalMarks", "removeDMAndLowerCase", "removeDMAndUpperCase"));
final List<String> listNoParamAlgo=listNoParamAlgoTemp;

final List<Map<String, String>> listKeyAlgo =(List<Map<String, String>>)ElementParameterParser.getObjectValue(node, "__ALGO__");



//StructHelper rowStruct = new StructHelper("mOutKey_"+cid, inputcolumns);
...
class Mapper extends MapperHelper{
    ...
    stringBuffer.append(TEXT_932);
        ...
        for(IMetadataColumn column : outPutColumns){
            if ("T_GEN_KEY".equals(column.getLabel())){
...
mapper.init(node, cid, null, connNameIn, null, connNameOut);
mapper.generate();
