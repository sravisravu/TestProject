...
public class THDFSRenameBeginJava
{
  ...
  protected final String TEXT_126 = " = 0;" + NL + "\t" + NL + "    java.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_127 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t";
  protected final String TEXT_128 = "    " + NL + "\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_129 = "_";
  protected final String TEXT_130 = " = new java.util.HashMap<String,String>();" + NL + "\t\tmap_";
  protected final String TEXT_131 = "_";
  protected final String TEXT_132 = ".put(";
  protected final String TEXT_133 = ",";
  protected final String TEXT_134 = ");\t\t" + NL + "\t \tlist_";
  protected final String TEXT_135 = ".add(map_";
  protected final String TEXT_136 = "_";
  protected final String TEXT_137 = ");       " + NL + "\t";
  protected final String TEXT_138 = "\t" + NL + "" + NL + "\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_139 = " : list_";
