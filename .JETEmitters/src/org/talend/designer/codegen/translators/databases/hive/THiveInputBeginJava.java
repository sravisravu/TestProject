...
public class THiveInputBeginJava
{
  ...
  protected final String TEXT_237 = ".execute(\"SET mapreduce.application.classpath=";
  protected final String TEXT_238 = "\");";
  protected final String TEXT_239 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_240 = ".execute(\"SET yarn.application.classpath=";
  protected final String TEXT_241 = "\");";
  protected final String TEXT_242 = NL + "        \t\t\tinit_";
  protected final String TEXT_243 = ".execute(\"SET mapreduce.map.memory.mb=\" + ";
  protected final String TEXT_244 = ");" + NL + "        \t\t\tinit_";
  protected final String TEXT_245 = ".execute(\"SET mapreduce.reduce.memory.mb=\" + ";
  protected final String TEXT_246 = ");" + NL + "        \t\t\tinit_";
  protected final String TEXT_247 = ".execute(\"SET yarn.app.mapreduce.am.resource.mb=\" + ";
  protected final String TEXT_248 = ");";
  protected final String TEXT_249 = NL + "\t\t\t\t\tinit_";
  protected final String TEXT_250 = ".execute(\"SET \"+";
  ...
  protected final String TEXT_257 = ".execute(\"SET hive.execution.engine=tez\");";
  protected final String TEXT_258 = NL + "                        System.err.println(\"Please set the path of Tez lib in 'Tez lib path'!\");";
  protected final String TEXT_259 = NL;
  protected final String TEXT_260 = NL + "        String username_";
  protected final String TEXT_261 = " = (";
  protected final String TEXT_262 = " != null && !\"\".equals(";
  protected final String TEXT_263 = ")) ? ";
  protected final String TEXT_264 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_265 = " = null;";
  protected final String TEXT_266 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_267 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_268 = ".set(\"";
  protected final String TEXT_269 = "\", ";
  protected final String TEXT_270 = ");" + NL + "        ";
  protected final String TEXT_271 = NL + "            conf_";
  protected final String TEXT_272 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_273 = NL + "        \t\tconf_";
  protected final String TEXT_274 = ".set(";
  protected final String TEXT_275 = " ,";
  protected final String TEXT_276 = ");" + NL + "        \t";
  protected final String TEXT_277 = NL + "            username_";
  protected final String TEXT_278 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_279 = ".set(\"dfs.namenode.kerberos.principal\", ";
  ...
  protected final String TEXT_285 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_286 = "+\",\"+username_";
  protected final String TEXT_287 = ");" + NL + "        \tfs_";
  protected final String TEXT_288 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_291 = " == null || \"\".equals(username_";
  protected final String TEXT_292 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_293 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_294 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_295 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_296 = ".get(\"";
  protected final String TEXT_297 = "\")),conf_";
  protected final String TEXT_298 = ",username_";
  protected final String TEXT_299 = ");" + NL + "        \t}\t";
  protected final String TEXT_300 = NL + "                    String hdfsUserName_";
  protected final String TEXT_301 = " = (";
  protected final String TEXT_302 = " != null && !\"\".equals(";
  protected final String TEXT_303 = ")) ? ";
  protected final String TEXT_304 = " : System.getProperty(\"user.name\");" + NL + "                    String tezLibPath_";
  protected final String TEXT_305 = " = \"/tmp/\" + hdfsUserName_";
  protected final String TEXT_306 = " + \"/talend_tez_libs/";
  protected final String TEXT_307 = "\";";
  protected final String TEXT_308 = NL + "                    String tezLibPath_";
  protected final String TEXT_309 = " = ";
  protected final String TEXT_310 = ";";
  protected final String TEXT_311 = NL + "                fs_";
  protected final String TEXT_312 = ".mkdirs(new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_313 = "));";
  protected final String TEXT_314 = NL + "                String[] classPaths_";
  protected final String TEXT_315 = " = System.getProperty(\"java.class.path\").split(";
  protected final String TEXT_316 = "String.valueOf(globalMap.get(\"current_client_path_separator\"))";
  protected final String TEXT_317 = "System.getProperty(\"path.separator\")";
  protected final String TEXT_318 = ");" + NL + "                String tezLibLocalPath_";
  protected final String TEXT_319 = " = null;" + NL + "                for(String classPath_";
  protected final String TEXT_320 = " : classPaths_";
  protected final String TEXT_321 = "){";
  protected final String TEXT_322 = NL + "                        if(classPath_";
  protected final String TEXT_323 = ".endsWith(\"";
  protected final String TEXT_324 = "\")){" + NL + "                            org.apache.hadoop.fs.Path tezJarPath_";
  protected final String TEXT_325 = " = new org.apache.hadoop.fs.Path(tezLibPath_";
  protected final String TEXT_326 = " + \"/";
  protected final String TEXT_327 = "\");" + NL + "                            if(!fs_";
  protected final String TEXT_328 = ".exists(tezJarPath_";
  protected final String TEXT_329 = ")){" + NL + "                                fs_";
  protected final String TEXT_330 = ".copyFromLocalFile(false, false, new org.apache.hadoop.fs.Path(classPath_";
  protected final String TEXT_331 = "), tezJarPath_";
  protected final String TEXT_332 = ");" + NL + "                            }" + NL + "                        }";
  protected final String TEXT_333 = NL + "                }";
  protected final String TEXT_334 = NL + "                String tezLibPath_";
  protected final String TEXT_335 = " = ";
  protected final String TEXT_336 = ";";
  protected final String TEXT_337 = NL + "\t\t\tStringBuilder script_";
  protected final String TEXT_338 = " = new StringBuilder();" + NL + "\t\t\tString[] tezLibPaths_";
  protected final String TEXT_339 = " = tezLibPath_";
  protected final String TEXT_340 = ".split(\",\");" + NL + "\t\t\tscript_";
  protected final String TEXT_341 = ".append(\"SET tez.lib.uris=\");" + NL + "\t\t\tint tezLibPathCount_";
  protected final String TEXT_342 = " = 1;" + NL + "\t\t\tfor(String tezLibPathKey_";
  protected final String TEXT_343 = " : tezLibPaths_";
  protected final String TEXT_344 = "){" + NL + "\t\t\t\t script_";
  protected final String TEXT_345 = ".append(";
  protected final String TEXT_346 = " + \"/\" + tezLibPathKey_";
  protected final String TEXT_347 = ");" + NL + "\t\t\t\t if(tezLibPathCount_";
  protected final String TEXT_348 = " < tezLibPaths_";
  protected final String TEXT_349 = ".length){" + NL + "\t\t\t\t \tscript_";
  protected final String TEXT_350 = ".append(\",\");" + NL + "\t\t\t\t }" + NL + "\t\t\t\t tezLibPathCount_";
  protected final String TEXT_351 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tinit_";
  protected final String TEXT_352 = ".execute(script_";
  protected final String TEXT_353 = ".toString());" + NL + "\t\t";
  protected final String TEXT_354 = NL + "            \t";
  protected final String TEXT_355 = NL + NL + "\t\t\tinit_";
  protected final String TEXT_356 = ".close();" + NL + "" + NL + "        \tString dbname_";
  protected final String TEXT_357 = " = ";
  protected final String TEXT_358 = ";" + NL + "        \tif(dbname_";
  protected final String TEXT_359 = "!=null && !\"\".equals(dbname_";
  protected final String TEXT_360 = ".trim()) && !\"default\".equals(dbname_";
  protected final String TEXT_361 = ".trim())) {" + NL + "            \tjava.sql.Statement goToDatabase_";
  protected final String TEXT_362 = " = conn_";
  protected final String TEXT_363 = ".createStatement();" + NL + "            \tgoToDatabase_";
  protected final String TEXT_364 = ".execute(\"use \" + dbname_";
  protected final String TEXT_365 = ");" + NL + "            \tgoToDatabase_";
  protected final String TEXT_366 = ".close();" + NL + "        \t}";
  protected final String TEXT_367 = NL + "    \t\t\tjava.sql.Statement statement_";
  protected final String TEXT_368 = " = conn_";
  protected final String TEXT_369 = ".createStatement();" + NL + "        \t\t";
  protected final String TEXT_370 = NL + "        \t\t\tstatement_";
  protected final String TEXT_371 = ".execute(\"SET hbase.zookeeper.quorum=\"+";
  protected final String TEXT_372 = ");" + NL + "        \t\t";
  protected final String TEXT_373 = NL + NL + "        \t\t";
  protected final String TEXT_374 = NL + "        \t\t\tstatement_";
  protected final String TEXT_375 = ".execute(\"SET hbase.zookeeper.property.clientPort=\"+";
  protected final String TEXT_376 = ");" + NL + "        \t\t";
  protected final String TEXT_377 = NL + NL + "\t\t\t\t";
  protected final String TEXT_378 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_379 = ".execute(\"SET zookeeper.znode.parent=\"+";
  protected final String TEXT_380 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_381 = NL + NL + "\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_383 = ".execute(\"SET hbase.security.authentication=kerberos\");" + NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_384 = ".execute(\"SET hbase.rpc.engine=org.apache.hadoop.hbase.ipc.SecureRpcEngine\");" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_386 = ".execute(\"SET hbase.master.kerberos.principal=\"+";
  protected final String TEXT_387 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_388 = NL + "\t\t\t\t\t";
  protected final String TEXT_389 = NL + "\t\t\t\t\t\tstatement_";
  protected final String TEXT_390 = ".execute(\"SET hbase.regionserver.kerberos.principal=\"+";
  protected final String TEXT_391 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_392 = NL + "\t\t\t\t";
  protected final String TEXT_393 = NL + NL + "        \t\t";
  protected final String TEXT_394 = NL + "    \t\t\t\tstatement_";
  protected final String TEXT_395 = ".execute(\"add jar \"+";
  protected final String TEXT_396 = ");" + NL + "        \t\t";
  protected final String TEXT_397 = NL + "    \t\t\tstatement_";
  protected final String TEXT_398 = ".close();";
  protected final String TEXT_399 = NL + "\t\t\t\tSystem.setProperty(";
  protected final String TEXT_400 = " ,";
  protected final String TEXT_401 = ");";
  protected final String TEXT_402 = NL + "\t\t\t\tSystem.setProperty(\"mapred.job.tracker\", ";
  protected final String TEXT_403 = ");";
  protected final String TEXT_404 = NL + "\t\t\t\tSystem.setProperty(\"";
  protected final String TEXT_405 = "\", ";
  protected final String TEXT_406 = ");";
  protected final String TEXT_407 = NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.sasl.enabled\", \"true\");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionDriverName\", ";
  protected final String TEXT_408 = ");" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_409 = NL + "                    System.setProperty(\"hive.security.authorization.enabled\", \"false\");";
  protected final String TEXT_410 = NL + "                    System.setProperty(\"hive.security.authorization.enabled\", \"true\");";
  protected final String TEXT_411 = NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionURL\", ";
  protected final String TEXT_412 = ");" + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionUserName\", ";
  protected final String TEXT_413 = ");" + NL + "" + NL + "        \t\t";
  protected final String TEXT_414 = NL + NL + "        \t\t";
  protected final String TEXT_415 = NL + "            \tString decryptedMetastorePassword_";
  protected final String TEXT_416 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_417 = ");" + NL + "       \t\t \t";
  protected final String TEXT_418 = NL + "            \tString decryptedMetastorePassword_";
  protected final String TEXT_419 = " = ";
  protected final String TEXT_420 = ";" + NL + "    \t\t\t";
  protected final String TEXT_421 = NL + NL + "\t\t\t\tSystem.setProperty(\"javax.jdo.option.ConnectionPassword\", decryptedMetastorePassword_";
  protected final String TEXT_422 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.kerberos.principal\", ";
  protected final String TEXT_423 = ");";
  protected final String TEXT_424 = NL + "                \tSystem.setProperty(\"hive.server2.authentication.kerberos.principal\", ";
  protected final String TEXT_425 = ");" + NL + "               \t\tSystem.setProperty(\"hive.server2.authentication.kerberos.keytab\", ";
  protected final String TEXT_426 = ");";
  protected final String TEXT_427 = NL + "\t\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_428 = ", ";
  protected final String TEXT_429 = ");";
  protected final String TEXT_430 = NL + "\t            String username_";
  protected final String TEXT_431 = " = ";
  protected final String TEXT_432 = ";" + NL + "\t            if(username_";
  protected final String TEXT_433 = "!=null && !\"\".equals(username_";
  protected final String TEXT_434 = ".trim())) {" + NL + "\t                System.setProperty(\"HADOOP_USER_NAME\",username_";
  protected final String TEXT_435 = ");" + NL + "\t            }" + NL + "\t            ";
  protected final String TEXT_436 = NL + "\t\t\tglobalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_437 = "\", System.getProperty(\"HADOOP_USER_NAME\"));";
  protected final String TEXT_438 = NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.local\", \"false\");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.uris\", \"thrift://\" + ";
  protected final String TEXT_439 = " + \":\" + ";
  protected final String TEXT_440 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.execute.setugi\", \"true\");" + NL + "\t\t\t\tString url_";
  protected final String TEXT_441 = " = \"jdbc:";
  protected final String TEXT_442 = "://\";";
  protected final String TEXT_443 = NL + "    \t\t\t\tif(dbUser_";
  protected final String TEXT_444 = "!=null && !\"\".equals(dbUser_";
  protected final String TEXT_445 = ".trim())) {" + NL + "    \t\t\t\t\tSystem.setProperty(\"HADOOP_USER_NAME\",dbUser_";
  protected final String TEXT_446 = ");" + NL + "    \t\t\t\t\t//make relative file path work for hive" + NL + "    \t\t\t\t\tglobalMap.put(\"current_client_user_name\", System.getProperty(\"user.name\"));" + NL + "    \t\t\t\t\tSystem.setProperty(\"user.name\",dbUser_";
  protected final String TEXT_447 = ");" + NL + "    \t\t\t\t}";
  protected final String TEXT_448 = NL + "\t\t\t            System.setProperty(\"pname\", \"MapRLogin\");" + NL + "\t\t\t            System.setProperty(\"https.protocols\", \"TLSv1.2\");" + NL + "\t\t\t            System.setProperty(\"mapr.home.dir\", ";
  protected final String TEXT_449 = ");" + NL + "\t\t\t            System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_450 = ");" + NL + "\t\t\t            ";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_452 = ", ";
  protected final String TEXT_453 = ");";
  protected final String TEXT_454 = NL + "\t\t\t            com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_455 = " = new com.mapr.login.client.MapRLoginHttpsClient();" + NL + "\t\t\t            maprLogin_";
  protected final String TEXT_456 = ".getMapRCredentialsViaKerberos(";
  protected final String TEXT_457 = ", ";
  protected final String TEXT_458 = ");" + NL + "\t\t\t            ";
  protected final String TEXT_459 = NL + "\t\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_460 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_461 = ");";
  protected final String TEXT_462 = NL + "\t\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  ...
  protected final String TEXT_471 = "+\";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_472 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  protected final String TEXT_473 = ";";
  protected final String TEXT_474 = NL + "\t\t\t\t\t\t\tString url_";
  protected final String TEXT_475 = " = \"jdbc:";
  protected final String TEXT_476 = "://\" + ";
  protected final String TEXT_477 = " + \":\" + ";
  protected final String TEXT_478 = " + \"/\" + ";
  protected final String TEXT_479 = " + \";principal=\" + ";
  protected final String TEXT_480 = "+\";sasl.qop=auth-conf\";";
  protected final String TEXT_481 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_482 = " = \"jdbc:";
  protected final String TEXT_483 = "://\" + ";
  protected final String TEXT_484 = " + \":\" + ";
  protected final String TEXT_485 = " + \"/\" + ";
  protected final String TEXT_486 = " + \";principal=\" + ";
  protected final String TEXT_487 = ";";
  protected final String TEXT_488 = NL + "                        System.setProperty(\"pname\", \"MapRLogin\");" + NL + "                        System.setProperty(\"https.protocols\", \"TLSv1.2\");" + NL + "                        System.setProperty(\"mapr.home.dir\", ";
  protected final String TEXT_489 = ");" + NL + "                        com.mapr.login.client.MapRLoginHttpsClient maprLogin_";
  protected final String TEXT_490 = " = new com.mapr.login.client.MapRLoginHttpsClient();";
  protected final String TEXT_491 = NL + "                            System.setProperty(\"hadoop.login\", ";
  protected final String TEXT_492 = ");";
  protected final String TEXT_493 = NL + "                            maprLogin_";
  protected final String TEXT_494 = ".setCheckUGI(false);";
  protected final String TEXT_495 = NL + "                            String decryptedMaprPassword_";
  protected final String TEXT_496 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_497 = ");";
  protected final String TEXT_498 = NL + "                            String decryptedMaprPassword_";
  protected final String TEXT_499 = " = ";
  protected final String TEXT_500 = ";";
  protected final String TEXT_501 = NL + "                        maprLogin_";
  protected final String TEXT_502 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_503 = ", ";
  protected final String TEXT_504 = ", decryptedMaprPassword_";
  protected final String TEXT_505 = ", ";
  protected final String TEXT_506 = ");";
  protected final String TEXT_507 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_508 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_509 = ");";
  protected final String TEXT_510 = NL + "\t\t\t\t\t\t\tString decryptedSslStorePassword_";
  protected final String TEXT_511 = " = ";
  protected final String TEXT_512 = ";";
  protected final String TEXT_513 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_514 = " = \"jdbc:";
  protected final String TEXT_515 = "://\" + ";
  protected final String TEXT_516 = " + \":\" + ";
  protected final String TEXT_517 = " + \"/\" + ";
  protected final String TEXT_518 = "+ \";ssl=true\" +\";sslTrustStore=\" + ";
  protected final String TEXT_519 = " + \";trustStorePassword=\" + decryptedSslStorePassword_";
  protected final String TEXT_520 = ";";
  protected final String TEXT_521 = NL + "\t\t\t\t\t\tString url_";
  protected final String TEXT_522 = " = \"jdbc:";
  protected final String TEXT_523 = "://\" + ";
  protected final String TEXT_524 = " + \":\" + ";
  protected final String TEXT_525 = " + \"/\" + ";
  protected final String TEXT_526 = ";";
  protected final String TEXT_527 = NL + "\t\t\t\tString additionalJdbcSettings_";
  protected final String TEXT_528 = " = ";
  protected final String TEXT_529 = ";" + NL + "\t\t\t\tif(!\"\".equals(additionalJdbcSettings_";
  protected final String TEXT_530 = ".trim())) {" + NL + "\t\t\t\t\tif(!additionalJdbcSettings_";
  protected final String TEXT_531 = ".startsWith(\";\")) {" + NL + "\t\t\t\t\t\tadditionalJdbcSettings_";
  protected final String TEXT_532 = " = \";\" + additionalJdbcSettings_";
  protected final String TEXT_533 = ";" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\turl_";
  protected final String TEXT_534 = " += additionalJdbcSettings_";
  protected final String TEXT_535 = ";" + NL + "\t\t\t\t}";
  protected final String TEXT_536 = NL + "\t\t\t\tif(true) {" + NL + "\t\t\t\t\tthrow new java.lang.UnsupportedOperationException(\"Parquet is only supported if the distribution uses embedded Hive version 0.10 or later.\");" + NL + "\t\t\t\t}";
  protected final String TEXT_537 = NL + "\t\t\t\t\troutines.system.GetJarsToRegister getJarsToRegister_";
  protected final String TEXT_538 = " = new routines.system.GetJarsToRegister();";
  protected final String TEXT_539 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_540 = NL + "\tclass GetHiveJarsToRegister_";
  protected final String TEXT_541 = " extends routines.system.GetJarsToRegister {" + NL + "\t\t" + NL + "\t\tprivate String uploadJarToHDFS(String jar) throws Exception {" + NL + "\t\t\t";
  protected final String TEXT_542 = NL;
  protected final String TEXT_543 = NL + "        String username_";
  protected final String TEXT_544 = " = (";
  protected final String TEXT_545 = " != null && !\"\".equals(";
  protected final String TEXT_546 = ")) ? ";
  protected final String TEXT_547 = " : System.getProperty(\"user.name\");;" + NL + "        org.apache.hadoop.fs.FileSystem fs_";
  protected final String TEXT_548 = " = null;";
  protected final String TEXT_549 = NL + "        org.apache.hadoop.conf.Configuration conf_";
  protected final String TEXT_550 = " = new org.apache.hadoop.conf.Configuration(); " + NL + "        conf_";
  protected final String TEXT_551 = ".set(\"";
  protected final String TEXT_552 = "\", ";
  protected final String TEXT_553 = ");" + NL + "        ";
  protected final String TEXT_554 = NL + "            conf_";
  protected final String TEXT_555 = ".set(\"dfs.client.use.datanode.hostname\", \"true\");";
  protected final String TEXT_556 = NL + "        \t\tconf_";
  protected final String TEXT_557 = ".set(";
  protected final String TEXT_558 = " ,";
  protected final String TEXT_559 = ");" + NL + "        \t";
  protected final String TEXT_560 = NL + "            username_";
  protected final String TEXT_561 = " = null;" + NL + "    \t\tconf_";
  protected final String TEXT_562 = ".set(\"dfs.namenode.kerberos.principal\", ";
  protected final String TEXT_563 = ");" + NL + "    \t\t";
  protected final String TEXT_564 = NL + "    \t\t\torg.apache.hadoop.security.UserGroupInformation.loginUserFromKeytab(";
  protected final String TEXT_565 = ", ";
  protected final String TEXT_566 = ");" + NL + "    \t\t";
  protected final String TEXT_567 = NL + "\t\t\tconf_";
  protected final String TEXT_568 = ".set(\"hadoop.job.ugi\",username_";
  protected final String TEXT_569 = "+\",\"+username_";
  protected final String TEXT_570 = ");" + NL + "        \tfs_";
  protected final String TEXT_571 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_572 = ");";
  protected final String TEXT_573 = NL + "        \t" + NL + "        \tif(username_";
  protected final String TEXT_574 = " == null || \"\".equals(username_";
  protected final String TEXT_575 = ")){" + NL + "        \t\tfs_";
  protected final String TEXT_576 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_577 = ");" + NL + "        \t}else{" + NL + "        \t\tfs_";
  protected final String TEXT_578 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_579 = ".get(\"";
  protected final String TEXT_580 = "\")),conf_";
  protected final String TEXT_581 = ",username_";
  protected final String TEXT_582 = ");" + NL + "        \t}\t";
  protected final String TEXT_583 = NL + "\t\t\t";
  protected final String TEXT_584 = NL + "\t\t\t" + NL + "\t\t\tString pathUsername_";
  protected final String TEXT_585 = " = username_";
  protected final String TEXT_586 = " == null ? org.apache.hadoop.security.UserGroupInformation.getLoginUser().getShortUserName() : username_";
  protected final String TEXT_587 = ";" + NL + "\t\t\tfs_";
  protected final String TEXT_588 = ".mkdirs(new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_589 = " + \"/tmp\"), new org.apache.hadoop.fs.permission.FsPermission(org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL, org.apache.hadoop.fs.permission.FsAction.ALL));" + NL + "\t\t\tfs_";
  protected final String TEXT_590 = ".copyFromLocalFile(false, true, new org.apache.hadoop.fs.Path(jar), new org.apache.hadoop.fs.Path(\"/user/\" + pathUsername_";
  protected final String TEXT_591 = " + \"/tmp\"));" + NL + "\t\t\treturn ";
  protected final String TEXT_592 = " + \"/user/\" + pathUsername_";
  protected final String TEXT_593 = " + \"/tmp/\" + new java.io.File(jar).getName();" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tpublic String replaceJarPaths(String originalClassPathLine) throws Exception {" + NL + "\t\t\tString classPathLine = super.replaceJarPaths(originalClassPathLine);" + NL + "\t\t\tString hdfsPath = uploadJarToHDFS(classPathLine);" + NL + "\t\t\treturn hdfsPath;" + NL + "\t\t}" + NL + "\t}" + NL + "\t\t\t\t\t\tGetHiveJarsToRegister_";
  protected final String TEXT_594 = " getJarsToRegister_";
  protected final String TEXT_595 = " = new GetHiveJarsToRegister_";
  protected final String TEXT_596 = "();";
  protected final String TEXT_597 = NL + "\t\t\t\t\tjava.sql.Statement addJar_";
  protected final String TEXT_598 = " = null;";
  protected final String TEXT_599 = NL + "\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_600 = " = conn_";
  protected final String TEXT_601 = ".createStatement();" + NL + "\t\t\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_602 = ".execute(\"add jar \" + getJarsToRegister_";
  protected final String TEXT_603 = ".replaceJarPaths(\"";
  protected final String TEXT_604 = "\"));" + NL + "\t\t\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t\t\t} finally {" + NL + "\t\t\t\t\t\t\t\t\taddJar_";
  protected final String TEXT_605 = ".close();" + NL + "\t\t\t\t\t\t\t\t}";
  protected final String TEXT_606 = NL + "\tSystem.setProperty(\"org.apache.commons.logging.Log\", \"org.apache.commons.logging.impl.NoOpLog\");";
  protected final String TEXT_607 = NL + "\t\tSystem.setProperty(\"java.io.tmpdir\", ";
  protected final String TEXT_608 = ");";
  protected final String TEXT_609 = NL + "\tglobalMap.put(\"current_client_path_separator\", System.getProperty(\"path.separator\"));" + NL + "\tSystem.setProperty(\"path.separator\", ";
  protected final String TEXT_610 = ");" + NL + "" + NL + "\t";
  protected final String TEXT_611 = NL + "\t\t    int nb_line_";
  protected final String TEXT_612 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_613 = " = null;";
  protected final String TEXT_614 = NL + "\t\t        conn_";
  protected final String TEXT_615 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_616 = "\");";
  protected final String TEXT_617 = NL + "\t\t        \tif (null == conn_";
  protected final String TEXT_618 = ") {" + NL + "\t\t\t\t\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_619 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\t\tconn_";
  protected final String TEXT_620 = " = dataSources_";
  protected final String TEXT_621 = ".get(";
  protected final String TEXT_622 = ").getConnection();" + NL + "\t\t\t\t\t\t//globalMap.put(\"";
  ...
  protected final String TEXT_627 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_628 = " =  conn_";
  protected final String TEXT_629 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_630 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_631 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_632 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_633 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_634 = NL + "                 conn_";
  protected final String TEXT_635 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_636 = NL + "               ";
  protected final String TEXT_637 = " + \"=\" + ";
  protected final String TEXT_638 = " + \";\" +";
  protected final String TEXT_639 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_640 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_641 = ");";
  protected final String TEXT_642 = NL + "\t\t    ";
  protected final String TEXT_643 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_644 = " = ";
  protected final String TEXT_645 = ";" + NL + "\t\t\t";
  protected final String TEXT_646 = NL + "                log.debug(\"";
  protected final String TEXT_647 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_648 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_649 = NL;
  protected final String TEXT_650 = NL + "                       globalMap.put(\"";
  protected final String TEXT_651 = "_QUERY\",dbquery_";
  protected final String TEXT_652 = ");";
  protected final String TEXT_653 = NL + "                       globalMap.put(\"";
  protected final String TEXT_654 = "_QUERY\",dbquery_";
  protected final String TEXT_655 = ");";
  protected final String TEXT_656 = NL + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_657 = " = null;" + NL + "\t\ttry{" + NL + "\t\t    rs_";
  protected final String TEXT_658 = " = stmt_";
  protected final String TEXT_659 = ".executeQuery(dbquery_";
  protected final String TEXT_660 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_661 = " = rs_";
  protected final String TEXT_662 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_663 = " = rsmd_";
  protected final String TEXT_664 = ".getColumnCount();" + NL;
  protected final String TEXT_665 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_666 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_667 = ".setDbmsId(\"";
  protected final String TEXT_668 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_669 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_670 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_671 = ".add(\"";
  protected final String TEXT_672 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_673 = NL + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_674 = " = ";
  protected final String TEXT_675 = ";" + NL + "" + NL + "            for (int i = ";
  protected final String TEXT_676 = "; i <= rsmd_";
  protected final String TEXT_677 = ".getColumnCount()-";
  protected final String TEXT_678 = "; i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_679 = ".contains(rsmd_";
  protected final String TEXT_680 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_681 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_682 = ".setName(rsmd_";
  protected final String TEXT_683 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  protected final String TEXT_684 = ".setDbName(rsmd_";
  protected final String TEXT_685 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_686 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_687 = "\", rsmd_";
  protected final String TEXT_688 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_689 = ".getPrecision(i), rsmd_";
  protected final String TEXT_690 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_691 = ".setDbType(rsmd_";
  protected final String TEXT_692 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_693 = ".setDbTypeId(rsmd_";
  protected final String TEXT_694 = ".getColumnType(i));";
  protected final String TEXT_695 = NL + "                \tdcm_";
  protected final String TEXT_696 = ".setFormat(";
  protected final String TEXT_697 = ");";
  protected final String TEXT_698 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_699 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_700 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_701 = ".setLength(rsmd_";
  protected final String TEXT_702 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_703 = ".setLength(rsmd_";
  protected final String TEXT_704 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_705 = NL + "\t\t\tdcm_";
  protected final String TEXT_706 = ".setLength(rsmd_";
  protected final String TEXT_707 = ".getPrecision(i));";
  protected final String TEXT_708 = NL + "                \tdcm_";
  protected final String TEXT_709 = ".setPrecision(rsmd_";
  protected final String TEXT_710 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_711 = ".setNullable(rsmd_";
  protected final String TEXT_712 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_713 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_714 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_715 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_716 = ".metadatas.add(dcm_";
  protected final String TEXT_717 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_718 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_719 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_720 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_721 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_722 = NL + "\t\t    ";
  protected final String TEXT_723 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_724 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_725 = NL + "\t\t    while (rs_";
  protected final String TEXT_726 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_727 = "++;" + NL + "\t\t        ";
  protected final String TEXT_728 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_729 = " = ";
  protected final String TEXT_730 = " + dcg_";
  protected final String TEXT_731 = ".getColumnCount();" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_732 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  protected final String TEXT_733 = " = ";
  protected final String TEXT_734 = ";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_735 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_736 = NL + "\t\t\t\t\t\t\tif(colQtyInRs_";
  protected final String TEXT_737 = " < ";
  protected final String TEXT_738 = "column_index_";
  protected final String TEXT_739 = ") {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_740 = ".";
  protected final String TEXT_741 = " = ";
  protected final String TEXT_742 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  ...
  protected final String TEXT_748 = " = (List)rs_";
  protected final String TEXT_749 = ".getObject(";
  protected final String TEXT_750 = "column_index_";
  protected final String TEXT_751 = ");";
  protected final String TEXT_752 = NL + "\t                         \t\t";
  protected final String TEXT_753 = NL + "\t                         \t\t";
  protected final String TEXT_754 = NL + "\t                         \t\t";
  protected final String TEXT_755 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_756 = ".getObject(";
  protected final String TEXT_757 = "column_index_";
  protected final String TEXT_758 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_759 = NL + "                                    ";
  protected final String TEXT_760 = ".";
  protected final String TEXT_761 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  protected final String TEXT_762 = NL + "                                      ";
  protected final String TEXT_763 = ".";
  protected final String TEXT_764 = " = null;" + NL + "                                    }";
  protected final String TEXT_765 = NL + "                                        if (";
  protected final String TEXT_766 = ".";
  protected final String TEXT_767 = " != null) {";
  protected final String TEXT_768 = NL + "                                        ";
  protected final String TEXT_769 = ".";
  protected final String TEXT_770 = ".setEPSG(";
  protected final String TEXT_771 = ");" + NL + "                                        }";
  protected final String TEXT_772 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_773 = NL + "                                  ";
  protected final String TEXT_774 = ".";
  protected final String TEXT_775 = "=dcg_";
  protected final String TEXT_776 = ";";
  protected final String TEXT_777 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_778 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_779 = " = ";
  protected final String TEXT_780 = "; i_";
  protected final String TEXT_781 = "  <= rsmd_";
  protected final String TEXT_782 = ".getColumnCount(); i_";
  protected final String TEXT_783 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_784 = ".getColumnTypeName(i_";
  protected final String TEXT_785 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_786 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_787 = ".getClob(i_";
  protected final String TEXT_788 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_789 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_790 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_791 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_792 = ".add(tNTextImpl_";
  protected final String TEXT_793 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_794 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_795 = ".";
  protected final String TEXT_796 = ", rs_";
  protected final String TEXT_797 = ", fixedColumnCount_";
  protected final String TEXT_798 = ",list_";
  protected final String TEXT_799 = ",";
  protected final String TEXT_800 = ");";
  protected final String TEXT_801 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_802 = ".";
  protected final String TEXT_803 = ", rs_";
  protected final String TEXT_804 = ", fixedColumnCount_";
  protected final String TEXT_805 = ",";
  protected final String TEXT_806 = ");";
  protected final String TEXT_807 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_808 = ".";
  protected final String TEXT_809 = ", rs_";
  protected final String TEXT_810 = ", fixedColumnCount_";
  protected final String TEXT_811 = ",";
  protected final String TEXT_812 = ");";
  protected final String TEXT_813 = NL + "                                  Object geom = rs_";
  protected final String TEXT_814 = ".getObject(";
  protected final String TEXT_815 = "column_index_";
  protected final String TEXT_816 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_817 = ".";
  protected final String TEXT_818 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  ...
  protected final String TEXT_824 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_825 = " - Retrieving the record \" + nb_line_";
