...
public class TJDBCOutputSparkcodeJava {
  protected static String nl;
  public static synchronized TJDBCOutputSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputSparkcodeJava result = new TJDBCOutputSparkcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = "_OutputFunction implements org.apache.spark.api.java.function.VoidFunction<java.util.Iterator<";
  protected final String TEXT_4 = ">> {" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_5 = NL;
  protected final String TEXT_6 = NL + "\t\tint batchSize = -1;" + NL + "\t\tint batchSizeCounter = 0;";
  protected final String TEXT_7 = NL + NL + "\t\t\tContextProperties context;" + NL + "" + NL + "\t\t\tpublic ";
  protected final String TEXT_8 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    this(new ContextProperties(conf));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic ";
  protected final String TEXT_9 = "_OutputFunction(ContextProperties context) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    Class.forName(";
  protected final String TEXT_10 = ");" + NL + "\t\t\t    this.context = context;" + NL + "\t\t\t    ";
  protected final String TEXT_11 = NL;
  protected final String TEXT_12 = NL + "\t\tbatchSize = ";
  protected final String TEXT_13 = ";";
  protected final String TEXT_14 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\tpublic void call(java.util.Iterator<";
  protected final String TEXT_15 = "> dataIterator) throws java.lang.Exception {" + NL + "\t\t\t\tjava.sql.Connection connection = ";
  protected final String TEXT_16 = ".get(context).borrowObject();" + NL + "\t\t\t\ttry {\t\t ";
  protected final String TEXT_17 = NL + "\t\t\t\t\t";
  protected final String TEXT_18 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_19 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_20 = "\" + ";
  protected final String TEXT_21 = " + \"";
  protected final String TEXT_22 = " (";
  protected final String TEXT_23 = ") VALUES(";
  protected final String TEXT_24 = ")\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_25 = " ";
  protected final String TEXT_26 = " = dataIterator.next();";
  protected final String TEXT_27 = NL + "\t\t\t";
  protected final String TEXT_28 = NL + "\t";
  protected final String TEXT_29 = NL;
  protected final String TEXT_30 = NL + "\tpstmt_";
  protected final String TEXT_31 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_32 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_36 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_37 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_38 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_39 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_40 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_41 = NL + "\t}             ";
  protected final String TEXT_42 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_43 = NL;
  protected final String TEXT_44 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_45 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_46 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_47 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_48 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_49 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_50 = NL + NL + "pstmt_";
  protected final String TEXT_51 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_52 = NL + "\t\t\t\t\t";
  protected final String TEXT_53 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_54 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_55 = "\" + ";
  protected final String TEXT_56 = " + \"";
  protected final String TEXT_57 = " SET ";
  protected final String TEXT_58 = " WHERE ";
  protected final String TEXT_59 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_60 = " ";
  protected final String TEXT_61 = " = dataIterator.next();";
  protected final String TEXT_62 = NL + "\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t";
  protected final String TEXT_65 = NL;
  protected final String TEXT_66 = NL + "\tpstmt_";
  protected final String TEXT_67 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_68 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_72 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_73 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_74 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_75 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_76 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_77 = NL + "\t}             ";
  protected final String TEXT_78 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_79 = NL;
  protected final String TEXT_80 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_81 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_82 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_83 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_84 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_85 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_86 = NL + NL + "pstmt_";
  protected final String TEXT_87 = ".close();";
  protected final String TEXT_88 = NL + "\t\t\t\t\t";
  protected final String TEXT_89 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_90 = " = connection.prepareStatement(\"SELECT COUNT(1) FROM ";
  protected final String TEXT_91 = "\" + ";
  protected final String TEXT_92 = " + \"";
  protected final String TEXT_93 = " WHERE ";
  protected final String TEXT_94 = "\");" + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_95 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_101 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_102 = "\" + ";
  protected final String TEXT_103 = " +\"";
  protected final String TEXT_104 = " SET ";
  protected final String TEXT_105 = " WHERE ";
  protected final String TEXT_106 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_107 = " ";
  protected final String TEXT_108 = " = dataIterator.next();";
  protected final String TEXT_109 = NL + "\t\t\t";
  protected final String TEXT_110 = NL + "\tjava.sql.ResultSet rs_";
  protected final String TEXT_111 = " = pstmt_";
  protected final String TEXT_112 = ".executeQuery();" + NL + "\tint checkCount_";
  protected final String TEXT_113 = " = -1;" + NL + "\t" + NL + "\twhile(rs_";
  protected final String TEXT_114 = ".next()) {" + NL + "\t\tcheckCount_";
  protected final String TEXT_115 = " = rs_";
  protected final String TEXT_116 = ".getInt(1);" + NL + "\t}" + NL + "\t" + NL + "\tif(checkCount_";
  protected final String TEXT_117 = " > 0) {";
  protected final String TEXT_118 = NL + "\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t pstmtUpdate_";
  protected final String TEXT_121 = ".executeUpdate();" + NL + "\t} else {";
  protected final String TEXT_122 = NL + "\t\t\t\t";
  protected final String TEXT_123 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_124 = ".executeUpdate();" + NL + "\t}\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmt_";
  protected final String TEXT_125 = ".close();" + NL + "pstmtInsert_";
  protected final String TEXT_126 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_127 = ".close();";
  protected final String TEXT_128 = NL + "\t\t\t\t\t";
  protected final String TEXT_129 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_130 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_136 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_137 = "\" + ";
  protected final String TEXT_138 = " +\"";
  protected final String TEXT_139 = " SET ";
  protected final String TEXT_140 = " WHERE ";
  protected final String TEXT_141 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_142 = " ";
  protected final String TEXT_143 = " = dataIterator.next();";
  protected final String TEXT_144 = NL + "\t\t\t";
  protected final String TEXT_145 = NL + "\t\t\t";
  protected final String TEXT_146 = NL + "\tint updateFlag_";
  protected final String TEXT_147 = " = pstmtUpdate_";
  protected final String TEXT_148 = ".executeUpdate();" + NL + "\t" + NL + "\tif(updateFlag_";
  protected final String TEXT_149 = " == 0) {";
  protected final String TEXT_150 = NL + "\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_152 = ".executeUpdate();" + NL + "\t}" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_153 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_154 = ".close();";
  protected final String TEXT_155 = NL + "\t\t\t\t\t";
  protected final String TEXT_156 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_157 = " = connection.prepareStatement(\"DELETE FROM ";
  protected final String TEXT_158 = "\" + ";
  protected final String TEXT_159 = " + \"";
  protected final String TEXT_160 = " WHERE ";
  protected final String TEXT_161 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_162 = " ";
  protected final String TEXT_163 = " = dataIterator.next();";
  protected final String TEXT_164 = NL + "\t\t\t";
  protected final String TEXT_165 = NL + "\t";
  protected final String TEXT_166 = NL;
  protected final String TEXT_167 = NL + "\tpstmt_";
  protected final String TEXT_168 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_169 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_173 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_174 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_175 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_176 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_177 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_178 = NL + "\t}             ";
  protected final String TEXT_179 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_180 = NL;
  protected final String TEXT_181 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_182 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_183 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_184 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_185 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_186 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_187 = NL + NL + "pstmt_";
  protected final String TEXT_188 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_189 = NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\tif(connection != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_190 = ".get(context).returnObject(connection);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} // end call()" + NL + "\t\t} // end class" + NL;
  protected final String TEXT_191 = NL + "\t\t\t";
  protected final String TEXT_192 = NL + NL + "public static class ";
  protected final String TEXT_193 = " {" + NL + "\tprivate static volatile org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_194 = "> pool;" + NL + "\t" + NL + "\tprivate ";
  protected final String TEXT_195 = "() {" + NL + "\t    // empty" + NL + "\t}" + NL + "" + NL + "\tpublic static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_196 = "> get(ContextProperties context) {" + NL + "\t\tif(pool == null) {" + NL + "\t\t\tsynchronized(";
  protected final String TEXT_197 = ".class) {" + NL + "\t\t\t\tif(pool == null) {" + NL + "\t\t\t\t\tpool = createPool(context);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t   return pool;" + NL + "\t}" + NL + "" + NL + "\tprivate static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_198 = "> createPool(ContextProperties context) {" + NL + "\t    org.apache.commons.pool2.impl.GenericObjectPoolConfig config = new org.apache.commons.pool2.impl.GenericObjectPoolConfig();" + NL + "\t    config.setMaxTotal(";
  protected final String TEXT_199 = ");" + NL + "\t    config.setMaxWaitMillis(";
  protected final String TEXT_200 = ");" + NL + "\t    config.setMinIdle(";
  protected final String TEXT_201 = ");" + NL + "\t    config.setMaxIdle(";
  protected final String TEXT_202 = ");" + NL + "\t    config.setBlockWhenExhausted(true);";
  protected final String TEXT_203 = NL + "\t\t\tconfig.setTimeBetweenEvictionRunsMillis(";
  protected final String TEXT_204 = ");" + NL + "\t\t\tconfig.setMinEvictableIdleTimeMillis(";
  protected final String TEXT_205 = ");" + NL + "\t\t\tconfig.setSoftMinEvictableIdleTimeMillis(";
  protected final String TEXT_206 = ");";
  protected final String TEXT_207 = NL + "\t    return new org.apache.commons.pool2.impl.GenericObjectPool<";
  protected final String TEXT_208 = ">(new ";
  protected final String TEXT_209 = "(context), config);" + NL + "\t}" + NL + "}" + NL + "\t\t\t";
  protected final String TEXT_210 = NL + NL + "public static class ";
  protected final String TEXT_211 = " extends org.apache.commons.pool2.BasePooledObjectFactory<";
  protected final String TEXT_212 = "> {" + NL + "" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_213 = "(ContextProperties context) {" + NL + "\t\tthis.context = context;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_214 = " create() throws Exception {" + NL + "\t   Class.forName(";
  protected final String TEXT_215 = ");" + NL + "\t\tjava.util.Properties jdbcDriverProperties = new java.util.Properties();" + NL + "\t\tString jdbcAdditionalParameters = ";
  protected final String TEXT_216 = ";" + NL + "\t\tif(jdbcAdditionalParameters != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters) && !\"\".equals(jdbcAdditionalParameters)){" + NL + "\t\t\tjdbcDriverProperties.load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters.replace(";
  protected final String TEXT_217 = ", \"\\n\").getBytes()));" + NL + "\t\t}" + NL + "\t\tif(";
  protected final String TEXT_218 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_219 = ") && !\"\".equals(";
  protected final String TEXT_220 = ")){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"user\", ";
  protected final String TEXT_221 = ");" + NL + "\t\t}" + NL + "\t\tString password = ";
  protected final String TEXT_222 = " ;" + NL + "\t\tif(password != null && !\"\\\"\\\"\".equals(password) && !\"\".equals(password)){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"password\", password);" + NL + "\t\t}" + NL + "\t   return java.sql.DriverManager.getConnection(";
  protected final String TEXT_223 = ", jdbcDriverProperties);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_224 = "> wrap(";
  protected final String TEXT_225 = " connection) {" + NL + "\t   return new org.apache.commons.pool2.impl.DefaultPooledObject<";
  protected final String TEXT_226 = ">(connection);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void destroyObject(org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_227 = "> pooledObject) throws Exception {" + NL + "\t\tif (pooledObject != null) {" + NL + "\t\t    pooledObject.getObject().close();" + NL + "\t\t}" + NL + "\t\tsuper.destroyObject(pooledObject);" + NL + "\t}" + NL + "}";
  protected final String TEXT_228 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_229 = " code : ";
