...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_433 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_487 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_488 = " + \"\\\" WHERE ";
  protected final String TEXT_489 = "\");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_490 = " = conn_";
  protected final String TEXT_491 = ".prepareStatement(insert_";
  protected final String TEXT_492 = ");" + NL + "\t    pstmtUpdate_";
  ...
  protected final String TEXT_540 = ");" + NL + "\t    pstmtInsert_";
  ...
  protected final String TEXT_556 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  ...
  protected final String TEXT_562 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_563 = " = insert_";
  protected final String TEXT_564 = ".split(\"\\\\?\");";
  protected final String TEXT_565 = NL + "\t\t\tdelete_";
  protected final String TEXT_566 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_567 = " = delete_";
  protected final String TEXT_568 = ".split(\"\\\\?\");";
  protected final String TEXT_569 = NL + "\t\t\treplace_";
  protected final String TEXT_570 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_571 = " = replace_";
  protected final String TEXT_572 = ".split(\"\\\\?\");";
  protected final String TEXT_573 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_574 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_575 = " = insertIgnore_";
  protected final String TEXT_576 = ".split(\"\\\\?\");";
  protected final String TEXT_577 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_578 = " = insert_";
  protected final String TEXT_579 = ".split(\"\\\\?\");";
  protected final String TEXT_580 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_581 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_582 = " = buffersSize_";
  protected final String TEXT_583 = ";";
  protected final String TEXT_584 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_585 = " = buffersSize_";
  protected final String TEXT_586 = ";";
  protected final String TEXT_587 = NL + "        whetherReject_";
  protected final String TEXT_588 = " = false;";
  protected final String TEXT_589 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_590 = ".setInsert_";
  protected final String TEXT_591 = "(";
  protected final String TEXT_592 = ",pstmt_";
  protected final String TEXT_593 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_594 = ",query_";
  protected final String TEXT_595 = ",insertSQLSplits_";
  ...
  protected final String TEXT_622 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_623 = " = insertedCount_";
  protected final String TEXT_624 = " + pstmt_";
  protected final String TEXT_625 = ".executeUpdate();";
  protected final String TEXT_626 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_632 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_633 = ".assign_";
  ...
  protected final String TEXT_651 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_652 = NL + "            }";
  protected final String TEXT_653 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_654 = ".setUpdate_";
  protected final String TEXT_655 = "(";
  protected final String TEXT_656 = ",pstmt_";
  protected final String TEXT_657 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_658 = ",query_";
  protected final String TEXT_659 = ",updateSQLSplits_";
  ...
  protected final String TEXT_665 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_666 = ",";
  protected final String TEXT_667 = ".";
  protected final String TEXT_668 = ", ";
  protected final String TEXT_669 = ",updateSQLSplits_";
  protected final String TEXT_670 = ");";
  protected final String TEXT_671 = NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_695 = NL + "        \t\tpstmt_";
  protected final String TEXT_696 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_697 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_698 = NL + "    \t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_699 = "++;" + NL + "    \t\t";
  protected final String TEXT_700 = NL + "            try {" + NL + "                nb_line_";
  ...
  protected final String TEXT_704 = ".executeUpdate();";
  protected final String TEXT_705 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_711 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_712 = ".assign_";
  protected final String TEXT_713 = "_";
  ...
  protected final String TEXT_735 = NL + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_736 = " = pstmt_";
  protected final String TEXT_737 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_738 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_739 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_740 = " = rs_";
  protected final String TEXT_741 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_742 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_743 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_744 = ".setUpdate_";
  protected final String TEXT_745 = "(";
  protected final String TEXT_746 = ",pstmtUpdate_";
  protected final String TEXT_747 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_748 = ",query_";
  protected final String TEXT_749 = ",updateSQLSplits_";
  ...
  protected final String TEXT_783 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_784 = " = updatedCount_";
  protected final String TEXT_785 = " + pstmtUpdate_";
  ...
  protected final String TEXT_796 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_797 = ".assign_";
  protected final String TEXT_798 = "_";
  ...
  protected final String TEXT_817 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_818 = ".setInsert_";
  protected final String TEXT_819 = "(";
  protected final String TEXT_820 = ",pstmtInsert_";
  protected final String TEXT_821 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_822 = ",query_";
  ...
  protected final String TEXT_832 = ",insertSQLSplits_";
  ...
  protected final String TEXT_846 = ".executeUpdate();" + NL + "                    nb_line_";
  ...
  protected final String TEXT_855 = "Struct();";
  protected final String TEXT_856 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_857 = ".assign_";
  ...
  protected final String TEXT_871 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_872 = NL + "                            ";
  protected final String TEXT_873 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_874 = ";";
  protected final String TEXT_875 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_876 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_877 = NL + "    \t    int updateFlag_";
  protected final String TEXT_878 = "=0;" + NL + "    \t    ";
  protected final String TEXT_879 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_880 = ".setUpdate_";
  protected final String TEXT_881 = "(";
  protected final String TEXT_882 = ",pstmtUpdate_";
  protected final String TEXT_883 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_884 = ",query_";
  protected final String TEXT_885 = ",updateSQLSplits_";
  ...
  protected final String TEXT_894 = ",updateSQLSplits_";
  protected final String TEXT_895 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_896 = NL + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_920 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_921 = "=pstmtUpdate_";
  protected final String TEXT_922 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_923 = " = updatedCount_";
  protected final String TEXT_924 = " + updateFlag_";
  protected final String TEXT_925 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_926 = " == 0) {" + NL + "            \t";
  protected final String TEXT_927 = NL + "\t\t\t\tquery_";
  protected final String TEXT_928 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_929 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_930 = ".setInsert_";
  protected final String TEXT_931 = "(";
  protected final String TEXT_932 = ",pstmtInsert_";
  protected final String TEXT_933 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_934 = ",query_";
  protected final String TEXT_935 = ",insertSQLSplits_";
  ...
  protected final String TEXT_944 = ",insertSQLSplits_";
  protected final String TEXT_945 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_946 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_956 = " = insertedCount_";
  protected final String TEXT_957 = " + pstmtInsert_";
  protected final String TEXT_958 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_959 = "++;";
  protected final String TEXT_960 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_961 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_962 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_970 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_971 = ".assign_";
  ...
  protected final String TEXT_1008 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_1009 = " = deletedCount_";
  ...
  protected final String TEXT_1016 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_1021 = NL + "                            \tdataPropagateUtil_";
  protected final String TEXT_1022 = ".assign_";
  ...
  protected final String TEXT_1048 = NL + "                                \tdataPropagateUtil_";
  protected final String TEXT_1049 = ".assign_";
  ...
  protected final String TEXT_1107 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1108 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1109 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1110 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1111 = ": pstmt_";
  protected final String TEXT_1112 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1113 = " += (countEach_";
  protected final String TEXT_1114 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_1126 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  ...
  protected final String TEXT_1147 = ".commit();" + NL + "                \t";
