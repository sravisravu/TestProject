...
public class THBaseInputBeginJava
{
  ...
  protected final String TEXT_76 = NL + NL + "            maprLogin_";
  protected final String TEXT_77 = ".getMapRCredentialsViaPassword(";
  ...
  protected final String TEXT_87 = " = (org.apache.hadoop.conf.Configuration)globalMap.get(\"";
  protected final String TEXT_88 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_89 = " == null){" + NL + "\t\tthrow new RuntimeException(\"";
  protected final String TEXT_90 = "'s connection is null!\");" + NL + "\t}";
  protected final String TEXT_91 = NL + "\tconn_";
  protected final String TEXT_92 = ".set(\"hbase.table.namespace.mappings\", ";
  protected final String TEXT_93 = ");";
  protected final String TEXT_94 = NL + "\torg.apache.hadoop.hbase.client.Scan scan_";
  protected final String TEXT_95 = " = new org.apache.hadoop.hbase.client.Scan(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_96 = "), org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_97 = "));";
  protected final String TEXT_98 = NL + "\torg.apache.hadoop.hbase.client.Scan scan_";
  protected final String TEXT_99 = " = new org.apache.hadoop.hbase.client.Scan();";
  protected final String TEXT_100 = NL + "\t\t\t\tscan_";
  protected final String TEXT_101 = ".addColumn(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_102 = "), org.apache.hadoop.hbase.util.Bytes.toBytes(\"";
  protected final String TEXT_103 = "\"));";
  protected final String TEXT_104 = NL + "\t\t\t\tString [] multipleValues_";
  protected final String TEXT_105 = " = null;" + NL + "\t\t\t\tbyte [][] multipleBytesValues_";
  protected final String TEXT_106 = " = null;";
  protected final String TEXT_107 = "\t\t\t" + NL + "\t\t\torg.apache.hadoop.hbase.filter.FilterList filterList_";
  protected final String TEXT_108 = " = new org.apache.hadoop.hbase.filter.FilterList(org.apache.hadoop.hbase.filter.FilterList.Operator.";
  protected final String TEXT_109 = ");" + NL + "\t\t\torg.apache.hadoop.hbase.filter.Filter filter_";
  protected final String TEXT_110 = " = null;";
  protected final String TEXT_111 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_112 = " = new org.apache.hadoop.hbase.filter.SingleColumnValueFilter(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_113 = "), org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_114 = "), org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_115 = ", org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_116 = "));";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_118 = " = new org.apache.hadoop.hbase.filter.SingleColumnValueFilter(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_119 = "), org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_120 = "), org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_121 = ", new org.apache.hadoop.hbase.filter.RegexStringComparator(";
  protected final String TEXT_122 = "));";
  protected final String TEXT_123 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_124 = " = new org.apache.hadoop.hbase.filter.SingleColumnValueFilter(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_125 = "), org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_126 = "), org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  ...
  protected final String TEXT_130 = " = new org.apache.hadoop.hbase.filter.FamilyFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_131 = ",new org.apache.hadoop.hbase.filter.BinaryComparator(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_132 = ")));";
  protected final String TEXT_133 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_134 = " = new org.apache.hadoop.hbase.filter.FamilyFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_135 = ",new org.apache.hadoop.hbase.filter.RegexStringComparator(";
  protected final String TEXT_136 = "));";
  protected final String TEXT_137 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_138 = " = new org.apache.hadoop.hbase.filter.FamilyFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_139 = ",new org.apache.hadoop.hbase.filter.SubstringComparator(";
  protected final String TEXT_140 = "));";
  protected final String TEXT_141 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_142 = " = new org.apache.hadoop.hbase.filter.QualifierFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_143 = ",new org.apache.hadoop.hbase.filter.BinaryComparator(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_144 = ")));";
  protected final String TEXT_145 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_146 = " = new org.apache.hadoop.hbase.filter.QualifierFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_147 = ",new org.apache.hadoop.hbase.filter.RegexStringComparator(";
  protected final String TEXT_148 = "));";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_150 = " = new org.apache.hadoop.hbase.filter.QualifierFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_151 = ",new org.apache.hadoop.hbase.filter.SubstringComparator(";
  protected final String TEXT_152 = "));";
  protected final String TEXT_153 = NL + "\t\t\t\t\t\tscan_";
  protected final String TEXT_154 = ".addFamily(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_155 = "));";
  protected final String TEXT_156 = NL + "\t\t\t\t\tfilter_";
  protected final String TEXT_157 = " = new org.apache.hadoop.hbase.filter.ColumnPrefixFilter(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_158 = "));";
  protected final String TEXT_159 = NL + "\t\t\t\t\t\tscan_";
  protected final String TEXT_160 = ".addFamily(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_161 = "));";
  protected final String TEXT_162 = NL + "\t\t\t\t\tif(";
  protected final String TEXT_163 = "!=null && !\"\".equals(";
  protected final String TEXT_164 = ")){" + NL + "\t\t\t\t\t\tmultipleValues_";
  protected final String TEXT_165 = " = ";
  protected final String TEXT_166 = ".split(\",\");" + NL + "\t\t\t\t\t\tmultipleBytesValues_";
  protected final String TEXT_167 = " = new byte [multipleValues_";
  protected final String TEXT_168 = ".length] [];" + NL + "\t\t\t\t\t\tfor(int i=0;i< multipleValues_";
  protected final String TEXT_169 = ".length;i++){" + NL + "\t\t\t\t\t\t\tmultipleBytesValues_";
  protected final String TEXT_170 = "[i] = org.apache.hadoop.hbase.util.Bytes.toBytes(multipleValues_";
  protected final String TEXT_171 = "[i]);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_172 = " =  new org.apache.hadoop.hbase.filter.MultipleColumnPrefixFilter(multipleBytesValues_";
  protected final String TEXT_173 = ");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_174 = NL + "\t\t\t\t\t\tscan_";
  protected final String TEXT_175 = ".addFamily(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_176 = "));";
  protected final String TEXT_177 = NL + "\t\t\t\t\tfilter_";
  protected final String TEXT_178 = " = new org.apache.hadoop.hbase.filter.ColumnRangeFilter(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_179 = ".split(\",\")[0]),true,org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_180 = ".split(\",\")[1]),true);";
  protected final String TEXT_181 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_182 = " = new org.apache.hadoop.hbase.filter.RowFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_183 = ",new org.apache.hadoop.hbase.filter.BinaryComparator(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_184 = ")));";
  protected final String TEXT_185 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_186 = " = new org.apache.hadoop.hbase.filter.RowFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_187 = ",new org.apache.hadoop.hbase.filter.RegexStringComparator(";
  protected final String TEXT_188 = "));";
  protected final String TEXT_189 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_190 = " = new org.apache.hadoop.hbase.filter.RowFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_191 = ",new org.apache.hadoop.hbase.filter.SubstringComparator(";
  protected final String TEXT_192 = "));";
  protected final String TEXT_193 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_194 = " = new org.apache.hadoop.hbase.filter.ValueFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_195 = ",new org.apache.hadoop.hbase.filter.BinaryComparator(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_196 = ")));";
  protected final String TEXT_197 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_198 = " = new org.apache.hadoop.hbase.filter.ValueFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_199 = ",new org.apache.hadoop.hbase.filter.RegexStringComparator(";
  protected final String TEXT_200 = "));";
  protected final String TEXT_201 = NL + "\t\t\t\t\t\tfilter_";
  protected final String TEXT_202 = " = new org.apache.hadoop.hbase.filter.ValueFilter(org.apache.hadoop.hbase.filter.CompareFilter.CompareOp.";
  protected final String TEXT_203 = ",new org.apache.hadoop.hbase.filter.SubstringComparator(";
  protected final String TEXT_204 = "));";
  protected final String TEXT_205 = NL + "\t\t\t\t\tfilterList_";
  protected final String TEXT_206 = ".addFilter(filter_";
  protected final String TEXT_207 = ");";
  protected final String TEXT_208 = NL + "\t\t\tscan_";
  protected final String TEXT_209 = ".setFilter(filterList_";
  protected final String TEXT_210 = ");";
  protected final String TEXT_211 = "\t\t" + NL + "\t\torg.apache.hadoop.hbase.client.HTable table_";
  protected final String TEXT_212 = " = new org.apache.hadoop.hbase.client.HTable(conn_";
  protected final String TEXT_213 = ", ";
  protected final String TEXT_214 = ");" + NL + "\t\tString temp_";
  protected final String TEXT_215 = "=null;" + NL + "\t\tbyte[] rowResult_";
  protected final String TEXT_216 = " = null;" + NL + "\t\torg.apache.hadoop.hbase.client.ResultScanner scanner_";
  protected final String TEXT_217 = " = table_";
  protected final String TEXT_218 = ".getScanner(scan_";
  protected final String TEXT_219 = ");";
  protected final String TEXT_220 = NL + "\t\t\t\tfor (org.apache.hadoop.hbase.client.Result rr_";
  protected final String TEXT_221 = " = scanner_";
  protected final String TEXT_222 = ".next(); rr_";
  protected final String TEXT_223 = " != null; rr_";
  protected final String TEXT_224 = " = scanner_";
  protected final String TEXT_225 = ".next()) {";
  protected final String TEXT_226 = NL + "\t\t\t\t\t\t\t\trowResult_";
  protected final String TEXT_227 = " = rr_";
  protected final String TEXT_228 = ".getValue(org.apache.hadoop.hbase.util.Bytes.toBytes(";
  protected final String TEXT_229 = "),org.apache.hadoop.hbase.util.Bytes.toBytes(\"";
  protected final String TEXT_230 = "\"));" + NL + "\t\t\t\t\t\t\t\ttemp_";
  protected final String TEXT_231 = " = org.apache.hadoop.hbase.util.Bytes.toString(rowResult_";
  protected final String TEXT_232 = ");" + NL + "\t\t\t\t\t\t\t\tif(temp_";
  protected final String TEXT_233 = "!=null && temp_";
  protected final String TEXT_234 = ".length() > 0) {";
  protected final String TEXT_235 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_236 = ".";
  protected final String TEXT_237 = "=temp_";
  protected final String TEXT_238 = ".toString();";
  protected final String TEXT_239 = " " + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_240 = ".";
  protected final String TEXT_241 = "=rowResult_";
  ...
  protected final String TEXT_250 = "=org.apache.hadoop.hbase.util.Bytes.toInt(rowResult_";
  protected final String TEXT_251 = ");  ";
  protected final String TEXT_252 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_253 = ".";
  protected final String TEXT_254 = "=(char)org.apache.hadoop.hbase.util.Bytes.toInt(rowResult_";
  protected final String TEXT_255 = ");  ";
  protected final String TEXT_256 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = "=org.apache.hadoop.hbase.util.Bytes.to";
  protected final String TEXT_259 = "(rowResult_";
  protected final String TEXT_260 = ");  ";
  protected final String TEXT_261 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_262 = ".";
  protected final String TEXT_263 = "=ParserUtils.parseTo_";
  ...
  protected final String TEXT_274 = NL + "\t\t\t\t\t\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_275 = "' in '";
  protected final String TEXT_276 = "' connection, value is invalid or this column should be nullable or have a default value.\");\t\t\t\t\t\t\t\t\t";
