...
public class TMDMWriteConfEndJava
{
  ...
  protected final String TEXT_60 = NL + NL + "    if(miList_";
  protected final String TEXT_61 = ".size() > 0){" + NL + "" + NL + "        org.talend.mdm.webservice.WSPutItemWithReportArray putItemWithReportArray = new org.talend.mdm.webservice.WSPutItemWithReportArray(miList_";
  protected final String TEXT_62 = ");" + NL + "        wspks_";
  protected final String TEXT_63 = " = service_";
  protected final String TEXT_64 = ".putItemWithReportArray(putItemWithReportArray).getWsItemPK();" + NL + "        ";
  protected final String TEXT_65 = NL + "        " + NL + "        miList_";
  protected final String TEXT_66 = ".clear();" + NL + "        miList_";
  protected final String TEXT_67 = " = null;";
  protected final String TEXT_68 = NL + NL + "            int i2_";
  protected final String TEXT_69 = " = 0;" + NL + "            for(org.talend.mdm.webservice.WSItemPK wspk2_";
  protected final String TEXT_70 = " : wspks_";
  protected final String TEXT_71 = "){" + NL + "" + NL + "                String compositeId = \"\";" + NL + "                for(String id:wspk2_";
  protected final String TEXT_72 = ".getIds()) {" + NL + "                  compositeId += id;" + NL + "                }" + NL + "" + NL + "                wspk2_";
  protected final String TEXT_73 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_74 = ");" + NL + "                service_";
  protected final String TEXT_75 = ".updateItemMetadata(util_";
  protected final String TEXT_76 = ".makeUpdateMeteItm(taskIDs_";
  protected final String TEXT_77 = ".get(i2_";
  protected final String TEXT_78 = "), wspk2_";
  protected final String TEXT_79 = "));" + NL + "                i2_";
  protected final String TEXT_80 = "++;" + NL + "            }" + NL;
  protected final String TEXT_81 = NL + "            taskIDs_";
  protected final String TEXT_82 = ".clear();";
  protected final String TEXT_83 = NL + "    }";
  protected final String TEXT_84 = NL + NL + "    if(miList_";
  protected final String TEXT_85 = ".size() > 0){" + NL + "" + NL + "        org.talend.mdm.webservice.WSPutItemArray putItemArray = new org.talend.mdm.webservice.WSPutItemArray(miList_";
  protected final String TEXT_86 = ");" + NL + "        wspks_";
  protected final String TEXT_87 = " = service_";
  protected final String TEXT_88 = ".putItemArray(putItemArray).getWsItemPK();" + NL;
  protected final String TEXT_89 = NL + NL + "        miList_";
  protected final String TEXT_90 = ".clear();" + NL + "        miList_";
  protected final String TEXT_91 = " = null;";
  protected final String TEXT_92 = NL + NL + "            int i2_";
  protected final String TEXT_93 = " = 0;" + NL + "            for(org.talend.mdm.webservice.WSItemPK wspk2_";
  protected final String TEXT_94 = " : wspks_";
  protected final String TEXT_95 = "){" + NL + "" + NL + "                String compositeId = \"\";" + NL + "                for(String id:wspk2_";
  protected final String TEXT_96 = ".getIds()) {" + NL + "                  compositeId += id;" + NL + "                }" + NL + "" + NL + "                wspk2_";
  protected final String TEXT_97 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_98 = ");" + NL + "                service_";
  protected final String TEXT_99 = ".updateItemMetadata(util_";
  protected final String TEXT_100 = ".makeUpdateMeteItm(taskIDs_";
  protected final String TEXT_101 = ".get(i2_";
  protected final String TEXT_102 = "), wspk2_";
  protected final String TEXT_103 = "));" + NL + "                i2_";
  protected final String TEXT_104 = "++;" + NL + "            }" + NL;
  protected final String TEXT_105 = NL + "            taskIDs_";
  protected final String TEXT_106 = ".clear();";
  protected final String TEXT_107 = NL + "    }";
  protected final String TEXT_108 = NL + "    service_";
  protected final String TEXT_109 = ".logout(new org.talend.mdm.webservice.WSLogout());";
