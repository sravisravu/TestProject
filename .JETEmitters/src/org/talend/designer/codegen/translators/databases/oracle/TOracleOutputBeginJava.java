...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_397 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_398 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_399 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_400 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_401 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_414 = ".equalsIgnoreCase(";
  protected final String TEXT_415 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_416 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_417 = ".close();";
  protected final String TEXT_418 = NL + "                                if(!whetherExist_";
  protected final String TEXT_419 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_451 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_459 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_467 = ".execute(\"";
  protected final String TEXT_468 = ")\");";
  protected final String TEXT_469 = NL + "                                stmtCreate_";
  protected final String TEXT_470 = ".close();";
  protected final String TEXT_471 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_472 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_473 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_487 = NL + "                              stmtTruncCount_";
  protected final String TEXT_488 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_489 = "));";
  protected final String TEXT_490 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_491 = " = stmtTruncCount_";
  protected final String TEXT_492 = ".executeQuery(\"";
  protected final String TEXT_493 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_494 = " = 0;" + NL + "            if(rsTruncCount_";
  ...
  protected final String TEXT_499 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_503 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_504 = "));";
  protected final String TEXT_505 = NL + "                conn_";
  protected final String TEXT_506 = ".commit();";
  ...
  protected final String TEXT_511 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_512 = ".commit();" + NL + "                }";
  protected final String TEXT_513 = NL + "            deletedCount_";
  protected final String TEXT_514 = " += rsTruncCountNumber_";
  protected final String TEXT_515 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_516 = ".close();";
  protected final String TEXT_517 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_518 = " = conn_";
  protected final String TEXT_519 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_520 = " = stmtTruncCount_";
  protected final String TEXT_521 = ".executeQuery(\"";
  protected final String TEXT_522 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_523 = " = conn_";
  protected final String TEXT_524 = ".createStatement();";
  protected final String TEXT_525 = NL + "                conn_";
  protected final String TEXT_526 = ".commit();";
  ...
  protected final String TEXT_536 = ".close();";
  ...
  protected final String TEXT_542 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_543 = " = new StringBuffer(insert_";
  protected final String TEXT_544 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_545 = ".insert(insert_";
  protected final String TEXT_546 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_547 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_548 = " =insertStringBuffer_";
  ...
  protected final String TEXT_556 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_557 = " = conn_";
  protected final String TEXT_558 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_559 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_560 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_561 = ",insert_";
  protected final String TEXT_562 = ",keyPsmt_";
  ...
  protected final String TEXT_569 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_570 = " = new StringBuffer(update_";
  protected final String TEXT_571 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_572 = ".insert(update_";
  protected final String TEXT_573 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_574 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_575 = " =updateStringBuffer_";
  ...
  protected final String TEXT_619 = " = \"UPDATE \" + tableName_";
  ...
  protected final String TEXT_631 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_647 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_655 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_656 = " = new StringBuffer(delete_";
  protected final String TEXT_657 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_658 = ".insert(delete_";
  protected final String TEXT_659 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_660 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_661 = " =deleteStringBuffer_";
  protected final String TEXT_662 = ".toString();  ";
  protected final String TEXT_663 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_664 = " = conn_";
  protected final String TEXT_665 = ".prepareStatement(delete_";
  protected final String TEXT_666 = ");";
  protected final String TEXT_667 = NL + "                StringBuffer query_";
  ...
  protected final String TEXT_673 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_679 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_687 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  ...
  protected final String TEXT_691 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_697 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_698 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_699 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_700 = " = true;";
  protected final String TEXT_701 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_702 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_703 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_704 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_705 = " clobTypeUtil_";
  protected final String TEXT_706 = "=new ClobTypeUtil_";
  protected final String TEXT_707 = "();";
  protected final String TEXT_708 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_709 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_710 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_711 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_712 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_713 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_714 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_715 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_716 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_717 = " blobTypeUtil_";
  protected final String TEXT_718 = "=new BlobTypeUtil_";
  protected final String TEXT_719 = "();";
  protected final String TEXT_720 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_721 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_722 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_723 = " =null;";
  protected final String TEXT_724 = NL + "            StringBuffer query_";
  protected final String TEXT_725 = " = null;";
  protected final String TEXT_726 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_730 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_731 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_732 = " = null;";
  protected final String TEXT_733 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_734 = " = null;";
  protected final String TEXT_735 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_736 = " = null;";
  protected final String TEXT_737 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  ...
  protected final String TEXT_741 = NL + NL + NL + NL;
