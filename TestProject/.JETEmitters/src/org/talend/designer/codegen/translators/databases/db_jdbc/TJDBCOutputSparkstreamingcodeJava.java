...
public class TJDBCOutputSparkstreamingcodeJava {
  protected static String nl;
  public static synchronized TJDBCOutputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCOutputSparkstreamingcodeJava result = new TJDBCOutputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_16 = "> dataIterator) throws java.lang.Exception {" + NL + "\t\t\t\tjava.sql.Connection connection = ";
  protected final String TEXT_17 = ".get(context).borrowObject();" + NL + "\t\t\t\ttry {\t\t ";
  protected final String TEXT_18 = NL + "\t\t\t\t\t";
  protected final String TEXT_19 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_20 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_21 = "\" + ";
  protected final String TEXT_22 = " + \"";
  protected final String TEXT_23 = " (";
  protected final String TEXT_24 = ") VALUES(";
  protected final String TEXT_25 = ")\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_26 = " ";
  protected final String TEXT_27 = " = dataIterator.next();";
  protected final String TEXT_28 = NL + "\t\t\t";
  protected final String TEXT_29 = NL + "\t";
  protected final String TEXT_30 = NL;
  protected final String TEXT_31 = NL + "\tpstmt_";
  protected final String TEXT_32 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_33 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_37 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_38 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_39 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_40 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_41 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_42 = NL + "\t}             ";
  protected final String TEXT_43 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_44 = NL;
  protected final String TEXT_45 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_46 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_47 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_48 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_49 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_50 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_51 = NL + NL + "pstmt_";
  protected final String TEXT_52 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_53 = NL + "\t\t\t\t\t";
  protected final String TEXT_54 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_55 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_56 = "\" + ";
  protected final String TEXT_57 = " + \"";
  protected final String TEXT_58 = " SET ";
  protected final String TEXT_59 = " WHERE ";
  protected final String TEXT_60 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_61 = " ";
  protected final String TEXT_62 = " = dataIterator.next();";
  protected final String TEXT_63 = NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t";
  protected final String TEXT_65 = NL + "\t";
  protected final String TEXT_66 = NL;
  protected final String TEXT_67 = NL + "\tpstmt_";
  protected final String TEXT_68 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_69 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_73 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_74 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_75 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_76 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_77 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_78 = NL + "\t}             ";
  protected final String TEXT_79 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_80 = NL;
  protected final String TEXT_81 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_82 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  ...
  protected final String TEXT_86 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_87 = NL + NL + "pstmt_";
  protected final String TEXT_88 = ".close();";
  protected final String TEXT_89 = NL + "\t\t\t\t\t";
  protected final String TEXT_90 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_91 = " = connection.prepareStatement(\"SELECT COUNT(1) FROM ";
  ...
  protected final String TEXT_96 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_97 = "\" + ";
  protected final String TEXT_98 = " + \"";
  protected final String TEXT_99 = " (";
  protected final String TEXT_100 = ") VALUES (";
  protected final String TEXT_101 = ")\");" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_102 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_103 = "\" + ";
  protected final String TEXT_104 = " +\"";
  protected final String TEXT_105 = " SET ";
  protected final String TEXT_106 = " WHERE ";
  protected final String TEXT_107 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_108 = " ";
  protected final String TEXT_109 = " = dataIterator.next();";
  protected final String TEXT_110 = NL + "\t\t\t";
  protected final String TEXT_111 = NL + "\tjava.sql.ResultSet rs_";
  protected final String TEXT_112 = " = pstmt_";
  protected final String TEXT_113 = ".executeQuery();" + NL + "\tint checkCount_";
  protected final String TEXT_114 = " = -1;" + NL + "\t" + NL + "\twhile(rs_";
  protected final String TEXT_115 = ".next()) {" + NL + "\t\tcheckCount_";
  protected final String TEXT_116 = " = rs_";
  protected final String TEXT_117 = ".getInt(1);" + NL + "\t}" + NL + "\t" + NL + "\tif(checkCount_";
  protected final String TEXT_118 = " > 0) {";
  protected final String TEXT_119 = NL + "\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t pstmtUpdate_";
  protected final String TEXT_122 = ".executeUpdate();" + NL + "\t} else {";
  protected final String TEXT_123 = NL + "\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_125 = ".executeUpdate();" + NL + "\t}\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmt_";
  protected final String TEXT_126 = ".close();" + NL + "pstmtInsert_";
  protected final String TEXT_127 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_128 = ".close();";
  protected final String TEXT_129 = NL + "\t\t\t\t\t";
  protected final String TEXT_130 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_131 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_137 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_138 = "\" + ";
  protected final String TEXT_139 = " +\"";
  protected final String TEXT_140 = " SET ";
  protected final String TEXT_141 = " WHERE ";
  protected final String TEXT_142 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_143 = " ";
  protected final String TEXT_144 = " = dataIterator.next();";
  protected final String TEXT_145 = NL + "\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t";
  protected final String TEXT_147 = NL + "\tint updateFlag_";
  protected final String TEXT_148 = " = pstmtUpdate_";
  protected final String TEXT_149 = ".executeUpdate();" + NL + "\t" + NL + "\tif(updateFlag_";
  protected final String TEXT_150 = " == 0) {";
  protected final String TEXT_151 = NL + "\t\t\t\t";
  protected final String TEXT_152 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_153 = ".executeUpdate();" + NL + "\t}" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_154 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_155 = ".close();";
  protected final String TEXT_156 = NL + "\t\t\t\t\t";
  protected final String TEXT_157 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_158 = " = connection.prepareStatement(\"DELETE FROM ";
  protected final String TEXT_159 = "\" + ";
  protected final String TEXT_160 = " + \"";
  protected final String TEXT_161 = " WHERE ";
  protected final String TEXT_162 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_163 = " ";
  protected final String TEXT_164 = " = dataIterator.next();";
  protected final String TEXT_165 = NL + "\t\t\t";
  protected final String TEXT_166 = NL + "\t";
  protected final String TEXT_167 = NL;
  protected final String TEXT_168 = NL + "\tpstmt_";
  protected final String TEXT_169 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_170 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_174 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_175 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_176 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_177 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_178 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_179 = NL + "\t}             ";
  protected final String TEXT_180 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_181 = NL;
  protected final String TEXT_182 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_183 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_184 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_185 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_186 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_187 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_188 = NL + NL + "pstmt_";
  protected final String TEXT_189 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_190 = NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\tif(connection != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_191 = ".get(context).returnObject(connection);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} // end call()" + NL + "\t\t} // end class" + NL;
  protected final String TEXT_192 = NL + "\t\t\t";
  protected final String TEXT_193 = NL + NL + "public static class ";
  protected final String TEXT_194 = " {" + NL + "\tprivate static volatile org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_195 = "> pool;" + NL + "\t" + NL + "\tprivate ";
  protected final String TEXT_196 = "() {" + NL + "\t    // empty" + NL + "\t}" + NL + "" + NL + "\tpublic static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_197 = "> get(ContextProperties context) {" + NL + "\t\tif(pool == null) {" + NL + "\t\t\tsynchronized(";
  protected final String TEXT_198 = ".class) {" + NL + "\t\t\t\tif(pool == null) {" + NL + "\t\t\t\t\tpool = createPool(context);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t   return pool;" + NL + "\t}" + NL + "" + NL + "\tprivate static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_199 = "> createPool(ContextProperties context) {" + NL + "\t    org.apache.commons.pool2.impl.GenericObjectPoolConfig config = new org.apache.commons.pool2.impl.GenericObjectPoolConfig();" + NL + "\t    config.setMaxTotal(";
  protected final String TEXT_200 = ");" + NL + "\t    config.setMaxWaitMillis(";
  protected final String TEXT_201 = ");" + NL + "\t    config.setMinIdle(";
  protected final String TEXT_202 = ");" + NL + "\t    config.setMaxIdle(";
  protected final String TEXT_203 = ");" + NL + "\t    config.setBlockWhenExhausted(true);";
  protected final String TEXT_204 = NL + "\t\t\tconfig.setTimeBetweenEvictionRunsMillis(";
  protected final String TEXT_205 = ");" + NL + "\t\t\tconfig.setMinEvictableIdleTimeMillis(";
  protected final String TEXT_206 = ");" + NL + "\t\t\tconfig.setSoftMinEvictableIdleTimeMillis(";
  protected final String TEXT_207 = ");";
  protected final String TEXT_208 = NL + "\t    return new org.apache.commons.pool2.impl.GenericObjectPool<";
  protected final String TEXT_209 = ">(new ";
  protected final String TEXT_210 = "(context), config);" + NL + "\t}" + NL + "}" + NL + "\t\t\t";
  protected final String TEXT_211 = NL + NL + "public static class ";
  protected final String TEXT_212 = " extends org.apache.commons.pool2.BasePooledObjectFactory<";
  protected final String TEXT_213 = "> {" + NL + "" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_214 = "(ContextProperties context) {" + NL + "\t\tthis.context = context;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_215 = " create() throws Exception {" + NL + "\t   Class.forName(";
  protected final String TEXT_216 = ");" + NL + "\t\tjava.util.Properties jdbcDriverProperties = new java.util.Properties();" + NL + "\t\tString jdbcAdditionalParameters = ";
  protected final String TEXT_217 = ";" + NL + "\t\tif(jdbcAdditionalParameters != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters) && !\"\".equals(jdbcAdditionalParameters)){" + NL + "\t\t\tjdbcDriverProperties.load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters.replace(";
  protected final String TEXT_218 = ", \"\\n\").getBytes()));" + NL + "\t\t}" + NL + "\t\tif(";
  protected final String TEXT_219 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_220 = ") && !\"\".equals(";
  protected final String TEXT_221 = ")){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"user\", ";
  protected final String TEXT_222 = ");" + NL + "\t\t}" + NL + "\t\tString password = ";
  protected final String TEXT_223 = " ;" + NL + "\t\tif(password != null && !\"\\\"\\\"\".equals(password) && !\"\".equals(password)){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"password\", password);" + NL + "\t\t}" + NL + "\t   return java.sql.DriverManager.getConnection(";
  protected final String TEXT_224 = ", jdbcDriverProperties);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_225 = "> wrap(";
  protected final String TEXT_226 = " connection) {" + NL + "\t   return new org.apache.commons.pool2.impl.DefaultPooledObject<";
  protected final String TEXT_227 = ">(connection);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void destroyObject(org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_228 = "> pooledObject) throws Exception {" + NL + "\t\tif (pooledObject != null) {" + NL + "\t\t    pooledObject.getObject().close();" + NL + "\t\t}" + NL + "\t\tsuper.destroyObject(pooledObject);" + NL + "\t}" + NL + "}";
  protected final String TEXT_229 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_230 = " code : ";
  protected final String TEXT_231 = "\");" + NL + "\t\t}";
  protected final String TEXT_232 = NL;
  protected final String TEXT_233 = NL + NL + "    public static class ";
  protected final String TEXT_234 = "_ForeachRDDOutput implements ";
  protected final String TEXT_235 = " {" + NL + "" + NL + "        private ContextProperties context;" + NL + "" + NL + "        public ";
  protected final String TEXT_236 = "_ForeachRDDOutput(JobConf conf) {" + NL + "            this.context = new ContextProperties(conf);" + NL + "        }" + NL + "" + NL + "        @Override" + NL + "        public ";
  protected final String TEXT_237 = " call(";
  protected final String TEXT_238 = " rdd) throws Exception {" + NL + "            rdd.foreachPartition(new ";
  protected final String TEXT_239 = "_OutputFunction(context));";
    ...
    public String generate(Object argument)
  {
    ...
    try {
		...
		((JDBCManager)manager).setLProtectedChar(ElementParameterParser.getValue(node, "__L_CHAR__"));
		((JDBCManager)manager).setRProtectedChar(ElementParameterParser.getValue(node, "__R_CHAR__"));
		
		String tableNameLDelimiter = manager.getLProtectedChar();
		String tableNameRDelimiter = manager.getRProtectedChar();
		List<Column> stmtStructure = manager.createColumnList(tJdbcOutputUtil.getColumns(), tJdbcOutputUtil.useFieldOptions(), tJdbcOutputUtil.getFieldOptions(), tJdbcOutputUtil.getAddCols());
      ...
      // Remove both added and replaced columns from the list. It does not make any sense to fill any PreparedStatement from those columns.
