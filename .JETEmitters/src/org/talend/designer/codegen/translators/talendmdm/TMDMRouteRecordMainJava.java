...
public class TMDMRouteRecordMainJava
{
  ...
  protected final String TEXT_159 = "\");" + NL + "" + NL + "org.talend.mdm.webservice.WSRouteItemV2 wsRouteItem_";
  protected final String TEXT_160 = " = new org.talend.mdm.webservice.WSRouteItemV2();" + NL + "" + NL + "List<String> pkIds = new java.util.ArrayList<String>();";
  protected final String TEXT_161 = NL + "pkIds.add(";
  protected final String TEXT_162 = ");";
  protected final String TEXT_163 = NL + "org.talend.mdm.webservice.WSItemPK wsItemPK_";
  protected final String TEXT_164 = " = new org.talend.mdm.webservice.WSItemPK(";
  protected final String TEXT_165 = ",pkIds,dataCluster_";
  protected final String TEXT_166 = ");" + NL + "" + NL + "wsRouteItem_";
  protected final String TEXT_167 = ".setWsItemPK(wsItemPK_";
  protected final String TEXT_168 = ");" + NL + "" + NL + "//" + NL + "service_";
  protected final String TEXT_169 = ".routeItemV2(wsRouteItem_";
