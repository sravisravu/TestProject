...
public class TFixedFlowInputMrconfigJava
{
  protected static String nl;
  public static synchronized TFixedFlowInputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFixedFlowInputMrconfigJava result = new TFixedFlowInputMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_121 = "_InputFormat.class," + NL + "                    ChainMapper.class, \"";
