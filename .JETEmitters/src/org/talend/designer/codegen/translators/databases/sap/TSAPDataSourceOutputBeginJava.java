...
public class TSAPDataSourceOutputBeginJava
{
  ...
  protected final String TEXT_60 = ".getBWService();" + NL;
  protected final String TEXT_61 = NL + "\torg.talend.sap.impl.bw.SAPBWDataRequest dataRequest_";
  protected final String TEXT_62 = " = new org.talend.sap.impl.bw.SAPBWDataRequest();" + NL + "\tdataRequest_";
  protected final String TEXT_63 = ".setDataSourceName(";
  protected final String TEXT_64 = ");" + NL + "\t" + NL + "\tdataRequest_";
  protected final String TEXT_65 = ".setDataSourceType(org.talend.sap.model.SAPDataSourceType.";
  protected final String TEXT_66 = ");" + NL + "\t" + NL + "\t";
  protected final String TEXT_67 = NL + "\tdataRequest_";
  protected final String TEXT_68 = ".setId(";
  protected final String TEXT_69 = ");" + NL + "\t";
  protected final String TEXT_70 = NL + "\t" + NL + "\t";
  protected final String TEXT_71 = NL + "\tdataRequest_";
  protected final String TEXT_72 = ".setPackageSize(";
  protected final String TEXT_73 = ");" + NL + "\t";
  protected final String TEXT_74 = NL + "\t" + NL + "\t";
  protected final String TEXT_75 = NL + "\tdataRequest_";
  protected final String TEXT_76 = ".setSourceSystemName(";
  protected final String TEXT_77 = ");" + NL + "\t";
  protected final String TEXT_78 = NL + "\t" + NL + "\t";
  protected final String TEXT_79 = NL + "\tjava.text.SimpleDateFormat format_";
  protected final String TEXT_80 = " = new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\");" + NL + "\t";
  protected final String TEXT_81 = NL + "\t" + NL + "\torg.talend.sap.bw.ISAPBWTableDataWritable data_";
  protected final String TEXT_82 = " = dataService_";
  protected final String TEXT_83 = ".createDataSourceRequest(dataRequest_";
  protected final String TEXT_84 = ")";
  protected final String TEXT_85 = NL + "\t\t.addField(\"";
  protected final String TEXT_86 = "\")";
  protected final String TEXT_87 = NL + NL + "\t";
  protected final String TEXT_88 = NL + "\t\t.dataSelection(format_";
  protected final String TEXT_89 = ".parse(";
  protected final String TEXT_90 = "))" + NL + "\t";
  protected final String TEXT_91 = NL + "\t\t" + NL + "\t\t.writable();";
