...
public class TMongoDBOutputSparkconfigJava
{
  protected static String nl;
  public static synchronized TMongoDBOutputSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMongoDBOutputSparkconfigJava result = new TMongoDBOutputSparkconfigJava();
    nl = null;
    return result;
  }
