...
public class TTeradataOutputMrcodeJava
{
  protected static String nl;
  public static synchronized TTeradataOutputMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TTeradataOutputMrcodeJava result = new TTeradataOutputMrcodeJava();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    if((metadatas != null) && (metadatas.size() > 0)){
        ...
        if(metadata != null){
			...
			String jdbcURL = "\"jdbc:teradata\"";
			String driverClass = "\"com.teradata.jdbc.TeraDriver\"";
			
			String url = jdbcURL + " + \"://\" + " + dbhost + " + \"/DATABASE=\" + " + dbname;
