...
public class TPredictClusterSparkconfigJava
{
  protected static String nl;
  public static synchronized TPredictClusterSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPredictClusterSparkconfigJava result = new TPredictClusterSparkconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = ", TalendPipelineModel.class, new TalendPipelineModelSerializer());" + NL + "" + NL + "    org.apache.spark.mllib.clustering.KMeansModel currentModel_";
  protected final String TEXT_9 = " = org.apache.spark.mllib.clustering.KMeansModel.load(ctx.sc(), ";
  ...
  protected final String TEXT_17 = " instanceof org.apache.spark.mllib.clustering.KMeansModel)) {" + NL + "        throw new RuntimeException(\"The selected model is of type \" + temporaryModel_";
  protected final String TEXT_18 = ".getClass() + \" is should be of type org.apache.spark.mllib.clustering.KMeansModel\");" + NL + "    }" + NL + "    org.apache.spark.mllib.clustering.KMeansModel currentModel_";
  protected final String TEXT_19 = " = (org.apache.spark.mllib.clustering.KMeansModel) temporaryModel_";
