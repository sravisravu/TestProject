...
public class TLogRowStormconfigJava
{
  protected static String nl;
  public static synchronized TLogRowStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TLogRowStormconfigJava result = new TLogRowStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_45 = NL + "{" + NL + "    Stream stream_";
  protected final String TEXT_46 = " = null;" + NL;
  protected final String TEXT_47 = NL + "        stream_";
  protected final String TEXT_48 = " = ";
  protected final String TEXT_49 = ";";
  protected final String TEXT_50 = NL + "        Connector ";
  protected final String TEXT_51 = " is not handled.";
  protected final String TEXT_52 = NL + NL + "    TridentState state_";
  protected final String TEXT_53 = " = stream_";
  protected final String TEXT_54 = NL + "            .partitionPersist(new storm.trident.testing.MemoryMapState.Factory(),";
  protected final String TEXT_55 = NL + "                    ";
  protected final String TEXT_56 = "," + NL + "                    new org.talend.libs.tbd.ee.libstorm.MemoryMapStateUpdater());" + NL + "" + NL + "    // Then, we create the DRPC function, which will be call by the DRPCClient in order to get the fields to the UIclient" + NL + "    ctx.getTridentTopology()" + NL + "            .newDRPCStream(topologyName + \"";
  protected final String TEXT_57 = "\" + \"__log\", ctx.getLocalDrpcServer())" + NL + "            .stateQuery(state_";
  protected final String TEXT_58 = ", new org.talend.libs.tbd.ee.libstorm.MemoryMapStateGet(),";
...
streamUtil.setInConnection(streamUtil.getFirstMainInConnection());

if (streamUtil.getInConnection() == null)
    return "";
...
String subprocessStartName = node.getSubProcessStartNode(false).getUniqueName();
String sourceUniqueName = streamUtil.getInConnection().getSource().getUniqueName();
String connectorName = streamUtil.getInConnection().getConnectorName();
...
streamUtil.generateAllOutStreamsDeclarations();
    ...
    // We slice the main stream in two, the "main stream" will continue to the seconde filter, the "log stream" will
    // persist every field with the partitionPersist
    if (connectorName.equals("MAIN") || connectorName.equals("FILTER")
            || connectorName.equals("FLOW") || connectorName.equals("REJECT")) {
