...
public class TSAPDataSourceOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSAPDataSourceOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDataSourceOutputFinallyJava result = new TSAPDataSourceOutputFinallyJava();
    nl = null;
    return result;
  }
