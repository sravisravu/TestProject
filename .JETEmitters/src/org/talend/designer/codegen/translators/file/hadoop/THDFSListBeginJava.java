...
public class THDFSListBeginJava
{
  ...
  protected final String TEXT_125 = NL + "\tjava.util.List<String> maskList_";
  protected final String TEXT_126 = " = new java.util.ArrayList<String>();" + NL + "\t";
  protected final String TEXT_127 = NL + "\t    maskList_";
  protected final String TEXT_128 = ".add(\"*\");" + NL + "\t    ";
  protected final String TEXT_129 = NL + "\t    maskList_";
  protected final String TEXT_130 = ".add(\".*\");" + NL + "\t    ";
  protected final String TEXT_131 = " " + NL + "    \tmaskList_";
  protected final String TEXT_132 = ".add(";
  protected final String TEXT_133 = ");" + NL + "  \t";
  protected final String TEXT_134 = NL + "  \t" + NL + "  \tint NB_FILE";
  protected final String TEXT_135 = " = 0;" + NL + "  \t" + NL + "  \tfor (String filemask_";
  protected final String TEXT_136 = " : maskList_";
  protected final String TEXT_137 = ") {//TD1024" + NL + "\t";
  protected final String TEXT_138 = NL + "\t\tfilemask_";
  protected final String TEXT_139 = " = org.apache.oro.text.GlobCompiler.globToPerl5(filemask_";
  protected final String TEXT_140 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);" + NL + "\t";
  protected final String TEXT_141 = "   " + NL + "\t\tString excludefilemask_";
  protected final String TEXT_142 = " = ";
  protected final String TEXT_143 = ";" + NL + "    \tList<java.util.regex.Pattern> excludefileNameEachPattern_";
  protected final String TEXT_144 = " = new java.util.ArrayList<java.util.regex.Pattern>();" + NL + "\t   \tif(excludefilemask_";
  protected final String TEXT_145 = "!=null && !\"\".equals(excludefilemask_";
  protected final String TEXT_146 = ")) {" + NL + "\t\t  \tfor(String excludefilemaskEach_";
  protected final String TEXT_147 = " : excludefilemask_";
  protected final String TEXT_148 = ".split(\",\")) {" + NL + "\t\t  \t";
  protected final String TEXT_149 = NL + "\t\t  \t\texcludefilemaskEach_";
  protected final String TEXT_150 = " = org.apache.oro.text.GlobCompiler.globToPerl5(excludefilemaskEach_";
  protected final String TEXT_151 = ".toCharArray(), org.apache.oro.text.GlobCompiler.DEFAULT_MASK);" + NL + "\t\t  \t";
  protected final String TEXT_152 = NL + "\t\t\t\texcludefileNameEachPattern_";
  protected final String TEXT_153 = ".add(java.util.regex.Pattern.compile(excludefilemaskEach_";
  protected final String TEXT_154 = ",java.util.regex.Pattern.CASE_INSENSITIVE));" + NL + "\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\texcludefileNameEachPattern_";
  protected final String TEXT_156 = ".add(java.util.regex.Pattern.compile(excludefilemaskEach_";
  protected final String TEXT_157 = "));" + NL + "\t\t\t";
  protected final String TEXT_158 = "\t  \t \t\t" + NL + "\t\t\t}" + NL + "\t  }";
  protected final String TEXT_159 = NL + "\tjava.util.regex.Pattern fileNamePattern_";
  protected final String TEXT_160 = " = java.util.regex.Pattern.compile(filemask_";
  protected final String TEXT_161 = ");" + NL + "\t";
  protected final String TEXT_162 = NL + "\tjava.util.regex.Pattern fileNamePattern_";
  protected final String TEXT_163 = " = java.util.regex.Pattern.compile(filemask_";
  protected final String TEXT_164 = ", java.util.regex.Pattern.CASE_INSENSITIVE);" + NL + "\t";
  protected final String TEXT_165 = NL + "\t" + NL + "\torg.apache.hadoop.fs.Path hdfsdir_";
  protected final String TEXT_166 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_167 = ");" + NL + "\tfinal java.util.List<org.apache.hadoop.fs.FileStatus> status_";
  protected final String TEXT_168 = " = new java.util.ArrayList<org.apache.hadoop.fs.FileStatus>();" + NL + "\tfinal org.apache.hadoop.fs.FileSystem filesystem_";
  protected final String TEXT_169 = " = fs_";
  protected final String TEXT_170 = ";" + NL + "\tfilesystem_";
  protected final String TEXT_171 = ".listStatus(hdfsdir_";
  protected final String TEXT_172 = ",new org.apache.hadoop.fs.PathFilter() {" + NL + "\t" + NL + "\t\tpublic boolean accept(org.apache.hadoop.fs.Path path) {" + NL + "\t\t\ttry {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileStatus statu = filesystem_";
  protected final String TEXT_173 = ".getFileStatus(path);" + NL + "\t\t\t\tif(statu.isDir()) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\t\tstatus_";
  protected final String TEXT_175 = ".add(statu);" + NL + "\t\t\t\t\t";
  protected final String TEXT_176 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\t\t\tfilesystem_";
  protected final String TEXT_178 = ".listStatus(path, this);" + NL + "\t\t\t\t\t";
  protected final String TEXT_179 = NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t\t\t\tstatus_";
  protected final String TEXT_181 = ".add(statu);" + NL + "\t\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t\t\t}" + NL + "\t\t\t} catch (java.io.FileNotFoundException e) {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t" + NL + "        \t\t";
  protected final String TEXT_183 = NL + "               \tlog.error(\"";
  protected final String TEXT_184 = " - \" + e.getMessage());";
  protected final String TEXT_185 = NL + "\t\t\t} catch (java.io.IOException e) {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t" + NL + "\t\t\t    ";
  protected final String TEXT_186 = NL + "               \tlog.error(\"";
  protected final String TEXT_187 = " - \" + e.getMessage());";
  protected final String TEXT_188 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "" + NL + "\t});" + NL + "\t" + NL + "\t";
  protected final String TEXT_189 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_190 = ");" + NL + "\t";
  protected final String TEXT_191 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_192 = ",new java.util.Comparator<org.apache.hadoop.fs.FileStatus>() {" + NL + "\t" + NL + "\t\tpublic int compare(org.apache.hadoop.fs.FileStatus f1, org.apache.hadoop.fs.FileStatus f2) {" + NL + "\t\t\tint result = 0;" + NL + "\t\t\tboolean f1IsFile = !f1.isDir(); " + NL + "\t\t\tboolean f2IsFile = !f2.isDir();" + NL + "\t\t\t" + NL + "\t\t\tif((f1IsFile && f2IsFile) || (!f1IsFile && !f2IsFile)) {" + NL + "\t\t\t\tresult = f1.getPath().getName().compareTo(f2.getPath().getName());" + NL + "\t\t\t} else if(f1IsFile && !f2IsFile) {" + NL + "\t\t\t\tresult = 1;" + NL + "\t\t\t} else if(!f1IsFile && f2IsFile) {" + NL + "\t\t\t\tresult = -1;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\treturn ";
  protected final String TEXT_193 = "-";
  protected final String TEXT_194 = "result;" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t});" + NL + "\t";
  protected final String TEXT_195 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_196 = ",new java.util.Comparator<org.apache.hadoop.fs.FileStatus>() {" + NL + "\t" + NL + "\t\tpublic int compare(org.apache.hadoop.fs.FileStatus f1, org.apache.hadoop.fs.FileStatus f2) {" + NL + "\t\t\tint result = 0;" + NL + "\t\t\tboolean f1IsFile = !f1.isDir(); " + NL + "\t\t\tboolean f2IsFile = !f2.isDir();" + NL + "\t\t\t" + NL + "\t\t\tif(f1IsFile && f2IsFile) {" + NL + "\t\t\t\tlong size_1 = f1.getLen();" + NL + "            \tlong size_2 = f2.getLen();" + NL + "                if (size_1 == size_2) {" + NL + "                    result = f1.getPath().getName().compareTo(f2.getPath().getName());" + NL + "                } else if (size_1 > size_2) {" + NL + "                    result = 1;" + NL + "                } else {" + NL + "                    result = -1;" + NL + "                }" + NL + "\t\t\t} else if(f1IsFile && !f2IsFile) {" + NL + "\t\t\t\tresult = 1;" + NL + "\t\t\t} else if(!f1IsFile && f2IsFile) {" + NL + "\t\t\t\tresult = -1;" + NL + "\t\t\t} else if(!f1IsFile && !f2IsFile) {" + NL + "\t\t\t\tresult = f1.getPath().getName().compareTo(f2.getPath().getName());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\treturn ";
  protected final String TEXT_197 = "-";
  protected final String TEXT_198 = "result;" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t});" + NL + "\t";
  protected final String TEXT_199 = NL + "\tjava.util.Collections.sort(status_";
  protected final String TEXT_200 = ",new java.util.Comparator<org.apache.hadoop.fs.FileStatus>() {" + NL + "\t" + NL + "\t\tpublic int compare(org.apache.hadoop.fs.FileStatus f1, org.apache.hadoop.fs.FileStatus f2) {" + NL + "\t\t\tint result = 0;" + NL + "\t\t\tboolean f1IsFile = !f1.isDir(); " + NL + "\t\t\tboolean f2IsFile = !f2.isDir();" + NL + "\t\t\t" + NL + "\t\t\tif((f1IsFile && f2IsFile) || (!f1IsFile && !f2IsFile)) {" + NL + "\t\t\t\tif(f1.getModificationTime() == f2.getModificationTime()) {" + NL + "\t\t\t\t\tresult = f1.getPath().getName().compareTo(f2.getPath().getName());" + NL + "\t\t\t\t} else if(f1.getModificationTime() > f2.getModificationTime()) {" + NL + "\t\t\t\t\tresult = 1;" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tresult = -1;" + NL + "\t\t\t\t}" + NL + "\t\t\t} else if(f1IsFile && !f2IsFile) {" + NL + "\t\t\t\tresult = 1;" + NL + "\t\t\t} else if(!f1IsFile && f2IsFile) {" + NL + "\t\t\t\tresult = -1;" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\treturn ";
  protected final String TEXT_201 = "-";
  protected final String TEXT_202 = "result;" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t});" + NL + "\t";
  protected final String TEXT_203 = NL + "\t" + NL + "\t";
  protected final String TEXT_204 = NL + "\t\tlog.info(\"";
  protected final String TEXT_205 = " - Start to list files\");" + NL + "\t";
  protected final String TEXT_206 = NL + "\tfor(int i_";
  protected final String TEXT_207 = "=0;i_";
  protected final String TEXT_208 = "<status_";
  protected final String TEXT_209 = ".size();i_";
  protected final String TEXT_210 = "++) {//TD512" + NL + "\t\torg.apache.hadoop.fs.FileStatus file_";
  protected final String TEXT_211 = " = status_";
  protected final String TEXT_212 = ".get(i_";
  protected final String TEXT_213 = ");" + NL + "\t\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_214 = " = file_";
  protected final String TEXT_215 = ".getPath();" + NL + "\t\tString fileName_";
  protected final String TEXT_216 = " = path_";
  protected final String TEXT_217 = ".getName();" + NL + "\t\t" + NL + "\t\tif (!fileNamePattern_";
  protected final String TEXT_218 = ".matcher(fileName_";
  protected final String TEXT_219 = ").matches()){" + NL + "          continue;" + NL + "        }" + NL + "        " + NL + "\t\t";
  protected final String TEXT_220 = " " + NL + "        boolean isExclude_";
  protected final String TEXT_221 = " = false;" + NL + "        for(java.util.regex.Pattern pattern : excludefileNameEachPattern_";
  protected final String TEXT_222 = ") {" + NL + "        \tif(pattern.matcher(fileName_";
  protected final String TEXT_223 = ").matches()) {" + NL + "        \t\tisExclude_";
  protected final String TEXT_224 = " = true;" + NL + "        \t\tbreak;" + NL + "        \t}" + NL + "        }" + NL + "        if(isExclude_";
  protected final String TEXT_225 = ") {" + NL + "          continue;" + NL + "        }" + NL + "\t\t";
  protected final String TEXT_226 = NL + "\t\t" + NL + "\t\tString currentFileName_";
  protected final String TEXT_227 = " = fileName_";
  protected final String TEXT_228 = ";" + NL + "\t\tString currentFilePath_";
  protected final String TEXT_229 = " = path_";
  protected final String TEXT_230 = ".toString();" + NL + "\t\tString currentFileDirectory_";
  protected final String TEXT_231 = " = path_";
  protected final String TEXT_232 = ".getParent().toString();" + NL + "\t\tString currentFileExtension_";
  protected final String TEXT_233 = " = \"\";" + NL + "\t\tif(!file_";
  protected final String TEXT_234 = ".isDir() && fileName_";
  protected final String TEXT_235 = ".contains(\".\")) {" + NL + "\t\t\tcurrentFileExtension_";
  protected final String TEXT_236 = " = fileName_";
  protected final String TEXT_237 = ".substring(fileName_";
  protected final String TEXT_238 = ".lastIndexOf(\".\")+1);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tNB_FILE";
  protected final String TEXT_239 = " ++;" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_240 = "_CURRENT_FILE\", currentFileName_";
  protected final String TEXT_241 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_242 = "_CURRENT_FILEPATH\", currentFilePath_";
  protected final String TEXT_243 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_244 = "_CURRENT_FILEDIRECTORY\", currentFileDirectory_";
  protected final String TEXT_245 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_246 = "_CURRENT_FILEEXTENSION\", currentFileExtension_";
  protected final String TEXT_247 = ");" + NL + "\t\tglobalMap.put(\"";
  protected final String TEXT_248 = "_NB_FILE\", NB_FILE";
  protected final String TEXT_249 = ");" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_250 = NL + "\t\tlog.info(\"";
  protected final String TEXT_251 = " - Current file or directory path : \" + currentFilePath_";
