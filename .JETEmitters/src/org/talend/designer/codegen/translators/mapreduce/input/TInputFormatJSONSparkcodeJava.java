...
public class TInputFormatJSONSparkcodeJava
{
  ...
  protected final String TEXT_136 = " == null || resultset_";
  protected final String TEXT_137 = ".isEmpty()){" + NL + "                    return false;" + NL + "                }" + NL + "                max = resultset_";
  protected final String TEXT_138 = ".size();" + NL + "                pos = 0;" + NL + "            }" + NL + "            //org.dom4j.tree.AbstractNode temp_";
  protected final String TEXT_139 = " = nodeList_";
  protected final String TEXT_140 = ".get(pos);" + NL + "            value.set(resultset_";
  protected final String TEXT_141 = ".get(pos));" + NL + "            pos++;" + NL + "            return true;" + NL + "        }" + NL + "" + NL + "        public NullWritable createKey() {" + NL + "            return NullWritable.get();" + NL + "        }" + NL + "" + NL + "        public ";
  protected final String TEXT_142 = " createValue() {  " + NL + "            return new ";
