...
public class TBoundedStreamInputSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TBoundedStreamInputSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TBoundedStreamInputSparkstreamingconfigJava result = new TBoundedStreamInputSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_136 = NL + NL + "Data_";
  protected final String TEXT_137 = " data_";
  protected final String TEXT_138 = " = new Data_";
  protected final String TEXT_139 = "();" + NL + "java.util.List<java.util.List<Object>> inputs_";
  protected final String TEXT_140 = " = data_";
  protected final String TEXT_141 = ".getData();" + NL + "java.util.List<java.util.List<";
  protected final String TEXT_142 = ">> formattedInputs_";
  protected final String TEXT_143 = " = new java.util.ArrayList<java.util.List<";
  protected final String TEXT_144 = ">>();" + NL + "" + NL + "java.util.List<";
  protected final String TEXT_145 = "> currentBatch_";
  protected final String TEXT_146 = " = new java.util.ArrayList<";
  protected final String TEXT_147 = ">(); " + NL + "formattedInputs_";
  protected final String TEXT_148 = ".add(currentBatch_";
  protected final String TEXT_149 = ");" + NL + "for (java.util.List<Object> input_";
  protected final String TEXT_150 = ": inputs_";
  protected final String TEXT_151 = ") {" + NL + "    if (data_";
  protected final String TEXT_152 = ".isBatchSeparator(input_";
  protected final String TEXT_153 = ")) {" + NL + "        currentBatch_";
  protected final String TEXT_154 = " = new java.util.ArrayList<";
  protected final String TEXT_155 = ">(); " + NL + "        formattedInputs_";
  protected final String TEXT_156 = ".add(currentBatch_";
  protected final String TEXT_157 = ");" + NL + "    } else {" + NL + "        currentBatch_";
  protected final String TEXT_158 = ".add(data_";
  protected final String TEXT_159 = ".transformToRowStruct(input_";
  protected final String TEXT_160 = "));" + NL + "    }" + NL + "}" + NL + "" + NL + "// Set up microbatches on the input queue." + NL + "org.apache.spark.streaming.api.java.JavaDStream<";
  protected final String TEXT_161 = "> ";
  protected final String TEXT_162 = "_sourceDStream = manualClock.prepareInput(formattedInputs_";
  protected final String TEXT_163 = ");" + NL + "" + NL + "org.apache.spark.streaming.api.java.JavaPairDStream<NullWritable, ";
  protected final String TEXT_164 = "> rdd_";
  protected final String TEXT_165 = " = ";
  protected final String TEXT_166 = "_sourceDStream.mapToPair(new ";
  protected final String TEXT_167 = "_mapToPair(job));" + NL;
