...
public class TModelEncoderSparkcodeJava
{
  protected static String nl;
  public static synchronized TModelEncoderSparkcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TModelEncoderSparkcodeJava result = new TModelEncoderSparkcodeJava();
    nl = null;
    return result;
  }
