...
public class THDFSInputFormatSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized THDFSInputFormatSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    THDFSInputFormatSparkstreamingconfigJava result = new THDFSInputFormatSparkstreamingconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_121 = " = ctx" + NL + "\t\t\t                .sparkContext().hadoopRDD(" + NL + "\t\t\t                        job," + NL + "\t\t\t                        ";
