...
public class TMDMViewSearchBeginJava
{
  ...
  protected final String TEXT_159 = "\");" + NL + "                org.talend.mdm.webservice.WSWhereCondition wc_";
  protected final String TEXT_160 = " = null;" + NL + "                java.util.List<org.talend.mdm.webservice.WSWhereItem> conditions_";
  protected final String TEXT_161 = " = new java.util.ArrayList<org.talend.mdm.webservice.WSWhereItem>();";
  protected final String TEXT_162 = NL + "                    wc_";
  protected final String TEXT_163 = " =new org.talend.mdm.webservice.WSWhereCondition(";
  protected final String TEXT_164 = ",org.talend.mdm.webservice.WSWhereOperator.";
  protected final String TEXT_165 = ", ";
  protected final String TEXT_166 = ", false, org.talend.mdm.webservice.WSStringPredicate.";
  protected final String TEXT_167 = ");" + NL + "                    org.talend.mdm.webservice.WSWhereItem wsItem_";
  protected final String TEXT_168 = "=new org.talend.mdm.webservice.WSWhereItem(null,wc_";
  protected final String TEXT_169 = ",null);" + NL + "                    conditions_";
  protected final String TEXT_170 = ".add(wsItem_";
  protected final String TEXT_171 = ");";
  protected final String TEXT_172 = NL + "                org.talend.mdm.webservice.WSWhereItem wsItem_";
  protected final String TEXT_173 = " = null;" + NL + "                if(conditions_";
  protected final String TEXT_174 = ".size() > 0){";
  protected final String TEXT_175 = NL + "                    org.talend.mdm.webservice.WSWhereAnd whereAnd_";
  protected final String TEXT_176 = " = new org.talend.mdm.webservice.WSWhereAnd(conditions_";
  protected final String TEXT_177 = ");" + NL + "                    wsItem_";
  protected final String TEXT_178 = " =new org.talend.mdm.webservice.WSWhereItem(whereAnd_";
  protected final String TEXT_179 = ",null,null);";
  protected final String TEXT_180 = NL + "                    org.talend.mdm.webservice.WSWhereOr whereOr_";
  protected final String TEXT_181 = " = new org.talend.mdm.webservice.WSWhereOr(conditions_";
  protected final String TEXT_182 = ");" + NL + "                    wsItem_";
  protected final String TEXT_183 = " =new org.talend.mdm.webservice.WSWhereItem(null,null,whereOr_";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "                }" + NL + "" + NL + "                org.talend.mdm.webservice.WSViewSearch wsViewSearch_";
  protected final String TEXT_186 = " = null;" + NL + "" + NL + "                int limit_";
  protected final String TEXT_187 = " = ";
  protected final String TEXT_188 = ";" + NL + "                int recordsPerPage_";
  protected final String TEXT_189 = " = ";
  protected final String TEXT_190 = ";" + NL + "                int skip_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";" + NL + "" + NL + "                if (skip_";
  protected final String TEXT_193 = " < 0)" + NL + "                    skip_";
  protected final String TEXT_194 = " = 0;" + NL + "" + NL + "                if (recordsPerPage_";
  protected final String TEXT_195 = " <= 0)" + NL + "                    recordsPerPage_";
  protected final String TEXT_196 = " = -1;// read whole records in one time" + NL + "" + NL + "                if (limit_";
  protected final String TEXT_197 = " <= 0)" + NL + "                    limit_";
  protected final String TEXT_198 = " = -1;// no limit" + NL + "" + NL + "                int retrievedCount_";
  protected final String TEXT_199 = " = 0;" + NL + "                   int readRecordsSize_";
  protected final String TEXT_200 = " = limit_";
  protected final String TEXT_201 = " == -1 ? recordsPerPage_";
  protected final String TEXT_202 = " : (recordsPerPage_";
  protected final String TEXT_203 = " == -1 ? limit_";
  protected final String TEXT_204 = " : (recordsPerPage_";
  protected final String TEXT_205 = " > limit_";
  protected final String TEXT_206 = " ? limit_";
  protected final String TEXT_207 = NL + "                : recordsPerPage_";
  protected final String TEXT_208 = "));" + NL + "" + NL + "                boolean continueFlag_";
  protected final String TEXT_209 = " = true;" + NL + "                int totalCount_";
  protected final String TEXT_210 = " = -1;";
  protected final String TEXT_211 = NL + "                while (continueFlag_";
  protected final String TEXT_212 = ") {" + NL + "                    wsViewSearch_";
  protected final String TEXT_213 = " = new org.talend.mdm.webservice.WSViewSearch();" + NL + "                    wsViewSearch_";
  protected final String TEXT_214 = ".setWsDataClusterPK(dataCluster_";
  protected final String TEXT_215 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_216 = ".setWsViewPK(new org.talend.mdm.webservice.WSViewPK(";
  protected final String TEXT_217 = "));" + NL + "" + NL + "                    wsViewSearch_";
  protected final String TEXT_218 = ".setSpellTreshold(";
  protected final String TEXT_219 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_220 = ".setSkip(skip_";
  protected final String TEXT_221 = " + retrievedCount_";
  protected final String TEXT_222 = ");" + NL + "                    wsViewSearch_";
  protected final String TEXT_223 = ".setMaxItems(readRecordsSize_";
  protected final String TEXT_224 = ");" + NL;
  protected final String TEXT_225 = NL + "                        wsViewSearch_";
  protected final String TEXT_226 = ".setOrderBy(";
  protected final String TEXT_227 = "); // OPTIONAL" + NL + "                        wsViewSearch_";
  protected final String TEXT_228 = ".setDirection(\"";
  protected final String TEXT_229 = "\"); // OPTIONAL";
  protected final String TEXT_230 = NL + "                    wsViewSearch_";
  protected final String TEXT_231 = ".setWhereItem(wsItem_";
  protected final String TEXT_232 = "); // OPTIONAL" + NL + "" + NL + "                    String[] items_";
  protected final String TEXT_233 = " = service_";
  protected final String TEXT_234 = ".viewSearch(wsViewSearch_";
  protected final String TEXT_235 = ").getStrings().toArray(new String[0]);" + NL;
  protected final String TEXT_236 = NL + NL + "                    if(totalCount_";
  protected final String TEXT_237 = " < 0){" + NL + "                        totalCount_";
  protected final String TEXT_238 = " = Integer.valueOf(items_";
  protected final String TEXT_239 = "[0].replaceAll(\"<totalCount>\", \"\").replaceAll(\"</totalCount>\", \"\"));";
  protected final String TEXT_240 = NL + "                    }" + NL + "" + NL + "                    retrievedCount_";
  protected final String TEXT_241 = " += items_";
  protected final String TEXT_242 = ".length - 1; // for header" + NL + "                    if (totalCount_";
  protected final String TEXT_243 = " == retrievedCount_";
  protected final String TEXT_244 = " || recordsPerPage_";
  protected final String TEXT_245 = " == -1 || items_";
  protected final String TEXT_246 = ".length < readRecordsSize_";
  protected final String TEXT_247 = " || limit_";
  protected final String TEXT_248 = " == retrievedCount_";
  protected final String TEXT_249 = ") {" + NL + "                        continueFlag_";
  protected final String TEXT_250 = " = false;" + NL + "                    } else if (limit_";
  protected final String TEXT_251 = " != -1 && limit_";
  protected final String TEXT_252 = " < retrievedCount_";
  protected final String TEXT_253 = " + readRecordsSize_";
  protected final String TEXT_254 = ") {" + NL + "                        readRecordsSize_";
  protected final String TEXT_255 = " = limit_";
  protected final String TEXT_256 = " - retrievedCount_";
  protected final String TEXT_257 = ";" + NL + "                    }" + NL + "" + NL + "                    for(int i_";
  protected final String TEXT_258 = "=1;i_";
  protected final String TEXT_259 = " < items_";
  protected final String TEXT_260 = ".length; i_";
  protected final String TEXT_261 = "++){" + NL + "                        nb_line_";
  protected final String TEXT_262 = " ++;";
  protected final String TEXT_263 = NL + "                        ";
  protected final String TEXT_264 = ".";
  protected final String TEXT_265 = " = items_";
