...
public class TSAPDSOOutputMainJava
{
  protected static String nl;
  public static synchronized TSAPDSOOutputMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDSOOutputMainJava result = new TSAPDSOOutputMainJava();
    nl = null;
    return result;
  }
