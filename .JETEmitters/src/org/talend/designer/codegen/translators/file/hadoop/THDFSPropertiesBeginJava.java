...
public class THDFSPropertiesBeginJava
{
  ...
  protected final String TEXT_127 = "Struct();" + NL + "\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_128 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_129 = ");" + NL + "\t" + NL + "\tif(fs_";
  protected final String TEXT_130 = ".exists(path_";
  protected final String TEXT_131 = ")) {" + NL + "\t    ";
  protected final String TEXT_132 = ".abs_path = path_";
  protected final String TEXT_133 = ".toString();" + NL + "\t    ";
  protected final String TEXT_134 = ".dirname = path_";
  protected final String TEXT_135 = ".getParent().toString();" + NL + "\t    ";
  protected final String TEXT_136 = ".basename = path_";
  protected final String TEXT_137 = ".getName();" + NL + "\t    " + NL + "\t    org.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_138 = " = fs_";
  protected final String TEXT_139 = ".getFileStatus(path_";
  protected final String TEXT_140 = ");" + NL + "\t    " + NL + "\t    StringBuffer stringBuffer_";
  protected final String TEXT_141 = " = new StringBuffer();" + NL + "\t    stringBuffer_";
  protected final String TEXT_142 = ".append(statu_";
  protected final String TEXT_143 = ".getPermission());" + NL + "\t    stringBuffer_";
  protected final String TEXT_144 = ".append(\"(owner=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_145 = ".append(statu_";
  protected final String TEXT_146 = ".getOwner());" + NL + "\t    stringBuffer_";
  protected final String TEXT_147 = ".append(\",\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_148 = ".append(\"group=\");" + NL + "\t    stringBuffer_";
  protected final String TEXT_149 = ".append(statu_";
  protected final String TEXT_150 = ".getGroup());" + NL + "\t    stringBuffer_";
  protected final String TEXT_151 = ".append(\")\");" + NL + "\t    ";
  protected final String TEXT_152 = ".mode_string = stringBuffer_";
  protected final String TEXT_153 = ".toString();" + NL + "\t    " + NL + "\t    ";
  protected final String TEXT_154 = ".size = statu_";
  protected final String TEXT_155 = ".getLen();" + NL + "\t    ";
  protected final String TEXT_156 = ".mtime = statu_";
  protected final String TEXT_157 = ".getModificationTime();" + NL + "\t    ";
  protected final String TEXT_158 = ".mtime_string =(new java.util.Date(statu_";
  protected final String TEXT_159 = ".getModificationTime())).toString();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_160 = NL + "\t\t\tif(!statu_";
  protected final String TEXT_161 = ".isDir()) {" + NL + "\t\t\t\torg.apache.hadoop.fs.FileChecksum checksum_";
  protected final String TEXT_162 = " = fs_";
  protected final String TEXT_163 = ".getFileChecksum(path_";
  protected final String TEXT_164 = ");" + NL + "\t\t\t\tif(checksum_";
  protected final String TEXT_165 = "!=null) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = ".md5 = checksum_";
  protected final String TEXT_167 = ".toString();" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_168 = NL + "\t\t" + NL + "\t\t" + NL + "\t}" + NL + "\t";
  protected final String TEXT_169 = NL + "\telse {" + NL + "\t\tlog.warn(\"";
  protected final String TEXT_170 = " - file or directory : \" + path_";
  protected final String TEXT_171 = " + \" does not exist.\");" + NL + "\t}" + NL + "\t";
