...
public class THCatalogInputBeginJava
{
  ...
  protected final String TEXT_230 = NL + NL + "                maprLogin_";
  protected final String TEXT_231 = ".getMapRCredentialsViaPassword(";
  protected final String TEXT_232 = ", ";
  protected final String TEXT_233 = ", decryptedPassword_";
  protected final String TEXT_234 = ", ";
  protected final String TEXT_235 = ");";
  protected final String TEXT_236 = NL + "\t\t\tusername_";
  protected final String TEXT_237 = " = ";
  protected final String TEXT_238 = ";";
  protected final String TEXT_239 = NL + "\t\t\t\tconf_";
  protected final String TEXT_240 = ".set(";
  protected final String TEXT_241 = " ,";
  protected final String TEXT_242 = ");";
  protected final String TEXT_243 = NL + "\t\tif(username_";
  protected final String TEXT_244 = " == null || \"\".equals(username_";
  protected final String TEXT_245 = ")){" + NL + "\t\t\tfs_";
  protected final String TEXT_246 = " = org.apache.hadoop.fs.FileSystem.get(conf_";
  protected final String TEXT_247 = ");" + NL + "\t\t}else{" + NL + "\t\t\tfs_";
  protected final String TEXT_248 = " = org.apache.hadoop.fs.FileSystem.get(new java.net.URI(conf_";
  protected final String TEXT_249 = ".get(\"fs.default.name\")),conf_";
  protected final String TEXT_250 = ",username_";
  protected final String TEXT_251 = ");" + NL + "\t\t}\t" + NL + "" + NL + "\t\torg.apache.hadoop.fs.FileStatus [] fileStatus_";
  protected final String TEXT_252 = "= fs_";
  protected final String TEXT_253 = ".listStatus(new org.apache.hadoop.fs.Path(pathHDFS_";
  protected final String TEXT_254 = "));";
  protected final String TEXT_255 = NL + "\t\tfor(int i_";
  protected final String TEXT_256 = "=0; i_";
  protected final String TEXT_257 = "<fileStatus_";
  protected final String TEXT_258 = ".length; i_";
  protected final String TEXT_259 = "++) {" + NL + "\t\t\tif(fileStatus_";
  protected final String TEXT_260 = "[i_";
  protected final String TEXT_261 = "].isDir()) {" + NL + "\t\t\t\tcontinue;" + NL + "\t\t\t}" + NL + "\t\t\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_262 = " = fileStatus_";
  protected final String TEXT_263 = "[i_";
  protected final String TEXT_264 = "].getPath();" + NL + "\t\t\torg.apache.hadoop.fs.FSDataInputStream fsDataInputStream_";
  protected final String TEXT_265 = " = fs_";
  protected final String TEXT_266 = ".open(path_";
  protected final String TEXT_267 = ");" + NL + "\t\t\torg.talend.fileprocess.FileInputDelimited fid_";
  protected final String TEXT_268 = " = new org.talend.fileprocess.FileInputDelimited(fsDataInputStream_";
  protected final String TEXT_269 = ", ";
  protected final String TEXT_270 = ",";
  protected final String TEXT_271 = ",";
  protected final String TEXT_272 = ",false,0,0,-1,-1, false);" + NL + "\t\t\twhile (fid_";
  protected final String TEXT_273 = ".nextRecord()) {";
