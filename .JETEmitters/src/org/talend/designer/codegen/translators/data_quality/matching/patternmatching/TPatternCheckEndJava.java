...
public class TPatternCheckEndJava
{
  protected static String nl;
  public static synchronized TPatternCheckEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TPatternCheckEndJava result = new TPatternCheckEndJava();
    nl = null;
    return result;
  }
