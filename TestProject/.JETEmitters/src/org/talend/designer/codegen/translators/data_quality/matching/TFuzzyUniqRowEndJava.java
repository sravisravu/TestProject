...
public class TFuzzyUniqRowEndJava
{
  protected static String nl;
  public static synchronized TFuzzyUniqRowEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFuzzyUniqRowEndJava result = new TFuzzyUniqRowEndJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = ".get());" + NL + "globalMap.put(\"";
