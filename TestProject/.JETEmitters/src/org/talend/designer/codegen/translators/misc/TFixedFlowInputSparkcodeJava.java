...
public class TFixedFlowInputSparkcodeJava
{
  ...
  protected final String TEXT_271 = NL + NL + "    public java.util.List<scala.Tuple2<NullWritable, ";
  protected final String TEXT_272 = ">> getPairList() {" + NL + "        java.util.List<scala.Tuple2<NullWritable, ";
  protected final String TEXT_273 = ">> list" + NL + "                = new java.util.ArrayList<scala.Tuple2<NullWritable, ";
  ...
  protected final String TEXT_279 = NL + "                 list.add(new scala.Tuple2<NullWritable,";
  protected final String TEXT_280 = ">(null, row));" + NL + "            }" + NL + "        }" + NL + "        return list;" + NL + "    }" + NL + "}" + NL;
