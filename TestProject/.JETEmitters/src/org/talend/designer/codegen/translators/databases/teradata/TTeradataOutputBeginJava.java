...
public class TTeradataOutputBeginJava {
  ...
  protected final String TEXT_421 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_422 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_423 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_424 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_425 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_426 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_427 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_431 = ".getMetaData();" + NL + "                                java.sql.ResultSet rsTable_";
  protected final String TEXT_432 = " = dbMetaData_";
  protected final String TEXT_433 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_434 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_435 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_436 = " = rsTable_";
  protected final String TEXT_437 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_438 = ".equalsIgnoreCase(";
  protected final String TEXT_439 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_440 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  protected final String TEXT_441 = ".close();";
  protected final String TEXT_442 = NL + "                                if(!whetherExist_";
  protected final String TEXT_443 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_451 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_463 = NL + "                                if(whetherExist_";
  protected final String TEXT_464 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  protected final String TEXT_465 = " = conn_";
  protected final String TEXT_466 = ".createStatement();";
  protected final String TEXT_467 = NL + "                                                      stmtDrop_";
  protected final String TEXT_468 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_469 = "));";
  protected final String TEXT_470 = NL + "                                    stmtDrop_";
  protected final String TEXT_471 = ".execute(\"";
  protected final String TEXT_472 = "\" ";
  protected final String TEXT_473 = ");";
  protected final String TEXT_474 = NL + "                                    stmtDrop_";
  protected final String TEXT_475 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_483 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_491 = ".execute(\"";
  protected final String TEXT_492 = ")\");";
  protected final String TEXT_493 = NL + "                                stmtCreate_";
  protected final String TEXT_494 = ".close();";
  protected final String TEXT_495 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_496 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_497 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_504 = ".executeUpdate(\"";
  ...
  protected final String TEXT_510 = ".createStatement();";
  protected final String TEXT_511 = NL + "                              stmtTruncCount_";
  protected final String TEXT_512 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_513 = "));";
  protected final String TEXT_514 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_515 = " = stmtTruncCount_";
  protected final String TEXT_516 = ".executeQuery(\"";
  protected final String TEXT_517 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_518 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_519 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_523 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_524 = " = conn_";
  protected final String TEXT_525 = ".createStatement();";
  protected final String TEXT_526 = NL + "                              stmtTrunc_";
  protected final String TEXT_527 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_534 = NL + "                if(!conn_";
  protected final String TEXT_535 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_536 = ".commit();" + NL + "                }";
  protected final String TEXT_537 = NL + "            deletedCount_";
  protected final String TEXT_538 = " += rsTruncCountNumber_";
  protected final String TEXT_539 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_540 = ".close();";
  protected final String TEXT_541 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_542 = " = conn_";
  protected final String TEXT_543 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_544 = " = stmtTruncCount_";
  protected final String TEXT_545 = ".executeQuery(\"";
  protected final String TEXT_546 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_547 = " = conn_";
  protected final String TEXT_548 = ".createStatement();";
  protected final String TEXT_549 = NL + "                conn_";
  protected final String TEXT_550 = ".commit();";
  protected final String TEXT_551 = NL + "            stmtTrunc_";
  protected final String TEXT_552 = ".executeUpdate(\"";
  protected final String TEXT_553 = "\");";
  protected final String TEXT_554 = NL + "            while(rsTruncCount_";
  protected final String TEXT_555 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_556 = " += rsTruncCount_";
  protected final String TEXT_557 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_558 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_559 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_579 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_588 = ");" + NL + "\t    String update_";
  protected final String TEXT_589 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_618 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_624 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  ...
  protected final String TEXT_630 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_631 = " = insert_";
  protected final String TEXT_632 = ".split(\"\\\\?\");";
  protected final String TEXT_633 = NL + "\t\t\tdelete_";
  protected final String TEXT_634 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_635 = " = delete_";
  protected final String TEXT_636 = ".split(\"\\\\?\");";
  protected final String TEXT_637 = NL + "\t\t\treplace_";
  protected final String TEXT_638 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_639 = " = replace_";
  protected final String TEXT_640 = ".split(\"\\\\?\");";
  protected final String TEXT_641 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_642 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_643 = " = insertIgnore_";
  ...
  protected final String TEXT_649 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_650 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_651 = " =null;" + NL + "\t";
  protected final String TEXT_652 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_653 = " = null;" + NL + "\t\t";
  protected final String TEXT_654 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_658 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_659 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_660 = " = null;";
  protected final String TEXT_661 = NL + "\t\t   \tString[] deleteSQLSplits_";
  ...
  protected final String TEXT_667 = NL + "\t\t \tString[] insertSQLSplits_";
