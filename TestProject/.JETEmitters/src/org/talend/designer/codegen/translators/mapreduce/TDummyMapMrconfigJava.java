...
public class TDummyMapMrconfigJava
{
  protected static String nl;
  public static synchronized TDummyMapMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TDummyMapMrconfigJava result = new TDummyMapMrconfigJava();
    nl = null;
    return result;
  }
