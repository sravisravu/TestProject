...
public class TSAPInfoObjectOutputOutBeginJava
{
  ...
  protected final String TEXT_61 = NL + NL + "\torg.talend.sap.bw.ISAPBWTableDataWritable data_";
  protected final String TEXT_62 = " = dataService_";
  protected final String TEXT_63 = NL + "\t";
  protected final String TEXT_64 = NL + "\t\t.createInfoObjectAttributeRequest(";
  ...
  protected final String TEXT_70 = NL + "      \t.protocolWork(";
  protected final String TEXT_71 = ")" + NL + "      \t";
  protected final String TEXT_72 = NL + " \t\t.updateAllAttributes(";
  protected final String TEXT_73 = ")" + NL + " \t\t";
  protected final String TEXT_74 = NL + " \t\t" + NL + "\t\t.writable();";
