...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_533 = "    " + NL + "" + NL + "        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_571 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_587 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_612 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_613 = " = new StringBuffer(insert_";
  protected final String TEXT_614 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_615 = ".insert(insert_";
  protected final String TEXT_616 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_617 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_618 = " =insertStringBuffer_";
  protected final String TEXT_619 = ".toString(); ";
  protected final String TEXT_620 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_664 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
