...
public class TJavaStormStormconfigJava
{
  protected static String nl;
  public static synchronized TJavaStormStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaStormStormconfigJava result = new TJavaStormStormconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_48 = ".each(";
  protected final String TEXT_49 = NL + "                ";
  protected final String TEXT_50 = "," + NL + "                new StormFunction_";
