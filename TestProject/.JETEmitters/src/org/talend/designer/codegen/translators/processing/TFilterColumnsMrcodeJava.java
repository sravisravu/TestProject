...
public class TFilterColumnsMrcodeJava
{
  protected static String nl;
  public static synchronized TFilterColumnsMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsMrcodeJava result = new TFilterColumnsMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_129 = " " + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t" + NL + "\t";
