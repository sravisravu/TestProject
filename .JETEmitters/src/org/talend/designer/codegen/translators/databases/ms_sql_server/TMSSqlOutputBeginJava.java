...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_365 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_366 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_367 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_368 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_369 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  ...
  protected final String TEXT_381 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_382 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_408 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_419 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_534 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_540 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_575 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  ...
  protected final String TEXT_580 = ") VALUES (";
  ...
  protected final String TEXT_585 = NL + NL + "    class BufferLine_";
  ...
  protected final String TEXT_600 = "> sInsertColValueList";
  protected final String TEXT_601 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_602 = " sInsertColValue";
  protected final String TEXT_603 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_604 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_605 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_606 = ".append(\"(";
  protected final String TEXT_607 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_608 = "-1) extendInsertValueStmt_";
  protected final String TEXT_609 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_610 = " = \"INSERT INTO \"+";
  protected final String TEXT_611 = "+\" (";
  protected final String TEXT_612 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_613 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_614 = " =  conn_";
  protected final String TEXT_615 = ".prepareStatement(insert_";
  protected final String TEXT_616 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_617 = " = \"";
  protected final String TEXT_618 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_619 = " =  \"";
  protected final String TEXT_620 = "\";" + NL + "    int rowCount";
  protected final String TEXT_621 = " = 0;";
  ...
  protected final String TEXT_652 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_653 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_654 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_655 = "\") == true;";
  protected final String TEXT_656 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_657 = " = conn_";
  protected final String TEXT_658 = ".createStatement();";
  protected final String TEXT_659 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_660 = " ) {" + NL + "\t        \tstmt_";
  protected final String TEXT_661 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_662 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_663 = NL + "     \t\tstmt_";
  protected final String TEXT_664 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_665 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_666 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_667 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_668 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_669 = " =null;" + NL + "\t";
  protected final String TEXT_670 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_671 = " = null;" + NL + "\t\t";
  protected final String TEXT_672 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_677 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_678 = " = null;";
  protected final String TEXT_679 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_680 = " = null;";
  protected final String TEXT_681 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_682 = " = null;";
  protected final String TEXT_683 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_684 = " = null;";
  protected final String TEXT_685 = NL + "\t\t \tString[] insertSQLSplits_";
