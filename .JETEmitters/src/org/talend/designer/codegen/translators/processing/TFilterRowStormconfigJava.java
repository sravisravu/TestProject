...
public class TFilterRowStormconfigJava
{
  protected static String nl;
  public static synchronized TFilterRowStormconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterRowStormconfigJava result = new TFilterRowStormconfigJava();
    nl = null;
    return result;
  }
...
rowTransformUtil.generateStormConfig(tFilterRowUtil);
