...
public class TMysqlInputMrconfigJava
{
  protected static String nl;
  public static synchronized TMysqlInputMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMysqlInputMrconfigJava result = new TMysqlInputMrconfigJava();
    nl = null;
    return result;
  }
