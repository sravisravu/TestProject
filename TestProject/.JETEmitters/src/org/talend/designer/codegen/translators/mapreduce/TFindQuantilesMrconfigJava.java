...
public class TFindQuantilesMrconfigJava
{
  protected static String nl;
  public static synchronized TFindQuantilesMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFindQuantilesMrconfigJava result = new TFindQuantilesMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_227 = NL + "    job.setInt(\"talend.component.tsortrow.quantiles\", job.getNumReduceTasks());" + NL + "\tjob.setNumReduceTasks(1);" + NL + "\tjob.setPartitionerClass(OneReducePartitioner_";
  protected final String TEXT_228 = ".class);" + NL + "\tjob.setOutputValueGroupingComparator(OneGroupingComparator_";
  protected final String TEXT_229 = ".class);" + NL + "\tjob.setOutputKeyComparatorClass(CompositeKeyComparator_";
  protected final String TEXT_230 = ".class);";
