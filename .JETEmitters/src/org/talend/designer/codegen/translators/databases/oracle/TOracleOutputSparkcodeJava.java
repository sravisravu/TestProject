...
public class TOracleOutputSparkcodeJava {
  ...
  protected final String TEXT_4 = NL + "\t\tpublic static class BlobTypeUtil_";
  protected final String TEXT_5 = " {" + NL + "\t\t" + NL + "\t\t\tpublic Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "\t\t\t\tif(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "\t\t\t\t\treturn data;" + NL + "\t\t\t}" + NL + "\t\t" + NL + "\t\t\toracle.sql.BLOB blob = null;" + NL + "\t\t\tjava.io.InputStream in = null;" + NL + "\t\t\tjava.io.OutputStream out = null;" + NL + "\t\t\ttry{" + NL + "\t\t\t\t//in" + NL + "\t\t\t\tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "\t\t\t\tin = blobData.getBinaryStream();" + NL + "\t\t" + NL + "\t\t    \t//out" + NL + "\t\t\t\tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "\t\t\t\tblob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "\t\t\t\t//blob = conn.createBlob(); oracle jdbc don't support it" + NL + "\t\t    \tout = blob.setBinaryStream(1);" + NL + "\t\t" + NL + "\t\t\t\tbyte[] cache = new byte[8192];" + NL + "\t\t\t\tint len = 0;" + NL + "\t\t\t\twhile ((len = in.read(cache)) != -1) {" + NL + "\t\t\t\t    out.write(cache, 0, len);" + NL + "\t\t\t\t}" + NL + "\t\t" + NL + "\t\t\t\treturn blob;" + NL + "\t\t    } catch(java.sql.SQLException sqlexp){" + NL + "\t\t\t\tif(blob!=null) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tblob.freeTemporary();" + NL + "\t\t\t\t\t} catch(java.sql.SQLException e_";
  protected final String TEXT_6 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t    \t\t}" + NL + "\t\t    \t}" + NL + "\t\t    \tsqlexp.printStackTrace();" + NL + "\t\t\t} catch(java.lang.Exception exp){" + NL + "\t\t   \tif(blob!=null) {" + NL + "\t\t\t\ttry {" + NL + "\t\t    \t\tblob.freeTemporary();" + NL + "\t\t    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_7 = ") {" + NL + "\t\t\t\t\t//keep quiet" + NL + "\t\t    \t}" + NL + "\t\t    }" + NL + "\t\t    exp.printStackTrace();" + NL + "\t\t\t} finally {" + NL + "\t\t\t\tif(out!=null) {" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tout.flush();" + NL + "\t\t    \t\t\tout.close();" + NL + "\t\t    \t\t} catch(java.io.IOException e_";
  protected final String TEXT_8 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t" + NL + "\t\t\t \tif(in!=null) {" + NL + "\t\t    \t\ttry {" + NL + "\t\t        \t\tin.close();" + NL + "\t\t        \t} catch(java.io.IOException e_";
  protected final String TEXT_9 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t" + NL + "\t\t    \tif(blob!=null) {" + NL + "\t\t    \t\ttry {" + NL + "\t\t        \t\tblob.close();" + NL + "\t\t        \t} catch(java.sql.SQLException e_";
  protected final String TEXT_10 = ") {" + NL + "\t\t\t\t\t\t//keep quiet" + NL + "\t\t        \t}" + NL + "\t\t    \t}" + NL + "\t\t    }" + NL + "\t\t" + NL + "\t\t    return null;" + NL + "\t\t" + NL + "\t\t    }" + NL + "\t\t" + NL + "\t\t}";
  protected final String TEXT_11 = NL + NL + NL + "\t\tpublic static class ";
  protected final String TEXT_12 = "_OutputFunction implements org.apache.spark.api.java.function.VoidFunction<java.util.Iterator<";
  protected final String TEXT_13 = ">> {" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_14 = NL;
  protected final String TEXT_15 = NL + "\t\tint batchSize = -1;" + NL + "\t\tint batchSizeCounter = 0;";
  protected final String TEXT_16 = NL + NL + "\t\t\tContextProperties context;" + NL + "" + NL + "\t\t\tpublic ";
  protected final String TEXT_17 = "_OutputFunction(JobConf conf) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    this(new ContextProperties(conf));" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tpublic ";
  protected final String TEXT_18 = "_OutputFunction(ContextProperties context) throws ClassNotFoundException, java.sql.SQLException {" + NL + "\t\t\t    Class.forName(";
  protected final String TEXT_19 = ");" + NL + "\t\t\t    this.context = context;" + NL + "\t\t\t    ";
  protected final String TEXT_20 = NL;
  protected final String TEXT_21 = NL + "\t\tbatchSize = ";
  protected final String TEXT_22 = ";";
  protected final String TEXT_23 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\tpublic void call(java.util.Iterator<";
  protected final String TEXT_24 = "> dataIterator) throws java.lang.Exception {" + NL + "\t\t\t\tjava.sql.Connection connection = ";
  protected final String TEXT_25 = ".get(context).borrowObject();" + NL + "\t\t\t\t" + NL + "\t\t\t\t// Not to break retro-compatibility with JDBC Talend Data Integration util classes" + NL + "\t\t\t\tjava.sql.Connection conn_";
  protected final String TEXT_26 = " = connection;";
  protected final String TEXT_27 = NL + "        \t\t\tBlobTypeUtil_";
  protected final String TEXT_28 = " blobTypeUtil_";
  protected final String TEXT_29 = " = new BlobTypeUtil_";
  protected final String TEXT_30 = "();";
  protected final String TEXT_31 = NL + NL + "\t\t\t\ttry {\t\t ";
  protected final String TEXT_32 = NL + "\t\t\t\t\t";
  protected final String TEXT_33 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_34 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_35 = "\" + ";
  protected final String TEXT_36 = " + \"";
  protected final String TEXT_37 = " (";
  protected final String TEXT_38 = ") VALUES(";
  protected final String TEXT_39 = ")\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_40 = " ";
  protected final String TEXT_41 = " = dataIterator.next();";
  protected final String TEXT_42 = NL + "\t\t\t";
  protected final String TEXT_43 = NL + "\t";
  protected final String TEXT_44 = NL;
  protected final String TEXT_45 = NL + "\tpstmt_";
  protected final String TEXT_46 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_47 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_51 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_52 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_53 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_54 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_55 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_56 = NL + "\t}             ";
  protected final String TEXT_57 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_58 = NL;
  protected final String TEXT_59 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_60 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_61 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_62 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_63 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_64 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_65 = NL + NL + "pstmt_";
  protected final String TEXT_66 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\t\t";
  protected final String TEXT_68 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_69 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_70 = "\" + ";
  protected final String TEXT_71 = " + \"";
  protected final String TEXT_72 = " SET ";
  protected final String TEXT_73 = " WHERE ";
  protected final String TEXT_74 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_75 = " ";
  protected final String TEXT_76 = " = dataIterator.next();";
  protected final String TEXT_77 = NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t";
  protected final String TEXT_80 = NL;
  protected final String TEXT_81 = NL + "\tpstmt_";
  protected final String TEXT_82 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_83 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_87 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_88 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_89 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_90 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_91 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_92 = NL + "\t}             ";
  protected final String TEXT_93 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_94 = NL;
  protected final String TEXT_95 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_96 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_97 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_98 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_99 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_100 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_101 = NL + NL + "pstmt_";
  protected final String TEXT_102 = ".close();";
  protected final String TEXT_103 = NL + "\t\t\t\t\t";
  protected final String TEXT_104 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_105 = " = connection.prepareStatement(\"SELECT COUNT(1) FROM ";
  ...
  protected final String TEXT_110 = " = connection.prepareStatement(\"INSERT INTO ";
  protected final String TEXT_111 = "\" + ";
  protected final String TEXT_112 = " + \"";
  protected final String TEXT_113 = " (";
  protected final String TEXT_114 = ") VALUES (";
  protected final String TEXT_115 = ")\");" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_116 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_117 = "\" + ";
  protected final String TEXT_118 = " +\"";
  protected final String TEXT_119 = " SET ";
  protected final String TEXT_120 = " WHERE ";
  protected final String TEXT_121 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_122 = " ";
  protected final String TEXT_123 = " = dataIterator.next();";
  ...
  protected final String TEXT_128 = " = -1;" + NL + "\t" + NL + "\twhile(rs_";
  ...
  protected final String TEXT_135 = NL + "\t\t pstmtUpdate_";
  protected final String TEXT_136 = ".executeUpdate();" + NL + "\t} else {";
  protected final String TEXT_137 = NL + "\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_139 = ".executeUpdate();" + NL + "\t}\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmt_";
  protected final String TEXT_140 = ".close();" + NL + "pstmtInsert_";
  protected final String TEXT_141 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_142 = ".close();";
  protected final String TEXT_143 = NL + "\t\t\t\t\t";
  protected final String TEXT_144 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_145 = " = connection.prepareStatement(\"INSERT INTO ";
  ...
  protected final String TEXT_151 = " = connection.prepareStatement(\"UPDATE ";
  protected final String TEXT_152 = "\" + ";
  protected final String TEXT_153 = " +\"";
  protected final String TEXT_154 = " SET ";
  protected final String TEXT_155 = " WHERE ";
  protected final String TEXT_156 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_157 = " ";
  protected final String TEXT_158 = " = dataIterator.next();";
  protected final String TEXT_159 = NL + "\t\t\t";
  protected final String TEXT_160 = NL + "\t\t\t";
  protected final String TEXT_161 = NL + "\tint updateFlag_";
  protected final String TEXT_162 = " = pstmtUpdate_";
  protected final String TEXT_163 = ".executeUpdate();" + NL + "\t" + NL + "\tif(updateFlag_";
  protected final String TEXT_164 = " == 0) {";
  protected final String TEXT_165 = NL + "\t\t\t\t";
  protected final String TEXT_166 = NL + "\t\tpstmtInsert_";
  protected final String TEXT_167 = ".executeUpdate();" + NL + "\t}" + NL + "} // end while (dataIterator.hasNext())" + NL + "" + NL + "pstmtInsert_";
  protected final String TEXT_168 = ".close();" + NL + "pstmtUpdate_";
  protected final String TEXT_169 = ".close();";
  protected final String TEXT_170 = NL + "\t\t\t\t\t";
  protected final String TEXT_171 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_172 = " = connection.prepareStatement(\"DELETE FROM ";
  protected final String TEXT_173 = "\" + ";
  protected final String TEXT_174 = " + \"";
  protected final String TEXT_175 = " WHERE ";
  protected final String TEXT_176 = "\");" + NL + "" + NL + "while (dataIterator.hasNext()) {" + NL + "\t";
  protected final String TEXT_177 = " ";
  protected final String TEXT_178 = " = dataIterator.next();";
  protected final String TEXT_179 = NL + "\t\t\t";
  protected final String TEXT_180 = NL + "\t";
  protected final String TEXT_181 = NL;
  protected final String TEXT_182 = NL + "\tpstmt_";
  protected final String TEXT_183 = ".addBatch();" + NL + "\tbatchSizeCounter++;" + NL + "\tif (batchSizeCounter >= batchSize) {" + NL + "\t\ttry{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_184 = ".executeBatch();" + NL + "\t\t}catch(Exception e){";
  ...
  protected final String TEXT_188 = ".clearBatch();" + NL + "\t\tbatchSizeCounter = 0;" + NL + "\t}";
  protected final String TEXT_189 = NL + "\ttry{" + NL + "\t\tpstmt_";
  protected final String TEXT_190 = ".executeUpdate();" + NL + "\t}catch(Exception e){";
  protected final String TEXT_191 = "                            " + NL + "\t\t\tthrow(e);";
  protected final String TEXT_192 = NL + "\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_193 = NL + "\t}             ";
  protected final String TEXT_194 = NL + "\t\t\t\t\t" + NL + "} // end while (dataIterator.hasNext())" + NL;
  protected final String TEXT_195 = NL;
  protected final String TEXT_196 = NL + "\t\tif (batchSizeCounter != 0) {" + NL + "\t\t    try{" + NL + "\t\t\t\tpstmt_";
  protected final String TEXT_197 = ".executeBatch();" + NL + "\t\t\t}catch(Exception e){";
  protected final String TEXT_198 = "                            " + NL + "\t\t\t\t\tthrow(e);";
  protected final String TEXT_199 = NL + "\t\t\t\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_200 = NL + "\t\t\t}" + NL + "\t\t\tpstmt_";
  protected final String TEXT_201 = ".clearBatch();" + NL + "\t\t}";
  protected final String TEXT_202 = NL + NL + "pstmt_";
  protected final String TEXT_203 = ".close();" + NL + "\t\t\t\t";
  protected final String TEXT_204 = NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\tif(connection != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_205 = ".get(context).returnObject(connection);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t} // end call()" + NL + "\t\t} // end class" + NL;
  protected final String TEXT_206 = NL + "\t\t\t";
  protected final String TEXT_207 = NL + NL + "public static class ";
  protected final String TEXT_208 = " {" + NL + "\tprivate static volatile org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_209 = "> pool;" + NL + "\t" + NL + "\tprivate ";
  protected final String TEXT_210 = "() {" + NL + "\t    // empty" + NL + "\t}" + NL + "" + NL + "\tpublic static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_211 = "> get(ContextProperties context) {" + NL + "\t\tif(pool == null) {" + NL + "\t\t\tsynchronized(";
  protected final String TEXT_212 = ".class) {" + NL + "\t\t\t\tif(pool == null) {" + NL + "\t\t\t\t\tpool = createPool(context);" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t   return pool;" + NL + "\t}" + NL + "" + NL + "\tprivate static org.apache.commons.pool2.ObjectPool<";
  protected final String TEXT_213 = "> createPool(ContextProperties context) {" + NL + "\t    org.apache.commons.pool2.impl.GenericObjectPoolConfig config = new org.apache.commons.pool2.impl.GenericObjectPoolConfig();" + NL + "\t    config.setMaxTotal(";
  protected final String TEXT_214 = ");" + NL + "\t    config.setMaxWaitMillis(";
  protected final String TEXT_215 = ");" + NL + "\t    config.setMinIdle(";
  protected final String TEXT_216 = ");" + NL + "\t    config.setMaxIdle(";
  protected final String TEXT_217 = ");" + NL + "\t    config.setBlockWhenExhausted(true);";
  protected final String TEXT_218 = NL + "\t\t\tconfig.setTimeBetweenEvictionRunsMillis(";
  protected final String TEXT_219 = ");" + NL + "\t\t\tconfig.setMinEvictableIdleTimeMillis(";
  protected final String TEXT_220 = ");" + NL + "\t\t\tconfig.setSoftMinEvictableIdleTimeMillis(";
  protected final String TEXT_221 = ");";
  protected final String TEXT_222 = NL + "\t    return new org.apache.commons.pool2.impl.GenericObjectPool<";
  protected final String TEXT_223 = ">(new ";
  protected final String TEXT_224 = "(context), config);" + NL + "\t}" + NL + "}" + NL + "\t\t\t";
  protected final String TEXT_225 = NL + NL + "public static class ";
  protected final String TEXT_226 = " extends org.apache.commons.pool2.BasePooledObjectFactory<";
  protected final String TEXT_227 = "> {" + NL + "" + NL + "\tprivate ContextProperties context;" + NL + "\t" + NL + "\tpublic ";
  protected final String TEXT_228 = "(ContextProperties context) {" + NL + "\t\tthis.context = context;" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic ";
  protected final String TEXT_229 = " create() throws Exception {" + NL + "\t   Class.forName(";
  protected final String TEXT_230 = ");" + NL + "\t\tjava.util.Properties jdbcDriverProperties = new java.util.Properties();" + NL + "\t\tString jdbcAdditionalParameters = ";
  protected final String TEXT_231 = ";" + NL + "\t\tif(jdbcAdditionalParameters != null && !\"\\\"\\\"\".equals(jdbcAdditionalParameters) && !\"\".equals(jdbcAdditionalParameters)){" + NL + "\t\t\tjdbcDriverProperties.load(new java.io.ByteArrayInputStream(jdbcAdditionalParameters.replace(";
  protected final String TEXT_232 = ", \"\\n\").getBytes()));" + NL + "\t\t}" + NL + "\t\tif(";
  protected final String TEXT_233 = " != null && !\"\\\"\\\"\".equals(";
  protected final String TEXT_234 = ") && !\"\".equals(";
  protected final String TEXT_235 = ")){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"user\", ";
  protected final String TEXT_236 = ");" + NL + "\t\t}" + NL + "\t\tString password = ";
  protected final String TEXT_237 = " ;" + NL + "\t\tif(password != null && !\"\\\"\\\"\".equals(password) && !\"\".equals(password)){" + NL + "\t\t\tjdbcDriverProperties.setProperty(\"password\", password);" + NL + "\t\t}" + NL + "\t   return java.sql.DriverManager.getConnection(";
  protected final String TEXT_238 = ", jdbcDriverProperties);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_239 = "> wrap(";
  protected final String TEXT_240 = " connection) {" + NL + "\t   return new org.apache.commons.pool2.impl.DefaultPooledObject<";
  protected final String TEXT_241 = ">(connection);" + NL + "\t}" + NL + "" + NL + "\t@Override" + NL + "\tpublic void destroyObject(org.apache.commons.pool2.PooledObject<";
  protected final String TEXT_242 = "> pooledObject) throws Exception {" + NL + "\t\tif (pooledObject != null) {" + NL + "\t\t    pooledObject.getObject().close();" + NL + "\t\t}" + NL + "\t\tsuper.destroyObject(pooledObject);" + NL + "\t}" + NL + "}";
  protected final String TEXT_243 = NL + "\t\tif(true) {" + NL + "\t\t\tthrow new RuntimeException(\"Cannot generate ";
  protected final String TEXT_244 = " code : ";
