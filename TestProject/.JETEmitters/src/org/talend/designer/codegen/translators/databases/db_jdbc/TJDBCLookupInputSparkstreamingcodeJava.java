...
public class TJDBCLookupInputSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TJDBCLookupInputSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJDBCLookupInputSparkstreamingcodeJava result = new TJDBCLookupInputSparkstreamingcodeJava();
    nl = null;
    return result;
  }
...
final class TJDBCLookupInputUtil extends AbstractJDBCLookupInputUtil {

	public TJDBCLookupInputUtil(INode node) {
		super(node);
	}
...
TJDBCLookupInputUtil tJDBCLookupInputUtil = new TJDBCLookupInputUtil(node);
JDBCSparkStorage storage = new JDBCSparkStorage(node);
TMapJDBCFlatMapperUtil tMapFlatMapperUtil = new TMapJDBCFlatMapperUtil(tJDBCLookupInputUtil, storage);
