...
public class TRedshiftConfigurationSparkstreamingcodeJava
{
  protected static String nl;
  public static synchronized TRedshiftConfigurationSparkstreamingcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRedshiftConfigurationSparkstreamingcodeJava result = new TRedshiftConfigurationSparkstreamingcodeJava();
    nl = null;
    return result;
  }
