...
public class THDFSInputBeginJava
{
  ...
  protected final String TEXT_125 = NL + "\t\torg.apache.hadoop.fs.Path rootPath_";
  protected final String TEXT_126 = " = new org.apache.hadoop.fs.Path(";
  protected final String TEXT_127 = ");" + NL + "\t\torg.apache.hadoop.fs.FileStatus rootStatu_";
  protected final String TEXT_128 = " = fs_";
  protected final String TEXT_129 = ".getFileStatus(rootPath_";
  protected final String TEXT_130 = ");" + NL + "\t\tfinal java.util.List<org.apache.hadoop.fs.FileStatus> status_";
  protected final String TEXT_131 = " = new java.util.ArrayList<org.apache.hadoop.fs.FileStatus>();" + NL + "\t\tif(rootStatu_";
  protected final String TEXT_132 = ".isDir()) {" + NL + "        \tfinal org.apache.hadoop.fs.FileSystem filesystem_";
  protected final String TEXT_133 = " = fs_";
  protected final String TEXT_134 = ";" + NL + "        \tfilesystem_";
  protected final String TEXT_135 = ".listStatus(rootPath_";
  protected final String TEXT_136 = ",new org.apache.hadoop.fs.PathFilter() {" + NL + "        \t" + NL + "        \t\tpublic boolean accept(org.apache.hadoop.fs.Path path) {" + NL + "        \t\t\ttry {" + NL + "        \t\t\t\torg.apache.hadoop.fs.FileStatus statu = filesystem_";
  protected final String TEXT_137 = ".getFileStatus(path);" + NL + "        \t\t\t\tString name = path.getName();" + NL + "        \t\t\t\tif(statu.isDir()) {" + NL + "        \t\t\t\t\t";
  protected final String TEXT_138 = NL + "        \t\t\t\t\tfilesystem_";
  protected final String TEXT_139 = ".listStatus(path, this);" + NL + "        \t\t\t\t\t";
  protected final String TEXT_140 = NL + "        \t\t\t\t} else if (name.startsWith(\".\") || name.startsWith(\"_\")) {" + NL + "        \t\t\t\t} else {" + NL + "        \t\t\t\t\tstatus_";
  protected final String TEXT_141 = ".add(statu);" + NL + "        \t\t\t\t}" + NL + "        \t\t\t} catch (java.io.FileNotFoundException e) {" + NL + "        \t\t\t\te.printStackTrace();" + NL + "        \t\t\t\t" + NL + "        \t\t\t\t";
  protected final String TEXT_142 = NL + "       \t\t\t\t\tlog.error(\"";
  protected final String TEXT_143 = " - \" + e.getMessage());" + NL + "        \t\t\t\t";
  protected final String TEXT_144 = NL + "        \t\t\t} catch (java.io.IOException e) {" + NL + "        \t\t\t\te.printStackTrace();" + NL + "        \t\t\t\t" + NL + "    \t\t\t\t\t";
  protected final String TEXT_145 = NL + "       \t\t\t\t\tlog.error(\"";
  protected final String TEXT_146 = " - \" + e.getMessage());" + NL + "        \t\t\t\t";
  protected final String TEXT_147 = NL + "        \t\t\t}" + NL + "        \t\t\treturn false;" + NL + "        \t\t}" + NL + "        " + NL + "        \t});\t\t\t" + NL + "\t\t} else {" + NL + "\t\t\tstatus_";
  protected final String TEXT_148 = ".add(rootStatu_";
  protected final String TEXT_149 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_150 = NL + "\t\tint nb_line_";
  protected final String TEXT_151 = " = 0;" + NL + "\t\t" + NL + "\t\tfor(org.apache.hadoop.fs.FileStatus statu_";
  protected final String TEXT_152 = " : status_";
  protected final String TEXT_153 = ") {" + NL + "\t\t\torg.apache.hadoop.fs.Path path_";
  protected final String TEXT_154 = " = statu_";
  protected final String TEXT_155 = ".getPath();";
  protected final String TEXT_156 = NL + "\t\torg.apache.hadoop.fs.FSDataInputStream fsDataInputStream_";
  protected final String TEXT_157 = " = fs_";
  protected final String TEXT_158 = ".open(path_";
  protected final String TEXT_159 = ");";
  protected final String TEXT_160 = NL + "\t\torg.talend.fileprocess.FileInputDelimited fid_";
  protected final String TEXT_161 = " = new org.talend.fileprocess.FileInputDelimited(fsDataInputStream_";
  protected final String TEXT_162 = ",  ";
  protected final String TEXT_163 = ",";
  protected final String TEXT_164 = ",";
  protected final String TEXT_165 = ",false,";
  protected final String TEXT_166 = ",0,-1,-1, false);";
  protected final String TEXT_167 = NL + "\t\t\t\torg.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_168 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\t\t\tcodec_";
  protected final String TEXT_169 = ".setConf(conf_";
  protected final String TEXT_170 = ");\t\t\t\t";
  protected final String TEXT_171 = NL + "\t\t\t\torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_172 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_173 = ");";
  protected final String TEXT_174 = NL + "\t\t\torg.apache.hadoop.io.compress.CompressionInputStream in";
  protected final String TEXT_175 = " = codec_";
  protected final String TEXT_176 = ".createInputStream(fsDataInputStream_";
  protected final String TEXT_177 = ");" + NL + "\t\t\torg.talend.fileprocess.FileInputDelimited fid_";
  protected final String TEXT_178 = " = new org.talend.fileprocess.FileInputDelimited(in";
  protected final String TEXT_179 = ",  ";
  protected final String TEXT_180 = ",";
  protected final String TEXT_181 = ",";
  protected final String TEXT_182 = ",false,";
  protected final String TEXT_183 = ",0,-1,-1, false);";
  protected final String TEXT_184 = NL + "\t\twhile (fid_";
  protected final String TEXT_185 = ".nextRecord()) {";
  protected final String TEXT_186 = NL + "\t\t\t";
  protected final String TEXT_187 = NL + "\t\t\t" + NL + "\t\torg.apache.hadoop.io.SequenceFile.Reader reader_";
  protected final String TEXT_188 = " = new org.apache.hadoop.io.SequenceFile.Reader(fs_";
  protected final String TEXT_189 = ", path_";
  protected final String TEXT_190 = ",  conf_";
  protected final String TEXT_191 = ");" + NL + "\t\t";
  protected final String TEXT_192 = " key_";
  protected final String TEXT_193 = " = (";
  protected final String TEXT_194 = ") reader_";
  protected final String TEXT_195 = ".getKeyClass().newInstance();" + NL + "\t\t";
  protected final String TEXT_196 = " value_";
  protected final String TEXT_197 = " = (";
  protected final String TEXT_198 = ") reader_";
  protected final String TEXT_199 = ".getValueClass().newInstance();" + NL + "\t\twhile (reader_";
  protected final String TEXT_200 = ".next(key_";
  protected final String TEXT_201 = ", value_";
