...
public class TWriteJSONFieldSparkstreamingconfigJava
{
  ...
  protected final String TEXT_16 = NL + "        // the UI of this component force us to generate node instead of BigDataNode" + NL + "        // So we have to force the output type to be a key-value with NullWrittable as the key" + NL + "        org.apache.spark.streaming.api.java.JavaPairDStream<NullWritable,";
  ...
  protected final String TEXT_22 = NL + "        org.apache.spark.streaming.api.java.JavaPairDStream<";
  protected final String TEXT_23 = ", ";
  protected final String TEXT_24 = ">" + NL + "            rdd_";
  protected final String TEXT_25 = " = rdd_";
  protected final String TEXT_26 = "_temp;";
  protected final String TEXT_27 = NL + "    org.apache.spark.streaming.api.java.JavaPairDStream<";
