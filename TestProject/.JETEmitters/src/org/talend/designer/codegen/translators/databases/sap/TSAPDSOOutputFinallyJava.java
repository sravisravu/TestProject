...
public class TSAPDSOOutputFinallyJava
{
  protected static String nl;
  public static synchronized TSAPDSOOutputFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDSOOutputFinallyJava result = new TSAPDSOOutputFinallyJava();
    nl = null;
    return result;
  }
