...
public class TWritePositionalFieldsSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TWritePositionalFieldsSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TWritePositionalFieldsSparkstreamingconfigJava result = new TWritePositionalFieldsSparkstreamingconfigJava();
    nl = null;
    return result;
  }
