...
public class TMongoDBGridFSPutMainJava
{
  ...
  protected final String TEXT_80 = " = \"\";" + NL + "\t\t\t\tString gridfsFilename_";
  protected final String TEXT_81 = " = map_";
  protected final String TEXT_82 = ".get(key_";
  protected final String TEXT_83 = ");" + NL + "\t\t\t\tfor (int m_";
  protected final String TEXT_84 = " = 0; m_";
  protected final String TEXT_85 = " < listings_";
  protected final String TEXT_86 = ".length; m_";
  protected final String TEXT_87 = "++){" + NL + "\t\t\t\t\tif((\"\").equals(map_";
  protected final String TEXT_88 = ".get(key_";
  protected final String TEXT_89 = "))){" + NL + "\t\t\t\t\t\tgridfsFilename_";
  protected final String TEXT_90 = " = listings_";
  protected final String TEXT_91 = "[m_";
  protected final String TEXT_92 = "].getName();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tcom.mongodb.gridfs.GridFSInputFile gridfsFile_";
  protected final String TEXT_93 = " = gridfs_";
  protected final String TEXT_94 = ".createFile(listings_";
  protected final String TEXT_95 = "[m_";
  protected final String TEXT_96 = "]);" + NL + "\t\t\t\t\tgridfsFile_";
  protected final String TEXT_97 = ".setFilename(gridfsFilename_";
  protected final String TEXT_98 = ");" + NL + "\t\t\t\t\tgridfsFile_";
  protected final String TEXT_99 = ".save();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_100 = "++;";
  protected final String TEXT_101 = NL + "\t\t\t\t\t\tlog.info(\"";
  protected final String TEXT_102 = " \" + \"file: \" + listings_";
  protected final String TEXT_103 = "[m_";
  protected final String TEXT_104 = "].getAbsolutePath() + \", size: \" + listings_";
  protected final String TEXT_105 = "[m_";
  protected final String TEXT_106 = "].length() + \" bytes upload successfully\");";
