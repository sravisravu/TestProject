...
public class TUniqRowMrconfigJava
{
  protected static String nl;
  public static synchronized TUniqRowMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TUniqRowMrconfigJava result = new TUniqRowMrconfigJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_227 = NL + "\t\tjob.setOutputKeyComparatorClass(UniqRowKeyComparator_";
  ...
  public String generate(Object argument)
  {
    ...
    for (IConnection conn : node.getOutgoingConnections()) {
		if (conn.getLineStyle().hasConnectionCategory(IConnectionCategory.DATA)) {
			...
			columnList = outMetadataTable.getListColumns();
			break;
		}
	}
	
	if(inputCols.isEmpty() || columnList == null || columnList.isEmpty())
		return "";
