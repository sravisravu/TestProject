...
public class TUniqRowSparkstreamingcodeJava
{
  ...
  protected final String TEXT_19 = " key = ";
  protected final String TEXT_20 = "(";
  protected final String TEXT_21 = NL + "                                ";
  protected final String TEXT_22 = ".toString().toLowerCase()";
  protected final String TEXT_23 = NL + "                                ";
  protected final String TEXT_24 = NL + "                                    ";
  protected final String TEXT_25 = ".toString().toLowerCase(),";
  protected final String TEXT_26 = NL + "                                    ";
  protected final String TEXT_27 = ",";
  protected final String TEXT_28 = NL + "                                ";
  protected final String TEXT_29 = ".toString().toLowerCase()";
  ...
  protected final String TEXT_36 = "UniqueMap_Function" + NL + "                implements org.apache.spark.api.java.function.PairFunction<scala.Tuple2<";
  protected final String TEXT_37 = "," + NL + "                Iterable<";
  ...
  protected final String TEXT_58 = "DuplicateFlatMap_Function" + NL + "                implements org.apache.spark.api.java.function.PairFlatMapFunction<" + NL + "                        scala.Tuple2<";
  protected final String TEXT_59 = ", Iterable<";
  protected final String TEXT_60 = ">>,";
  protected final String TEXT_61 = NL + "                        ";
  protected final String TEXT_62 = ",";
  protected final String TEXT_63 = NL + "                        ";
  protected final String TEXT_64 = ">{" + NL + "" + NL + "            private ContextProperties context = null;" + NL + "" + NL + "            public ";
  protected final String TEXT_65 = "DuplicateFlatMap_Function(JobConf job) {" + NL + "                this.context = new ContextProperties(job);" + NL + "            }" + NL + "" + NL + "            public ";
  protected final String TEXT_66 = "<scala.Tuple2<";
  protected final String TEXT_67 = ", ";
  protected final String TEXT_68 = ">> call(scala.Tuple2<";
  protected final String TEXT_69 = ", Iterable<";
  protected final String TEXT_70 = ">> data){" + NL + "" + NL + "                    java.util.Iterator<";
  protected final String TEXT_71 = "> iterator = data._2().iterator();";
  protected final String TEXT_72 = NL + "                    ";
  protected final String TEXT_73 = " key = data._1();";
  protected final String TEXT_74 = NL + "                    ";
  protected final String TEXT_75 = " value;" + NL + "                    java.util.List<scala.Tuple2<";
  protected final String TEXT_76 = ", ";
  protected final String TEXT_77 = ">> outputList =" + NL + "                    new ArrayList<scala.Tuple2<";
  protected final String TEXT_78 = ", ";
  protected final String TEXT_79 = ">>();" + NL + "" + NL + "                    iterator.next();" + NL + "" + NL + "                    if(!iterator.hasNext()){" + NL + "                        return ";
  protected final String TEXT_80 = ";" + NL + "                    } else{" + NL + "                        while(iterator.hasNext()){" + NL + "                            value = iterator.next();" + NL + "                            outputList.add(new scala.Tuple2<";
  protected final String TEXT_81 = ", ";
  protected final String TEXT_82 = ">(key,value));";
  protected final String TEXT_83 = NL + "                                break;";
  protected final String TEXT_84 = NL + "                        }" + NL + "                    }" + NL + "                return ";
