...
public class TJavaMRMrconfigJava
{
  protected static String nl;
  public static synchronized TJavaMRMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TJavaMRMrconfigJava result = new TJavaMRMrconfigJava();
    nl = null;
    return result;
  }
