...
public class TFindQuantilesMrcodeJava
{
  protected static String nl;
  public static synchronized TFindQuantilesMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFindQuantilesMrcodeJava result = new TFindQuantilesMrcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_899 = NL + "\t\t\tprivate OutputCollector<";
  protected final String TEXT_900 = ", ";
  protected final String TEXT_901 = "> output_";
  protected final String TEXT_902 = " = null;" + NL + "\t\t\tprivate ";
  protected final String TEXT_903 = "[] samples_";
  protected final String TEXT_904 = " = null;" + NL + "\t\t\t";
  protected final String TEXT_905 = NL + "\t\t\tprivate int maxSampleNum_";
  protected final String TEXT_906 = " = 100;" + NL + "\t\t\tprivate int index_";
  protected final String TEXT_907 = " = 0;" + NL + "\t\t\tjava.util.Random randGen_";
  protected final String TEXT_908 = " = new java.util.Random();" + NL + "" + NL + "\t\t\tprivate ";
  protected final String TEXT_909 = " build(";
  protected final String TEXT_910 = " value_";
  protected final String TEXT_911 = "){" + NL + "\t\t\t\t";
  protected final String TEXT_912 = " ";
  protected final String TEXT_913 = " = value_";
  protected final String TEXT_914 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_915 = " sample_";
  protected final String TEXT_916 = " = new ";
  protected final String TEXT_917 = "();" + NL + "\t\t\t\t";
  protected final String TEXT_918 = NL + "\t\t\t\t\tsample_";
  protected final String TEXT_919 = ".";
  protected final String TEXT_920 = " = ";
  protected final String TEXT_921 = ".";
  protected final String TEXT_922 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_923 = NL + "\t\t\t\treturn sample_";
  protected final String TEXT_924 = ";" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_925 = NL + "\t\t\tif(this.output_";
  protected final String TEXT_926 = " == null){" + NL + "\t\t\t\tthis.output_";
  protected final String TEXT_927 = " = output_";
  protected final String TEXT_928 = ";" + NL + "\t\t\t}" + NL + "\t\t\tif(this.samples_";
  protected final String TEXT_929 = " == null){" + NL + "\t\t\t\tthis.samples_";
  protected final String TEXT_930 = " = new ";
  protected final String TEXT_931 = "[maxSampleNum_";
  protected final String TEXT_932 = "];" + NL + "\t\t\t}" + NL + "\t\t\tif(index_";
  protected final String TEXT_933 = " < maxSampleNum_";
  protected final String TEXT_934 = "){" + NL + "\t\t\t\tsamples_";
  protected final String TEXT_935 = "[index_";
  protected final String TEXT_936 = "] = build(value_";
  protected final String TEXT_937 = ");" + NL + "\t\t\t}else{" + NL + "\t\t\t\tint rand_";
  protected final String TEXT_938 = " = randGen_";
  protected final String TEXT_939 = ".nextInt(index_";
  protected final String TEXT_940 = ");" + NL + "\t\t\t\tif(rand_";
  protected final String TEXT_941 = " < maxSampleNum_";
  protected final String TEXT_942 = "){" + NL + "\t\t\t\t\tsamples_";
  protected final String TEXT_943 = "[rand_";
  protected final String TEXT_944 = "] = build(value_";
  protected final String TEXT_945 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\tindex_";
  protected final String TEXT_946 = "++;" + NL + "\t\t";
  protected final String TEXT_947 = NL + "\t\t\tif(this.output_";
  protected final String TEXT_948 = " != null && samples_";
  protected final String TEXT_949 = " != null){" + NL + "\t\t\t\tfor(int i = 0; i < maxSampleNum_";
  protected final String TEXT_950 = "; i++){" + NL + "\t\t\t\t\tif(samples_";
  protected final String TEXT_951 = "[i] != null){" + NL + "\t\t\t\t\t\toutput_";
  protected final String TEXT_952 = ".collect(samples_";
  protected final String TEXT_953 = "[i], samples_";
  protected final String TEXT_954 = "[i]);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_955 = NL + "\t\t\tint numQuantiles_";
  protected final String TEXT_956 = ";" + NL + "\t\t";
  protected final String TEXT_957 = NL + "\t\t\tnumQuantiles_";
  protected final String TEXT_958 = " = job_";
  protected final String TEXT_959 = ".getInt(\"talend.component.tsortrow.quantiles\", 1);" + NL + "\t\t";
  protected final String TEXT_960 = NL + "\t\t\tjava.util.List<";
  protected final String TEXT_961 = "> keys_";
  protected final String TEXT_962 = " = new java.util.ArrayList<";
  protected final String TEXT_963 = ">();" + NL + "\t\t\tjava.util.ArrayList<";
  protected final String TEXT_964 = "> quantilesList_";
  protected final String TEXT_965 = " = new java.util.ArrayList<";
  protected final String TEXT_966 = ">();" + NL + "" + NL + "\t\t\twhile(values_";
  protected final String TEXT_967 = ".hasNext()){" + NL + "\t\t\t\t";
  protected final String TEXT_968 = " ";
  protected final String TEXT_969 = " = values_";
  protected final String TEXT_970 = ".next();" + NL + "\t\t\t\t";
  protected final String TEXT_971 = " k_";
  protected final String TEXT_972 = " = new ";
  protected final String TEXT_973 = "();" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_974 = NL + "\t\t\t\t\tk_";
  protected final String TEXT_975 = ".";
  protected final String TEXT_976 = " = ";
  protected final String TEXT_977 = ".";
  protected final String TEXT_978 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_979 = NL + "\t\t\t\tkeys_";
  protected final String TEXT_980 = ".add(k_";
  protected final String TEXT_981 = ");" + NL + "\t\t\t}" + NL + "\t\t\tlong numSamples_";
  protected final String TEXT_982 = " = keys_";
  protected final String TEXT_983 = ".size();" + NL + "\t\t\tlong toSkip_";
  protected final String TEXT_984 = " = numSamples_";
  protected final String TEXT_985 = " / numQuantiles_";
  protected final String TEXT_986 = ";" + NL + "\t\t\tif (toSkip_";
  protected final String TEXT_987 = " == 0) {" + NL + "\t\t\t\tnumQuantiles_";
  protected final String TEXT_988 = " = (int)numSamples_";
  protected final String TEXT_989 = ";" + NL + "\t\t\t\ttoSkip_";
  protected final String TEXT_990 = " = 1;" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tlong index_";
  protected final String TEXT_991 = " = 1;" + NL + "\t\t\tfor (";
  protected final String TEXT_992 = " k_";
  protected final String TEXT_993 = " : keys_";
  protected final String TEXT_994 = ") {" + NL + "\t\t\t\tif (index_";
  protected final String TEXT_995 = " % toSkip_";
  protected final String TEXT_996 = " == 0) {" + NL + "\t\t\t\t\tquantilesList_";
  protected final String TEXT_997 = ".add(k_";
  protected final String TEXT_998 = ");" + NL + "\t\t\t\t\tif (quantilesList_";
  protected final String TEXT_999 = ".size() == numQuantiles_";
  protected final String TEXT_1000 = " - 1) {" + NL + "\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tindex_";
  protected final String TEXT_1001 = "++;" + NL + "\t\t\t}" + NL + "\t\t\tfor (";
  protected final String TEXT_1002 = " quantiles_";
  protected final String TEXT_1003 = " : quantilesList_";
  protected final String TEXT_1004 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_1005 = NL + "\t\t\t}" + NL + "" + NL + "\t\t";
  ...
  protected final String TEXT_1010 = "\tstatic class OneReducePartitioner_";
  protected final String TEXT_1011 = " implements org.apache.hadoop.mapred.Partitioner {" + NL + "\t\tpublic int getPartition(Object keyObj, Object valueObj, int splitNum) {" + NL + "\t\t\treturn 0;" + NL + "\t\t}" + NL + "" + NL + "\t\tpublic void configure(JobConf arg0) {" + NL + "" + NL + "\t\t}" + NL + "\t}" + NL + "\t";
  protected final String TEXT_1012 = "    static class OneGroupingComparator_";
  protected final String TEXT_1013 = " extends WritableComparator {" + NL + "" + NL + "        protected OneGroupingComparator_";
  protected final String TEXT_1014 = "() {" + NL + "            super(";
  protected final String TEXT_1015 = ".class, true);" + NL + "        }" + NL + "" + NL + "        public int compare(WritableComparable key1, WritableComparable key2) {" + NL + "            return 0;" + NL + "        }" + NL + "    }" + NL + "    ";
  ...
  public String generate(Object argument)
  {
	...
	if(listCriteriasColsPrepa.isEmpty())
		return "";

	StructHelper rowStruct = new StructHelper("mOut_"+cid, listCriteriasColsPrepa, true);
    ...
    stringBuffer.append(getOutKeyClass());
    ...
    //maxSampleNum could be set dynamic
	...
	mapper.init(node, cid, null, inConnName, "mOut_"+cid, "mOut_"+cid);
	mapper.generate();
    ...
    stringBuffer.append(TEXT_1004);
				...
				this.output(null, "quantiles_"+cid);
	...
	reducer.init(cid, "mOut_"+cid, "mOut_"+cid, null, outConnName);
	reducer.generate();
    ...
    stringBuffer.append(reducer.getOutKeyClass());
