...
public class TReplicateStormcodeJava
{
  protected static String nl;
  public static synchronized TReplicateStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplicateStormcodeJava result = new TReplicateStormcodeJava();
    nl = null;
    return result;
  }
