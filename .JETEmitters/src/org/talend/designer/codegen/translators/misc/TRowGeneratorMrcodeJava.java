...
public class TRowGeneratorMrcodeJava
{
  protected static String nl;
  public static synchronized TRowGeneratorMrcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRowGeneratorMrcodeJava result = new TRowGeneratorMrcodeJava();
    nl = null;
    return result;
  }
