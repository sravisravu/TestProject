...
public class TReplaceMrconfigJava
{
  protected static String nl;
  public static synchronized TReplaceMrconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TReplaceMrconfigJava result = new TReplaceMrconfigJava();
    nl = null;
    return result;
  }
