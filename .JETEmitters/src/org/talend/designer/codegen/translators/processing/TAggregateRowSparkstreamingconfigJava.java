...
public class TAggregateRowSparkstreamingconfigJava
{
  protected static String nl;
  public static synchronized TAggregateRowSparkstreamingconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TAggregateRowSparkstreamingconfigJava result = new TAggregateRowSparkstreamingconfigJava();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "\t\t\t\t" + NL + "\t\t\t\t\t // Zero function" + NL + "            \t";
  protected final String TEXT_2 = " zero_";
  protected final String TEXT_3 = " = new ";
  protected final String TEXT_4 = "();" + NL + "            \t";
  protected final String TEXT_5 = NL + "                \t";
  protected final String TEXT_6 = NL + "               org.apache.spark.api.java.JavaPairRDD<";
  protected final String TEXT_7 = ", ";
  protected final String TEXT_8 = "> rdd_";
  protected final String TEXT_9 = " = rdd_";
  protected final String TEXT_10 = ".aggregateByKey(zero_";
  protected final String TEXT_11 = ", new Seq";
  protected final String TEXT_12 = "(), new Comb";
  protected final String TEXT_13 = "())" + NL + "               \t.mapToPair(new Map";
  protected final String TEXT_14 = "());" + NL + "\t\t\t\t";
  protected final String TEXT_15 = NL + NL + "\t            org.apache.spark.streaming.api.java.JavaPairDStream<";
  protected final String TEXT_16 = ", ";
  protected final String TEXT_17 = "> rdd_";
  protected final String TEXT_18 = " = rdd_";
  protected final String TEXT_19 = NL + "\t                .mapToPair(new PreMap";
  protected final String TEXT_20 = "())" + NL + "\t                .reduceByKey(new Comb";
  protected final String TEXT_21 = "())" + NL + "\t                .mapToPair(new Map";
...
if (metadatas != null && metadatas.size() > 0) {
    ...
    stringBuffer.append(aggregateFunction.getZero());
