...
public class Storm_subprocess_runJava
{
  protected static String nl;
  public static synchronized Storm_subprocess_runJava create(String lineSeparator)
  {
    nl = lineSeparator;
    Storm_subprocess_runJava result = new Storm_subprocess_runJava();
    nl = null;
    return result;
  }

  public final String NL = nl == null ? (System.getProperties().getProperty("line.separator")) : nl;
  protected final String TEXT_1 = "        // runMRJob(job, ";
