...
public class TSAPDSOOutputEndJava
{
  protected static String nl;
  public static synchronized TSAPDSOOutputEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSAPDSOOutputEndJava result = new TSAPDSOOutputEndJava();
    nl = null;
    return result;
  }
