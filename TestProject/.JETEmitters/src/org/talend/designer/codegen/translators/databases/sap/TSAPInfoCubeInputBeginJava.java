...
public class TSAPInfoCubeInputBeginJava
{
  ...
  protected final String TEXT_58 = ".getBWService();" + NL + "\t" + NL + "\ttry {" + NL + "\t\t" + NL + "\t\torg.talend.sap.model.bw.request.ISAPInfoCubeRequest request_";
  protected final String TEXT_59 = " = dataService_";
  protected final String TEXT_60 = ".createInfoCubeRequest(";
