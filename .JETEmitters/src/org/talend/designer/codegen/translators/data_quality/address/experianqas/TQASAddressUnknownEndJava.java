...
public class TQASAddressUnknownEndJava
{
  protected static String nl;
  public static synchronized TQASAddressUnknownEndJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TQASAddressUnknownEndJava result = new TQASAddressUnknownEndJava();
    nl = null;
    return result;
  }
