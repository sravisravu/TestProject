...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_386 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_387 = ", null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_388 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_389 = ".next()) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_390 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_391 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_392 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }" + NL + "                                rsTable_";
  ...
  protected final String TEXT_398 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "                                boolean whetherExist_";
  protected final String TEXT_399 = " = false;" + NL + "                                while(rsTable_";
  ...
  protected final String TEXT_408 = ") {" + NL + "                                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_429 = ") {" + NL + "                                    java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_440 = ".close();" + NL + "                                }" + NL + "                                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_462 = NL + "            java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_479 = NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_480 = " = stmtTruncCount_";
  protected final String TEXT_481 = ".executeQuery(\"";
  protected final String TEXT_482 = "\");" + NL + "            int rsTruncCountNumber_";
  protected final String TEXT_483 = " = 0;" + NL + "            if(rsTruncCount_";
  protected final String TEXT_484 = ".next()) {" + NL + "                rsTruncCountNumber_";
  ...
  protected final String TEXT_488 = ".close();" + NL + "            java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_499 = NL + "                if(!conn_";
  protected final String TEXT_500 = ".getAutoCommit()){" + NL + "                    conn_";
  protected final String TEXT_501 = ".commit();" + NL + "                }";
  protected final String TEXT_502 = NL + "            deletedCount_";
  protected final String TEXT_503 = " += rsTruncCountNumber_";
  protected final String TEXT_504 = ";" + NL + "            stmtTrunc_";
  protected final String TEXT_505 = ".close();";
  protected final String TEXT_506 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_507 = " = conn_";
  protected final String TEXT_508 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_509 = " = stmtTruncCount_";
  protected final String TEXT_510 = ".executeQuery(\"";
  protected final String TEXT_511 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_512 = " = conn_";
  protected final String TEXT_513 = ".createStatement();";
  protected final String TEXT_514 = NL + "                conn_";
  protected final String TEXT_515 = ".commit();";
  protected final String TEXT_516 = NL + "            stmtTrunc_";
  protected final String TEXT_517 = ".executeUpdate(\"";
  protected final String TEXT_518 = "\");";
  protected final String TEXT_519 = NL + "            while(rsTruncCount_";
  protected final String TEXT_520 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_521 = " += rsTruncCount_";
  protected final String TEXT_522 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_523 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_524 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_525 = ".close();";
  ...
  protected final String TEXT_656 = ".prepareStatement(delete_";
  protected final String TEXT_657 = ");";
  protected final String TEXT_658 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_659 = " = insert_";
  protected final String TEXT_660 = ".split(\"\\\\?\");";
  protected final String TEXT_661 = NL + "\t\t\tupdate_";
  protected final String TEXT_662 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  ...
  protected final String TEXT_680 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  ...
  protected final String TEXT_703 = ",insertSQLSplits_";
  protected final String TEXT_704 = ");";
  protected final String TEXT_705 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_719 = NL + "        try {" + NL + "            insertedCount_";
  ...
  protected final String TEXT_755 = NL + "                    int count_";
  protected final String TEXT_756 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_783 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_784 = "++;";
  protected final String TEXT_785 = NL + "            batchSizeCounter_";
  ...
  protected final String TEXT_789 = " + pstmt_";
  ...
  protected final String TEXT_811 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_812 = NL + "            }";
  protected final String TEXT_813 = NL + "                        ";
  protected final String TEXT_814 = NL + "                    ";
  protected final String TEXT_815 = NL + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_816 = " = pstmt_";
  protected final String TEXT_817 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_818 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_819 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_820 = " = rs_";
  protected final String TEXT_821 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_822 = " > 0) {";
  protected final String TEXT_823 = NL + "                        ";
  protected final String TEXT_824 = NL + "                            query_";
  protected final String TEXT_825 = " = ";
  protected final String TEXT_826 = ";";
  protected final String TEXT_827 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_828 = ",";
  protected final String TEXT_829 = ".";
  protected final String TEXT_830 = ", ";
  protected final String TEXT_831 = ",updateSQLSplits_";
  protected final String TEXT_832 = ");";
  protected final String TEXT_833 = NL + NL + "                        int count_";
  protected final String TEXT_834 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_858 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_859 = " = updatedCount_";
  ...
  protected final String TEXT_885 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_886 = NL + "                        ";
  protected final String TEXT_887 = NL + "                            query_";
  protected final String TEXT_888 = " = ";
  protected final String TEXT_889 = ";";
  protected final String TEXT_890 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_891 = ",";
  protected final String TEXT_892 = ".";
  protected final String TEXT_893 = ", ";
  protected final String TEXT_894 = ",insertSQLSplits_";
  protected final String TEXT_895 = ");";
  protected final String TEXT_896 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_897 = ".";
  protected final String TEXT_898 = ", pstmtInsert_";
  ...
  protected final String TEXT_905 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_906 = " = insertedCount_";
  protected final String TEXT_907 = " + pstmtInsert_";
  protected final String TEXT_908 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_909 = "++;";
  protected final String TEXT_910 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_911 = " = true;";
  protected final String TEXT_912 = NL + "                        throw(e);";
  ...
  protected final String TEXT_917 = "Struct();";
  protected final String TEXT_918 = NL + "                                ";
  protected final String TEXT_919 = ".";
  protected final String TEXT_920 = " = ";
  protected final String TEXT_921 = ".";
  protected final String TEXT_922 = ";";
  protected final String TEXT_923 = NL + "                            rejectedCount_";
  protected final String TEXT_924 = " = rejectedCount_";
  protected final String TEXT_925 = " + 1;";
  protected final String TEXT_926 = NL + "                            ";
  protected final String TEXT_927 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_928 = NL + "                            ";
  protected final String TEXT_929 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_930 = ";";
  protected final String TEXT_931 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_932 = NL + "                }" + NL + "            }";
  protected final String TEXT_933 = NL + "            int updateFlag_";
  ...
  protected final String TEXT_939 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_940 = ",";
  protected final String TEXT_941 = ".";
  protected final String TEXT_942 = ", ";
  protected final String TEXT_943 = ",updateSQLSplits_";
  protected final String TEXT_944 = ");";
  protected final String TEXT_945 = NL + NL + "                    int count_";
  protected final String TEXT_946 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_970 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_971 = "=pstmtUpdate_";
  protected final String TEXT_972 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_973 = " = updatedCount_";
  protected final String TEXT_974 = " + updateFlag_";
  protected final String TEXT_975 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_976 = " == 0) {";
  protected final String TEXT_977 = NL + "                query_";
  protected final String TEXT_978 = " = new StringBuffer(\"\");";
  protected final String TEXT_979 = NL + "                        ";
  protected final String TEXT_980 = NL + "                            query_";
  protected final String TEXT_981 = " = ";
  protected final String TEXT_982 = ";";
  protected final String TEXT_983 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_984 = ",";
  protected final String TEXT_985 = ".";
  protected final String TEXT_986 = ", ";
  protected final String TEXT_987 = ",insertSQLSplits_";
  protected final String TEXT_988 = ");";
  protected final String TEXT_989 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_990 = ".";
  protected final String TEXT_991 = ", pstmtInsert_";
  protected final String TEXT_992 = ", ";
  protected final String TEXT_993 = ", \"";
  protected final String TEXT_994 = "\");";
  protected final String TEXT_995 = NL + "                    globalMap.put(\"";
  protected final String TEXT_996 = "_QUERY\", query_";
  protected final String TEXT_997 = ".toString().trim());";
  protected final String TEXT_998 = NL + "                    insertedCount_";
  protected final String TEXT_999 = " = insertedCount_";
  protected final String TEXT_1000 = " + pstmtInsert_";
  protected final String TEXT_1001 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_1002 = "++;";
  protected final String TEXT_1003 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_1004 = "++;";
  protected final String TEXT_1005 = NL + "                }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_1044 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_1045 = " = deletedCount_";
  protected final String TEXT_1046 = " + pstmt_";
  protected final String TEXT_1047 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_1048 = "++;";
  protected final String TEXT_1049 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1050 = " = true;";
  protected final String TEXT_1051 = NL + "                    throw(e);";
  protected final String TEXT_1052 = NL + "                    nb_line_";
  protected final String TEXT_1053 = "++;";
  protected final String TEXT_1054 = NL + "                        ";
  protected final String TEXT_1055 = " = new ";
  protected final String TEXT_1056 = "Struct();";
  protected final String TEXT_1057 = NL + "                            ";
  protected final String TEXT_1058 = ".";
  protected final String TEXT_1059 = " = ";
  protected final String TEXT_1060 = ".";
  protected final String TEXT_1061 = ";";
  protected final String TEXT_1062 = NL + "                        rejectedCount_";
  protected final String TEXT_1063 = " = rejectedCount_";
  protected final String TEXT_1064 = " + 1;";
  protected final String TEXT_1065 = NL + "                        ";
  protected final String TEXT_1066 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1067 = NL + "                        ";
  protected final String TEXT_1068 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1069 = ";";
  protected final String TEXT_1070 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1071 = NL + "            }";
  protected final String TEXT_1072 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_1083 = NL + "                if ((batchSize_";
  protected final String TEXT_1084 = " > 0) && (batchSize_";
  protected final String TEXT_1085 = " <= batchSizeCounter_";
  protected final String TEXT_1086 = ")) {" + NL + "                try {";
  protected final String TEXT_1087 = NL + "                        pstmt_";
  protected final String TEXT_1088 = ".executeBatch();";
  protected final String TEXT_1089 = NL + "                        java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1090 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1091 = ".toString().getBytes());";
  protected final String TEXT_1092 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1093 = ").executeCopyIn(template_";
  protected final String TEXT_1094 = ", bais_";
  protected final String TEXT_1095 = ");";
  protected final String TEXT_1096 = NL + "                            com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_1097 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_1098 = ",template_";
  protected final String TEXT_1099 = ");" + NL + "                            vcs_";
  protected final String TEXT_1100 = ".start();" + NL + "                            vcs_";
  protected final String TEXT_1101 = ".addStream(bais_";
  protected final String TEXT_1102 = ");" + NL + "                            vcs_";
  protected final String TEXT_1103 = ".execute();" + NL + "                            vcs_";
  protected final String TEXT_1104 = ".finish();";
  protected final String TEXT_1105 = NL + "                        stmtBuilder_";
  protected final String TEXT_1106 = " = null;" + NL + "                        if (bais_";
  protected final String TEXT_1107 = " != null) {" + NL + "                            bais_";
  protected final String TEXT_1108 = ".close();" + NL + "                            bais_";
  protected final String TEXT_1109 = " = null;" + NL + "                        }" + NL + "                        stmtBuilder_";
  protected final String TEXT_1110 = " = new StringBuilder();";
  ...
  protected final String TEXT_1120 = NL + "                                copiedCount_";
  protected final String TEXT_1121 = " += stmt_";
  protected final String TEXT_1122 = ".getUpdateCount();";
  protected final String TEXT_1123 = " " + NL + "                                copiedCount_";
  protected final String TEXT_1124 = " += vcs_";
  protected final String TEXT_1125 = ".getRowCount();";
  protected final String TEXT_1126 = NL + "                        batchSizeCounter_";
  protected final String TEXT_1127 = " = 0;" + NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1128 = NL + "                        throw(e);";
  protected final String TEXT_1129 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_1130 = NL + "                }" + NL + "            }";
  protected final String TEXT_1131 = NL + "                commitCounter_";
  protected final String TEXT_1132 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1133 = " <= commitCounter_";
  protected final String TEXT_1134 = ") {" + NL;
  protected final String TEXT_1135 = NL + "                try {";
  protected final String TEXT_1136 = NL + "                            boolean isCountResult_";
  protected final String TEXT_1137 = " = false;" + NL + "                            if(batchSizeCounter_";
  protected final String TEXT_1138 = " > 0){";
  protected final String TEXT_1139 = NL + "                                pstmt_";
  protected final String TEXT_1140 = ".executeBatch();";
  protected final String TEXT_1141 = NL + "                                isCountResult_";
  protected final String TEXT_1142 = " = true;" + NL + "                                batchSizeCounter_";
  protected final String TEXT_1143 = " = 0;" + NL + "                            }";
  protected final String TEXT_1144 = NL + "                        if(isCountResult_";
  protected final String TEXT_1145 = "){";
  protected final String TEXT_1146 = NL + "                        insertedCount_";
  protected final String TEXT_1147 = " += pstmt_";
  protected final String TEXT_1148 = ".getUpdateCount();";
  ...
  protected final String TEXT_1156 = NL + "                        if (stmtBuilder_";
  protected final String TEXT_1157 = " != null && stmtBuilder_";
  protected final String TEXT_1158 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_1159 = " start" + NL + "                            java.io.ByteArrayInputStream bais_";
  protected final String TEXT_1160 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_1161 = ".toString().getBytes());";
  protected final String TEXT_1162 = NL + "                            ((com.vertica.PGStatement)stmt_";
  protected final String TEXT_1163 = ").executeCopyIn(template_";
  protected final String TEXT_1164 = ", bais_";
  protected final String TEXT_1165 = ");";
  protected final String TEXT_1166 = NL + "                            stmtBuilder_";
  protected final String TEXT_1167 = " = null;" + NL + "                            if (bais_";
  protected final String TEXT_1168 = " != null) {" + NL + "                                bais_";
  protected final String TEXT_1169 = ".close();" + NL + "                                bais_";
  protected final String TEXT_1170 = " = null;" + NL + "                            }" + NL + "                            stmtBuilder_";
  protected final String TEXT_1171 = " = new StringBuilder();" + NL + "                            copiedCount_";
  protected final String TEXT_1172 = " += stmt_";
  protected final String TEXT_1173 = ".getUpdateCount();" + NL + "                        } // stmtBuilder_";
  protected final String TEXT_1174 = " end";
  protected final String TEXT_1175 = NL + "                }catch (java.sql.SQLException e){";
  protected final String TEXT_1176 = NL + "                        throw(e);";
  protected final String TEXT_1177 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_1178 = NL + NL + "                }";
  protected final String TEXT_1179 = NL + "                    conn_";
  protected final String TEXT_1180 = ".commit();";
  protected final String TEXT_1181 = NL + "                    commitCounter_";
  protected final String TEXT_1182 = "=0;" + NL + "                }";
