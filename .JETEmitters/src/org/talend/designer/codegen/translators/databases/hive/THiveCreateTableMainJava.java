...
public class THiveCreateTableMainJava
{
  ...
  protected final String TEXT_622 = NL + "    java.sql.Statement stmt_";
  protected final String TEXT_623 = " = conn_";
  protected final String TEXT_624 = ".createStatement();";
  protected final String TEXT_625 = NL + "    String query_";
  protected final String TEXT_626 = " = \"\";" + NL + "    String tableName_";
  protected final String TEXT_627 = " = ";
  protected final String TEXT_628 = ";";
  protected final String TEXT_629 = NL + "    String likeTableName_";
  protected final String TEXT_630 = " = ";
  protected final String TEXT_631 = ";";
  protected final String TEXT_632 = NL + "        String location_";
  protected final String TEXT_633 = " = ";
  protected final String TEXT_634 = ";";
  protected final String TEXT_635 = NL + "    String querySQL_";
  protected final String TEXT_636 = " = \"";
  protected final String TEXT_637 = "\";";
  protected final String TEXT_638 = NL + "    try {" + NL + "        stmt_";
  protected final String TEXT_639 = ".execute(querySQL_";
  protected final String TEXT_640 = ");" + NL + "    } catch(java.sql.SQLException e_";
  protected final String TEXT_641 = ") {";
  protected final String TEXT_642 = NL + "            throw(e_";
  protected final String TEXT_643 = ");";
  protected final String TEXT_644 = NL + "            System.err.println(e_";
  protected final String TEXT_645 = ".getMessage());";
  protected final String TEXT_646 = NL + "    }" + NL + "    stmt_";
  protected final String TEXT_647 = ".close();" + NL + "    globalMap.put(\"";
  protected final String TEXT_648 = "_QUERY\", querySQL_";
  protected final String TEXT_649 = ");" + NL + "" + NL + "    String currentClientPathSeparator_";
  protected final String TEXT_650 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "    if(currentClientPathSeparator_";
  protected final String TEXT_651 = "!=null) {" + NL + "        System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_652 = ");" + NL + "        globalMap.put(\"current_client_path_separator\", null);" + NL + "    }";
  protected final String TEXT_653 = NL + "        conn_";
  protected final String TEXT_654 = ".close();";
  protected final String TEXT_655 = NL + "            bw_";
  protected final String TEXT_656 = ".write(querySQL_";
  protected final String TEXT_657 = " + \";\");" + NL + "            globalMap.put(\"";
  protected final String TEXT_658 = "_QUERY\", querySQL_";
  protected final String TEXT_659 = ");" + NL + "" + NL + "            bw_";
  protected final String TEXT_660 = ".close();" + NL + "" + NL + "            if(libjars_";
  protected final String TEXT_661 = ".length() > 0) {" + NL + "                instance_";
  protected final String TEXT_662 = ".setLibJars(libjars_";
  protected final String TEXT_663 = ".toString().substring(0, libjars_";
  protected final String TEXT_664 = ".length()-1));" + NL + "            }" + NL + "            instance_";
  protected final String TEXT_665 = ".callWS(instance_";
  protected final String TEXT_666 = ".sendFiles());" + NL + "            int exitCode_";
  protected final String TEXT_667 = " = instance_";
  protected final String TEXT_668 = ".execute();" + NL + "            if(exitCode_";
  protected final String TEXT_669 = " > 0) {" + NL;
  protected final String TEXT_670 = NL + "                    throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_671 = NL + "                    System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_672 = NL + "                        log.error(\"";
  protected final String TEXT_673 = " - The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_674 = NL + "            }";
  protected final String TEXT_675 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_676 = "_";
  protected final String TEXT_677 = "_";
  protected final String TEXT_678 = " = ";
  protected final String TEXT_679 = ";";
  protected final String TEXT_680 = NL + "\t\t\t\t\tString comment_";
  protected final String TEXT_681 = "_";
  protected final String TEXT_682 = "_";
  protected final String TEXT_683 = " = ";
  protected final String TEXT_684 = ";";
  protected final String TEXT_685 = NL + "\t\t\t\t\tString key_";
  protected final String TEXT_686 = "_";
  protected final String TEXT_687 = "_";
  protected final String TEXT_688 = " = ";
  protected final String TEXT_689 = ";" + NL + "\t\t\t\t\tString value_";
  protected final String TEXT_690 = "_";
  protected final String TEXT_691 = "_";
  protected final String TEXT_692 = " = ";
  protected final String TEXT_693 = ";";
  protected final String TEXT_694 = NL + "    String tableComment_";
  protected final String TEXT_695 = " = ";
  protected final String TEXT_696 = ";";
  protected final String TEXT_697 = NL + "    String clustededOrSkewed_";
  protected final String TEXT_698 = " = ";
  protected final String TEXT_699 = ";";
  protected final String TEXT_700 = NL + "            String fieldChar_";
  protected final String TEXT_701 = " = ";
  protected final String TEXT_702 = ";";
  protected final String TEXT_703 = NL + "                String escapeChar_";
  protected final String TEXT_704 = " = ";
  protected final String TEXT_705 = ";";
  protected final String TEXT_706 = NL + "            String collectionChar_";
  protected final String TEXT_707 = " = ";
  protected final String TEXT_708 = ";";
  protected final String TEXT_709 = NL + "            String mapChar_";
  protected final String TEXT_710 = " = ";
  protected final String TEXT_711 = ";";
  protected final String TEXT_712 = NL + "            String lineChar_";
  protected final String TEXT_713 = " = ";
  protected final String TEXT_714 = ";";
  protected final String TEXT_715 = NL + "        String serdeName_";
  protected final String TEXT_716 = " = ";
  protected final String TEXT_717 = ";";
  protected final String TEXT_718 = NL + "        String inputClass_";
  protected final String TEXT_719 = " = ";
  protected final String TEXT_720 = ";" + NL + "        String outputClass_";
  protected final String TEXT_721 = " = ";
  protected final String TEXT_722 = ";";
  protected final String TEXT_723 = NL + "    String storageClass_";
  protected final String TEXT_724 = " = ";
  protected final String TEXT_725 = ";";
  protected final String TEXT_726 = NL + "            String decryptedS3Password_";
  protected final String TEXT_727 = " = routines.system.PasswordEncryptUtil.decryptPassword(";
  protected final String TEXT_728 = ");";
  protected final String TEXT_729 = NL + "            String decryptedS3Password_";
  protected final String TEXT_730 = " = ";
  protected final String TEXT_731 = ";";
  protected final String TEXT_732 = NL + "        String location_";
  protected final String TEXT_733 = " = \"s3n://\" + ";
  protected final String TEXT_734 = " +\":\" + decryptedS3Password_";
  protected final String TEXT_735 = " + \"@\" + ";
  protected final String TEXT_736 = ";";
  protected final String TEXT_737 = NL + "    String location_";
  protected final String TEXT_738 = " = ";
  protected final String TEXT_739 = ";";
  protected final String TEXT_740 = NL + "    String select_";
  protected final String TEXT_741 = " = ";
  protected final String TEXT_742 = ";";
  protected final String TEXT_743 = NL + "String querySQL_";
  protected final String TEXT_744 = " = \"";
  protected final String TEXT_745 = "\";";
  protected final String TEXT_746 = NL + "try {" + NL + "    stmt_";
  protected final String TEXT_747 = ".execute(querySQL_";
  protected final String TEXT_748 = ");" + NL + "} catch(java.sql.SQLException e_";
  protected final String TEXT_749 = ") {";
  protected final String TEXT_750 = NL + "        throw(e_";
  protected final String TEXT_751 = ");";
  protected final String TEXT_752 = NL + "        System.err.println(e_";
  protected final String TEXT_753 = ".getMessage());";
  protected final String TEXT_754 = NL + "        }" + NL + "stmt_";
  protected final String TEXT_755 = ".close();";
  protected final String TEXT_756 = NL + "    conn_";
  protected final String TEXT_757 = ".close();";
  protected final String TEXT_758 = NL + "globalMap.put(\"";
  protected final String TEXT_759 = "_QUERY\", querySQL_";
  protected final String TEXT_760 = ");" + NL + "" + NL + "String currentClientPathSeparator_";
  protected final String TEXT_761 = " = (String)globalMap.get(\"current_client_path_separator\");" + NL + "if(currentClientPathSeparator_";
  protected final String TEXT_762 = "!=null) {" + NL + "    System.setProperty(\"path.separator\", currentClientPathSeparator_";
  protected final String TEXT_763 = ");" + NL + "    globalMap.put(\"current_client_path_separator\", null);" + NL + "}" + NL + "" + NL + "String currentClientUsername_";
  protected final String TEXT_764 = " = (String)globalMap.get(\"current_client_user_name\");" + NL + "if(currentClientUsername_";
  protected final String TEXT_765 = "!=null) {" + NL + "    System.setProperty(\"user.name\", currentClientUsername_";
  protected final String TEXT_766 = ");" + NL + "    globalMap.put(\"current_client_user_name\", null);" + NL + "}" + NL + "" + NL + "String originalHadoopUsername_";
  protected final String TEXT_767 = " = (String)globalMap.get(\"HADOOP_USER_NAME_";
  protected final String TEXT_768 = "\");" + NL + "if(originalHadoopUsername_";
  protected final String TEXT_769 = "!=null) {" + NL + "    System.setProperty(\"HADOOP_USER_NAME\", originalHadoopUsername_";
  protected final String TEXT_770 = ");" + NL + "    globalMap.put(\"HADOOP_USER_NAME_";
  protected final String TEXT_771 = "\", null);" + NL + "} else {" + NL + "    System.clearProperty(\"HADOOP_USER_NAME\");" + NL + "}";
  protected final String TEXT_772 = NL + "        bw_";
  protected final String TEXT_773 = ".write(querySQL_";
  protected final String TEXT_774 = " + \";\");" + NL + "        globalMap.put(\"";
  protected final String TEXT_775 = "_QUERY\", querySQL_";
  protected final String TEXT_776 = ");" + NL + "" + NL + "        bw_";
  protected final String TEXT_777 = ".close();" + NL + "" + NL + "        if(libjars_";
  protected final String TEXT_778 = ".length() > 0) {" + NL + "            instance_";
  protected final String TEXT_779 = ".setLibJars(libjars_";
  protected final String TEXT_780 = ".toString().substring(0, libjars_";
  protected final String TEXT_781 = ".length()-1));" + NL + "        }" + NL + "        instance_";
  protected final String TEXT_782 = ".callWS(instance_";
  protected final String TEXT_783 = ".sendFiles());" + NL + "        int exitCode_";
  protected final String TEXT_784 = " = instance_";
  protected final String TEXT_785 = ".execute();" + NL + "        if(exitCode_";
  protected final String TEXT_786 = " > 0) {" + NL;
  protected final String TEXT_787 = NL + "                throw new Exception(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_788 = NL + "                System.err.println(\"The Hive job failed. Please read the logs for more details\");";
  protected final String TEXT_789 = NL + "                    log.error(\"";
  protected final String TEXT_790 = " - The Hive job failed. Please read the logs for more details\");";
