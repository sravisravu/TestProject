...
public class TFilterColumnsStormcodeJava
{
  protected static String nl;
  public static synchronized TFilterColumnsStormcodeJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TFilterColumnsStormcodeJava result = new TFilterColumnsStormcodeJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " stream_";
  protected final String TEXT_4 = " = ";
  protected final String TEXT_5 = ";";
  protected final String TEXT_6 = NL + "        public static class ";
  protected final String TEXT_7 = " implements Serializable {";
  protected final String TEXT_8 = NL + "        }";
  protected final String TEXT_9 = NL + "        public final static Fields fields = new Fields(";
  protected final String TEXT_10 = ");";
  protected final String TEXT_11 = NL + "            public static final int tupleIndex";
  protected final String TEXT_12 = "_";
  protected final String TEXT_13 = " = ";
  protected final String TEXT_14 = ";";
  protected final String TEXT_15 = NL + "        /** Default serial version UID. */" + NL + "        private static final long serialVersionUID = 1L;";
  protected final String TEXT_16 = NL + "           private TridentTuple tuple;";
  protected final String TEXT_17 = NL + "            ";
  protected final String TEXT_18 = "(TridentTuple tuple) {";
  protected final String TEXT_19 = NL + "            }";
  protected final String TEXT_20 = NL + "            this.tuple = tuple;";
  protected final String TEXT_21 = NL + "            public TridentTuple getTuple() {" + NL + "                return tuple;" + NL + "            }" + NL + "" + NL + "            public void setTuple(TridentTuple tuple) {" + NL + "                this.tuple = tuple;" + NL + "            }";
  protected final String TEXT_22 = NL + "            public final static String getField";
  protected final String TEXT_23 = "_";
  protected final String TEXT_24 = "() {";
  protected final String TEXT_25 = NL + "                    return \"";
  protected final String TEXT_26 = "__";
  protected final String TEXT_27 = "\";";
  protected final String TEXT_28 = NL + "                    return ";
  protected final String TEXT_29 = ";";
  protected final String TEXT_30 = NL + "            }";
  protected final String TEXT_31 = NL + "            public final ";
  protected final String TEXT_32 = " get";
  protected final String TEXT_33 = "_";
  protected final String TEXT_34 = "() {" + NL + "                return ";
  protected final String TEXT_35 = "(tupleIndex";
  protected final String TEXT_36 = "_";
  protected final String TEXT_37 = ");" + NL + "            }";
  protected final String TEXT_38 = NL + "        public final static Values createValues(";
  protected final String TEXT_39 = " ";
  protected final String TEXT_40 = ") {" + NL + "            return new Values(";
  ...
  protected final String TEXT_44 = " {" + NL + "            /** Default serial version UID. */" + NL + "            private static final long serialVersionUID = 1L;" + NL + "            public ";
  protected final String TEXT_45 = "(TridentTuple tuple) {" + NL + "                super(tuple);" + NL + "            }" + NL + "        }";
...
for (IMetadataColumn column : streamUtil.getFirstOutConnection().getMetadataTable().getListColumns()) {
  twhStandard.setCodeFieldName(column,
          new TupleWrapperHelper().getClassName(
                  streamUtil.getInConnection())
                  + ".getField_" + column.getLabel() +"()");
}
