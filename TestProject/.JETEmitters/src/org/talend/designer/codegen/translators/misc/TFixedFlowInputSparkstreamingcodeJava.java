...
public class TFixedFlowInputSparkstreamingcodeJava
{
  ...
  protected final String TEXT_271 = NL + NL + "    public java.util.List<";
  protected final String TEXT_272 = "> getList() {" + NL + "        java.util.List<";
  protected final String TEXT_273 = "> list = new java.util.ArrayList<";
  protected final String TEXT_274 = ">(data.size());" + NL + "        for (int n = 0; n < ";
  protected final String TEXT_275 = "; n++) {" + NL + "            for (int i = 0; i < data.size(); i++) {";
  protected final String TEXT_276 = NL + "                ";
  protected final String TEXT_277 = " row = new ";
  protected final String TEXT_278 = "();";
  protected final String TEXT_279 = NL + "                 list.add(row);" + NL + "            }" + NL + "        }" + NL + "        return list;" + NL + "    }" + NL + "}" + NL;
  protected final String TEXT_280 = NL + NL + NL + "public static class CustomReceiver_";
  protected final String TEXT_281 = " extends org.apache.spark.streaming.receiver.Receiver<";
  protected final String TEXT_282 = "> {" + NL + "" + NL + "    private final java.util.List<";
  protected final String TEXT_283 = "> list;" + NL + "    private long repetitionInterval;" + NL + "" + NL + "    public CustomReceiver_";
  protected final String TEXT_284 = "(java.util.List<";
  protected final String TEXT_285 = "> list, long repetitionInterval) {" + NL + "        super(org.apache.spark.storage.StorageLevel.MEMORY_AND_DISK());" + NL + "        this.list = list;" + NL + "        this.repetitionInterval = repetitionInterval < 1 ? 1 : repetitionInterval;" + NL + "    }" + NL + "" + NL + "    @Override" + NL + "    public void onStart() {" + NL + "        new Thread()  {" + NL + "              @Override" + NL + "              public void run() {" + NL + "                try {" + NL + "                    receive();" + NL + "                } catch (InterruptedException e) {" + NL + "                    e.printStackTrace();" + NL + "                }" + NL + "              }" + NL + "            }.start();" + NL + "    }" + NL + "" + NL + "    @Override" + NL + "    public void onStop() {" + NL + "    }" + NL + "" + NL + "    private void receive() throws InterruptedException{" + NL + "        while(true){" + NL + "            Thread.sleep(repetitionInterval);" + NL + "            storeRecords(list);" + NL + "        }" + NL + "    }" + NL + "" + NL + "    private void storeRecords(java.util.List<";
  protected final String TEXT_286 = "> list){" + NL + "        java.util.Iterator<";
  protected final String TEXT_287 = "> iterator = list.iterator();" + NL + "        while(iterator.hasNext()){" + NL + "            store(iterator.next());" + NL + "        }" + NL + "    }" + NL + "" + NL + "}";
  protected final String TEXT_288 = NL + "public static class ";
  protected final String TEXT_289 = "_mapToPair implements org.apache.spark.api.java.function.PairFunction<";
  protected final String TEXT_290 = ", NullWritable, ";
  protected final String TEXT_291 = "> {" + NL + "" + NL + "    private ContextProperties context = null;" + NL + "" + NL + "    public ";
  protected final String TEXT_292 = "_mapToPair(JobConf job) {" + NL + "                this.context = new ContextProperties(job);" + NL + "            }" + NL + "" + NL + "    public scala.Tuple2<NullWritable, ";
  protected final String TEXT_293 = "> call(";
  protected final String TEXT_294 = " data){" + NL + "        return new scala.Tuple2<NullWritable, ";
  protected final String TEXT_295 = ">(NullWritable.get(), data);" + NL + "    }" + NL + "}";
