...
public class TMongoDBGridFSPutBeginJava
{
  ...
  protected final String TEXT_127 = ");" + NL + "" + NL + "\t\t\tjava.util.List<String> msg_";
  protected final String TEXT_128 = " = new java.util.ArrayList<String>();" + NL + "\t\t\tjava.util.List<java.util.Map<String,String>> list_";
  protected final String TEXT_129 = " = new java.util.ArrayList<java.util.Map<String,String>>();\t" + NL + "\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\tjava.util.Map<String,String> map_";
  protected final String TEXT_131 = "_";
  protected final String TEXT_132 = " = new java.util.HashMap<String,String>();" + NL + "\t\t\t\tmap_";
  protected final String TEXT_133 = "_";
  protected final String TEXT_134 = ".put(";
  protected final String TEXT_135 = ",";
  protected final String TEXT_136 = ");" + NL + "\t\t\t \tlist_";
  protected final String TEXT_137 = ".add(map_";
  protected final String TEXT_138 = "_";
  protected final String TEXT_139 = ");       " + NL + "\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\tString localdir_";
  protected final String TEXT_141 = "  = ";
  protected final String TEXT_142 = ";\t" + NL + "\t\t\tfor (java.util.Map<String, String> map_";
  protected final String TEXT_143 = " : list_";
