...
public class TMapSparkconfigJava
{
  protected static String nl;
  public static synchronized TMapSparkconfigJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TMapSparkconfigJava result = new TMapSparkconfigJava();
    nl = null;
    return result;
  }
