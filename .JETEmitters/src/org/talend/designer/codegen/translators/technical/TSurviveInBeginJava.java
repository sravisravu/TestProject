...
public class TSurviveInBeginJava
{
  protected static String nl;
  public static synchronized TSurviveInBeginJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TSurviveInBeginJava result = new TSurviveInBeginJava();
    nl = null;
    return result;
  }
