...
public class THDFSRowCountMainJava
{
  ...
  protected final String TEXT_125 = NL + "\t  String filename_";
  protected final String TEXT_126 = " = ";
  protected final String TEXT_127 = ";" + NL + "\t  int emptyLineCount_";
  protected final String TEXT_128 = " = 0;" + NL + "\t  org.apache.hadoop.fs.Path file_";
  protected final String TEXT_129 = " = new org.apache.hadoop.fs.Path(filename_";
  protected final String TEXT_130 = ");" + NL + "\t  org.apache.hadoop.fs.FSDataInputStream fsdis_";
  protected final String TEXT_131 = " = fs_";
  protected final String TEXT_132 = ".open(file_";
  protected final String TEXT_133 = ");" + NL + "\t" + NL + "\t  int lineCount_";
  protected final String TEXT_134 = " = 0;" + NL + "\t  " + NL + "\t  ";
  protected final String TEXT_135 = NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_136 = " = new java.io.BufferedReader(new java.io.InputStreamReader(fsdis_";
  protected final String TEXT_137 = ", ";
  protected final String TEXT_138 = "));" + NL + "\t  ";
  protected final String TEXT_139 = NL + "\t    org.apache.hadoop.io.compress.GzipCodec codec_";
  protected final String TEXT_140 = " = new org.apache.hadoop.io.compress.GzipCodec();" + NL + "\t\tcodec_";
  protected final String TEXT_141 = ".setConf(conf_";
  protected final String TEXT_142 = ");\t" + NL + "\t  ";
  protected final String TEXT_143 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionCodec codec_";
  protected final String TEXT_144 = " = org.apache.hadoop.util.ReflectionUtils.newInstance(org.apache.hadoop.io.compress.BZip2Codec.class, conf_";
  protected final String TEXT_145 = ");" + NL + "\t  ";
  protected final String TEXT_146 = NL + "\t  \torg.apache.hadoop.io.compress.CompressionInputStream in";
  protected final String TEXT_147 = " = codec_";
  protected final String TEXT_148 = ".createInputStream(fsdis_";
  protected final String TEXT_149 = ");" + NL + "\t  \tjava.io.BufferedReader br_";
  protected final String TEXT_150 = " = new java.io.BufferedReader(new java.io.InputStreamReader(in";
  protected final String TEXT_151 = ", ";
  protected final String TEXT_152 = "));" + NL + "\t  ";
  protected final String TEXT_153 = NL + "\t  " + NL + "\t  \t\t\t" + NL + "\t  String rowSeparator_";
  protected final String TEXT_154 = " = ";
  protected final String TEXT_155 = ";" + NL + "\t  byte[] bytes_";
  protected final String TEXT_156 = " = rowSeparator_";
  protected final String TEXT_157 = ".getBytes();" + NL + "\t  int index_";
  protected final String TEXT_158 = " = 0, oneChar_";
  protected final String TEXT_159 = " = 0, tipEmptyLineCount_";
  protected final String TEXT_160 = " = 0; " + NL + "\t  boolean bTipEmptyFlagOpen_";
  protected final String TEXT_161 = " = true, bReadyEOF_";
  protected final String TEXT_162 = " = false;" + NL + "\t\t\t" + NL + "\t  if(bytes_";
  protected final String TEXT_163 = ".length > 0) {" + NL + "\t    while ((oneChar_";
  protected final String TEXT_164 = " = br_";
  protected final String TEXT_165 = ".read()) != -1) {" + NL + "\t      if (oneChar_";
  protected final String TEXT_166 = " == bytes_";
  protected final String TEXT_167 = "[index_";
  protected final String TEXT_168 = "]) {" + NL + "\t      " + NL + "\t        if (index_";
  protected final String TEXT_169 = " < bytes_";
  protected final String TEXT_170 = ".length - 1){" + NL + "\t          index_";
  protected final String TEXT_171 = " ++ ;" + NL + "\t          continue; // match next char" + NL + "\t        }" + NL + "\t        " + NL + "\t        if (index_";
  protected final String TEXT_172 = " == bytes_";
  protected final String TEXT_173 = ".length - 1) {                  " + NL + "\t          lineCount_";
  protected final String TEXT_174 = "++;" + NL + "\t          if(bTipEmptyFlagOpen_";
  protected final String TEXT_175 = ") {" + NL + "\t            tipEmptyLineCount_";
  protected final String TEXT_176 = " ++;" + NL + "\t            emptyLineCount_";
  protected final String TEXT_177 = " ++;" + NL + "\t          }" + NL + "\t          bReadyEOF_";
  protected final String TEXT_178 = " = false; // next row must be have char(or EOF flag)" + NL + "\t          bTipEmptyFlagOpen_";
  protected final String TEXT_179 = " = true; " + NL + "\t          index_";
  protected final String TEXT_180 = " = 0;" + NL + "\t        }" + NL + "\t        " + NL + "\t      }else{      " + NL + "\t        bReadyEOF_";
  protected final String TEXT_181 = " = true;" + NL + "\t        bTipEmptyFlagOpen_";
  protected final String TEXT_182 = " = false;" + NL + "\t        tipEmptyLineCount_";
  protected final String TEXT_183 = " = 0;" + NL + "\t        index_";
  protected final String TEXT_184 = " = 0;        " + NL + "\t      }" + NL + "\t    }" + NL + "\t    " + NL + "\t    if (bReadyEOF_";
  protected final String TEXT_185 = ") lineCount_";
  protected final String TEXT_186 = " ++ ; // add last row if not end by row separator" + NL + "\t    " + NL + "\t    if (bTipEmptyFlagOpen_";
  protected final String TEXT_187 = ") {" + NL + "\t      lineCount_";
  protected final String TEXT_188 = " -= tipEmptyLineCount_";
  protected final String TEXT_189 = ";" + NL + "\t      emptyLineCount_";
  protected final String TEXT_190 = " -= tipEmptyLineCount_";
  protected final String TEXT_191 = ";" + NL + "\t    }          " + NL + "\t  }" + NL + "\t  br_";
  protected final String TEXT_192 = ".close();" + NL + "\t";
  protected final String TEXT_193 = NL + "  \tlineCount_";
  protected final String TEXT_194 = " -= emptyLineCount_";
  protected final String TEXT_195 = ";" + NL + "\t";
  protected final String TEXT_196 = "   " + NL + "  \tglobalMap.put(\"";
  protected final String TEXT_197 = "_COUNT\",lineCount_";
  protected final String TEXT_198 = ");" + NL + "  \t" + NL + "\t";
  protected final String TEXT_199 = NL + "\tlog.info(\"";
  protected final String TEXT_200 = " - file : \" + file_";
  protected final String TEXT_201 = " + \" line count is \" + lineCount_";
